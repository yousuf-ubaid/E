...
!function (a, b) {
    ...
    var n = {
        dialog: "<div class='bootbox modal' tabindex='-1' role='dialog'><div class='modal-dialog'><div class='modal-content' style='border-radius: 0px;'><div class='modal-body'><div class='bootbox-body'></div></div></div></div></div>",
        header: "<div class='modal-header'><h4 class='modal-title'></h4></div>",
        footer: "<div class='modal-footer' style='padding:8px;'></div>",
        closeButton: "<button type='button' class='bootbox-close-button close' style='margin-right: -15px; color: red;' data-dismiss='modal' aria-hidden='true'>&times;</button>",
    ...
    p.alert = function () {
        ...
        if (g(j, function (a, b) {
                k += "<button data-bb-handler='" + a + "' type='button' class='btn btn-sm " + b.className + "'>" + b.label + "</button>", l[a] = b.callback
