                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" style="box-sizing: border-box; font-size: 14px; margin: 0;">
                                ...
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0; text-align: justify; text-justify: inter-word;">
                                    <td class="content-block" style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 0 0 20px;" valign="top">
                                        Kindly note that your subscription is expiring / has expired on <b><?=date('dS F Y', strtotime($subscriptionStartDate))?></b>. We request you to renew the subscription before <b><?=date('dS F Y', strtotime($dueDate))?></b> in order to avoid and service disruption. You may contact us on the following mail-id to get more details: <a href="mailto:Shabab.riyal@pbs-int.net"><b>Shabab.riyal@pbs-int.net</b></a>. Please ignore the message if you have already paid.
                                    </td>
                                </tr>
