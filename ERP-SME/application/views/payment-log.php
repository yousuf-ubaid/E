    ...
    <div class="col-md-12">
        <div class="box">            
            ...
            <div class="box-header with-border">
                <h3 class="box-title">Payment Log</h3>
                <span class=""> 
                        ...
                        <div class="table-responsive">
                            <table id="payDet_tb" class="<?=table_class()?>">
                                ...
                                <tr>
                                    ...
                                    <th style="min-width: 10%">Invoice Type</th>
                                    <th style="min-width: 8%">Invoice No</th>                                    
                                    <th style="min-width: 10%">Summary</th>
                                    <th style="min-width: 35%">Log</th> 
                                    <th style="min-width: 10%">Log Date</th>
...
<script type="text/javascript">    
    ...
    function load_payment_log_data() {
        payDet_tb = $('#payDet_tb').DataTable({
            "bProcessing": true,
            "bServerSide": true,
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Dashboard/fetch_payment_log'); ?>",
            "aaSorting": [[0, 'DESC']],
    ...
    function logDecode(logID){
        $.ajax({
            type: 'POST',
            dataType: 'html',
            url: "<?php echo site_url('Dashboard/logDecode'); ?>",
            data: {'logID': logID},
            cache: false,
            beforeSend: function () {
                startLoad(); 
