...
class SendEmail extends ERP_Controller
{
    ...
    function sendEmail()/*send mail*/
    {
        ...
        $mail->Host = 'xcloud-portal.com';  // Specify main and backup SMTP servers
        $mail->SMTPAuth = true;                               // Enable SMTP authentication
        $mail->Username = 'info@xcloud-portal.com';                 // SMTP username
        $mail->Password = 'P@ssw0rd240!';                           // SMTP password
        $mail->Port = 25;                                    // TCP port to connect to
        $mail->setFrom('info@xcloud-portal.com', 'Info xCloud');
