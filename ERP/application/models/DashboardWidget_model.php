    ...
    function save_template_setup_add()
    {
        if (!empty($this->input->post('description'))) {
            ...
            if ($desc) {
                ...
                {
                    return array('s', 'Dashboard Updated Successfully');
                }
            }
        } else {
