...
<table class="table table-bordered table-striped table-condesed">
    ...
    <tr>
        ...
        <th colspan="2" class=""> <?php echo $this->lang->line('sales_markating_transaction_markup');?></th><!--Item Details-->
        ...
        <th class="" colspan="1"><?php echo $this->lang->line('sales_markating_transaction_top_margin');?><!--Amount--> <span class="currency"><?php echo $transaction_currency ?></span></th>
        <th>&nbsp;</th>
    </tr>
    <tr>
        <th style="min-width: 5%">#</th>
        <th style="min-width: 15%">Cost Sheet</th>
        <th class="text-center" style="min-width: 10%"><?php echo $this->lang->line('common_value');?></th><!--Code-->
        <th  class="text-center" style="min-width: 5%" class="text-left">%</th><!--Description-->
        ...
        <th class="text-center"  style="min-width: 10%"><?php echo $this->lang->line('common_value');?></th><!--Discount-->
        <th  class="text-center" style="min-width: 10%"></th><!--Discount-->
    </tr>
    </thead>
        ...
        <?php foreach($charge_data as $data) { 
            ...
            <tr class="danger lineitem">
                <td>#
                    ...
                    <input type="hidden" name="contractAutoID" id="contractAutoID" class="contractAutoID" value="<?php echo $data['contractAutoID'] ?>"/>
                ...
                <td>
                    ...
                    <input type="number" style="width:90%;border:1px solid #d2d6de;border-top: 0px !important;border-right: 0 !important;border-left: 0 !important;" class="markupPercentage text-right" onchange="update_values(this,'markup_percentage')" value="<?php echo $data['markup_percentage'] ?>" />
                    <a class="btn btn-default btn-sm" onclick="apply_to_all_commission(this)"><i class="fa fa-arrow-down"></i></a>
...
<script>
    ...
    function update_values(ev,column){
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('Quotation_contract/update_contract_extra_charge'); ?>",
            beforeSend: function () {
                startLoad();
            },
