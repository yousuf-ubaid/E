...
$customerOrderList = get_customerOrderList(1);
...
if($pID != '') {
    ...
    $customerOrderList = get_customerOrderList(1,$customeridcurrentdoc['customerOrderID']);
}
...
<div class="m-b-md" id="wizardControl">
        ...
        <div class="steps">
            ...
            <a class="step-wiz step--incomplete step--inactive btn-wizard hide" id="cost_allocation_tab" href="#step4" onclick="fetch_cost_allocation_table();" data-toggle="tab">
                <span class="step__icon"></span>
                <span class="step__label"><?php echo $this->lang->line('sales_markating_transaction_step_three');?> - <?php echo $this->lang->line('sales_markating_transaction_cost_allocation');?> </span>
            </a>
            <a class="step-wiz step--incomplete step--inactive btn-wizard" href="#step3" onclick="load_conformation();"  data-toggle="tab">
                <span class="step__icon"></span>
                <span class="step__label"><?php echo $this->lang->line('sales_markating_transaction_step_four');?> - <?php echo $this->lang->line('sales_markating_transaction_confirmation');?></span>
            </a>
        </div>
</div>
<hr>
<div class="tab-content">
    <div id="step1" class="tab-pane active">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-4">
              <label for="RVbankCode"><?php echo $this->lang->line('accounts_receivable_common_bank_or_cash');?><!--Bank or Cash--> </label>
                  <?php echo form_dropdown('RVbankCode', company_bank_account_drop(), '', 'class="form-control select2" id="RVbankCode" onchange="" '); ?>
              </div>            
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="row">                    
                    ...
                    <div class="form-group col-sm-4">
                        <div class="form-group">
                            <label for=""><?php echo $this->lang->line('sales_marketing_show_item_image');?></label><!-- Show Item Image-->
                            ...
                            <div class="hide" id="checkbox_back_to_back">
                                <label for="enable_backtoback"><?php echo $this->lang->line('sales_maraketing_is_back_to_back');?></label><!-- Show Item Image-->

                                <div class="skin skin-square">
                                    <div class="skin-section">
                                        <input id="enable_backtoback" type="checkbox" name="enable_backtoback" value="1" onchange="change_enable_backtoback(this)">
                                        <label for="checkbox">
                                            &nbsp;
                                        </label>
                                    </div>
                ...
                <div class="row">    
                    ...
                    <div class="col-md-4">
                        <div class="form-group" id="purchaseOrderDrop" style="display:none">
                            <label for="purchaseOrderID"><?php echo 'Select Purchase Order';?><!--Bank or Cash--> <?php required_mark(); ?></label>
                            <?php echo form_dropdown('purchaseOrderID', $purchaseOrderList , '', 'class="form-control select2" id="purchaseOrderID"'); ?>
                        </div>    
                        <div class="form-group" id="customerOrderDrop" style="display:none">
                            <label for="purchaseOrderID"><?php echo 'Select Customer Order';?><!--Bank or Cash--></label>
                            <?php echo form_dropdown('customerOrderID', $customerOrderList , '', 'class="form-control select2" id="customerOrderID" onchange="get_customer_order_details(this)"'); ?>
                        </div>  

                        <div class="form-group" id="marginPercentage" style="display:none">
                            <label for="marginPercentageValue"><?php echo 'Margin Percentage';?> </label><!--Contact Person Name-->
                            <input type="number" class="form-control " id="marginPercentageValue" name="marginPercentage">
                        </div>

                        <div class="form-group" id="modeOfPaymentField" style="display:none">
                            <label for="modeOfPayment"><?php echo 'Mode of Shipment';?> </label><!--Contact Person Name-->
                            <?php echo form_dropdown('modeOfPayment', $modeOfPayment , '', 'class="form-control select2" id="modeOfPayment" onchange=""'); ?>
                        </div>
                        <div class="form-group" id="principleRefField" style="display:none">
                            <label for="principleRef"><?php echo 'Principle Ref';?> </label><!--Contact Person Name-->
                            <input type="text" class="form-control " id="principleRef" name="principleRef">
                        </div>
                        <div class="form-group" id="clientRefField" style="display:none">
                            <label for="clientRef"><?php echo 'Client Ref';?> </label><!--Contact Person Name-->
                            <input type="text" class="form-control " id="clientRef" name="clientRef">
                        </div>
                        <div class="form-group" id="deleiverWeeksField" style="display:none">
                            <label for="deleiverWeeks"><?php echo 'Delivery Weeks';?> </label><!--Contact Person Name-->
                            <input type="number" class="form-control " id="deleiverWeeks" name="deleiverWeeks">
                        </div>
                        <div class="form-group" id="retentionPercentage" style="display:none">
                            <label for="retentionPercentageValue"><?php echo 'Retention Percentage';?> </label><!--Contact Person Name-->
                            <input type="number" class="form-control " id="retentionPercentageValue" name="retentionPercentage">
                        </div>
    ...
    <div id="step2" class="tab-pane">
        <div class="" id="itemDetailSection">
            <div class="row">
    ...
    <div id="step4" class="tab-pane">
        <div class="row">
            <div class="col-md-8"><h4><i class="fa fa-hand-o-right"></i> <?php echo $this->lang->line('sales_markating_transaction_document_item_detail');?> </h4><h4></h4></div><!--Item Detail-->
            <div class="col-md-4">
                <button type="button" onclick="pull_default_extra_cost()" class="btn btn-primary hide"><i
                        class="fa fa-plus"></i><?php echo ' Pull Default Extra Costs';?> <!--Add Item-->
                </button>
        ...
        <br>
        <div id="cost_allocation_table"></div>          
        <br>
    ...
    <div class="modal-dialog" style="width: 95%">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title"><?php echo $this->lang->line('sales_markating_transaction_sales_add_item_detail');?><!--Add Item Detail--></h5>
            </div>
                ...
                <div class="modal-body" style="overflow-x: scroll;">
                    <table class="table table-bordered table-striped table-condesed" id="item_add_table" style="table-layout: fixed">
                        ...
                        <tr>
                            ...
                            <th style="width: 100px;"><?php echo $this->lang->line('sales_marketing_current_stock'); ?><!--Current Stock-->
                ...
                <div class="modal-body" style="overflow-x: scroll;">
                    <table class="table table-bordered table-striped table-condesed" id="edit_item_add_form" style="table-layout: fixed">
                        ...
                        <tr>
                            ...
                            <?php } ?>
                            <th style="width: 150px;"><?php echo $this->lang->line('sales_markating_transaction_document_uom');?> <?php required_mark(); ?></th><!--UOM-->
                            <th style="width: 150px;"><?php echo $this->lang->line('sales_marketing_current_stock'); ?><!--Current Stock-->
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('.headerclose').click(function () {
            fetchPage('system/quotation_contract/quotation_contract_management', contractAutoID, 'Customer Quotation_contract');
        });
        ...
        $('#quotation_contract_form').bootstrapValidator({
            ...
            fields: {
                ...
                //RVbankCode: {validators: {notEmpty: {message: '<?php echo $this->lang->line('sales_markating_transaction_contract_bank_account_is_required');?>.'}}},/*Contract Bank Acc is required.*/
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data['status']) {
                        ...
                        $("#a_link").attr("href", "<?php echo site_url('Quotation_contract/load_contract_conformation'); ?>/" + contractAutoID);
                        $('[href=#step2]').tab('show');
    ...
    function fetch_detail_table() {
        ...
        var enable_backtoback = $('#enable_backtoback').is(":checked");
        
        if (contractAutoID) {
            if(enable_backtoback){
                $('#itemDetailSection').addClass('hide');
                $('#itemBackToBack').removeClass('hide');

                //call for different item view
                fn_backtoback_view(contractAutoID);

            }
            else{

                $('#itemDetailSection').removeClass('hide');
                $('#itemBackToBack').addClass('hide');
    ...
    function fn_backtoback_view(contractAutoID){
        ...
        $.ajax({
                ...
                dataType: 'html',
                data: {"contractAutoID":contractAutoID},
                url: "<?php echo site_url('Quotation_contract/get_backtoback_item_view'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
                    stopLoad();
                    $('#itemBackToBack').empty();
                    $('#itemBackToBack').html(data);
...
//                    $('#item_detail_form').bootstrapValidator('revalidateField', 'estimatedAmount');
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (!jQuery.isEmptyObject(data)) {
                        ...
                        $('#customerOrderID').val(data['customerOrderID']).change();
                        $('#modeOfPayment').val(data['modeOfPayment']).change();

                        $('#principleRef').val(data['principleRef']);
                        $('#clientRef').val(data['clientRef']);
                        $('#deleiverWeeks').val(data['deliveryWeek']);
                        ...
                        if (data['isBackToBack'] == 1) {
                            $('#enable_backtoback').iCheck('check').change();
                        } else {
                            $('#enable_backtoback').iCheck('uncheck').change();
                        }

                        $('#marginPercentageValue').val(data['marginPercentage']);
    ...
    function load_default_note(){
        ...
        if(docType == 'Quotation'){
            $('#checkbox_back_to_back').removeClass('hide');
        }else{
            $('#checkbox_back_to_back').addClass('hide');
        }
    }
       ...
       // $('#contactPersonNumber').val('');
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#addressBoxEditH').val(data['customerAddress1']);
                $('#emailBoxEditH').val(data['customerEmail']);
                $('#contactNumberBoxEditH').val(data['customerTelephone']);
                $('#customerUrlBoxEditH').val(data['customerUrl']);
    ...
    function change_enable_backtoback(ev){
      
        if($(ev).is(':checked')){
            $('#itemAddBtn').addClass('hide');
           // $("#purchaseOrderDrop").css('display','block');  // checked

            $("#customerOrderDrop").css('display','block'); 
            $("#marginPercentage").css('display','block');
            $("#retentionPercentage").css('display','block');  
            $('#cost_allocation_tab').removeClass('hide');

            $("#modeOfPaymentField").css('display','block'); 
            $("#principleRefField").css('display','block'); 
            $("#clientRefField").css('display','block'); 
            $("#deleiverWeeksField").css('display','block'); 

        }else{
            $('#itemAddBtn').removeClass('hide');
            // $("#purchaseOrderDrop").css('display','none');  // checked

            $("#customerOrderDrop").css('display','none'); 
            $("#marginPercentage").css('display','none'); 
            $("#retentionPercentage").css('display','none'); 
            $('#cost_allocation_tab').addClass('hide');

            
            $("#modeOfPaymentField").css('display','none'); 
            
            $("#principleRefField").css('display','none'); 
            
            $("#clientRefField").css('display','none'); 
            
            $("#deleiverWeeksField").css('display','none'); 
        }
            
    }

    function fetch_cost_allocation_table(){
        ...
        $.ajax({
            ...
            dataType: 'html',
            data: {'contractAutoID': contractAutoID},
            url: "<?php echo site_url('Quotation_contract/fetch_extra_charge_tbl'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
                stopLoad();
                $('#cost_allocation_table').empty();
                $('#cost_allocation_table').html(data);
            }, error: function () {
                swal("Cancelled", "Your file is safe :)", "error");
            }
        });
    ...
    function add_extra_charge_detail(){
        ...
        $.ajax({
            ...
            type: 'post',
            dataType: 'json',
            data: {'contractAutoID': contractAutoID,'extraChargeID':extraChargeID,'extraChargeValue':extraChargeValue},
            url: "<?php echo site_url('Quotation_contract/set_contract_extra_charge'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
    ...
    function pull_default_extra_cost(){

            swal({
                    title: "<?php echo $this->lang->line('common_are_you_sure');?>",/*Are you sure*/
                    text: "<?php echo $this->lang->line('common_you_want_to_pull_extra_charges');?>",/*You want to confirm this document*/
                    type: "warning",/*warning*/
                    showCancelButton: true,
                    confirmButtonColor: "#DD6B55",
                    confirmButtonText: "<?php echo $this->lang->line('common_confirm');?>",/*Confirm*/
    ...
    function get_customer_order_details(ev){

        $.ajax({
            async: true,
            type: 'post',
            dataType: 'json',
            data: {'contractAutoID': contractAutoID,'customerOrderID':$(ev).val()},
            url: "<?php echo site_url('Quotation_contract/get_customer_order_details'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
                stopLoad();
                $('#referenceNo').val(data.customerReferenceNumber);
                $('#clientRef').val(data.customerReferenceNumber);
                $('#customerID').val(data.customerID).change();
                $('#contractNarration').val(data.narration).change();
...
<script type="text/javascript">   
    ...
    function contract_customer_details_edit(modal = 0){
