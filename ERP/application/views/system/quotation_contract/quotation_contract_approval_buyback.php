...
<script type="text/javascript">
    ...
    function quotation_contract_table() {
        Otable = $('#quotation_contract_approval_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Quotation_contract/fetch_quotation_contract_approval_buyback'); ?>",
            "aaSorting": [[0, 'desc']],
            ...
            "columnDefs": [{"targets": [10,11], "visible": false},{"targets": [0,6], "searchable": false}],
