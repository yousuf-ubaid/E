    ...
    <table>
        ...
        <tr>
            ...
            <td style="width:80%;">
                <table>
                    <tr>
                        <td><?php echo str_replace(PHP_EOL, '<br /> ', $extra['master']['JVNarration']);?></td>
                    </tr>
                </table>
...
<div class="table-responsive">
    <table id="add_new_grv_table" class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <th class='theadtr' colspan="3"> <?php echo $this->lang->line('common_amount');?><!--Amount--> (<?php echo $extra['master']['transactionCurrency']; ?>)</th>
        </tr>
        <tr>
            ...
            <th class='theadtr' style="min-width: 32%"><?php echo $this->lang->line('common_gl_code_description');?><!--GL Code Description--></th>
