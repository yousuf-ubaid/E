<!---- =============================================
-- File Name : erp_finance_drilldown_templatereport.php
-- Project Name : SME ERP
-- Module Name : Report - Finance
-- Create date : 04 - DEC 2023
-- Description : This file contains General Ledger Template Details
...
<div id="tbl_general_ledger_tb">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="text-center reportHeader reportHeaderColor">Template General Ledger</div>
            <!--<div
