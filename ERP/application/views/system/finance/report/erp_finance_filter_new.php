...
}else
{
    ...
    if ($reportID == "FIN_IS" || $reportID == "FIN_BS" ) {
       
        
        $comtemplate = fetch_all_companytemplate($reportID);
    }
        ...
        <div class="row">
            <div class="col-md-12 animated zoomIn">
                <fieldset class="scheduler-border">
                        ...
                        <div class="form-group col-sm-4" style="margin-bottom: 0px">
                            ...
                            <div class="input-group col-md-8">
                                ...
                                echo form_dropdown('financeYear[]', $financeyear,$this->common_data['company_data']['companyFinanceYearID'], 'class="financeYear form-control" id="financeYear"');
                                    ...
                                    echo form_dropdown('financeYear[]', $financeyear, 'class="financeYear form-control" id="financeYear"');
                                }
                                ?>
                            </div>
                        </div>
                    ...
                    <?php if ($reportID == "FIN_IS" || $reportID == "FIN_BS") { ?>
                <div class="col-md-3">
                <label class="">Select  Template</label>
                <div>
                    <?php echo form_dropdown('TemplateID', $comtemplate, '', 'id="TemplateID" class="form-control select2" ');  ?>
                </div>
               </div>
               <?php } ?>
