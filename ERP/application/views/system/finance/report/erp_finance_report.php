...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/finance/report/erp_finance_report', '<?php echo $_POST["page_id"] ?>', '<?php echo $_POST["page_name"] ?>')
        });
        ...
        if(type == 1){
            ...
            urlDrill = '<?php echo site_url('Report/get_report_drilldown'); ?>';
    ...
    function get_finance_filter() {
        $.ajax({
            ...
            url: "<?php echo site_url('Report/get_finance_filter'); ?>",
            beforeSend: function () {
