                                                ...
                                                <div class="form-group  col-sm-5">                                                                                              
                                                    ...
                                                    <div class="dropdown-menu set-dropdown-action" aria-labelledby="dropdownMenuButton">
                                                        <!-- <a class="btn btn-outline-primary btn-circle btn-sm mrb-1" onclick="open_attachment_model_supplier_view(<?php echo $sup['inquiryMasterID']?>,<?php echo $sup['supplierID'] ?>)" ><span title="View" rel="tooltip" class="glyphicon glyphicon-eye-open"></span></a> -->
                                                                        <a class="btn btn-outline-info btn-circle btn-sm mrb-1" onclick="open_chat_model(<?php echo $sup['inquiryMasterID'] ?>, <?php echo $sup['supplierID'] ?>, 4)">
                                                                            <span title="Chat" rel="tooltip" class="glyphicon glyphicon-comment"></span>
                                                                        </a>
                ...
                <table class="table table-hover table-striped order-review-style-tbl">
                    <tbody>
                        ...
                        <tr id="supplier_col" class="tbl-bg-1">
                            ...
                            ?>
                            <td class="text-center supplier-col" colspan="6" style="border-bottom: 1px solid transparent"><?php echo $val['supplierName'] ?> 
                        ...
                        <tr class="tbl-bg-2">
                            ...
                            <?php foreach($supplier_Data as $val) { ?>
                            <td class="" style="border-bottom: 1px solid #eee">Unit Price </td>
                            <td class="" style="border-bottom: 1px solid #eee">Qty </td>

                            <td class="" style="border-bottom: 1px solid #eee">Discount</td>
                            <td class="" style="border-bottom: 1px solid #eee">Tax </td>
                            <td class="" style="border-bottom: 1px solid #eee">Technical Spec</td>
                            <td class="" style="border-bottom: 1px solid #eee">Total Price</td>
                        ...
                        <tr class="fw-500">
                            ...
                            <td class="" style="border-bottom: 1px solid #eee "> <?php echo $val['itemName'] ?> </td>
                            ...
                            <?php 
                                ...
                                $submit_value = $this->db->query("SELECT inquiryDetailID,inquiryMasterID,supplierID,supplierQty,supplierPrice,supplierDiscount,supplierTax,supplierOtherCharge,supplierTaxPercentage,supplierDiscountPercentage from srp_erp_srm_orderinquirydetails  where srp_erp_srm_orderinquirydetails.supplierID = " . $val1['supplierID'] . " AND srp_erp_srm_orderinquirydetails.itemAutoID = " . $val['itemAutoID'] . " AND srp_erp_srm_orderinquirydetails.isSupplierSubmited =  1 AND srp_erp_srm_orderinquirydetails.inquiryMasterID =".$val['inquiryMasterID']."")->row_array();
                                
                            ?>

                            <?php if($submit_value){ ?>
                                <td class="text-right" style="border-bottom: 1px solid #eee;background: rgb(138 98 124 / <?php echo $bg; ?>%)">
                                    <div class="dropdown">
                                        <button class="btn btn-xs dropdown-toggle btn-d" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <td class="text-right" style="border-bottom: 1px solid #eee;background: rgb(138 98 124 / <?php echo $bg; ?>%)"> <?php echo number_format($submit_value['supplierDiscount'],2) ?> (<?php echo $submit_value['supplierDiscountPercentage'] ?>%)</td>
                                <td class="text-right" style="border-bottom: 1px solid #eee;background: rgb(138 98 124 / <?php echo $bg; ?>%)"> <?php echo number_format($submit_value['supplierTax'],2) ?> (<?php echo $submit_value['supplierTaxPercentage'] ?>%)</td>
                                <td class="text-center" style="border-bottom: 1px solid #eee;background: rgb(138 98 124 / <?php echo $bg; ?>%)">
                                    <div class="or-set-group">
                                        <div class="dropdown mr-1">
                                            ...
                                            <div class="dropdown-menu set-dropdown-action" aria-labelledby="dropdownMenuButton">
                                            <?php if (isset($self_filter[0]['isCurrentUser']) && $self_filter[0]['isCurrentUser'] == 1): ?>
                                                <a class="btn btn-outline-info btn-circle btn-sm fs-12 mrb-1" onclick="open_chat_model(<?php echo $submit_value['inquiryDetailID'] ?>,<?php echo $submit_value['inquiryMasterID']?>,<?php echo $submit_value['supplierID'] ?>,<?php echo $val['itemAutoID'] ?>, 3)">
                                                    <span title="Chat" rel="tooltip" class="glyphicon glyphicon-comment fs-12"></span>
                                                </a>
                                            <?php else: ?>
                                        ...
                                        <div class="skin-section extraColumns">
                                                <input
                                                    ...
                                                    if (!empty($supplierIDarr)) {
                                                        if (in_array($submit_value['supplierID'].'_'.$val['itemAutoID'], $supplierIDarr)) {
                                                            echo "checked";
                                                        }
                                                    }
                                                    ?>
                                                    data-caption=""
                                                    class="columnSelected supplier_checkbox"
                                                    name="isSuppliers"
                                                    onclick="orderItem_selected_check_supplier_base(this)"
                                                    value="<?php echo $val['itemAutoID'] . "_" . $submit_value['supplierID'] . "_" . $submit_value['inquiryDetailID'] ?>"
                                                    disabled="disabled"
                                                >
                                ...
                                <td class="text-right" style="border-bottom: 1px solid #eee;background: rgb(138 98 124 / <?php echo $bg; ?>%)"> <?php echo number_format($submit_value['supplierPrice']*$submit_value['supplierQty'],2) ?> </td>
                            <?php }else{ ?>
                        ...
                        <tr class="fw-500">
                            ...
                            <?php foreach($supplier_Data as $val) {
                                ...
                                ?>
                                <td class="text-right" colspan="6" style="border-bottom: 1px solid #eee "> <?php echo number_format($sum,2) ?> </td>
                            <?php } ?>
                        ...
                        <tr class="fw-500">
                            ...
                            ?>
                            <td class="text-right" colspan="6" style="border-bottom: 1px solid #eee "> <?php echo number_format($supplierDiscount,2) ?> </td>
                            <?php } ?>
                        ...
                        <tr class="fw-500">
                            ...
                            ?>
                            <td class="text-right" colspan="6" style="border-bottom: 1px solid #eee "> <?php echo number_format($lastAmount,2) ?> </td>
                            <?php } ?>
   ...
   /*  $(".srmqty").editable({
    ...
    function open_chat_model(inquiryDetailID,inquiryMasterID,supplierID,itemAutoID,chatType){
        ...
        $.ajax({
            ...
            type: 'post',
            dataType: 'html',
            data: {inquiryMasterID: inquiryMasterID,inquiryDetailID:inquiryDetailID, supplierID: supplierID,itemAutoID:itemAutoID,chatType:chatType, html: true},
