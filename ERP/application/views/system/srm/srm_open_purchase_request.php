...
<div class="row">
    <div class="col-md-4">
        <!-- <table class="<?php echo table_class(); ?>">
            <tr>
                <td><span class="label label-success">&nbsp;</span> Completed</td>
                <td><span class="label label-warning">&nbsp;</span> Pending</td>
            </tr>
        </table> -->
    </div>
...
<div class="customer_master_style">
    <ul class="nav nav-tabs" id="main-tabs">
        <li class="btn-default-new size-sm tab-style-one mr-1 active"><a href="#pr_pending" data-toggle="tab" onclick="Otable.draw()">Pending</a></li>
        <li class="btn-default-new size-sm tab-style-one "><a href="#pr_completed" data-toggle="tab" onclick="Otable.draw()">Completed</a></li>
        
    </ul>
</div>
<br>
<div class="tab-content">
    <div class="tab-pane " id="pr_completed">
    ...
    <div class="tab-pane active" id="pr_pending">
    <div class="table-responsive">
            <table id="purchase_request_table_pending" class="<?php echo table_class() ?>">
                <thead>
                <tr>
                    <th style="min-width: 4%">#</th>
                    <th style="min-width: 15%"><?php echo $this->lang->line('procurement_approval_prq_number');?><!--PRQ Number--></th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/srm/srm_open_purchase_request', 'Test', 'Purchase Request');
        });
        purchase_request_table();
        purchase_request_table_pending();
    ...
    function purchase_request_table(selectedID=null) {
         Otable = $('#purchase_request_table').DataTable({
            ...
            "bDestroy": true,
            "StateSave": true,
            "sAjaxSource": "<?php echo site_url('Srm_master/fetch_purchase_request_srm'); ?>",
            "aaSorting": [[0, 'desc']],
    ...
    function purchase_request_table_pending(selectedID=null) {
         Otable = $('#purchase_request_table_pending').DataTable({
             "language": {
                 "url": "<?php echo base_url("plugins/datatables/i18n/$primaryLanguage.json") ?>"
             },
            "bProcessing": true,
            ...
            "bDestroy": true,
            "StateSave": true,
            "sAjaxSource": "<?php echo site_url('Srm_master/fetch_purchase_request_srm_pending'); ?>",
            "aaSorting": [[0, 'desc']],
            "fnInitComplete": function () {
            },
            "fnDrawCallback": function (oSettings) {
