                    ...
                    <div class="row">
                        <div class="col-sm-1">
                            ...
                            <ul class="nav nav-tabs zx-nav zx-nav-tabs zx-tabs-left zx-vertical-text" role="tablist">
                                ...
                                <li role="tab_">
                                    <a href="#tab_checklist" aria-controls="messages" role="tab" data-toggle="tab" onclick="load_checklist()">
                                        <?php echo $this->lang->line('common_checklist');?>
                                    </a><!-- Item Master Sub-->
                                </li>
                            </ul>
                        </div>
                        ...
                        <div class="tab-content col-sm-11">
                            ...
                            <div role="tabpanel" class="tab-pane" id="tab_checklist">
                                <h4><?php echo $this->lang->line('common_checklist');?> </h4><!--Sub Item Configuration-->
    ...
    function load_checklist(){
        ...
        $.ajax({
           ...
           // dataType: 'html',
            ...
            url: "<?php echo site_url('Grv/fetch_checklist'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
