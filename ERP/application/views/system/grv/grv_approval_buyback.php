...
<div class="table-responsive">
    <table id="grv_table_approval" class="<?php echo table_class(); ?>">
        ...
        <tr>
            ...
            <th style="min-width: 15%"><?php echo $this->lang->line('transaction_common_grv_code');?> </th><!--GRV Code-->
                        ...
                        <div class="tab-content col-sm-11">
                            ...
                            <div role="tabpanel" class="tab-pane" id="tab_attachment">
                                <div class="table-responsive">
                                    ...
                                    &nbsp; <strong><?php echo $this->lang->line('transaction_approval_grv_attachments');?> </strong><!--GRV Attachments-->
                                    <br><br>
...
<!--
<div class="modal fade" id="grv_modalX" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">GRV Approval</h4>
            </div>
            <form class="form-horizontal" id="grv_approval_form">
                <div class="modal-body">
                    <div id="myTabs">
                    </div>
                    ...
                    <div class="row">
                        <div class="col-sm-1">
                            <ul class="zx-nav zx-nav-tabs zx-tabs-left zx-vertical-text">
                                <li id="grv_attachement_approval_Tabview_v" class="active">
                                    <a href="#Tab-home-v"
                                       data-toggle="tab"
                                       onclick="tabView()">View</a>
                                </li>
                                <li id="grv_attachement_approval_Tabview_a">
                                    <a href="#Tab-profile-v" data-toggle="tab"
                                       onclick="tabAttachement()">Attachment</a>
                                <li>
                                    <a href="#Tab-itemMasterSub" data-toggle="tab">Item Details</a>
                                </li>
                            </ul>
                        </div>
                        <div class="col-sm-11">
                            <div class="zx-tab-content">
                                ...
                                <div class="tab-pane" id="Tab-profile-v"></div>
                                <div class="tab-pane" id="Tab-itemMasterSub">
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function load_itemMasterSub_approval(receivedDocumentID, grvAutoID) {
        $.ajax({
            ...
            url: "<?php echo site_url('Grv/load_itemMasterSub_approval_buyback'); ?>",
            beforeSend: function () {
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/grv/grv_approval_buyback', 'Test', 'GRV Approval');
        });
        ...
        $('#grv_approval_form').bootstrapValidator({
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: data,
                url: "<?php echo site_url('Grv/save_grv_approval_buyback'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
    ...
    function grv_table_approval() {
        Otable = $('#grv_table_approval').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Grv/fetch_grv_approval_buyback'); ?>",
            "aaSorting": [[1, 'desc']],
            ...
            "columnDefs": [{"searchable": true, "orderable": false, "visible": false, "targets": [9,10]},{"searchable": false, "targets": [0,5,7,8]}],
