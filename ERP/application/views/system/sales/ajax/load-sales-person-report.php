        ...
        <div class="col-md-12 " id="salespersonrpt">
            ...
            <div style="">
                <table id="tbl_rpt_salesorder" class="borderSpace report-table-condensed" style="width: 100%">
                    ...
                    <tr>
                        <th rowspan="2"><?php echo $this->lang->line('common_name'); ?><!--Name--></th>
                        <th rowspan="2"><?php echo $this->lang->line('common_currency'); ?><!--Currency--></th>
                        <th colspan="2"><?php echo $this->lang->line('sales_markating_contract_salesorder'); ?><!--Contract/ Sales Order--></th>
                        <th colspan="2"><?php echo $this->lang->line('sales_markating_invoice_delivery_order'); ?><!--Invoice/ Delivery Order--></th>
                        <th rowspan="2"><?php echo $this->lang->line('common_balance'); ?><!--Balance--></th>
                    </tr>
                    <tr>
                        <th style="width: 9%;"><?php echo $this->lang->line('common_qty'); ?><!--Qty--></th>
...
SELECT
	ifnull( invoicedetail.contractAutoID, 0 ) 
FROM
...
condetails.contractAutoID = '{$value['contractAutoID']}' ")->row_array();
                                ...
                                if($currency==1){
                                    ...
                                    $invoice = ($val['invoicetransactionamount'] + $val['dotransactionamount']);
                                    ...
                                    $invoice = ($val['invoicelocalmamount']+ $val['dolocalmamount']);
                                ...
                                <tr>
                                    <td><a href="#" class="drill-down-cursor"
                                           onclick="opensalespersondd(<?php echo $val['salesPersonID'] ?>,<?php echo $val['docTye']?>)"> <?php echo $val["salesPersonName"] ?></a>
                                    </td>
                                    <td> <?php echo $curr ?></td>
                                    <?php   if($val['docTye']!='2'){?>
                                    <td width="200px" style="text-align: right"><?php echo $qtycontractsales['contractcount'] ?> </td>
                                        <td width="200px" style="text-align: right"><?php echo number_format($totalamt,$decimalplaces); ?></td>
                                    <?php }else { ?>
                                    ...
                                    <td width="200px" style="text-align: right"><?php
                                        ...
                                        ?></td>
                                    <td width="200px" style="text-align: right"><?php echo number_format($invoice,$decimalplaces) ?></td>
                                    <?php
                                    if($val['docTye']!='2')
                                    {
                                    ...
                                    <?php if($val['docTye']!='2')
                                    {?>
                                    <td width="200px" style="text-align: right"><?php echo number_format($balance,$decimalplaces)?></td>
                                        <?php }else {?>
                    ...
                    <tr>
                        <td colspan="6"><b><?php echo $this->lang->line('common_total'); ?><!--Total--></b></td>
                        <td class="text-right reporttotal"><?php echo number_format($totalbalance,$decimalplaces) ?></td>
                    </tr>
                    </tbody>
                    <tfoot>
                    </tfoot>
