        ...
        <?php echo form_open('login/loginSubmit', ' name="frm_rpt_sales_order" id="frm_rpt_sales_order" class="form-group" role="form"'); ?>
            <div class="col-md-12">
                ...
                <div class="form-group col-sm-2">
                    ...
                    <select id="currencyType" name="currencyType" class="form-control select2">
                        <option value="local_currency">Local Currency</option>
                        <option value="reporting_currency">Reporting Currency</option>
                    </select>
                </div>
                <div class="form-group col-sm-1">
                    <label for=""></label>
                    <button style="margin-top: 28px" type="button" onclick="get_sales_order()" class="btn btn-primary btn-xs">
...
<script>
    ...
    $(document).ready(function (e) {
       ...
       $("#segmentID").multiselect2('selectAll', false);
        ...
        if(type == 1){
            url = '<?php echo site_url('sales/get_sales_summary_report'); ?>';
