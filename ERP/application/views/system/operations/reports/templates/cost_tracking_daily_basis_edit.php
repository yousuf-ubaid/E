...
<input type="hidden" name="activity_billing_id" id="activity_billing_id" value="<?php echo $billing_id ?>" />
<input type="hidden" name="activity_confirmed_yn" id="activity_confirmed_yn" value="<?php echo $report_header['confirmedYN'] ?>" />
                    ...
                    <table class="table table-bordered-1 table_check_list table-striped">
                        <tr>
                            ...
                            <?php foreach($get_defined_prices as $services){
                                ...
                                echo '<th style="text-align:center;background:#eee;font-size:12px;font-weight:bold;border: 1px solid #dee2e6;width:10%">'.$services['typeItemName'].'</th>';
                            } ?>
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;font-size:12px;font-weight:400;border: 1px solid #dee2e6;"><?php echo date('H:i:s',strtotime($shifts['dateFrom'])) ?></td>
                                <td style="text-align:center;font-size:12px;font-weight:400;border: 1px solid #dee2e6;"><?php echo date('H:i:s',strtotime($shifts['dateTo'])) ?></td>
                                <?php foreach($columns_order as $order_id){ ?>
                                    
                                    <?php if(isset($shifts['values'][$order_id])){
                                        $row_total_hours = $row_total_hours + $shifts['values'][$order_id];  
                                        if(isset($columns_total[$order_id])){
                                            $columns_total[$order_id] =  $columns_total[$order_id] + $shifts['values'][$order_id];
                                        }else{
                                            $columns_total[$order_id] = $shifts['values'][$order_id];
                                        }

                                        $daily_cost = $daily_cost + ($shifts['values'][$order_id]*$columns_unit_pricing[$order_id]);
                                        
                                        echo ' <td style="text-align:center;font-size:12px;font-weight:400;border: 1px solid #dee2e6;">'.round($shifts['values'][$order_id],2).'</td>';
                                    }else{
            ...
            <div class="col-12 col-md-12">  
                <div class="table-responsive" style="background:#fff;">
                    <table class="table table-bordered-1">                        
                        <tr>
                            <?php foreach($get_defined_prices as $services){
                                echo '<th style="text-align:center;background:#eee;font-size:12px;font-weight:bold;border: 1px solid #dee2e6;width: 10%;" valign="middle" height="30">'.$services['typeItemName'].'</th>';
                             } ?>
            ...
            <div class="col-12 col-md-12">  
                <div class="table-responsive" style="background:#fff;">
                    <table class="table table-bordered-1">
                        ...
                        <tr>
                            <th style="text-align:left;font-size:12px;width: 20%;" valign="middle" height="30">POET Code :  </th>
            ...
            <div class="col-12 col-md-12">  
                <div class="table-responsive" style="background:#fff;">
                    <table class="table table-bordered-1">
                        ...
                        <?php foreach($get_defined_prices as $services){
                            echo '<tr>';
                            echo '<td width="40%" style="font-size:12px;border: 1px solid #dee2e6;height:30px">'.$services['typeItemName'].' Rate: </td>';
