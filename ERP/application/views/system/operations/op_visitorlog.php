...
<body>
    ...
    <div class="col-md-12">
        ...
        <div class="row">
            <div class="text-center">
                ...
                <p class="text-bold"><h4>Visitor Log </h4></p>
            </div>
        </div>

    <?php echo form_open('', 'role="form" id="visitor_log_form"'); ?>
    ...
    <div class="form-group">
        <label for="p_of_visit">Purpose of Visit</label>
        <input type="text" class="form-control" id="p_of_visit" name="p_of_visit" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="h2s_validity">H2S Validity</label>
        <input type="text" class="form-control" id="h2s_validity" name="h2s_validity">
    </div>
    <div class="form-group">
        <label for="rig_safety">Rig Safety Briefing</label>
        <input type="text" class="form-control" id="rig_safety" name="rig_safety">
    </div>
    <div class="form-group">
        <label for="propper_ppe">Proper PPE in Use</label>
        <input type="text" class="form-control" id="propper_ppe" name ="propper_ppe">
    </div>
    <div class="form-group">
    ...
    <button class="btn btn-primary-new btn-block btn-sm" onclick="save_accept()" type="button"><i class="fa fa-save"></i> &nbsp Save</button>
