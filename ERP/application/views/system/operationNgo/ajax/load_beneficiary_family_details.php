                    ...
                    <div class="familyContainer">
                        ...
                        <table class="table table-condensed">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $filename = '/images/flags/' . trim($familyInfo['countryNameFlag'] ?? '') . '.png';
                    ...
                    <div class="familyContainer">
                        <div class="show-image" style="text-align: center;">
                            ...
                            <?php if (!empty($familyInfo['image'])) {
                                $bnimage = get_all_operationngo_images($familyInfo['image'],'uploads/ngo/beneficiaryFamilyImage/','bnfamdetail');
