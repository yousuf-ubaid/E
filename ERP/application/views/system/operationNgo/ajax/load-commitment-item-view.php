      ...
      <div class="table-responsive mailbox-messages">
          <table class="table table-hover table-striped">
              ...
              <tr class="task-cat-upcoming">
                  ...
                  <td class="headrowtitle" style="border-bottom: solid 1px #f76f01;">Expiry Date</td>
                  ...
                  <td class="headrowtitle" style="border-bottom: solid 1px #f76f01;text-align: right">Unit Amount</td>
                ...
                foreach ($header as $val) {
                  ?>
                    <tr>
                        ...
                        <td class="mailbox-star"><?php echo $val['projectName'] ?></td>
                        <td class="mailbox-star" width="5%"><?php echo $val['itemSystemCode'] ?></td>
                        <td class="mailbox-star"><?php echo $val['itemDescription'] ?> - <?php echo $val['description'] ?></td>
                        <td class="mailbox-star"><?php echo $val['commitmentExpiryDate'] ?></td>
                        <td class="mailbox-star"><?php echo $val['defaultUOM'] ?></td>
                        <td class="mailbox-star"><?php echo $val['itemQty'] ?></td>
                        ...
                        <td class="mailbox-attachment taskaction_td"><span class="pull-right">
                            <a onclick="edit_item(<?php echo $val['commitmentDetailAutoID'] ?>)"><span title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;<a
                                        onclick="delete_commitmentDetails(<?php echo $val['commitmentDetailAutoID'] ?>,1)"><span title="Delete" rel="tooltip" class="glyphicon glyphicon-trash" style="color:rgb(209, 91, 71);"></span></a></span>
                        </td>
                    </tr>
                  <?php
                  $x++;
