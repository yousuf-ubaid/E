...
<?php
if (!empty($header)) {
    $printHelpAndNestArray = fetch_ngo_project_shortCode($header['benificiaryID']);
        ...
        if ($header['confirmedYN'] == 0) { ?>
            <div class="col-md-3 text-right">
                <button type="button" class="btn btn-primary pull-right"
                        onclick="fetchPage('system/operationNgo/create_beneficiary',<?php echo $header['benificiaryID'] ?>,'Edit Beneficiary','NGO');">
    ...
    <ul class="nav nav-tabs" id="main-tabs">
       ...
       <!-- --><?php /*if (in_array('HN', $testArray)) { */?>
        ...
        <?php /*} */?>
        <li><a href="#files" onclick="fetch_beneficiary_documentView()" data-toggle="tab"><i
                ...
                <div class="col-sm-3">
                    ...
                    <div class="fileinput-new thumbnail">
                        <?php if ($header['benificiaryImage'] != '') {
                            $benificiaryImg = get_all_operationngo_images($header['benificiaryImage'],'uploads/ngo/beneficiaryImage/','bnfamdetail');?>
                            <img
                                src="<?php echo $benificiaryImg; ?>"
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#frm_beneficiary_add_notes').bootstrapValidator({
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: data,
                url: "<?php echo site_url('OperationNgo/add_beneficiary_notes'); ?>",
                beforeSend: function () {
                    startLoad();
                },
    ...
    function beneficiary_notes() {
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('OperationNgo/load_beneficiary_all_notes'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
    ...
    function profileImageUploadBeneficiary_helpNest() {
        ...
        $.ajax({
            ...
            cache: false,
            processData: false,
            url: "<?php echo site_url('OperationNgo/beneficiary_image_upload_helpNest'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
    ...
    function profileImageUploadBeneficiary_helpNest_two() {
        ...
        $.ajax({
            ...
            cache: false,
            processData: false,
            url: "<?php echo site_url('OperationNgo/beneficiary_image_upload_helpNest_two'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
    ...
    function profileImageUploadBeneficiary() {
        ...
        $.ajax({
            ...
            cache: false,
            processData: false,
            url: "<?php echo site_url('OperationNgo/beneficiary_image_upload'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
    ...
    function beneficiary_family_details() {
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('OperationNgo/fetch_beneficiary_family_details_view'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
    ...
    function fetch_beneficiary_documentView() {
        var benificiaryID = $('#editbenificiaryID').val();
        ...
        $.ajax({
            ...
            url: '<?php echo site_url("OperationNgo/load_beneficiary_documents_view_forEdit"); ?>',
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
