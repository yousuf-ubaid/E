...
<div class="row">
    ...
    <div class="col-md-7">
        <div class="box box-default" style="background-color: #f5f5f5;border: 1px solid #e3e3e3;">
            ...
            <form class="form-horizontal">
                <input type="hidden" name="benificiaryID" id="hn_benificiaryID" value="<?php echo $benificiaryID; ?>">
                    ...
                    if (!empty($docDet)) {
                        foreach ($docDet as $doc) {
                            ...
                            if ($doc['beneficiaryImage'] != '') {
                                $file = get_all_operationngo_images($doc['beneficiaryImage'],'uploads/ngo/beneficiaryImage/','beniImg');
                               // $file = base_url() . 'uploads/ngo/beneficiaryImage/' . $doc['beneficiaryImage'];
                                ...
                                $linkStart = '<i class="fa fa-times-circle pull-right" aria-hidden="true" style="color: red;" onclick="delete_beneficiary_Document(' . $doc['beneficiaryImageID'] . ', \'' . $doc['beneficiaryImage'] . '\')"></i>
                            ...
                            ' . $linkStart . '
                                <img class="" src="' . $file . '" style="width:100px; height:85px; ">
    ...
    <div class="col-md-5">
        <div class="box box-default" style="background-color: #f5f5f5;border: 1px solid #e3e3e3;">
            ...
            <input type="hidden" name="benificiaryID" value="<?php echo $benificiaryID; ?>">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#empDoc_form').bootstrapValidator({
            ...
            $.ajax({
                ...
                dataType: 'JSON',
                data: formData,
                url: '<?php echo site_url('OperationNgo/upload_beneficiary_multiple_image'); ?>',
                contentType: false,
                cache: false,
                processData: false,
                beforeSend: function () {
    ...
    function delete_beneficiary_Document(beneficiaryImageID, description) {
        swal({
                title: "Are you sure?",
            ...
            function () {
                $.ajax({
                    async: true,
                    url: "<?php echo site_url('OperationNgo/delete_beneficiary_multiple_image'); ?>",
                    type: 'post',
                    dataType: 'json',
    ...
    function update_pp_imageStatus(beneficiaryImageID, status) {
        var benificiaryID = $('#hn_benificiaryID').val();
        $.ajax({
            async: true,
            type: 'post',
            dataType: 'json',
            data: {benificiaryID: benificiaryID,beneficiaryImageID:beneficiaryImageID,status:status},
            url: "<?php echo site_url('OperationNgo/update_beneficiary_multiple_image'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
