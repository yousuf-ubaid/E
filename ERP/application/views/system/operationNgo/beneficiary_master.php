...
$title = $this->lang->line('operationngo_beneficiary');
    ...
    <div class="row">
        ...
        <div class="col-md-3 text-right">
            <button type="button" class="btn btn-primary pull-right"
                    onclick="fetchPage('system/operationNgo/create_beneficiary',null,'<?php echo $this->lang->line('operationngo_add_new_benificiary'); ?>'/*Add New Beneficiary*/,'CRM');">
                <i
                        class="fa fa-plus"></i>
                <?php echo $this->lang->line('operationngo_new_benificiary'); ?><!--New Beneficiary-->
            </button>
        </div>
    </div>
    <div class="row">
...
<script type="text/javascript">
    ...
    function getBeneficiaryManagement_tableView(filtervalue) {
        ...
        $.ajax({
            ...
            dataType: 'html',
            data: data,
            url: "<?php echo site_url('OperationNgo/load_beneficiaryManagement_view'); ?>",
            beforeSend: function () {
                startLoad();
            },
        ...
        swal({
            ...
            function () {
                $.ajax({
                    ...
                    url: "<?php echo site_url('OperationNgo/delete_beneficiary_master'); ?>",
                    beforeSend: function () {
                        startLoad();
                    },
                    success: function (data) {
