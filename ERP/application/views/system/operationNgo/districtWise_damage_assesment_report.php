...
?>
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="display">
            <?php echo form_open('', 'role="form" id="districtWise_damage_form"'); ?>
            <div class="row">
            ...
            <div class="row">
                <div class="col-md-12" style="margin-top: 10px">
                    <button type="button" class="btn btn-primary pull-right"
                            onclick="generateDAdistrictReport('districtWise_damage_form')" name="filtersubmit"
                            id="filtersubmit"><i
...
<?php echo footer_page('Right foot', 'Left foot', false); ?>
        ...
        <div class="modal-dialog modal-lg" style="width:95%" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">District Wise Disaster Assessment Report</h4>
                </div>
    ...
    <script type="text/javascript">
        ...
        /*call report content*/
        function generateDAdistrictReport(formName) {
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: finalArray2,
                url: '<?php echo site_url('OperationNgo/districtWise_damage_assesment_report'); ?>',
                beforeSend: function () {
                    startLoad();
                },
