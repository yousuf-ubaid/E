...
<table class="table table-bordered table-striped">
    <thead class='thead'>
    <tr>
        <th class='theadtr'><?php echo $this->lang->line('hrms_attendance_empnum')?>  </th>
        <th class='theadtr'><?php echo $this->lang->line('hrms_attendance_empname')?>  </th>
        <?php
        if (!empty($detail)){
        ...
        <th class='theadtr'><?php if ($val['defaultcategoryID']==0) {
            ...
            <th class='theadtr'><?php echo $this->lang->line('hrms_attendance_rate')?>  </th>
