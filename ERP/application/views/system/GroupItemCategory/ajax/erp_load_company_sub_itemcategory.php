        ...
        <div class="form-group col-sm-5" >
            <div class="">
                ...
                if(!empty($categoryval)){
                    echo form_dropdown('itemCategoryID[]', dropdown_company_group_sub_item_categories($val,$categoryval['itemCategoryID'],$groupItemCategoryID), $categoryval['itemCategoryID'], 'class="form-control select2" id="itemCategoryID_'.$val.'" required"');
                }else{
                    echo form_dropdown('itemCategoryID[]', dropdown_company_group_sub_item_categories($val,null,$groupItemCategoryID), '', 'class="form-control select2" id="itemCategoryID_'.$val.'" required"');
                }
                ?>
            </div>
        </div>
