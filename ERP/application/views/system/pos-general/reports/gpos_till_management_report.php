...
<form id="frm_till_management_rpt" method="post" class="form-inline text-center" role="form">
    ...
    <div class="col-md-3">
        ...
        <a href="" class="btn btn-excel btn-sm" id="btn-excel" download="Till_Management_Report.xls"
           onclick="var file = tableToExcel('till_management_report_excel', 'Till Management Report'); $(this).attr('href', file);">
...
<div class="table-responsive" id="till_management_report_excel">
    <table id="TMRpt_table" class="<?php echo table_class(); ?> table-hover">
        <thead>
        <tr>
            <th style="width: 5%">#</th>
            <th>Start Date <br/> Time <i class="fa fa-clock-o"></i> </th>
            <th>End Date <br/> Time <i class="fa fa-clock-o"></i> </th>
            <th style="min-width: 150px;">Outlet</th>
            <th>Counter</th>
            <th>Closed By</th>
            <th>Opening Cash <br/>Balance</th>
            <th>Cash Sales</th>
            <th>Gift Card <br/>Top Up</th>
            <th>Closing Cash <br/>Balance <abbr title="Opening Cash Balance + Cash Sales + Gift Card Top Up"><i class="fa fa-question"></i></abbr>  </th>
            <th>Till Cash <br/>Balance</th>
...
<script type="text/javascript">
    ...
    function load_TMReport() {
        TMRpt_table = $('#TMRpt_table').DataTable({
            ...
            "bServerSide": true,
            "bDestroy": true,
            "sAjaxSource": "<?php echo site_url('Pos_general_report/fetch_till_management_report'); ?>",
            "aaSorting": [[0, 'desc']],
    ...
    function load_till_management_report(){
      /**  var data= $("#frm_till_management_rpt").serialize();
        ...
        form.target = '_blank';
        form.action = '<?php echo site_url('Pos_general_report/load_till_management_report'); ?>';
        form.submit();
    }
