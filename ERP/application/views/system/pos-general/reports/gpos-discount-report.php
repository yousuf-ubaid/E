...
<a href="" class="btn btn-excel btn-xs" id="btn-excel" download="Discount_Report.xls"
   onclick="var file = tableToExcel('printContainer_itemizedSalesReport', 'Discount Report'); $(this).attr('href', file);">
...
<div id="printContainer_itemizedSalesReport">
    ...
    <h3 class="text-center">Discount Report </h3>
    ...
    <table class="<?php echo table_class() ?>">
        ...
        if (!empty($deliveryPersonReport)) {
            foreach ($deliveryPersonReport as $val) {
                ...
                <tr>
                    ...
                    <td class="ac"> <?php echo number_format(($val['totaldisc']/$val['grossTotal'])*100,2) . '%' ?> </td>
                    <td class="ar">
                        <?php
                        echo number_format($val['totaldisc'], $d);
                        $generalDiscountTotal += $val['totaldisc'];
                        ?>
                    </td>
                    <td class="ar"> <?php echo number_format($val['netTotal']-$val['totaldisc'], $d); ?> </td>
                </tr>
        ...
        <tr style="font-size:12px !important;" class="t-foot">
            ...
            <td style="font-weight: bold;text-align: right">
                <strong><?php echo number_format($generalDiscountTotal, $d); ?></strong></td>
    ...
    <h3>Total Discount : <?php echo number_format(($generalDiscountTotal), $d); ?></h3>
