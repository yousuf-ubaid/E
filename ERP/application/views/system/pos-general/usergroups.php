            ...
            <div class="modal-content">
                ...
                <form role="form" id="userGroup_form" class="form-horizontal">
                    ...
                    <div class="modal-footer">
                        ...
                        <input type="hidden" id="posType" name="posType" value="2">
    ...
    <script type="text/javascript">
        ...
        function load_assigned_pos_user(userGroupMasterID) {
            $.ajax({
                ...
                url: '<?php echo site_url('Pos/fetch_assigned_users_gpos'); ?>',
                beforeSend: function () {
                },
                success: function (data) {
        ...
        function load_user_table() {
            usergroup_table = $('#user_table').DataTable({
                ...
                "bServerSide": true,
                "bDestroy": true,
                "sAjaxSource": "<?php echo site_url('Pos/fetch_user_for_group_gpos'); ?>",
                "aaSorting": [[0, 'desc']],
                "fnDrawCallback": function (oSettings) {
        ...
        function add_users() {
            $.ajax({
                ...
                url: "<?php echo site_url('Pos/save_usergroup_users_gpos'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
            ...
            swal({
                ...
                function () {
                    $.ajax({
                        ...
                        type: 'post',
                        dataType: 'json',
                        data: {userGroupMasterID: id,posType: 2},
                        url: "<?php echo site_url('Pos/delete_UserGroup'); ?>",
                        beforeSend: function () {
                            startLoad();
                        },
                        success: function (data) {
