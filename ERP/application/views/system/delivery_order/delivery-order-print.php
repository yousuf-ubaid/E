...
<hr>
<div class="table-responsive">
    <div style="text-align: center"><h4><?php echo $this->lang->line('sales_marketing_delivery_order');?></h4></div>
    ...
    <table style="width: 100%">
        <tbody>
            ...
            <tr>
                ...
                <?php } ?>
                <td style="font-weight: bold"><strong><?php echo $this->lang->line('common_document_code');?></strong></td><!--Invoice Number-->
                <td style="font-weight: bold"><strong>:</strong></td>
            ...
            <tr>
                ...
                if ($extra['master']['referenceNo'] != null) { ?>
                    <td style="font-weight: bold"><strong><?php echo $this->lang->line('common_reference_number');?></strong></td><!--Reference Number-->
                    <td style="font-weight: bold"><strong>:</strong></td>
                    <td><?php echo $extra['master']['referenceNo']; ?></td>
                <?php } else if (!empty($extra['contactperson_detail'])){?>
                    <td style="vertical-align: top; font-weight: bold"><strong><strong><?php echo $this->lang->line('common_reference_number');?></strong></td><!--Reference Number-->
            ...
            <?php } ?>
            <tr>
                <td style="vertical-align: top; font-weight: bold"><strong> <?php echo $this->lang->line('sales_markating_narration');?> </strong></td><!--Narration-->
                <td style="vertical-align: top; font-weight: bold"><strong>:</strong></td>
                <td>
                    <table>
                        <tr>
                ...
                <td style="font-weight: bold"><strong><?php echo $this->lang->line('common_currency');?> </strong></td><!--Currency-->
                <td style="font-weight: bold"><strong>:</strong></td>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <th class='theadtr' style="min-width: 15%">Part No<?php //echo $this->lang->line('sales_markating_view_invoice_item_code');?></th><!--Item Code-->
                ...
                <th class='theadtr' style="min-width: 35%"><strong><?php echo $this->lang->line('common_warehouse');?></th><!--Warehouse-->
            ...
            foreach ($extra['item_detail'] as $val) {
                ...
                <tr>
                    ...
                    <td style="text-align:center;"><?php echo $val['partNo']; ?></td>
                    <td>
                        <?php if($extra['master']['DOType'] == 'Sales Order'){
                             echo ($val['contractCode'] ? $link.' - ' : '')?> <?php echo $val['itemDescription'];?> - <?php echo $val['remarks']; ?>
                        <?php }elseif ($extra['master']['DOType'] == 'Contract'){  ?>
                           <?php echo ($val['contractCode'] ? $link.' - ' : '')?> <?php echo $val['itemDescription'];?> - <?php echo $val['remarks']; ?>
    ...
    <div class="table-responsive">
        <table style="width: 100%">
            <tbody>
                <tr>                    
                    <td>
                        <span>____________________________</span><br><br><span><b>&nbsp; Prepared By</b></span>
                    </td>
                    <td>
                        <span>____________________________</span><br><br><span><b>&nbsp; Received By</b></span>
                    </td>
                </tr>
            </tbody>
        </table>
