...
<!-- SMSD start-->
<div class="modal fade" id="requiredFields_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document" style="width: 40%;">
            <div class="modal-content">
                ...
                <div class="modal-footer ">
                    <button class="btn btn-default fclose" type="button" data-dismiss="modal"><?php echo $this->lang->line('common_Close'); ?></button>
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(confirmedYN == 1){
                                        ...
                                        // if(confirm == 1){
                                        //     $('#addRequiredFields_form input').prop('disabled', true);
                                        //     //$('#fieldvalue').attr('disabled', 'disabled');  //.addClass('disabled');    //$('#fieldvalue').prop('readonly', true);
                                        // }
                                        // else{
                                        //     $('#addRequiredFields_form input').prop('disabled', false);
