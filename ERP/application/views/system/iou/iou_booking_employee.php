...
echo head_page($this->lang->line('iou_expenses'), false);
...
<ul class="nav nav-tabs" id="main-tabs">
    <li class="active"><a href="#iouvoucher" data-toggle="tab"><i class="fa fa-television"></i><?php echo $this->lang->line('iou_voucher');?></a></li>
    <li><a href="#iouexpences"  data-toggle="tab"><i class="fa fa-television"></i><?php echo $this->lang->line('iou_expenses')?></a></li>
</ul>
<br>
<div class="tab-content">
    <div class="tab-pane active" id="iouvoucher">
        ...
        <div class="row" style="margin-top: 2%;">
            ...
            <div class="col-md-2">
                <?php echo form_dropdown('iouvoucherstatus', array('' => $this->lang->line('iou_status'), '1' => $this->lang->line('common_draft'), '2' => $this->lang->line('common_confirmed'), '3' => $this->lang->line('common_approved')), '', 'class="form-control" onchange="startMasterSearchiou()" id="iouvoucherstatus"'); ?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
    ...
    <div class="tab-pane" id="iouexpences">
        ...
        <div class="row">
            ...
            <div class="col-md-3 text-right">
                <button type="button" class="btn btn-primary pull-right"
                        onclick="fetchPage('system/iou/create_iou_booking_employee',null,'<?php echo $this->lang->line('إضافة حساب IOU جديد'); ?>','IOUE');"><i
        ...
        <div class="row" style="margin-top: 2%;">
            ...
            <div class="col-md-2">
                <?php echo form_dropdown('iouvoucherstatusexpence', array('' => $this->lang->line('iou_status'), '1' => $this->lang->line('common_draft'), '2' => $this->lang->line('common_confirmed'), '3' => $this->lang->line('common_approved'),'4' => $this->lang->line('common_submited')), '', 'class="form-control" onchange="startMasterSearch()" id="iouvoucherstatusexpence"'); ?>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
