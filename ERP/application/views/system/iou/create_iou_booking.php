...
$projectCode = fetchProjectCode_ioubooking();/**SMSD */
$jobCode = fetchJobCode_ioubooking();/**SMSD */

$checkPolicy_1 = getPolicyValues('EOM', 'All');/**SMSD */
$checkPolicy_2 = getPolicyValues('SDIOUB', 'All');/**SMSD */

$gl_code_arr = company_PL_account_drop();
$segment_arr = fetch_segment();

$employeedrop = fetch_users_iou();
$fuel_usage = array(''=> $this->lang->line('common_select_document'));
...
<div class="m-b-md" id="wizardControl">
    ...
    <a class="btn btn-default btn-wizard" href="#step2" data-toggle="tab" onclick="load_confirmation();"><?php echo $this->lang->line('iou_step_two') . '- ' . $this->lang->line('iou_expense_confirmation')?></a>
...
<div class="tab-content">
        ...
        <div class="row">
            <div class="col-md-12 animated zoomIn">
                <header class="head-title">
                    <h2><?php echo $this->lang->line('iou_iou_expense_header') ?></h2>
                </header>
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="form-group col-sm-4">
                      <span class="input-req" title="<?php echo $this->lang->line('iou_required_field') ?>">
                      <?php echo form_dropdown('employeeid', $employeedrop, '', 'class="form-control select2" id="employeeid" onchange = "loadiou_voucher()"'); ?>
                          <span class="input-req-inner" style="z-index: 100"></span></span>
                    </div>
                </div>
                <div class="row" style="margin-top: 10px;">
                ...
                <?php echo form_dropdown('iouvoucher', array('' => $this->lang->line('iou_select_iou_voucher')), 'Each', 'class="form-control" id="iouvoucher" '); ?>
                               </div>
                            <span class="input-req-inner"></span>
                    </div>
                    ...
                    <div class="form-group col-sm-4">
                         <span class="input-req" title="<?php echo $this->lang->line('iou_required_field') ?>">
                        <textarea class="form-control" rows="2" id="comment" name="comment"></textarea><!--SMSD : rows="3" to rows="2"-->
                         <span class="input-req-inner"></span></span>
                    </div>

                </div>
            <!--SMSD:start-->
            <?php if($checkPolicy_1 == 1){ ?>
                <div class="row" style="margin-top: 10px;">
                    <div class="form-group col-sm-2">
                        <label class="title">Project Code</label>
                    </div>
                    <div class="form-group col-sm-4">
                        <span class="input-req" title="<?php echo $this->lang->line('iou_required_field') ?>">
                            <?php echo form_dropdown('projectCode', $projectCode , 'select project code', 'class="form-control select2" id="projectCode" onchange = "" required'); ?>
                        <span class="input-req-inner"></span>
                    </div>
                    <div class="form-group col-sm-2">
                        <label class="title">Job Code</label>
                    </div>
                    <div class="form-group col-sm-4">
                        <span class="input-req" title="<?php echo $this->lang->line('iou_required_field') ?>">
                            <?php echo form_dropdown('jobCode', $jobCode , 'select job code', 'class="form-control select2" id="jobCode" '); ?>
                        <span class="input-req-inner"></span></span>
                    </div>
                </div>
            <?php } ?>
            <!--SMSD:end-->
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="form-group col-sm-2">
                        <label class="title"><?php echo $this->lang->line('iou_link_to_fuel_expense') ?></label>
                    </div>
                    <div class="form-group col-sm-4">
    ...
    <div id="step2" class="tab-pane">
        ...
        <div class="text-right m-t-xs">
            ...
            <button class="btn btn-warning" id="submitbtn" onclick="submit_booking()"><?php echo $this->lang->line('common_submit'); ?></button>
            <button class="btn btn-success submitWizard" id="confirmbtn" onclick="confirmation()"><?php echo $this->lang->line('common_confirm'); ?></button>
        </div>
    </div>
...
<div aria-hidden="true" role="dialog" id="iou_booking_model" class="modal fade" style="display: none;">
    <div class="modal-dialog" style="width: 90%;"><!--SMSD:80% to 90%-->
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="iou_booking_det_form" class="form-horizontal">
                    <table class="table table-bordered table-condensed no-color" id="po_detail_add_table">
                        ...
                        <thead>
                        <tr>
                            <th style="width: 11%;"><?php echo $this->lang->line('iou_expense_category'); ?></th>
                            <th class="linktofuel hide"><?php echo $this->lang->line('iou_fuel_usage'); ?></th>
                            <th style="width: 11%;"><?php echo $this->lang->line('common_segment'); ?> <?php required_mark(); ?></th>
                        <?php if($checkPolicy_2 == 1): ?><!--SMSD-->
                            <th style="width: 11%;">Invoice Number<?php required_mark(); ?></th><!--SMSD-->
                            <th style="width: 11%;">Supplier Name<?php required_mark(); ?></th><!--SMSD-->
                            <th style="width: 11%;">Supplier Mobile<?php required_mark(); ?></th><!--SMSD-->
                        <?php endif; ?><!--SMSD-->
                            <th style="width: 8%;">Amount<?php required_mark(); ?></th>
                        <?php if($checkPolicy_2 == 1): ?><!--SMSD-->
                            <th style="width: 8%;">VAT<?php required_mark(); ?></th><!--SMSD-->
                            <th style="width: 8%;">Net Amount<?php required_mark(); ?></th><!--SMSD-->
                            <th style="width: 8%;">VAT Number<?php required_mark(); ?></th><!--SMSD-->
                        <?php endif; ?><!--SMSD-->
                            <th style="width: 8%;">Narration<?php required_mark(); ?></th><!--SMSD-->
                            <th style="width: 5%;">
                                <button type="button" class="btn btn-primary btn-xs" onclick="add_more()"><i
                                            class="fa fa-plus"></i></button>
                            </th>
                        ...
                        <tr>
                            <td>
                                <?php echo form_dropdown('category[]', $cat_arr, '', 'class="form-control select2 category" onchange="change_validation(this),fetch_fuel_usage_documents(this);"'); ?>
                            </td>
                            <td class="linktofuel hide">
                                    <?php echo form_dropdown('fuelusge[]', $fuel_usage, '', 'class="form-control select2 fuelusge" id="fuelusge" onchange="fuel_usage_expense_amount(this)" '); ?>
                            ...
                            <?php if($checkPolicy_2 == 1): ?><!--SMSD-->
                            <td>
                                <input type="text" name="invoiceNumber[]" class="form-control invoiceNumber" id="invoiceNumber"><!--SMSD-->
                            </td>

                            <td>
                            <input type="text" name="supplierName[]" class="form-control supplierName" id="supplierName"><!--SMSD-->
                            </td>

                            <td>
                                <input type="text" name="supplierMobile[]" class="form-control supplierMobile" id="supplierMobile"><!--SMSD-->
                            </td>
                            <?php endif; ?><!--SMSD-->
                            <td>
                            ...
                            <?php if($checkPolicy_2 == 1): ?><!--SMSD-->
                            <td>
                                <?php echo form_dropdown('vat[]', '', '', 'class="form-control select2 vat" id="vat" '); ?><!--required--><!--SMSD-->
                            </td>

                            <td>
                                <input type="text" name="netAmounts[]" id="netAmounts" class="form-control netAmounts"><!--SMSD-->
                            </td>

                            <td>
                                <input type="text" name="vatNumber[]" id="vatNumber" class="form-control vatNumber"><!--SMSD-->
                            </td>
                            <?php endif; ?><!--SMSD-->
                            <td>
                                <textarea  name="description[]" rows="1" id="description"  class="form-control"></textarea><!--SMSD-->
                            </td>
...
<div aria-hidden="true" role="dialog" tabindex="-1" id="iou_booking_detail_edit_modal" data-backdrop="static"
    ...
    <div class="modal-dialog modal-lg" style="width: 80%">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button data-dismiss="modal" class="btn btn-default" type="button"><?php echo $this->lang->line('common_Close'); ?></button>
                <button class="btn btn-primary" type="button" onclick="update_voucher_details()"><?php echo $this->lang->line('common_update_changes'); ?></button>
            </div>
...
<div class="modal fade" id="requiredFields_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"><!--SMSD : add this model-->
        <div class="modal-dialog" role="document" style="width: 40%;">
            <div class="modal-content">
                ...
                <form role="form" id="addRequiredFields_form" class="form-horizontal">
                ...
                <div class="modal-footer ">
                    ...
                    <button class="btn btn-primary" id="fieldsavebtn" type="button" onclick="add_requiredFields()">save</button>
                </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.headerclose').click(function () {
            fetchPage('system/iou/iou_booking', '', '<?php echo $this->lang->line('iou_voucher'); ?>')
        });
        ...
        $.ajax({
            ...
            success: function (data) {
                if (!jQuery.isEmptyObject(data)) {
                    ...
                    // $("#iouvoucher").removeAttr('disabled');
                    setTimeout(function () {
                        //$('#advance_iouvoucher').val(data['iouVoucherAutoID']).change();
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (!jQuery.isEmptyObject(data)) {
                        ...
                        if(data['iouVoucherAutoID'] == null)
                        {
                            $('.addTableView').addClass('hide');
                        }
                        if (data['pullFromFuelYN'] == 1) {
            ...
            swal({
                ...
                function () {
                    $.ajax({
                        ...
                        dataType: 'json',
                        data: {'IOUbookingmasterid': IOUbookingmasterid},
                        url: "<?php echo site_url('Iou/ioubooking_confirmation'); ?>",
                        beforeSend: function () {
                            startLoad();
                        },
                        success: function (data) {
                            ...
                            if (data['error'] == 1) {
                                ...
                                fetchPage('system/iou/iou_booking', IOUbookingmasterid, '<?php echo $this->lang->line('iou_booking');?>');
                            }
                        }, error: function () {
                            swal("Cancelled", "Your file is safe :)", "error");
                        }
    ...
    function iou_booking_detail_model() {
            ...
            if(linktofuel == 1)
            {
                $('.linktofuel').removeClass('hide');
            }else
            {
                $('.linktofuel').addClass('hide');
            }
        ...
        $(".fuelusge").val(null).trigger("change");
    ...
    function add_more() {
        ...
        appendData.find('input').val('');
        appendData.find('textarea').val('');
        appendData.find('.category').val(null).trigger('change');
        appendData.find('.remove-td').html('<span class="glyphicon glyphicon-trash remove-tr" style="color:rgb(209, 91, 71);"></span>');
    ...
    function iou_voucher_total(iouvoucherid) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (!jQuery.isEmptyObject(data)) {
                    $('#totalamt').html(parseFloat(data['totalvoucheramount']).formatMoney(data['transactionCurrencyDecimalPlaces'], '.', ''));
                    $('#matchedamount').html(parseFloat(data['matchedamt']).formatMoney(data['transactionCurrencyDecimalPlaces'], '.', ''));
                    $('#balance').html(parseFloat((data['totalvoucheramount'] - data['matchedamt'])).formatMoney(data['transactionCurrencyDecimalPlaces'], '.', ''));
    ...
    function fetch_fuel_usage_documents(thes){
        var catergoryid = thes.value;
        var transactioncurreny = $('#transactionCurrencyID').val()
        if(catergoryid)
        {
        $.ajax({
            async: true,
            type: 'post',
            dataType: 'json',
            data: {'catergoryid': thes.value,'Transactioncurrency':transactioncurreny},
            url: "<?php echo site_url('Iou/fetch_iou_booking_fuelusage'); ?>",
            success: function (data) {
                $(thes).closest('tr').find('.fuelusge').empty();
                var mySelect = $(thes).closest('tr').find('.fuelusge');
                mySelect.append($('<option></option>').val('').html('Please Select'));
                if (!jQuery.isEmptyObject(data)) {
                    $.each(data, function (val, text) {
                        mySelect.append($('<option></option>').val(text['fuelusageID']).html(text['docuemntdes']));
                    });
                }
             /*   if (selectedvalue) {
                    $(thes).closest('tr').find('.fuelusge').val(selectedvalue).change();
                }*/
    ...
    function fuel_usage_expense_amount(id) {
        var fuelusageID = id.value;
        if(fuelusageID)
        {
            $.ajax({
                async: true,
                ...
                url: "<?php echo site_url('Iou/fuel_usage_expense_amount'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
                    stopLoad();
                    $(id).closest('tr').find('.amounts').val(data['totalvalue']);
        ...
        {
            $(id).closest('tr').find('.amounts').val('');
        }

    }

/**SMSD : create function */
    function Fields_modal(bookingDetailsID, bookingMasterID,expemseCategoryId,confirmedYN,approvedYN){
            if(bookingDetailsID)
            {
                $.ajax({
                    async: true,
                    type: 'post',
                    dataType: 'html',
                    data: {'bookingDetailsID': bookingDetailsID, 'bookingMasterID' : bookingMasterID},
                    url: "<?php echo site_url('Iou/load_iou_booking_required_fields'); ?>",
                    beforeSend: function () {
                        startLoad();
                    },
                    success: function (data) {
                        ...
                        $('#requiredFields_modal').modal({ backdrop: "static" });

                        if(confirmedYN == 1 || approvedYN == 1){
                                                        // Disable all input elements of form 
                                                        $('#addRequiredFields_form :input').prop('disabled', true);
                                                        // Doing disable using Bootstrap
                                                        //$('#addRequiredFields_form :input').addClass('disabled');

                                                        // Disable form save button
                                                        $('#fieldsavebtn').prop('disabled', true);
                                        }else{
                                                        // enable all input elements of form 
                                                        $('#addRequiredFields_form :input').prop('disabled', false);
                                                        //Doing enable using Bootstrap
                                                        // $('#addRequiredFields_form :input').removeClass('disabled');

                                                        // Disable form save button
                                                        $('#fieldsavebtn').prop('disabled', false);
                                        }
                        refreshNotifications(true);
                        stopLoad();
                },
...
/**SMSD : create function */
    function add_requiredFields(){
        var data = $('#addRequiredFields_form').serializeArray();
        $.ajax({
            async: true,
            type: 'post',
            dataType: 'json',
            data: data,
            url: "<?php echo site_url('Iou/add_iouBooking_requiredFields'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
                ...
                $('#requiredFields_modal').modal('hide');
...
/**SMSD : create function */    
    function required_field_details(bookingDetailsID,bookingMasterID, confirmedYN){
        $.ajax({
            async: true,
            type: 'post',
            dataType: 'html',
            data: {'bookingDetailsID':bookingDetailsID, 'bookingMasterID':bookingMasterID},
            url: "<?php echo site_url('Iou/load_iouBooking_requiredFields_details'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
