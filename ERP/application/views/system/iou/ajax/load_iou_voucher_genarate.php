...
<div class="table-responsive mailbox-messages" id="advancerecid">
    <table class="table table-hover table-striped">
        ...
        <tr class="task-cat-upcoming">
            ...
            <td class="headrowtitle" style="border-bottom: solid 1px #f76f01;">IOU Voucher Total</td>
            <td class="headrowtitle" style="border-bottom: solid 1px #f76f01;">Balance</td>
            <td class="headrowtitle" style="border-bottom: solid 1px #f76f01;">Payment Voucher</td>
            <td class="headrowtitle" style="border-bottom: solid 1px #f76f01;">Receipt Voucher</td>
        </tr>
