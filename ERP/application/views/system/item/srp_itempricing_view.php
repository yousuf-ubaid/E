    ...
    <div class="col-md-6">
        ...
        <?php } else if ($usergroupcompanywiseallow != 0) { ?>
            <button type="button" class="btn btn-primary size-sm "
                ...
                <?php echo $this->lang->line('common_bulk_upload')?>
            </button>
        ...
        <button type="button" class="btn btn-success size-sm "
            ...
            <?php echo $this->lang->line('common_add_attributes')?>
        </button>
    ...
    <div class="modal-dialog " style="width: 100%;" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="form-group col-sm-3">
                        <label> <?php echo $this->lang->line('transaction_main_category'); ?> </label>
...
<div class="modal fade" id="item_pricing_report_model" role="dialog" data-keyboard="false" data-backdrop="static">
...
<div class="modal fade" id="item_pricing_report_model_old" role="dialog" aria-labelledby="myModalLabel">
    ...
    function item_table() {
        if(hideWacAmount == 1)
         ...
         Otable = $('#item_table').DataTable({
                ...
                "bDestroy": true,
                "bStateSave": true,
                "sAjaxSource": "<?php echo site_url('ItemMaster/fetch_item_pricing'); ?>",
                "aaSorting": [[0, 'desc']],
        ...
        if(hideWacAmount == 1)
         {
            ...
            "columnDefs": [{"targets": [2, 3], "orderable": false},{"targets": [9], "searchable": true, "visible": false, "orderable": false}],
            "fnServerData": function (sSource, aoData, fnCallback) {
                aoData.push({"name": "mainCategory", "value": $("#mainCategoryID").val()});
                aoData.push({"name": "subcategory", "value": $("#subcategoryID").val()});
                aoData.push({"name": "subsubcategoryID", "value": $("#subsubcategoryID").val()});
