    ...
    function item_table() {
        if(hideWacAmount == 1)
         ...
         Otable = $('#item_table').DataTable({
                ...
                "bDestroy": true,
                "bStateSave": true,
                "sAjaxSource": "<?php echo site_url('ItemMaster/fetch_item_pending'); ?>",
                "aaSorting": [[0, 'desc']],
...
/*function reverse_approved_item(id) {
    swal({
            title: "<?php //echo $this->lang->line('common_are_you_sure');?>", /!*Are you sure?*!/
            text: "<?php //echo $this->lang->line('config_you_want_to_reverse_this_record');?>",
            type: "warning",
            showCancelButton: true,
            confirmButtonColor: "#DD6B55",
            confirmButtonText: "<?php //echo $this->lang->line('common_yes');?>", /!*Delete*!/
        ...
        function () {
            $.ajax({
                ...
                dataType: 'json',
                data: {'itemAutoID': id},
                url: "<?php //echo site_url('ItemMaster/reverse_approved_item'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
