...
$employe_useridp =curent_employee_drop();
...
<!--            <div class="form-group col-sm-4">
            ...
            <div class="form-group col-sm-4">
                ...
                <input type="text" class="form-control" id="employeeName" name="employeeName" value="<?php echo reset($employe_useridp); ?>" required readonly>

                    <span class="input-group-btn">
                        <button class="btn btn-default" type="button" title="Clear" rel="tooltip"
                                onclick="clearEmployee()" disabled
                        ...
                        <button class="btn btn-default" type="button" title="Add Employee" rel="tooltip"
                                onclick="link_employee_model()" disabled
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('.headerclose').click(function () {
            fetchPage('system/inventory/material_request_employee','Test','Material Request');
        });
        $('.select2').select2();
        type = 'Inventory';
        EIdNo = null;
    ...
    function save_draft() {
        if (mrAutoID) {
            swal({
                ...
                function () {
                    fetchPage('system/inventory/material_request_employee', mrAutoID, 'Material Request');
                });
        }
    }
