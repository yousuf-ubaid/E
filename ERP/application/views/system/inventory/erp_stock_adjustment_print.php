...
<div class="table-responsive">
    ...
    <table class="table table-bordered table-striped">
        ...
        <thead>
            <tr>
                <th class='theadtr' colspan="<?php echo ($itemBatch_policy == 1 ? '6':'4')?>"><?php echo $this->lang->line('transaction_common_item_details');?> </th>
                <th class='theadtr' colspan="2"><?php echo $this->lang->line('common_previous');?> (<?php echo $extra['master']['companyLocalCurrency']; ?>)</th>
                <th class='theadtr' colspan="2"><?php echo $this->lang->line('transaction_common_currenct');?> (<?php echo $extra['master']['companyLocalCurrency']; ?>)</th>
                <th class='theadtr' colspan="3"><?php echo $this->lang->line('transaction_common_adjusted');?> (<?php echo $extra['master']['companyLocalCurrency']; ?>)</th>
            </tr>
            <tr>
            ...
            if (!empty($extra['detail'])) {
                ...
                <tr>
                    ...
                    <?php if($itemBatch_policy==1){?>
                        ...
                        <td><?php echo $val['batchExpireDate']; ?></td>
                    <?php }?>
                    ...
                    if($extra['master']['adjustmentType']==1){
                        ?>
                        <td style="text-align:right;"><?php echo $val['currentStockadjustment']; ?></td>
                        <?php
                    }else{
                        ?>
                        <td style="text-align:right;"><?php echo $val['currentWareHouseStockadjustment']; ?></td>
                        <?php
                    }
                    ?>
        ...
        <tfoot>
            <tr>
                <td class="text-right sub_total" colspan="10"><?php echo $this->lang->line('transaction_adjustment_item_total');?> (<?php echo $extra['master']['companyLocalCurrency']; ?>)</td><!--Adjustment Item Total-->
...
<script>
    ...
    a_link=  "<?php echo site_url('Inventory/load_stock_adjustment_conformation'); ?>/<?php echo $extra['master']['stockAdjustmentAutoID'] ?>";
