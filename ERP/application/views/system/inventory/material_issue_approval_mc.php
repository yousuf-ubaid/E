...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/inventory/material_issue_approval_mc', 'Test', 'Material Issue Approval');
        });
    ...
    function material_issue_table() {
         Otable = $('#material_issue_approval_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Inventory/fetch_material_issue_approval_mc'); ?>",
            "aaSorting": [[1, 'desc']],
