...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary pull-right" onclick="fetchPage('system/inventory/erp_material_issue_mc',null,'Add New Material Issue','GRV');"><i class="fa fa-plus"></i> <?php echo $this->lang->line('transaction_create_material_issue');?></button><!--Create Material Issue-->
    </div>
</div><hr>
...
$(document).ready(function() {
    $('.headerclose').click(function(){
        fetchPage('system/inventory/material_issue_management_mc','Test','Material Issue');
    });
    grvAutoID = null;
    number_validation();
...
function material_issue_table(selectedID=null){
     Otable = $('#material_issue_master_table').DataTable({
        ...
        "bDestroy": true,
        "bStateSave": true,
        "sAjaxSource": "<?php echo site_url('Inventory/fetch_material_issue_mc'); ?>",
        "aaSorting": [[0, 'desc']],
