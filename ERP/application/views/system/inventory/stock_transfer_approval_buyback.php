...
<div class="table-responsive">
    <table id="stock_transfer_approval_table" class="<?php echo table_class() ?>">
        ...
        <tr>
            ...
            <th style="min-width: 30%"><?php echo $this->lang->line('transaction_common_warehouse_description'); ?> </th>
...
<script type="text/javascript">
    ...
    function stock_transfer_table() {
        Otable = $('#stock_transfer_approval_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Inventory/fetch_stock_transfer_approval_buyback'); ?>",
            "aaSorting": [[1, 'desc']],
            ...
            "columnDefs": [{"targets": [7], "orderable": false}, {"targets": [0,3,6,7], "searchable": false}, {
                "visible": false,
                "searchable": true,
