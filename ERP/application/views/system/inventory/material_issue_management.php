...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary size-sm pull-right" onclick="fetchPage('system/inventory/erp_material_issue',null,'Add New Material Issue','GRV');"><i class="fa fa-plus"></i> <?php echo $this->lang->line('transaction_create_material_issue');?></button><!--Create Material Issue-->
    </div>
</div><hr>
...
function traceDocument(poID,DocumentID){
    $.ajax({
        ...
        type: 'post',
        dataType: 'json',
        data: {'materialIssueID': poID,'DocumentID': DocumentID},
        url: "<?php echo site_url('Tracing/trace_mi_document'); ?>",
        beforeSend: function () {
            startLoad();
        },
        success: function (data) {
