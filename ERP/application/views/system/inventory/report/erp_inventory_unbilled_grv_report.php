...
<div class="row">
    <div class="col-md-12">
        ...
        if ($type == 'html') { ?>
            ...
            <?php
            echo export_buttons('tbl_unbilled_grv', 'Unbilled GRV', false, true);
        } ?>
    </div>
</div>
<div id="tbl_unbilled_grv">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="text-center reportHeader reportHeaderColor"><?php echo $this->lang->line('transaction_unbilled_grv');?></div><!--Unbilled GRV-->
            <div
            ...
            <?php if (!empty($output)) { ?>
                <table class="borderSpace report-table-condensed" id="tbl_report">
                    ...
                    <tr>
                        ...
                        $grnvalue=$this->lang->line('transaction_grn_value');
                    ...
                    if (!empty($category)) {
                        foreach ($category as $key => $supplierName) {
                            ...
                            foreach ($supplierName as $key2 => $val) {
                                ...
                                if($type == 'html') {
                                    echo '<td><a href="#" class="drill-down-cursor" onclick="documentPageView_modal(\'' . $val["documentID"] . '\',' . $val["grvAutoID"] . ')">' . $val["grvPrimaryCode"] . '</a></td>';
                                }
                                else{
                                    echo '<td>'. $val["grvPrimaryCode"] . '</td>';
                                }
                                echo "<td>" . $val["docrefno"] . "</td>";
                                echo "<td>" . $val["grvDate"] . "</td>";
                                if (!empty($fieldName)) {
