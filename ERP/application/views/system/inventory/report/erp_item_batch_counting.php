...
<div class="row">
    <div class="col-md-12">
        <form method="POST" id="frm_filter" class="form-horizontal" action="" name="frm_filter">
            ...
            <input type="hidden" id="fieldNameChkexceltypeas" name="fieldNameChkexceltypeas" value="">
            <input type="hidden" id="fieldNameChkpdftypeas" name="fieldNameChkpdftypeas" value="">
            ...
            <input type="hidden" id="fieldNameChkexceltypecheck1" name="fieldNameChkexceltypecheck1" value="">
    ...
    <div class="modal-dialog" style="width: 420px">
        <div class="modal-content">
            ...
            <div class="modal-footer" style="margin-top: 0px;">
                <button type="button" class="btn btn-block btn-primary btn-flat hidden" onclick="print_pos_report()"
                        style="">
...
<script type="text/javascript">
    ...
    function get_item_filter() {
        $.ajax({
            ...
            url: "<?php echo site_url('Report/get_item_filter'); ?>",
            beforeSend: function () {
    ...
    function generateReportPdf() {
        var fieldNameChk = [];
        var captionChk = [];
        var typeas = $('#fieldNameChk').val();
        var typeaschk1 = $('#fieldNameChk1').val();
        $("input[name=fieldName]:checked").each(function () {
        ...
        document.getElementById('fieldNameChkpdftypeas').value = typeas;
        document.getElementById('fieldNameChkexceltypecheck1').value = typeaschk1;
    ...
    function excel_export() {
        ...
        document.getElementById('fieldNameChkexceltypeas').value = typeas;
        document.getElementById('fieldNameChkexceltypecheck1').value = typeaschk1;
        form.target = '_blank';
        form.method = 'post';
        form.post = $('#frm_filter').serializeArray();
        form.action = '<?php echo site_url('Report/export_excel_item_report'); ?>';
        form.submit();
    }
