...
$title = $this->lang->line('inventory_item_master_report');
...
<div class="row">
    ...
    <div class="form-group col-sm-3">
        <label>Search</label><!--Sub Sub Category-->
        <input type="text" id="search" name="search" onkeyup="Otable.draw()" class="form-control">
    </div>
    ...
    <div class="modal-dialog " style="width: 100%;" role="document">
        <div class="modal-content">
                            ...
                            <div class="table-responsive">
                                <table class="<?php echo table_class(); ?>" id="itemmultipletableserver">
                                    ...
                                    <tr>
                                        ...
                                        <td class="inventry_row_div assetGlCode_div" style="z-index: 100000;">Asset GL
                                            Code
                                        </td>
                                        ...
                                        <td class="stockadjustment" style="z-index: 100000;">Stock Adjustment GL Code
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    </thead>
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" type="button" onclick="saveMultipleItemMaster()">
...
<script type="text/javascript">
    ...
    function item_table() {
        Otable = $('#item_table').DataTable({
            ...
            "bInfo": true,
            "bStateSave": true,
            "lengthMenu": [[100, 10, 20, -1], [100, 10, 20, "All"]],
            "sAjaxSource": "<?php echo site_url('ItemMaster/fetch_item_report'); ?>",
            "aaSorting": [[0, 'desc']],
        ...
        if (!jQuery.isEmptyObject(mainCategoryIDselect)) {
            Otables = $('#itemmultipletableserver').DataTable({
                ...
                "columnDefs": [{"targets": [1], "orderable": false}, {
                    className: "inventry_row_div tdCol",
                    "targets": [14, 15]
                }, {
                    className: "inventry_row_div assetGlCode_div tdCol",
                    "targets": [16]
                }, {className: "fixed_row_div tdCol", "targets": [17, 18, 19, 20]}, {
                    className: "stockadjustment tdCol",
                    "targets": [17, 18, 19, 21]
                }, {className: "cls_maximunQty tdCol", "targets": [11]}, {
                    className: "cls_minimumQty tdCol",
                    "targets": [12]
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data[0] == 's') {
                        ...
                        //Otables.draw();
                        setTimeout(function () {
                            uploadExcelItemMasterServerdidemodel()
                        }, 1500);
    ...
    function excel_export() {
        ...
        form.action = '<?php echo site_url('ItemMaster/export_excel_item_master_report'); ?>';
        form.submit();
    }
</script>