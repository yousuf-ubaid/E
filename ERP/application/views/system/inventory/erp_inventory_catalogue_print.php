                    ...
                    <table>
                        <tr>
                            <td colspan="3">
                                ...
                                <h4><?php echo 'Inventory Catalogue'?><!--Material Request--> </h4>
                            </td>
                        </tr>
                        <tr>
                            <td><strong><?php echo 'Inventory Catalogue Number'//$this->lang->line('transaction_material_request_number')?><!--Material Request Number--> </strong></td>
                            <td><strong>:</strong></td>
                            <td><?php echo $extra['master']['MRCode']; ?></td>
                        </tr>
                        <tr>
                            <td><strong><?php echo 'Inventory Catalogue Date'//$this->lang->line('transaction_material_request_date')?><!--Material Request Date--> </strong></td>
                            <td><strong>:</strong></td>
    ...
    <table class="table table-bordered table-striped">
        <thead>
            <tr>
                ...
                <th class='theadtr' style="min-width: 10%"><?php echo $this->lang->line('common_price')?><!--Current Qty--></th>
                <th class='theadtr' style="min-width: 10%"><?php echo $this->lang->line('common_comments')?><!--Current Qty--></th>
        ...
        <tbody>
            ...
            if (!empty($extra['detail'])) {
                ...
                <tr>
                    ...
                    <td style="text-align:right;"><?php echo number_format($val['transactionAmount'],2); ?></td>
...
<script>
    ...
    a_link=  "<?php echo site_url('Inventory/load_inventory_catalogue_conformation'); ?>/<?php echo $extra['master']['mrAutoID'] ?>";
