...
<script type="text/javascript">
    ...
    function stock_adjustment_table() {
         Otable = $('#stock_adjustment_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Inventory/fetch_stock_adjustment_approval_buyback'); ?>",
            "aaSorting": [[1, 'desc']],
            ...
            "aoColumns": [
             ...
             "columnDefs": [{"targets": [7], "orderable": false},{"targets": [0,3,6,7], "searchable": false},{"visible":false,"searchable": true,"targets": [8,9,10] }],
