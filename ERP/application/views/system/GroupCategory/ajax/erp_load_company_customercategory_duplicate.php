<div class="row">
    <div class="col-md-12">
        <div style="font-size: 16px; font-weight: 700;"><?php echo $extra['customerCategoryDetails']['categoryDescription']  ?></div>
    </div>
</div>
<br>
<?php
foreach ($companyID as $val)
{
    ...
    $customerCategoryVal = get_group_customer_category_details($groupCustomerCategoryID, $val);
?>
    <div class="row">
