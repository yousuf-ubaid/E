...
$title = $this->lang->line('config_common_supplier_category');
...
<div class="row table-responsive">
    ...
    <div class="col-md-7 text-right">
        <button type="button" style="" class="btn btn-primary pull-right" onclick="opensuppliercategorymodel()"><i
                class="fa fa-plus"></i> <?php echo $this->lang->line('common_create_category') ?><!-- Create Category-->
        </button>
    </div>
</div>
<hr>
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm btn-primary " onclick="saveCategory()"><i
                            class="fa fa-plus"></i> <?php echo $this->lang->line('common_save') ?>
                    </button>
...
<div class="modal fade" id="supplierCategoryDuplicateModal" role="dialog" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog" style="width: 60%">
        <div class="modal-content" id="">
            <?php echo form_open('', 'role="form" id="suplier_category_duplicate_form"'); ?>
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"><?php echo $this->lang->line('config_supplier_category_replication') ?><!--Chart of account Replication--> <span id=""></span></h4>
            </div>
            <div class="modal-body" style="margin-left: 10px">
                <div class="row">
                    <div class="col-sm-12">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#suplier_category_duplicate_form').bootstrapValidator({
            live: 'enabled',
            message: 'This value is not valid.',
            excluded: [':disabled'],
            fields: {
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: data,
                url: "<?php echo site_url('GroupCategory/save_supplier_category_duplicate'); ?>",
                beforeSend: function() {
                    startLoad();
                },
                success: function(data) {
                    ...
                    if (data[0] == 's') {
                        ...
                        $('#supplierCategoryDuplicateModal').modal('hide');
                    }
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data) {
                    ...
                    $('#categoryHead').html('<?php echo $this->lang->line('config_edit_category') ?>');
    ...
    function opensuppliercategorymodel() {
        $('#partyCategoryID').val('');
        $('#categoryHead').html('<?php echo $this->lang->line('config_add_new_category') ?>');
    ...
    function link_group_supplier_category(partyCategoryID) {
        $('#supplierCategoryLinkModal').modal({
            backdrop: "static"
        });
    ...
    function load_all_companies_category() {
        $.ajax({
            ...
            dataType: 'html',
            data: {
                groupSupplierCategoryID: $('#partyCategoryIDhn').val()
            },
    ...
    function load_duplicate_group_supplier_category(id) {
        $('#supplierCategoryDuplicateModal').modal({
            backdrop: "static"
        });
    ...
    function load_all_companies_duplicate() {
        $.ajax({
            ...
            dataType: 'html',
            data: {
                groupSupplierCategoryID: $('#partyCategoryIdDuplicatehn').val()
            },
            url: "<?php echo site_url('GroupCategory/load_all_supplier_companies_duplicate'); ?>",
            beforeSend: function() {
