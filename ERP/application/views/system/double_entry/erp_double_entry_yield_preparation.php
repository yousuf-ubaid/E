...
<div class="table-responsive"><br>
    <table class="table table-bordered table-striped">
        <thead>
        <tr>
            <th class='theadtr' colspan="5">GL Details</th>
        ...
        <tfoot>
        <tr>
            <td class="text-right sub_total" colspan="5">Double Entry Total (<?php echo $extra['currency']; ?>) </td>
            <td class="total" style="text-align:right;"><?php echo format_number($dr_total,$extra['decimal_places']); ?></td>
            <td class="total" style="text-align:right;"><?php echo format_number($cr_total,$extra['decimal_places']); ?></td>
        </tr>
        </tfoot>
    </table>
</div>