...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/accounts_payable/supplier_invoices_management_suom', InvoiceAutoID, 'Supplier Invoices');
        });
        $('.select2').select2();
        InvoiceAutoID = null;
    ...
    function fetch_supplier_invoice_detail(type, supplierID, currencyID,tabid=1) {
        $.ajax({
            ...
            url: "<?php echo site_url('Payable/fetch_supplier_invoice_detail_suom'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
    ...
    function save_draft() {
        if (InvoiceAutoID) {
            swal({
                ...
                function () {
                    fetchPage('system/accounts_payable/supplier_invoices_management_suom',InvoiceAutoID,'Supplier Invoice');
                });
        }
    }
