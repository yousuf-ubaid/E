                                        ...
                                        foreach ($suppliers as $key3 => $type1) {
                                            {
                                                ...
                                                if($isTransCost) {
                                                    foreach ($type1 as $key4 => $currency) {
                                                        $transtotalcred = array();
                                                        $transtotaldeb = array();
                                                        $decimalPlace = 2;
                                                        foreach ($currency as $key5 => $val) {
                                                        ...
                                                        if (!empty($fieldName)) {
                                                            foreach ($fieldName as $val2) {
                                                                if ($val2 == "transactionAmount") {
                                                                    ...
                                                                    echo "<td class='text-right reporttotal'>" . format_number(array_sum($transtotalcred[$val2]), $decimalPlace) . "</td>";
                                                                }
                            ...
                            if (!empty($category)) {
                                foreach ($category as $key => $glcodes) {
                                    ...
                                    foreach ($glcodes as $key2 => $suppliers) {
                                        ...
                                        if ($isTransCost) {
                                            foreach ($suppliers as $key3 => $currencyArr) {
                                                $Transsubtotaldeb = array();
                                                $Transsubtotalcred = array();
                                                $decimalPlace = 2;
                                                foreach ($currencyArr as $key4 => $val) {
                                                    echo "<tr class='hoverTr'>";
                                                    if ($val["documentDate"] == "1970-01-01") {
                                                        echo "<td><div style='margin-left: 30px;color: #ffffff;opacity: 0; '>" . $val["documentDate"] . "</div></td>";
                                                    } else {
                                    ...
                                    if ($isLocCost || $isRptCost) {
                                        ...
                                        if ($isTransCost) {
                                            ...
                                            echo "<td colspan='10'><div style='margin-left: 30px'><strong>$gran<!--Grand Total--></strong></div></td>";
                                        } else {
                                            echo "<td colspan='7'><div style='margin-left: 30px'><strong>$gran<!--Grand Total--></strong></div></td>";
                                        }
                                    }
                                    if (!empty($fieldName)) {
                                        foreach ($fieldName as $val2) {
