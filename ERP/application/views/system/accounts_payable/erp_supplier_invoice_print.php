...
if(($printHeaderFooterYN == 1) || ($printHeaderFooterYN == 2)){?>
    ...
    <hr>
    <h4 class="text-center"><strong><?php echo $this->lang->line('accounts_payable_supplier_invoice');?></strong></h4><!--Supplier Invoice-->
<?php } else { ?>
    ...
    <br>
    <hr>
    <h4 class="text-center"><strong><?php echo $this->lang->line('accounts_payable_supplier_invoice'); ?></strong>
    </h4><!--Supplier Invoice-->
    <?php
    }
}?>
    ...
    <table style="width: 100%">
        <tbody>
            ...
            <tr>
                ...
                <td><strong><?php echo $this->lang->line('common_supplier_document_date');?><!--Document Date/(or Apply Date)--></strong></td>
                <td><strong>:</strong></td>
            ...
            <tr>
                ...
                <td><strong><?php echo $this->lang->line('common_supplier_invoice_date');?><!--Supplier Invoice Date/(or Invoice Date)--> </strong></td>
                <td><strong>:</strong></td>
                <td> <?php echo $extra['master']['invoiceDate']; ?></td>
            </tr>
            <tr>
                <td><strong><?php echo $this->lang->line('accounts_payable_supplier_vat_number');?><!--Supplier VAT No--></strong></td>
                <td><strong>:</strong></td>
            ...
            <?php if($extra['master']['invoiceType'] == 'StandardPO') { ?>
                <tr>

                    <td style="vertical-align: top"><strong><?php echo $this->lang->line('common_po_number');?><!--Narration--> </strong></td>
                    <td style="vertical-align: top"><strong>:</strong></td>
                    <td>
                        <?php 
                            if($extra['master']['purchaseOrderDetails']){
                                $temp_arr = explode('|',$extra['master']['purchaseOrderDetails']);
                                echo isset($temp_arr[0])? $temp_arr[0] : '';
                            }
                        ?>
                    </td>
            ...
            <?php if($isRcmDocument == 1){?>
                <tr>
                    <td style="width: 25%"><span class="label label-danger" style="font-size: 9px;" title="Not Received" rel="tooltip">Reverse Charge Mechanism Activated</span>
                    </td>
                </tr>
            <?php }?>
       </tbody>
    ...
    <table id="add_new_grv_table" class="table table-bordered table-striped">
        <thead>
            <tr>
              ...
              <!--  <th class='theadtr' colspan="3"> <?php /*echo $this->lang->line('common_amount');*/?> </th>-->
                <th class='theadtr' colspan="<?php echo ($group_based_tax ==1?5:3) ?>"> <?php echo $this->lang->line('common_amount');?><!--Amount--> </th>
            </tr>
            <tr>
                <th class='theadtr' style="width: 3%">#</th>
                <th class='theadtr' style="width: 14%"><?php echo $this->lang->line('common_gl_code');?><!--GL Code--></th>
                <th class='theadtr' style="width: 27%"><?php echo $this->lang->line('common_gl_code_description');?><!--GL Code Description--></th>
                <th class='theadtr' style="width: 10%"><?php echo $this->lang->line('common_segment');?><!--Segment--></th>
                <?php if($advanceCostCapturing == 1){ ?>
                    <th class='theadtr' style="width: 10%">Activity Code</th>
                <?php } ?>
                <th class='theadtr' style="width: 12%"><?php echo $this->lang->line('common_transaction');?><!--Transaction--> (<?php echo $extra['master']['transactionCurrency']; ?>) </th>
                <th class='theadtr' style="width: 12%"><?php echo $this->lang->line('common_discount');?><!--Discount--></th>
                <?php if($retensionEnabled == 1){ ?>

                    <th class='theadtr' style="width: 12%"><?php echo $this->lang->line('common_retension');?><!--Discount--></th>

                <?php } ?>
                <?php if($group_based_tax == 1) {?>
                <th class='theadtr' style="width: 15%">Tax</th>
                <th class='theadtr' style="width: 15%">Tax Amount</th>
                <?php }?>
            ...
            if (!empty($extra['detail'])) {
                for ($i=0; $i < count($extra['detail']); $i++) {
                    ...
                    if($advanceCostCapturing == 1){
                        echo '<td class="text-center">'.$extra['detail'][$i]['activityCodeName'].'</td>';
                    }
                    echo '<td class="text-right">'.format_number($extra['detail'][$i]['transactionAmount']+$extra['detail'][$i]['discountAmount'], $extra['master']['transactionCurrencyDecimalPlaces']).'</td>';
                    echo '<td class="text-right">('.format_number($extra['detail'][$i]['discountPercentage'], 2).'%) '.format_number($extra['detail'][$i]['discountAmount'], $extra['master']['transactionCurrencyDecimalPlaces']).'</td>';
                    
                    if($retensionEnabled == 1) {
                        echo '<td class="text-right">('.format_number($extra['detail'][$i]['retensionPercentage'], 2).'%) '.format_number($extra['detail'][$i]['retensionValue'], $extra['master']['transactionCurrencyDecimalPlaces']).'</td>';
                        $extra['detail'][$i]['transactionAmount'] = $extra['detail'][$i]['transactionAmount'] - $extra['detail'][$i]['retensionValue'];
                    }
                    
                    if ($group_based_tax == 1) {
                        if($extra['detail'][$i]['taxAmountLedger'] > 0) {
                            echo '<td class="text-left">'.$extra['detail'][$i]['Description'].'</td>';
                            echo '<td class="text-right">
                                     <a onclick="open_tax_dd(null,'.$extra['detail'][$i]['InvoiceAutoID'].',\'BSI\','. $extra['master']['transactionCurrencyDecimalPlaces'].' ,'. $extra['detail'][$i]['InvoiceDetailAutoID'].', \'srp_erp_paysupplierinvoicedetail\',\'InvoiceDetailAutoID\',0,1) ">'. number_format($extra['detail'][$i]['taxAmountLedger'], $extra['master']['transactionCurrencyDecimalPlaces']).'</a>      
                                  </td>';
                        }else {
                            echo '<td class="text-left">'.$extra['detail'][$i]['Description'].'</td>';
                            echo '<td class="text-right">'.format_number($extra['detail'][$i]['taxAmountLedger'], $extra['master']['transactionCurrencyDecimalPlaces']).'</td>';
                        }
                      ...
                      if ($group_based_tax == 1) {
                          echo '<td class="text-right">' . format_number($extra['detail'][$i]['transactionAmount'] + $extra['detail'][$i]['taxAmountLedger'], $extra['master']['transactionCurrencyDecimalPlaces']) . '</td>';
                      }else {
                    ...
                    echo '</tr>';
                    if ($group_based_tax == 1) {
                        $gran_total += ($extra['detail'][$i]['transactionAmount'] + $extra['detail'][$i]['taxAmountLedger']);
                        $transaction_total+= ($extra['detail'][$i]['transactionAmount'] + $extra['detail'][$i]['taxAmountLedger']);
                    }else {
        ...
        <tfoot>
            <tr>
                <?php if($retensionEnabled == 1) { ?>
                    <td class="text-right sub_total" colspan="<?php echo ($group_based_tax==1?9:7)?>"><?php echo $this->lang->line('common_gl_total');?><!--GL Total--> </td>
                <?php } else { ?>
                    <td class="text-right sub_total" colspan="<?php echo ($group_based_tax==1?8:6)?>"><?php echo $this->lang->line('common_gl_total');?><!--GL Total--> </td>
                <?php } ?>
    ...
    <table id="add_new_grv_table" class="table table-bordered table-striped">
        <thead>
            <tr>
                ...
                <th class='theadtr' colspan="4"> <?php echo $this->lang->line('common_amount');?><!--Amount--> </th>
            </tr>
            <tr>
        ...
        <tbody>
            ...
            if (!empty($extra['grv_detail'])) {
                ...
                for ($i=0; $i < count($extra['grv_detail']); $i++) {
                    echo '<tr>';
                    echo '<td>'.($i+1).'</td>';
                    echo '<td>'.$extra['grv_detail'][$i]['grvPrimaryCode'].'</td>';
                    ...
                    if($retensionEnabled == 1) {
                        echo '<td class="text-right">('.format_number($extra['grv_detail'][$i]['retensionPercentage'], 2).'%) '.format_number($extra['grv_detail'][$i]['retensionValue'], $extra['master']['transactionCurrencyDecimalPlaces']).'</td>';
                        $extra['detail'][$i]['transactionAmount'] = $extra['detail'][$i]['transactionAmount'] - $extra['detail'][$i]['retensionValue'];
                    }
                    if ($group_based_tax == 1) {
                        if($extra['detail'][$i]['taxAmountLedger'] > 0) {
                ...
                echo '<tr class="danger"><td colspan="9" class="text-center"><b>'.$norecordfound.'<!--No Records Found--></b></td></tr>';
            }
            ?>
        </tbody>
        <tfoot>
            <?php if($group_based_tax == 1) {
                $colspan = 7 + $retensionEnabled;
            }else {
                $colspan = 5 + $retensionEnabled;

            }?>
            <tr>
                <td class="text-right sub_total" colspan="<?php echo $colspan ?>"><?php echo $this->lang->line('accounts_payable_grv_total');?><!--GRV Total--> </td>
                <td class="text-right total"><?php echo format_number($transaction_total,$extra['master']['transactionCurrencyDecimalPlaces']); ?></td>
                <!-- <td class="text-right total"><?php //echo format_number($Local_total,$extra['master']['companyLocalCurrencyDecimalPlaces']); ?></td>
                <td class="text-right total"><?php //echo format_number($supplier_total,$extra['master']['supplierCurrencyDecimalPlaces']); ?></td> -->
                <!--<td class="sub_total"> &nbsp; </td>-->
...
if (!empty($extra['Itemdetail'])) { ?>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped table-condensed">
            ...
            <tr>
                <th class='theadtr'
                    colspan="<?php echo ($itemBatch_policy == 1 ? '6':'5')?>">Item Details</th>
                <!---->
                <th class='theadtr' colspan="<?php echo ($group_based_tax == 1  ? 5:3) ?>"><?php echo $this->lang->line('common_amount'); ?>
            ...
            <tr>
                ...
                <th class='theadtr'
                    style="min-width: 15%"><?php echo $this->lang->line('accounts_payable_tr_pv_item_code'); ?><!--Item Code--></th>
                <th class='theadtr'
                    style="min-width: 45%"><?php echo $this->lang->line('common_item_description'); ?><!--Item Description--></th>
                <!---->
                <?php if ($itemBatch_policy == 1) { ?>
                    <th class='theadtr' style="min-width: 10%">Batch Number</th>
                <?php }?>
                <th class='theadtr'
                    style="min-width: 10%"><?php echo $this->lang->line('common_uom'); ?><!--UOM--></th>
                <!---->
                <th class='theadtr'
                    style="min-width: 5%"><?php echo $this->lang->line('common_qty'); ?><!--Qty--></th>
                <!---->
                <th class='theadtr'
                    style="min-width: 10%"><?php echo $this->lang->line('common_unit'); ?><!--Unit--></th>
                <th class='theadtr'
                    style="min-width: 5%"><?php echo $this->lang->line('common_discount'); ?><!--Discount--></th>
                <?php if($retensionEnabled == 1){ ?>
                ...
                foreach ($extra['Itemdetail'] as $val) { ?>
                    <tr>
                        ...
                        <?php if($val['discountAmount']){ ?>
                            <td style="text-align: right;"><?php echo  format_number(($val['discountAmount']), $extra['master']['transactionCurrencyDecimalPlaces']) .'( '.format_number($val['discountPercentage'],2). '% )' ?></td>
                        <?php  } else { ?>
                            <td><?php echo '0' ?></td>
                        <?php }?>

                        <?php if($retensionEnabled == 1) { 
                            echo '<td class="text-right">('.format_number($val['retensionPercentage'], 2).'%) '.format_number($val['retensionValue'], $extra['master']['transactionCurrencyDecimalPlaces']).'</td>';
                        ...
                        <?php if($group_based_tax == 1) {?>
                            ...
                            <?php if($val['taxAmountLedger'] > 0) {
                                echo '<td class="text-right">
                                     <a onclick="open_tax_dd(null,'.$val['InvoiceAutoID'].',\'BSI\','. $extra['master']['transactionCurrencyDecimalPlaces'].' ,'. $val['InvoiceDetailAutoID'].', \'srp_erp_paysupplierinvoicedetail\',\'InvoiceDetailAutoID\',0,1) ">'. number_format($val['taxAmountLedger'], $extra['master']['transactionCurrencyDecimalPlaces']).'</a>      
                                  </td>';
                            }else {
                                echo '<td class="text-right">'.format_number(isset($extra['detail'][$i]['taxAmountLedger']) ? $extra['detail'][$i]['taxAmountLedger'] : 0, $extra['master']['transactionCurrencyDecimalPlaces']).'</td>';
                            }?>


                            <td style="text-align:right;"><?php echo format_number((($val['transactionAmount']+$val['taxAmountLedger'])), $extra['master']['transactionCurrencyDecimalPlaces']); ?></td>
                    ...
                    if($group_based_tax == 1) {
                        ...
                        $item_total += $val['transactionAmount']+$val['taxAmountLedger'];
                        $gran_total += $val['transactionAmount']+$val['taxAmountLedger'];
                    }else {
            ...
            <tr>
                <?php if($retensionEnabled == 1) {  ?>
                    <td class="text-right sub_total"
                        colspan="<?php echo ($group_based_tax == 1 ? 10:8) ?>">Item Total
                        (<?php echo $extra['master']['transactionCurrency']; ?>)
                        </td><!---->

                <?php } else { ?>
                    <td class="text-right sub_total"
                            colspan="<?php echo ($group_based_tax == 1 ? 9:7) ?>">Item Total
                            (<?php echo $extra['master']['transactionCurrency']; ?>)
                        </td><!---->
                <?php } ?>
...
<div class="table-responsive">
    <table id="add_new_grv_table" class="<?php echo table_class(); ?>">
        ...
        <tr>
            ...
            <th class='theadtr' colspan="<?php echo ($group_based_tax == 1? 6:3) ?>">Received Item <span class="currency"> (<?php echo $extra['master']['transactionCurrency']; ?>)</span></th>
        </tr>
        <tr>
            <th class='theadtr' style="min-width: 5%">#</th>
            ...
            <?php if($group_based_tax == 1) {?>
                ...
                <th class='theadtr' style="min-width: 12%">Tax Amount </th>
                <th class='theadtr' style="min-width: 12%">Total </th>
            <?php }?>
        ...
        if (!empty($extra['podetail'])) {
            for ($i=0; $i < count($extra['podetail']); $i++) {
                ...
                echo '<td>'.$extra['podetail'][$i]['purchaseOrderCode'];
                ...
                echo '<td class="text-right">'.format_number($extra['podetail'][$i]['unittransactionAmount'],$extra['master']['transactionCurrencyDecimalPlaces']).'</td>';
                 ...
                 if ($group_based_tax == 1) {
                     echo '<td class="text-left">' . $extra['podetail'][$i]['Description'] . '</td>';
                     echo '<td class="text-right">' . format_number($extra['podetail'][$i]['taxAmountLedger'], $extra['master']['transactionCurrencyDecimalPlaces']) . '</td>';
                     ...
                     echo '<td class="text-right">'.format_number(($extra['podetail'][$i]['transactionAmount'] + $extra['podetail'][$i]['taxAmountLedger']),$extra['master']['transactionCurrencyDecimalPlaces']).'</td>';
                 }else {
                     echo '<td class="text-right">'.format_number(($extra['podetail'][$i]['transactionAmount']),$extra['master']['transactionCurrencyDecimalPlaces']).'</td>';
                 }
                ...
                echo '</tr>';
                  ...
                  if ($group_based_tax == 1) {
                      ...
                      $received_total += ($extra['podetail'][$i]['transactionAmount']+$extra['podetail'][$i]['taxAmountLedger']);
                      $gran_total += ($extra['podetail'][$i]['transactionAmount']+$extra['podetail'][$i]['taxAmountLedger']);
                  }else {
        ...
        <tr>
            ...
            <td class="text-right sub_total" colspan="<?php echo ($group_based_tax == 1?5:2)?>"><?php echo $this->lang->line('transaction_recived_item_total');?> <span class="currency"> (<?php echo $extra['master']['transactionCurrency']; ?>)</span></td><!--Received Item Total-->
            ...
            <tr>
                ...
                <td style="width:60%;padding: 0;">
                    <table style="width: 100%; " class="<?php echo table_class(); ?>">
                        ...
                        echo '<td class="text-right">'. number_format($discountamnt,$extra['master']['transactionCurrencyDecimalPlaces']).'</td>';
                        echo '</tr>';
