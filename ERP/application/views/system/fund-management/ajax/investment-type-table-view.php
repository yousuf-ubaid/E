...
<?php
if (empty($invType)) {
    echo '<div class="search-no-results">'. $this->lang->line('fn_man_there_are_no_investment_types').'</div>';
    die();
}
?>
    ...
    <div class="table-responsive mailbox-messages">
        <table class="table table-hover table-striped">
            ...
            <tr>
                ...
                <td class="head-row-title" style="border: solid 1px rgba(158, 158, 158, 0.23);">
                    <?php echo $this->lang->line('common_gl_code'); ?>
                </td>
            ...
            foreach ($invType as $val) {
                ...
                <tr>
                    ...
                    <td class="mailbox-attachment sup_table">
                        <?php echo $val['GLSecondaryCode'].' - '.$val['GLDescription'] ?>
                    </td>
                    <td class="mailbox-attachment sup_table">
