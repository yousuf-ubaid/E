...
?>
<div class="row">
    <?php echo form_open_multipart('', 'id="qs_attachment_form" class="form-inline"'); ?>
    <div class="col-sm-12" style="margin-left: 3%">
        <div class="col-sm-4">
            <div class="form-group">
                <input type="text" class="form-control" id="qsattachmentDescription"
                       name="attachmentDescription" placeholder="Description..." style="width: 240%;">
                <input type="hidden" class="form-control" id="qs_documentID" name="documentID" value="PROQS">
                <input type="hidden" class="form-control" id="qs_document_name" name="document_name"
                       value="QUANTITY SURVEYING ATTACHMENT">
                <input type="hidden" class="form-control" id="qs_documentSystemCode" name="documentSystemCode" value="<?php echo $headerID ?>">
        ...
        <div class="col-sm-4" style="margin-top: -8px;">
            ...
            <button type="button" class="btn btn-default" onclick="document_uplode_qs()"><span
