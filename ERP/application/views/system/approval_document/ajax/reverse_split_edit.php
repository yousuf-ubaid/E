...
<div class="col-md-12">
    ...
    <div class="row">
        ...
        <input type="hidden" name="split_autoid" id="split_autoid" value="<?php echo $ex_document['id'] ?>" >
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <?php echo form_dropdown('segment', $segment_arr, $ex_document['segment_id'], 'class="form-control select2" id="segment" onchange="check_all_selected()" required'); ?>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
            <?php echo form_dropdown('cr_gl_code', $gl_codes, $ex_document['credit_gl_autoid'], 'class="form-control select2" id="cr_gl_code" onchange="check_all_selected()" required'); ?>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
            <?php echo form_dropdown('dr_gl_code', $gl_codes, $ex_document['debit_gl_autoid'], 'class="form-control select2" id="dr_gl_code" onchange="check_all_selected()" required'); ?>
            </div>
    ...
    <div class="row">
        ...
        <div class="table-responsive">
            ...
            <table id="tbl_split_calc" class="<?php echo table_class() ?>">
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php foreach($selected as $key => $value) { ?>
                        <tr>
                            ...
                            <?php if($value['amount_type'] == 'cr') { ?>
                                <td><span class="text-bold"><?php echo $value['transactionCurrency'] ?></span>&nbsp<span id="amount_<?php echo $value['amount_type'] ?>" class="amount value"><?php echo number_format($ex_document['credit_amount'],2) ?></span></td>
                                <td><input type="number" class="form-control adjust_value" id="adjust_value_<?php echo $value['amount_type'] ?>" onchange="recalculate_row($(this))" value="<?php echo number_format($ex_document['credit_adjusment'],2) ?>"/></td>
                                <td><span class="text-bold"><?php echo $value['transactionCurrency'] ?></span>&nbsp<span id="final_amount_<?php echo $value['amount_type'] ?>" class="fianl_amount value"><?php echo number_format($ex_document['credit_final_amount'],2) ?></span></td>
                            <?php }else{ ?>
                                <td><span class="text-bold"><?php echo $value['transactionCurrency'] ?></span>&nbsp<span id="amount_<?php echo $value['amount_type'] ?>" class="amount value"><?php echo number_format($ex_document['debit_amount'],2) ?></span></td>
                                <td><input type="number" class="form-control adjust_value" id="adjust_value_<?php echo $value['amount_type'] ?>" onchange="recalculate_row($(this))" value="<?php echo number_format($ex_document['debit_adjusment'],2) ?>"/></td>
                                <td><span class="text-bold"><?php echo $value['transactionCurrency'] ?></span>&nbsp<span id="final_amount_<?php echo $value['amount_type'] ?>" class="fianl_amount value"><?php echo number_format($ex_document['debit_final_amount'],2) ?></span></td>
                            <?php } ?>
            ...
            <table id="tbl_split_amount" class="<?php echo table_class() ?>">
                <thead>
                    <tr>
                        <th style="min-width: 10%">GL Code</th><!--Code-->
                        <th style="min-width: 10%">GL Description</th><!--Code-->
...
<script type="text/javascript">
    ...
    function check_all_selected(){
        ...
        if(segment == '' || credit_gl == '' || debit_gl == ''){
            ...
            var table_row_cr = '<tr><td>'+credit_gl_text[0]+'</td><td>'+credit_gl_text[2]+'</td><td>'+segment_text[1]+'</td><td>Credit</td><td>'+credit_gl_text[3]+'</td><td>0.00</td><td><input type="text" id="cr_value" onchange="reverse_calc_split($(this))" value="<?php echo trim($ex_document['credit_adjusment'] ?? '') ?>" ></td><td><span class="text-bold"><?php echo $value['transactionCurrency'] ?></span>&nbsp<span id="cr_final_val"><?php echo trim($ex_document['credit_adjusment'] ?? '') ?></span></td></tr>';
            $('#tbl_split_amount tbody').append(table_row_cr);

            var table_row_dr = '<tr><td>'+debit_gl_text[0]+'</td><td>'+debit_gl_text[2]+'</td><td>'+segment_text[1]+'</td><td>Debit</td><td>'+debit_gl_text[3]+'</td><td>0.00</td><td><input type="text" id="dr_value" onchange="reverse_calc_split($(this))" value="<?php echo trim($ex_document['debit_adjusment'] ?? '') ?>"></td><td><span class="text-bold"><?php echo $value['transactionCurrency'] ?></span>&nbsp<span id="dr_final_val"><?php echo trim($ex_document['debit_adjusment'] ?? '') ?></span></td></tr>';
    ...
    function submitSplitDocument(){
        ...
        var split_autoid = $('#split_autoid').val();
