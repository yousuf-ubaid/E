    ...
    <div class="col-md-12">
        <div class="box-body no-padding">
            ...
            <div class="row">
                ...
                <div class="col-sm-1">
                    <ul class="alpha-box">
                        <li><a href="#" class="leadsorting selected"  id="sorting_1" onclick="load_lead_filter('#',1)">#</a></li>
...
<script type="text/javascript">
    ...
    function pagination(obj) {
        ...
        var filtervalue = '#';
        getLeadManagement_tableView(filtervalue,data_pagination, uriSegment);
    }
    ...
    function getLeadManagement_tableView(filtervalue,pageID,uriSegment = 0) {
        ...
        $.ajax({
            ...
            type: 'post',
            dataType: 'json',
            data: {'searchTask': searchTask, 'filtervalue': filtervalue,status:status,'pageID':pageID,responsible:responsible,'pageID':pageID,'createdby':createdby},
            url: "<?php echo site_url('CrmLead/load_leadManagement_view'); ?>/" + uriSegment,
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
                $('#LeadMaster_view').html(data['view']);
  ...
  function edit_lead(leadID,createdUserIDtask,responsiblePersonEmpID)
    {
        if((createdUserIDtask == '<?php echo $cuurentuser ?>') || ('<?php echo $admin['isSuperAdmin'] ?? 0?>' == 1) || ('<?php echo $isgroupadmin['adminYN'] ?? 0?>' == 1) || (responsiblePersonEmpID ==  '<?php echo $cuurentuser ?>'))
        {
