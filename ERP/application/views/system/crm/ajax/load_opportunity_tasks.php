            ...
            if (!empty($category)) {
                foreach ($category as $key => $value) {
                    ...
                    foreach ($value as $key2 => $value1) {
                        ...
                        echo "<td class='mailbox-name'><a href='#' class='.$textdecoration.' onclick=\"fetchPage('system/crm/task_edit_view','".$value1['taskID']."','View Task','".$masterID."','opportunityTaks')\">".$value1['subject']."</a></td>";
