            ...
            foreach ($header as $val) { ?>
                <tr>
                    ...
                    <td class="mailbox-name"><div class="contact-box">
                            <div class="link-box">
                                <?php
                                $contactimage = get_all_crm_images($val['organizationLogo'],'uploads/crm/organizationLogo/','org');
                                if($val['organizationLogo'] != ''){ ?>
                                 ...
                                 <!--   <img class="align-left" src="<?php /*echo base_url('uploads/crm/organizationLogo/'.$val['organizationLogo']. '?' . time()); */?>" width="40" height="40" style="border-radius: 40px;">-->
                                    <?php
                                } else { ?>
                                   <img class="person-circle align-left" style="width: 40px; height: 40px; cursor: pointer; border-radius: 40px" src="<?php echo $contactimage ?>">
                                ...
                                <?php } ?>
                                <div class="link-box"><strong class="contacttitle"><a class="link-person noselect" href="#"  onclick="fetchPage('system/crm/organization_edit_view','<?php echo $val['organizationID'] ?>','View Organization','CRM')"></a></strong></div></div>
                    </td>
                    ...
                    <td class="mailbox-name"><div class="contact-box">
                            <div class="link-box">
                                <div class="link-box"><strong class="contacttitle">
                                        ...
                                        <a class="link-person noselect" href="#"  onclick="fetchPage('system/crm/organization_edit_view','<?php echo $val['organizationID'] ?>','View Organization','CRM')">
                                            <?php echo $val['documentSystemCode'] ?><br>
                                            </a>
                                        <?php echo $val['Name'] ?>
                                        <br><?php echo $val['email'] ?></a></strong></div></div>
                    </td>
                    ...
                    <td class="mailbox-attachment"><span class="pull-right">
                            <a href="#"
                               onclick="fetchPage('system/crm/create_organization','<?php echo $val['organizationID'] ?>','<?php echo $this->lang->line('crm_edit_organization');?>','CRM')"><span
                                    title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;<a
                                onclick="delete_organization(<?php echo $val['organizationID'] ?>);"><span title="Delete" rel="tooltip"
                                                                                           class="glyphicon glyphicon-trash"
                                                                                           style="color:rgb(209, 91, 71);"></span></a></span><!--Edit Organization-->
                    </td>
