    ...
    <div class="table-responsive mailbox-messages">
        <table class="table table-hover table-striped">
            ...
            <!--Name-->
                ...
                <td class="headrowtitle" style="border-top: 1px solid #ffffff;text-align: center">Action</td><!--Action-->
            </tr>
            <?php
            $x = 1;
            foreach ($header as $val) { ?>
                <tr>
                 <!--   <td class="mailbox-name suptable"><a href="#" class="numberColoring"><?php /*echo $x; */?></a></td>-->
                        ...
                        <div class="contact-box">
                            <div class="link-box"><strong class="contacttitle">
                                    <a class="link-person noselect" href="#"
                                       onclick="fetchPage('system/crm/contact_edit_view','<?php echo $val['contactID'] ?>','View Contact','CRM')">
                                        <?php
                                        $contactimage = get_all_crm_images($val['contactImage'], 'uploads/crm/profileimage/', 'contact');
                                        if ($val['contactImage'] != '') {
                                            ?>
                        ...
                        <div class="contact-box">
                            <div class="link-box"><strong class="contacttitle">
                                    ...
                                    <a class="link-person noselect" href="#"
                                        ...
                                        <?php echo $val['documentSystemCode'] ?>  </a>
                                    <br> <?php echo $val['firstName'] . " " . $val['lastName'] ?>
                                     <br><?php echo $val['occupation'] ?>
                    ...
                    <td class="mailbox-attachment suptable"><span class="pull-right">
                            <a href="#"
                               onclick="fetchPage('system/crm/create_contact','<?php echo $val['contactID'] ?>','<?php echo $this->lang->line('crm_edit_contact'); ?>','CRM')"><span
                                        title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;<a
                                    onclick="delete_contact(<?php echo $val['contactID'] ?>);"><span title="Delete"
                                                                                                     rel="tooltip"
