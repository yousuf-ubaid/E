<div class="row">
    <div class="col-sm-12">
        <div class="past-info">
            <div id="toolbar">
                <div class="toolbar-title">Project Notes</div>
            </div>
            <?php
            if (!empty($notes)) {
                foreach ($notes as $row) {
                    ...
                    <div class="post-area">
                        <article class="post" style="padding-bottom: 2%">
                            ...
                            <div class="time"><!--<span class="hithighlight"><a href="#" onclick="edit_note(<?php /*echo $row['notesID']; */?>)"><span title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;-->
                                <?php if($row['createdUserID'] == current_userID()) { ?>
                                <a onclick="delete_note(<?php echo $row['notesID']; ?>);"><span title="Delete" rel="tooltip" class="glyphicon glyphicon-trash" style="color:rgb(209, 91, 71);"></span></a></span>
                            <?php } ?>
                            </div>
                            <div class="icon">
