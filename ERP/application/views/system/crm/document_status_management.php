                    ...
                    <form class="form-horizontal" id="crm_documentStatus">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label"
                                   for="selectbasic"><?php echo $this->lang->line('common_document'); ?> </label>
                            <!--Document-->
                            <div class="col-md-6" id="">
                                <?php echo form_dropdown('documentID', $all_crm_status_arr, '', 'class="form-control" id="documentID" onchange="typedrop(this.value)"'); ?>
            ...
            $.ajax({
                ...
                success: function (data) {
                   ...
                   // $('#IsClosestatus').val(data['statusType']).change();
                    if (data['documentID'] == 5) {

                        $('.otherstatustype').addClass('hide');
                        $('.statuswithoppo').addClass('hide');
                        $('.statuswithproject').addClass('hide');
                        $('.Leadstatus').removeClass('hide');
                        $('#IsClosestatuslead').val(data['statusType']).change();
                    } else if(data['documentID'] == 4)
                    {
                        $('.Leadstatus').addClass('hide');
                        $('.otherstatustype').addClass('hide');
                        $('.statuswithoppo').removeClass('hide');
                        $('.statuswithproject').addClass('hide');
                        $('#IsClosestatusopportunities').val(data['statusType']).change();

                    } else if(data['documentID'] == 9)
                    {
                        $('.Leadstatus').addClass('hide');
                        $('.otherstatustype').addClass('hide');
                        $('.statuswithoppo').addClass('hide');
                        $('.statuswithproject').removeClass('hide');
                        $('#IsClosestatusproject').val(data['statusType']).change();
                    }
                    else {
