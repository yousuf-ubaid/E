    ...
    <div id="step1" class="tab-pane active">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-12">
                ...
                <textarea class="form-control notes_termsandcond" rows="6" name="invoiceNote" id="invoiceNote"></textarea>
            </div>
        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('.headerclose').click(function(){
            fetchPage('system/invoices/invoices_management_DS',invoiceAutoID,'Customer Invoices');
        });
    ...
    function load_conformation() {
        if (invoiceAutoID) {
            $.ajax({
                ...
                url: "<?php echo site_url('Invoices/load_invoices_conformation_ds'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
                    $('#conform_body').html(data);
                    $("#a_link").attr("href", "<?php echo site_url('Invoices/load_invoices_conformation_ds'); ?>/" + invoiceAutoID);
                    $("#de_link").attr("href", "<?php echo site_url('Double_entry/fetch_double_entry_customer_invoice');?>/" + invoiceAutoID + '/CINV');
    ...
    function save_draft() {
        if (invoiceAutoID) {
            swal({
                ...
                function () {
                    fetchPage('system/invoices/invoices_management_DS', invoiceAutoID, 'Invoices');
                });
        }
    }
