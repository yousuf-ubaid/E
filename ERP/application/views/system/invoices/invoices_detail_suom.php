            ...
            <div class="tab-content">
                ...
                <div id="tab_2" class="tab-pane">
                    <table class="table table-bordered table-striped table-condesed">
                        <thead>
                        <tr>
                            <th colspan="3"><?php echo $this->lang->line('sales_markating_transaction_document_item_details'); ?> </th>
                            <!--Item Details-->
                                ...
                                <ul class="nav nav-stacked">
                                    ...
                                    if (!empty($customer_con)) {
                                        for ($i = 0; $i < count($customer_con); $i++) {
                                            ...
                                            echo '<li id="pull-'.$con_id.'" class="pull-li"><a onclick="fetch_con_detail_table(' . $con_id . ')">' . $customer_con[$i]['contractCode'] . ' <span class="glyphicon glyphicon-chevron-right pull-right" aria-hidden="true"></span></a></li>';
                                        }
                                    } else {
                    ...
                    <table class="table table-bordered table-condensed" id="income_add_table">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="amount[]" onkeypress="return validateFloatKeyPress(this,event)"
                                       value="00" class="form-control m_number number"></td>
                            <td><textarea class="form-control" rows="1" name="description[]"></textarea></td>
                            <td class="remove-td" style="vertical-align: middle;text-align: center"></td>
                        </tr>
                        </tbody>
                ...
                <div class="modal-body">
                    <table class="table table-bordered table-condensed" id="item_add_table">
                        ...
                        <tr>
                            ...
                            <th><?php echo $this->lang->line('sales_markating_transaction_document_uom'); ?></th>
                            <!--UOM-->
                            <th style="width: 100px;"><?php echo $this->lang->line('sales_markating_transaction_document_qty'); ?></th>
                            <!--Qty-->
                            ...
                            <!--Discount-->
                            <?php if(($taxEnabled == 1 || $taxEnabled == null)){ ?>
                                <th colspan="2"><?php echo $this->lang->line('sales_markating_transaction_tax'); ?>  </th><!--Tax-->
                            <?php } ?>
                        ...
                        <tr>
                            ...
                            <td style="width: 100px;">
                                <input type="text" name="discount_amount[]" placeholder="<?php echo $placeholder ?>" value="0"
                                       onkeyup="cal_discount_amount(this)" onfocus="this.select();" onkeypress="return validateFloatKeyPress(this,event)"
                                ...
                                <td style="width: 120px">
                                    <div class="input-group">
                                        <input type="text" name="item_taxPercentage[]" id=""
                                               placeholder="<?php echo $placeholder ?>" onfocus="this.select();"
                ...
                <div class="modal-body">
                    <table class="table table-bordered table-condensed" id="item_edit_table">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" name="estimatedAmount"  placeholder="<?php echo $placeholder ?>" onkeypress="return validateFloatKeyPress(this,event)"
                                           class="form-control number input-mini" onfocus="this.select();"
                            ...
                            <td style="width: 100px;" class="directdiscount">
                                <input type="text" name="discount_amount" id="edit_discount_amount"  placeholder="<?php echo $placeholder ?>" onkeypress="return validateFloatKeyPress(this,event)"
                            ...
                            <td class="hideTaxpolicy_edit" style="width: 120px">
                                <div class="input-group">
                                    <input type="text" name="item_taxPercentage" id="edit_item_taxPercentage"
                                           placeholder="<?php echo $placeholder ?>" onkeypress="return validateFloatKeyPress(this,event)" onfocus="this.select();"
                                           class="form-control number item_taxPercentage input-mini" value="0" readonly>
                                    <span class="input-group-addon input-group-addon-mini">%</span>
                                </div>
                            </td>
...
<script type="text/javascript">
                ...
                success: function (data) {
                    ...
                    if (jQuery.isEmptyObject(data['detail'])) {
                        ...
                        $.each(data['detail'], function (key, value) {
                            ...
                            str += '<td class="text-center"><input type="text" class="number" size="8" id="qty_' + value['contractDetailsAutoID'] + '" onkeyup="validate_Qty_DO(' + value['contractDetailsAutoID'] + ',this.value, ' + balQty + ')" ></td>';
                            <?php } else { ?>
                            str += '<td class="text-center"><input type="text" class="number" size="8" id="qty_' + value['contractDetailsAutoID'] + '" onkeyup="validate_with_wareHouse_qty(' + value['contractDetailsAutoID'] + '),select_check_box(' + value['contractDetailsAutoID'] + ')" ></td>';
                            <?php } if($costChange_validate == 1) { ?>
                            str += '<td class="text-center"><input type="text" class="number" size="10" onkeypress="return validateFloatKeyPress(this,event);" value="' + (parseFloat(value['unittransactionAmount']) + parseFloat(value['discountAmount'])) + '" id="amount_' + value['contractDetailsAutoID'] + '" onkeyup="select_amount(' + value['contractDetailsAutoID'] + ',this.value)"></td>';
                            <?php } else { ?>
                            str += '<td class="text-center"><input type="text" class="number" size="10" onkeypress="return validateFloatKeyPress(this,event);" value="' + (parseFloat(value['unittransactionAmount']) + parseFloat(value['discountAmount'])) + '" id="amount_' + value['contractDetailsAutoID'] + '" onkeyup="select_amount(' + value['contractDetailsAutoID'] + ',this.value)" disabled></td>';
                            <?php } ?>
                            str += '<td class="text-center"><input type="text" class="number" size="10" onkeypress="return validateFloatKeyPress(this,event);" value="' + parseFloat(value['discountAmount']).toFixed(currency_decimal) + '" id="discount_' + value['contractDetailsAutoID'] + '" onkeyup="cal_tot_amount(' + value['contractDetailsAutoID'] + ',this.value)"></td>';
                            <?php if(($taxEnabled == 1 || $taxEnabled == null) ){ ?>
                            ...
                            str += '<td class="text-right" style="display: none;"><input class="checkbox" id="check_' + value['contractDetailsAutoID'] + '" type="checkbox" value="' + value['contractDetailsAutoID'] + '"></td>';
                            str += '</tr>';
    ...
    function validate_Qty_DO(id,Qty, balanceQty) {
        validate_with_wareHouse_qty(id);
        select_check_box(id);
        if(balanceQty < Qty) {
            $('#qty_' + id).val('');
    ...
    function validate_with_wareHouse_qty(id){
        let qty = $('#qty_' + id).val();
    ...
    function fetch_invoice_direct_details() {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#gl_table_body,#gl_insurance_table_body,#item_table_body,#item_table_tfoot,#gl_table_tfoot,#gl_insurance_table_tfoot,#delivery_table_body').empty();
                if (jQuery.isEmptyObject(data['detail'])) {
                    $('#gl_table_body,#gl_insurance_table_body,#item_table_body').append('<tr class="danger"><td colspan="14" class="text-center"><b>'+no_records_found_str+'</b></td></tr>');
                    /*No Records Found*/
                    ...
                    $.each(data['detail'], function (key, value) {
                        ...
                        if (value['type'] == 'Item') {
                            ...
                            if (data['currency']['invoiceType'] == "Direct") {
                                $('#item_table_tfoot').append('<tr><td colspan="12" class="text-right taxenablefooter"><?php echo $this->lang->line('sales_markating_transaction_sales_Item_tot');?> </td><td class="text-right total">' + parseFloat(item_trans_amount).formatMoney(transactionDecimalPlaces, '.', ',') + '</td><td>&nbsp;</td></tr>');
                                <!--Item Total-->
                            } else {
                            ...
                            $('#gl_table_tfoot').append('<tr><td colspan="4" class="text-right"> Total </td><td class="text-right total">' + parseFloat(gl_trans_amount).formatMoney(transactionDecimalPlaces, '.', ',') + '</td></tr>');
                ...
                $('#discount_tot').text('Discount Applicable Amount( ' + parseFloat(discount_total).formatMoney(data['currency']['transactionCurrencyDecimalPlaces'], '.', ',') + ' )');
                $('#discount_tot_hn').val(discount_total);
                ...
                if( $('#gl_table_body > tr').length == 0 ){
                    $('#gl_table_body').append('<tr class="danger"><td colspan="6" class="text-center"><b>'+no_records_found_str+'</b></td></tr>')
                }
    ...
    function cal_tax(discount, total_amount) {
        ...
        if (tottaxappamnt && discount) {
            $('#tax_amount').val((tottaxappamnt / 100) * parseFloat(discount));
        } else {
            $('#tax_amount').val(0);
        }
    }
            ...
            $.ajax(
                {
                    ...
                    dataType: 'json',
                    data: data,
                    url: "<?php echo site_url('Invoices/save_invoice_item_detail_suom'); ?>",
                    beforeSend: function () {
                        startLoad();
    ...
    function Update_Invoice_Item_Detail() {
        ...
        if (invoiceAutoID) {
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: data,
                url: "<?php echo site_url('Invoices/update_invoice_item_detail_suom'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
