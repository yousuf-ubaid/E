...
if($extra['master']['invoiceType']=='Sales Order' || $extra['master']['invoiceType']=='Operation') {
...
if (!empty($extra)) {
    if($extra['master']['invoiceType']=='Sales Order' || $extra['master']['invoiceType']=='Operation'){
        ...
        $html .= '
        <table class="table table-bordered" style="width: 50%; padding-left: 7px;">
            <tr><td style="font-size: 11px; line-height: 3px;border: 1px solid black; border-bottom: none;">Consignee</tr>
            <tr><td style="font-size: 11px; line-height: 3px;border: 1px solid black; border-bottom: none;">'. $extra['customer']['customerName'].'</td></tr>
            <tr><td style="font-size: 11px; line-height: 3px;border: 1px solid black; border-bottom: none;">'. $extra['customer']['customerAddress1'].'</td></tr>
            <tr><td style="font-size: 11px; line-height: 3px;border: 1px solid black;">'. $extra['customer']['customerCountry'].'</td></tr>
        </table>
            ...
            <tr>
                <td style="width: 60%;">
                    <table class="table table-bordered">
                        <tbody>
                        <tr>
                            <td style="width: 20%;border: 1px solid black; border-bottom: none; border-right:none;"><strong>Invoice No :</strong></td>
                            <td style="border: 1px solid black; border-bottom: none;">'. $extra['master']['invoiceCode'].'</td>
                        </tr>
                        <tr>
                            <td style="width: 20%;border: 1px solid black; border-bottom: none; border-right:none;"><strong>PO No :</strong></td>
                            <td style="border: 1px solid black; border-bottom: none;">'. $extra['master']['referenceNo'].'</td>
                        </tr>
                        <tr>
                            <td style="width: 20%;border: 1px solid black; border-right:none;"><strong>Area :</strong></td>
                            <td style="border: 1px solid black;">'. $extra['master']['opLocation'].'</td>
                        </tr>
                        </tbody>
                    </table>
                </td>
                <td style="width: 40%;vertical-align: top;">
                    <table class="table table-bordered" align="right" style="">
                        <tbody>
                        <tr>
                            <td style="border: 1px solid black; border-right: none;border-bottom: none;"><strong> Date :</strong></td>
                            <td style="border: 1px solid black;border-bottom: none;"> '. $extra['master']['invoiceDate'].'</td>
                        </tr>';
        ...
        $html .= '<tr>
                            <td colspan="2" style="border: 1px solid black;">(Month of '. $monthName .' '.$dat[0] .')</td>
                        </tr>
                        </tbody>
                    </table>
                </td>
    ...
    <br>';
        ...
        if(!empty($extra['master']['isOpYN']==1 && $extra['master']['retensionInvoiceID'] =='' ) ) {
            ...
            <table class="table table-bordered table-striped" style="">
                <thead>
                <tr>
                    <th class="theadtr" style="font-size: 8px !important; min-width: 5%;border: 1px solid black; border-right:none; border-bottom: none;">Sr No</th>
                    <!--   <th class="theadtr" style="font-size: 8px !important; min-width: 15%">Item Code</th>-->
                    <th class="theadtr" style="font-size: 8px !important; min-width: 35%;border: 1px solid black;border-right:none;border-bottom: none;">Item Description</th>
                    <!-- <th class="theadtr" style="font-size: 8px !important; min-width: 10%">Line Details</th>-->
                    <th class="theadtr" style="font-size: 8px !important; min-width: 5%;border: 1px solid black;border-right:none;border-bottom: none;">UOM</th>
                    <th class="theadtr" style="font-size: 8px !important; min-width: 10%;border: 1px solid black;border-right:none;border-bottom: none;">Qty</th>
                    <th class="theadtr" style="font-size: 8px !important; min-width: 10%;border: 1px solid black;border-right:none;border-bottom: none;">Unit Rate ('. $extra['master']['transactionCurrency'].')</th>
                    <th class="theadtr" style="font-size: 8px !important; min-width: 10%;border: 1px solid black;border-right:none;border-bottom: none;">Total Value ('. $extra['master']['transactionCurrency'].')</th>
                    <th class="theadtr" style="font-size: 8px !important; min-width: 10%;border: 1px solid black;border-right:none;border-bottom: none;">Previous Certified (%)</th>
                    <th class="theadtr" style="font-size: 8px !important; min-width: 10%;border: 1px solid black;border-right:none;border-bottom: none;">Current Month Certified (%)</th>
                    <th class="theadtr" style="font-size: 8px !important; min-width: 10%;border: 1px solid black;border-right:none;border-bottom: none;">Cummulative (%)</th>
                    <th class="theadtr" style="font-size: 8px !important; min-width: 10%;border: 1px solid black;border-right:none;border-bottom: none;">Previous Certified Amount ('. $extra['master']['transactionCurrency'].')</th>
                    <th class="theadtr" style="font-size: 8px !important; min-width: 10%;border: 1px solid black;border-bottom: none;">This Month Invoice ('. $extra['master']['transactionCurrency'].')</th>
                </tr>
                </thead>
                <tbody>';
            ...
            foreach ($extra['op_detail'] as $val) {
                ...
                $html .= '<tr>
                        <td style="text-align:right;border: 1px solid black;border-right:none;border-bottom: none;">'. $num.'.&nbsp;</td>

                        <td style="border: 1px solid black;border-right:none;border-bottom: none;">'. $val['itemDescription'].' </td>
                        <td style="text-align:center;border: 1px solid black;border-right:none;border-bottom: none;">'. $val['unitOfMeasure'].'</td>
                        <td style="text-align:right;border: 1px solid black;border-right:none;border-bottom: none;">'. $val['contractQty'].'</td>
                        <td style="text-align:right;border: 1px solid black;border-right:none;border-bottom: none;">'. format_number($val['contractAmount'], $extra['master']['transactionCurrencyDecimalPlaces']).'</td>
                        <td style="text-align:right;border: 1px solid black;border-right:none;border-bottom: none;">'. format_number($val['contractAmount']*$val['contractQty'], $extra['master']['transactionCurrencyDecimalPlaces']).'</td>
                        <td style="text-align:right;border: 1px solid black;border-right:none;border-bottom: none;">'. round($val['previousCertified'],2) .' %</td>
                        <td style="text-align:right;border: 1px solid black;border-right:none;border-bottom: none;">'. round($val['currentCertified'],2)  .' %</td>
                        <td style="text-align:right;border: 1px solid black;border-right:none;border-bottom: none;">'. round($val['previousCertified']+ $val['currentCertified'],2) .' %</td>
                        <td style="text-align:right;border: 1px solid black;border-right:none;border-bottom: none;">'. format_number(($val['previousCertifiedAmount'] != '' ? $val['previousCertifiedAmount'] : 0), $extra['master']['transactionCurrencyDecimalPlaces'])  .' </td>
                        <td style="text-align:right;border: 1px solid black;border-bottom: none;">'. format_number( $val['transactionAmount'], $extra['master']['transactionCurrencyDecimalPlaces']) .' </td>
                    </tr>';
            ...
            $html .= '</tbody>
                <tfoot>
                <tr>
                    <td class="" style="text-align: right;border: 1px solid black;border-right: none;" colspan="10">Total Amount in '. $extra['master']['transactionCurrency'].' </td>
                    <td class="text-right " style="text-align:right;border: 1px solid black;">'. format_number($item_total, $extra['master']['transactionCurrencyDecimalPlaces']).'</td>
                </tr>';
            ...
            $ttamntword= $this->numbertowords->convert_number($item_total);
            $str_arr = explode('.',$number);
            $str_arrtt = explode('.',$item_total);
            if($str_arr[1]>0){
            ...
            if($str_arrtt[1]>0){
                if($extra['master']['transactionCurrency']=="OMR"){
                    $numinwrdtot=$ttamntword.' and '.$str_arrtt[1].' / 1000 Only';
                }else{
                    $numinwrdtot=$ttamntword.' and '.$str_arrtt[1].' / 100 Only';
                }
            }else{
                $numinwrdtot=$ttamntword.' Only';
            }

            $html .= '<td colspan="11" class="" style="font-size: 11px;border: 1px solid black;border-top:none;">Amount Chargeable (in words) &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; ('. $numinwrdtot .')</td>';
            /*if($retensionTransactionAmount>0){
                $html .= '<td colspan="2"  class="sub_total" style="text-align: right;border: 1px solid black;border-left: none;border-bottom: none;border-right: none;border-top:none;">Net Amount in '. $extra['master']['transactionCurrency'].'</td>
                        <td colspan="1"  class="sub_total" style="text-align: right;border: 1px solid black;border-left: none;border-bottom: none;border-top:none;"> '. format_number($item_total-$extra['master']['retensionTransactionAmount'], $extra['master']['transactionCurrencyDecimalPlaces']).'</td>';
            }*/
            $html .= '</tr> </tfoot> </table>';
            $html .= '<br>';
            if($retensionTransactionAmount>0) {
            ...
            <table class="table table-bordered table-striped" style="width:100%">
                <tbody>';
                $html .= '<tr><td style="width:50%;">Retention Amount</td><td style="text-align:right;width:50%;">'. format_number($extra['master']['retensionTransactionAmount'], $extra['master']['transactionCurrencyDecimalPlaces']).'</td></tr>';
                $html .= '<tr><td style="width:50%;">Invoice Balance Net Of Retention</td><td style="text-align:right;width:50%;">'. format_number($item_total-$extra['master']['retensionTransactionAmount'], $extra['master']['transactionCurrencyDecimalPlaces']).'</td></tr>';
                $html .= '<tr><td style="width:50%;">Invoice Balance Net Of Retention (Words)</td><td style="text-align:right;width:50%;">'. $numinwrd.'</td></tr>';
    ...
    <br>';
        ...
        if(!empty($extra['item_detail']) ) {
            ...
            foreach ($extra['item_detail'] as $val) {
                ...
                $reqqty=$this->db->query("SELECT IFNULL(SUM(requestedQty),0) as requestedQty,IFNULL(SUM(srp_erp_customerinvoicedetails.transactionAmount),0) as amount FROM `srp_erp_customerinvoicedetails` LEFT JOIN srp_erp_customerinvoicemaster ON srp_erp_customerinvoicedetails.invoiceAutoID = srp_erp_customerinvoicemaster.invoiceAutoID WHERE invoiceDate <= '$invoiceDate' AND invoiceDetailsAutoID !=$invoiceDetailsAutoID AND contractDetailsAutoID = $contractDetailsAutoID")->row_array();
                    $Cummulative = (round((($reqqty['requestedQty'] / $val['contractQty'])*100),2) + round((($val['requestedQty'] / $val['contractQty'])*100),2) );
                $html .= '<tr>
                        <td style="text-align:right;">'. $num .'</td>
                        ...
                        <td style="text-align:right;">'. $val['contractQty'].'</td>
                        ...
                        <td style="text-align:right;">'. $Cummulative.' %</td>
        ...
        $html .= ' <table class="table " style="border: 2px solid #ececec; width: 100%;">
        <tr>
            <th style="border: 2px solid #ececec; font-size: 9px; padding: 10px;">Dant Najd Trading & Transport '. $designation.'</th>
            <th style="border: 2px solid #ececec; font-size: 9px; padding: 10px;">AHPS Representative</th>
            <th style="border: 2px solid #ececec; font-size: 9px; padding: 10px;">AHPS Representative</th>
        </tr>
        <tr>
            <td height="60px;" style="font-size: 9px;">Name :  Mahmood Al Darii</td>
