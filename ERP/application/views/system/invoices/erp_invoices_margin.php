    ...
    <div id="step1" class="tab-pane active">
        ...
        <div class="row">
            <div class="form-group col-sm-4">
                ...
                <?php echo form_dropdown('invoiceType', array('' =>$this->lang->line('common_select_type') /*'Select Type'*/, 'Direct' =>$this->lang->line('sales_markating_transaction_add_new_customer_direct_invoice') /*'Direct Invoice'*/,'Quotation' =>$this->lang->line('sales_markating_transaction_add_new_customer_quotation_based') /*'Quotation Based'*/,'Contract' =>$this->lang->line('sales_markating_transaction_add_new_customer_contract_based') /*'Contract Based'*/,'Sales Order' => $this->lang->line('sales_markating_transaction_add_new_customer_sales_order_based') /*'Sales Order Based'*/,'Manufacturing' => 'Manufacturing' /*'Manufacturing'*/), 'Direct', 'class="form-control select2" onchange="validatenarration()" id="invoiceType" required'); ?>
            </div>
            <div class="form-group col-sm-4">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('.headerclose').click(function(){
            fetchPage('system/invoices/invoices_management_margin',invoiceAutoID,'Customer Invoices');
        });
        $('.select2').select2();
        invoiceAutoID = null;
        invoiceType = null;
                ...
                function () {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if(data[0]=='s'){
                                fetchPage('system/invoices/invoices_management_margin', invoiceAutoID, 'Invoices');
                            }
    ...
    function fetch_detail(type, customerID, currencyID,tab) {
        $.ajax({
            ...
            url: "<?php echo site_url('Invoices/fetch_detail_margin'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
