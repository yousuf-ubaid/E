...
if (!empty($extra)) {
    ...
    $html .= '<hr>
            <div class="table-responsive">
                <div style="text-align: center">
                    <h4>' . $templateInvoiceDetails[0]['invoiceTemplateName'] . '</h4><!--Sales Invoice -->
                </div>';

    $html .= '<table class="table-header-info" style="width: 100%">
                <tbody>
                <tr>';
                if ($templateInvoiceDetails[0]['customerName'] == 'on') {
        $html .= '<td style=""><strong> ' . $this->lang->line('common_customer_name') . '</strong></td><!--Customer Name-->
                    <td style=""><strong>:</strong></td>
                    <td style=""> ' . $custnam . '</td>
                    ';
                }
                if ($templateInvoiceDetails[0]['invoiceNumber'] == 'on') {
        $html .= '<td><strong>' . $this->lang->line('common_invoice_number') . '</strong></td><!--Invoice Number-->
                    <td><strong>:</strong></td>
    ...
    if (!empty($extra['customer']['customerSystemCode'])) {
        $html .= '<tr>';
        if ($templateInvoiceDetails[0]['customerAddress'] == 'on') {
            $html .= '<td><strong> ' . $this->lang->line('sales_markating_view_invoice_customer_address') . '</strong></td><!--Customer Address -->
                    <td><strong>:</strong></td>
                    <td> ' . $extra['customer']['customerAddress1'] . '</td>
                    ';
                }
        if ($templateInvoiceDetails[0]['documentDate'] == 'on') {
            $html .= '<td><strong>' . $this->lang->line('sales_markating_view_invoice_document_date') . '</strong></td><!--Document Date-->
                    <td><strong>:</strong></td>
            ...
            $html .= '<tr>';
        if ($templateInvoiceDetails[0]['customerTelephone'] == 'on') {
            $html .= '<td><strong>' . $this->lang->line('common_customer_telephone') . ' </strong></td><!--Customer Telephone-->
                    <td><strong>:</strong></td>
                    <td> ' . $extra['customer']['customerTelephone'] . '</td>
                    ';
                }
        if ($templateInvoiceDetails[0]['referenceNumber'] == 'on') {
            $html .= '<td><strong>' . $this->lang->line('common_reference_number') . '</strong></td><!--Reference Number-->
                ...
                $html .= '<tr>';
        if ($templateInvoiceDetails[0]['contactPerson'] == 'on') {
            $html .= '<td><strong> ' . $this->lang->line('common_contact_person') . '</strong></td>
                    <td><strong>:</strong></td>
                    <td> ' . $extra['master']['contactPersonName'] . '</td>
                    ';
                }
        if ($templateInvoiceDetails[0]['currency'] == 'on') {
            $html .= '<td><strong>' . $this->lang->line('common_currency') . ' </strong></td><!--Currency-->
                    <td><strong>:</strong></td>
        ...
        if($group_based_tax == 1){
            $html .= '            
                <tr>';
            if ($templateInvoiceDetails[0]['customerVatNo'] == 'on') {
                $html .= '<td><strong>Customer VATIN</strong></td>
                    <td><strong>:</strong></td>
        ...
        $html .= '<tr>';
        if ($templateInvoiceDetails[0]['contactPersonTel'] == 'on') {
            $html .= '<td><strong>' . $this->lang->line('sales_marketing_contact_person_tel') . '</strong></td><!--Reference Number-->
                    <td><strong>:</strong></td>
                    <td>' . $extra['master']['contactPersonNumber'] . '</td>
                    ';
                }
        if ($templateInvoiceDetails[0]['invoiceDate'] == 'on') {
            $html .= '<td><strong> ' . $this->lang->line('sales_markating_view_invoice_invoice_date') . '</strong></td><!--Invoice Date-->
                    <td><strong>:</strong></td>
    ...
    $html .= '      <td><strong>' . $this->lang->line('sales_markating_view_invoice_invoice_due_date') . '</strong></td><!--Invoice Due Date-->
        ...
        $html .= '  </tr>
                <tr>';
        if ($templateInvoiceDetails[0]['customerVatNo'] == 'on') {
            $html .= '<td><strong>Customer VAT No</strong></td>
                <td><strong>:</strong></td>
                <td>'. $extra['master']['vatIdNo'].'</td>     
                ';
                }
        if ($templateInvoiceDetails[0]['customerVatNo'] == 'on') {
            $html .= '<td><strong>VAT No</strong></td>
                    <td><strong>:</strong></td>
    ...
    if ($templateInvoiceDetails[0]['segment'] == 'on') {
    $html .= '<tr>
            <td><strong>Segment </strong></td><!--segment-->
          <td><strong>:</strong></td>
    ...
    if (!empty($extra['master']['salesPersonID'])) {
        if ($templateInvoiceDetails[0]['narration'] == 'on') {
            ...
            $html .= '
                    <tr>
                       <td><strong>&nbsp;</strong></td>
                        <td><strong>&nbsp;</strong></td>
                        <td>&nbsp;</td>
                        <td><strong>VATIN</strong></td><!--VATIN-->
                        <td><strong>:</strong></td>
                        <td> ' . $extra['master']['companyVatNumber'] . '</td>
                    </tr>';
            }
...
if($invoiceType == 'Project') {
    ...
    if (!empty($extra['item_detail'])) {
        ...
        if(($istaxEnable == 1) && ($group_based_tax!=1))
        {
            ...
            $col_name.='
                <th class="theadtr" style="min-width: 10%">Tax<br>Applicable<br>Amount</th>
                <th class="theadtr" style="min-width: 10%">Taxes</th>';
        }
        else {
        ...
        <table class="table table-bordered table-striped" style="width: 100%">
            ...
            <tr>
                ...
                '.$col_name.'
                <th class="theadtr" colspan="3" style="min-width: 10%">' . $this->lang->line('sales_markating_view_invoice_net') . '</th><!--Net-->
            </tr>
            </thead>
            <tbody>';
        ...
        foreach ($extra['item_detail'] as $val) {
            ...
            $html .= '<td colspan="3" style="text-align:right;font-size: 12px;">' . format_number($val['transactionAmount'], $extra['master']['transactionCurrencyDecimalPlaces']) . '</td>';
            $html .='</tr>';
        ...
        $html .= '</tbody>
         ...
         if ($group_based_tax == 1) {
            ...
            //  $html .= '<td class="text-right sub_total" style="font-size: 12px;text-align:right;">' . format_number($amount_tal, $extra['master']['transactionCurrencyDecimalPlaces']) . '</td>';
             $html .= '<td class="text-right sub_total" style="font-size: 12px;text-align:right;">' . format_number(($amount_other_tal+$amount_tal), $extra['master']['transactionCurrencyDecimalPlaces']) . '</td>';
         }
    ...
    if($group_based_tax==1) {
        ...
        $grop_based_col_tax_html.='<th class="theadtr" style="width: 24%">Tax<br>Applicable<br>Amount</th>
                                   <th class="theadtr" style="width: 22%">Taxes</th>';
        ...
        <div class="table-responsive">
            ...
            foreach ($extra['gl_detail'] as $val) {
                ...
                if($group_based_tax==1){
                    ...
                    //         <td style="font-size: 12px;text-align: right"> '.format_number(($val['taxAmount']), $extra['master']['transactionCurrencyDecimalPlaces']) .'</td>';
                    ...
                    $amount_total_other += $val['taxAmount'];
            ...
            <tr>
                ...
                <td style="width:60%;padding:0px;margin:0px">
                    <table style="width: 100%" class="' . table_class() . '">
                        <thead>
                            <tr>
                                <td class="theadtr" colspan="4">&nbsp;&nbsp;&nbsp;&nbsp;<strong>' . $this->lang->line('sales_markating_view_invoice_tax_details') . '</strong></td><!--Tax Details-->
                            </tr>
                            <tr>
                                <th class="theadtr">#</th>
                                <th class="theadtr">' . $this->lang->line('common_type') . '</th><!--Type-->
                                <th class="theadtr"> ' . $this->lang->line('sales_markating_view_invoice_detail') . '</th><!--Detail-->
                                <th class="theadtr">' . $this->lang->line('common_transaction') . '(' . $extra['master']['transactionCurrency'] . ') &nbsp;&nbsp;&nbsp;&nbsp; </th>
                        ...
                        <tbody>';
                            ...
                            foreach ($taxDetails as $value) {
                                $html .= '<tr>
                                        ...
                                        <td style="font-size: 12px;">' . $value['taxDescription'] . '</td>
                                        <!--<td class="text-right" style="font-size: 12px; text-align:right;">' . $value['taxPercentage'] . ' % </td>-->
                                        <td class="text-right" style="font-size: 12px; text-align:right;">' . number_format($value['taxAmount'],$extra['master']['transactionCurrencyDecimalPlaces'])  . '</td>
                                        </tr>';
                                $x++;
                                //$gran_total += number_format($value['taxAmount'],$extra['master']['transactionCurrencyDecimalPlaces']);
                                $tr_total_amount +=  $value['taxAmount'];
                                //number_format($value['taxAmount'],$extra['master']['transactionCurrencyDecimalPlaces']);
                            }
    ...
    if($group_based_tax == 1) {
        ...
        if($group_based_tax == 1 && $extra['master']['transactionCurrencyID'] != $extra['master']['companyLocalCurrencyID']) {
            ...
            //    ';
            // $html .= '
            //             <h5 class="text-right" style="text-align:right;font-size: 12px;margin:5px 0px 5px 0px"> Taxes (' . $extra['master']['companyLocalCurrency'] . ' )<!--Total-->
            //            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : ' . format_number(($grandtotal_otherTax_amount+$grandtotalVAT_amount) / $extra['master']['companyLocalExchangeRate'], $extra['master']['companyLocalCurrencyDecimalPlaces']) . '</h5>
            //     ';
            ...
            $html .= '<div class="table-responsive">
                        <h5 class="text-right" style="text-align:right;font-size: 12px;margin:5px 0px 5px 0px">
                        Taxes (' . $extra['master']['transactionCurrency'] . ' )<!--Total-->
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  : ' . format_number(($grandtotal_otherTax_amount+$grandtotalVAT_amount), $extra['master']['transactionCurrencyDecimalPlaces']) . '</h5>
                    </div>';
            $html .= '<div class="table-responsive">
                        <h5 class="text-right" style="text-align:right;font-size: 12px;margin:5px 0px 5px 0px">
