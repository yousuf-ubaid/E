...
<div class="row">
    ...
    <div class="col-md-3 text-center">
        <?php echo form_dropdown('approvedYN', array('0' => $this->lang->line('common_pending')/*'Pending'*/, '1' => $this->lang->line('common_approved')/*'Approved'*/), '', 'class="form-control" id="approvedYN" required onchange="Invoices_table()"'); ?>
    </div>
</div>
<hr>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/invoices/invoice_approval_suom', '', 'Invoice Approval');
        });
        Invoices_table();
    ...
    function Invoices_table() {
        var Otable = $('#Invoices_table').DataTable({
            "language": {
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Invoices/fetch_invoices_approval_suom'); ?>",
            "aaSorting": [[0, 'desc']],
            ...
            "columnDefs": [{"visible":false,"searchable": true,"targets": [9], "orderable": false}],
