...
<?php
    ...
    <br>
    <br>
    <h4 class="text-center"><strong><?php echo $invoiceheaderName;?></strong></h4><!--Sales Invoice -->
    <?php
}
?>
<div class="table-responsive">
...
<?php $is_item_active = 0; $gran_total=0; $tax_transaction_total = 0;$tax_Local_total = 0;$tax_customer_total = 0; $p_total=0; $disc_nettot=0;$t_extraCharge=0;
...
<?php  } ?>
<?php $transaction_total = 0;$Local_total = 0;$party_total = 0; if(!empty($extra['insurance_detail'])){  ?>
    <br>
    <div class="table-responsive">
        <table class="table table-bordered table-striped">
            <thead>
            <tr>
                ...
                <th class='theadtr' style="width: 20%">Total Amount (<?php echo $extra['master']['transactionCurrency']; ?>)</th>
            </tr>
            </thead>
            <tbody>
            <?php
                ...
                <td style="width:60%;padding: 0;">
                    <table style="width: 100%; " class="<?php echo table_class(); ?>">
                        ...
                        foreach ($extra['discount'] as $value) {
                            ...
                            echo '<td class="text-right" style="font-size: 12px;">'.$value['discountPercentage'].'%</td>';
...
<?php } ?>
    ...
    <?php if ($extra['master']['isPrintDN']==1 && $html!=1 && $is_item_active==1) { ?>
        ...
        <?php } else{?>
            ...
            <br>
            <br>
            <h4 class="text-center"><strong><?php echo $this->lang->line('sales_markating_view_invoice_delivery_note');?></strong></h4><!--Delivery note-->
        <?php } ?>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped">
                    ...
                    $num ++;
                        ...
                        echo '<tr class="danger" style="font-size: 12px;"><td colspan="5" class="text-center">'.$norecordfound.'</td></tr>';
                    } ?><!--No Records Found-->
                    </tbody>
                </table>
            </div>
