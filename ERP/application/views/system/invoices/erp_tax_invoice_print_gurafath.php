    ...
    $htmlHeader .= '
            <div class="table-responsive">
                <div style="text-align: center;padding:0px">
                    <h3 style="padding-bottom:10px">' . $invoiceheaderName . '</h3><!--Sales Invoice -->
                </div>
                <div style="text-align: left;padding:0px">
                    <h4 style="padding:0px">TRN No: '. $extra['master']['companyVatNumber'] .'</h4><!--Sales Invoice -->
                </div>';


                $htmlHeader .= '<table  class="table table-bordered table-striped" style="width: 100%; border:1px solid #333;" cellspacing="0" cellpadding="0">  
                                    <tbody>
                                           <tr>
                                                <td style="width: 50%; padding:0px;border-collapse: collapse;background:none;border-right:1px solid #333">
                                                    <table class="table-style-three" style="width: 100%; ">  
                                                        
                                                            <tr>
                                                                <td style="width: 50%;padding:0px;">
                                                                    <table  style="width: 100%">                                                                       
                                                                        <tr>
                                                                            <td width="100px">' . $custnam . '</td> <!---customer address-->                                                                        
                                                                        </tr>                
                                                                        <tr>
                                                            ...
                                                            <tr>
                                                                <td align="left" style="width: 50%;padding:0px;text-align:left">
                                                                            ...
                                                                            <td style="padding:0px;">
                                                                                <table>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>'. $extra['customer']['customerEmail'] .'</td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>                                                                   
                                                                        </tr>         
                                                ...
                                                <td style="width: 50%;padding:0px;border-collapse: collapse;background:none">
                                                    <table class="table table-bordered table-striped table-style-three" style="width: 100%;">  
                                                        <thead>
                                                            <tr>
                                                                <td style="width: 50%;padding:0px;">
                                                                    <table  style="width: 100%">
                                                            ...
                                                            <tr>
                                                                <td style="width: 50%;padding:0px;">
                                                                    <table  style="width: 100%">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                '. str_replace(PHP_EOL, '<br /> ',  $extra['master']['referenceNo'])  .'
                                                                            </td>
                                                                        </tr>
                                                                    </table>                                                                  
                                                                </td>
                                                            ...
                                                            <tr>
                                                                <td style="width: 50%;padding:0px;">
                                                                    <table  style="width: 100%">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                            '.$extra['master']['contractPaymentTerms'].'
                                                                            </td>
                                                                        </tr>
                                                                    </table>                                                                  
                                                                </td>
...
if($invoiceType == 'Project') {
        ...
        if (!empty($extra['item_detail'])) {
            foreach ($extra['item_detail'] as $val) {
                ...
                $html .= '<tr>
                        ...
                        <td style="text-align: center; width: 80px">' . $val['requestedQty'] . '</td>
    ...
    if ((($taxEnabled == 1) || ($taxEnabled == null) || ($extra['item_detail_tax'] > 0))&&  ($group_based_tax!=1)) {
        ...
        if($HideOtherTaxDetails){
            ...
            if($invoiceType == "Contract" || $invoiceType == "Quotation" || $invoiceType == "Sales Order"){        
                $footercolspan = 4;
                $colspan2 = 3;
                $colspan = 4;
            } else if($invoiceType == "DirectIncome"){
                $footercolspan = 6;
                $colspan2 = 4;
                $colspan = 5;
            } else if($invoiceType == "DirectItem"){
                $footercolspan = 4; // 5 set old
                $colspan2 = 3;
                $colspan = 3;
            } else{
                $footercolspan = 4;
    ...
    if (!empty($extra['item_detail'])) {
        ...
        if(($istaxEnable == 1) && ($group_based_tax!=1))
        {
            ...
            $col_name.='
                ...
                <th class="theadtr" style="min-width: 10%">VAT<br>Amount 5%</th>';
...
/************* Gurafath column add From date and To Date ******************************************** */
        if($invoiceType == "Contract" || $invoiceType == "Quotation" || $invoiceType == "Sales Order"){        
            $col_name_gu .= '<th class="theadtr" style="min-width: 5%">Service Date</th>
            <th class="theadtr" style="min-width: 25%">Van Type</th>';
        }

        foreach ($extra['item_detail'] as $valCheck) {
            $c[] = $valCheck['serviceFromDate'];
            $d[] = $valCheck['serviceToDate'];
        }

        //check if array contains null serviceFromDate value
        if (in_array("0000-00-00", $c)) {
            $serviceFromDate = false;
        } else{
            $serviceFromDate = true;
        }
        //check if array contains null serviceToDate value
        if (in_array("0000-00-00", $d)) {
            $serviceToDate = false;
        } else{
            $serviceToDate = true;
        }
        ...
        if($invoiceType == "DirectItem"){   
            if($serviceFromDate == true && $serviceToDate == true){   
                $col_name_gu .= '<th class="theadtr" style="min-width: 5%">From Date</th>
                                <th class="theadtr" style="min-width: 5%">To Date</th>
                                <th class="theadtr" style="min-width: 25%">Van Type</th>';
            } else if($serviceFromDate == true && $serviceToDate == false){  
                $col_name_gu .= '<th class="theadtr" style="min-width: 5%">Start Date</th>
                                <th class="theadtr" style="min-width: 25%">Van Type</th>';
            } else {
                $col_name_gu .= '';
                /*$col_name_gu .= '<th class="theadtr" style="min-width: 5%">Start Date</th>
                                <th class="theadtr" style="min-width: 25%">Van Type2</th>';*/
            }
        }     
        if($invoiceType == "DirectItem"){   
            if($serviceFromDate == true && $serviceToDate == true){   
        ...
        <table class="table table-bordered table-striped" style="width: 100%">
            <thead>
            <tr>
                <th class="theadtr" colspan="'.$colspan2.'">PREFFERD PAYMENT METHOD</th>
                <th class="theadtr" colspan="'.$colspan.'">REF.</th>
                <th class="theadtr" colspan="'.$colspanDT.'">JOB</th>
            </tr>
            <tr>
                <th class="theadtr" colspan="'.$colspan2.'">Cheque AED</th><!--Cheque AED-->
                <th class="theadtr" colspan="'.$colspan.'">Agreed Transport Agreement</th><!--Agreed Transport Agreement-->
                <th class="theadtr" colspan="'.$colspanDT.'">Staff / Guest Transportation</th><!--Transportation-->
            </tr>
            <tr>
                <th class="theadtr" style="min-width: 3%">#</th>
                '.$col_name_gu.'
                <th class="theadtr" style="min-width: 30%">' . $this->lang->line('sales_markating_view_invoice_item_description') . '</th><!--Item Description-->
                <th class="theadtr" style="min-width: 5%">' . $this->lang->line('common_qty') . '</th><!--Qty-->
                <th class="theadtr" style="min-width: 10%">' . $this->lang->line('sales_markating_view_invoice_unit_price') . '</th><!--Unit-->
                <!--<th class="theadtr" style="min-width: 10%">' . $this->lang->line('sales_markating_view_invoice_discount') . '</th>--><!--Discount-->
                '.$col_name.'
                <th class="theadtr" colspan="'.$NetColspan.'" style="min-width: 13%">Amount</th><!--Net-->
            </tr>
            </thead>
            <tbody>';
        ...
        foreach ($extra['item_detail'] as $val) {
            ...
            if($itemBarcodeView == 1) {
                $item_description_view = '<td style="font-size: 12px;">' .$val['barcode'].'  -  ' . $val['remarks'] . '</td>';
            } else {
                $item_description_view = '<td style="font-size: 11px;min-width:50%;">' . $val['remarks'] . '</td>';
            }
            //<td style="text-align:center;font-size: 12px;">' . $val['itemSystemCode']. '</td>'
            
            if($invoiceType == "Contract" || $invoiceType == "Quotation" || $invoiceType == "Sales Order"){        
                $item_description_view_serviceFromDate .= '<td style="text-align:right;font-size: 12px;">' . $val['serviceFromDate'] . '</td>';
            }
            
            $html .= '<tr style="line-height:1.5em">
                    <td style="text-align:right;font-size: 12px;">' . $num . '.&nbsp;</td>';
                    if($invoiceType == "Contract" || $invoiceType == "Quotation" || $invoiceType == "Sales Order"){        
                        $html .= '<td style="text-align:right;font-size: 12px;">' . $val['serviceFromDate'] . '</td>';
                        $html .= '<td style="text-align:left;font-size: 12px;">' . $val['itemDescription'] . '</td>';
                    }
                    if($invoiceType == "DirectItem"){   
                        if($serviceFromDate == true && $serviceToDate == true){   
                            $html .= '<td style="text-align:right;font-size: 12px;">' . $val['serviceFromDate'] . '</td>';
                            $html .= '<td style="text-align:left;font-size: 12px;">' . $val['serviceToDate'] . '</td>';
                            $html .= '<td style="text-align:left;font-size: 12px;">' . $val['itemDescription'] . '</td>';
                        } else if($serviceFromDate == true && $serviceToDate == false){
                            $html .= '<td style="text-align:right;font-size: 12px;">' . $val['serviceFromDate'] . '</td>';
                            $html .= '<td style="text-align:left;font-size: 12px;">' . $val['itemDescription'] . '</td>';
                    ...
                    $html .= $item_description_view;
                    $html .= '<td style="text-align:center;font-size: 12px;">' . $val['requestedQty'] . '</td>
    ...
    if($group_based_tax==1) {
        if($invoiceType == "DirectItem"){    
            $grop_based_col_tax_html.='<th class="theadtr" style="">VAT Amount 5%</th>';
        }else{
            $grop_based_col_tax_html.='<th class="theadtr" style="width: 8%">VAT<br> Amount 5%</th>';
        }
    ...
    if (!empty($extra['gl_detail'])) {
        ...
        if($invoiceType == "DirectIncome"){        
            $col_name_gu_DI_th .= '<th class="theadtr" style="min-width: 14.5%;">From<br>Date</th>
                                <th class="theadtr" style="min-width: 14.5%;">To<br>Date</th>
                                <th class="theadtr" style="min-width: 19.5%;">Van Type</th>';
        }
        if($invoiceType == "DirectItem"){        
            $col_name_gu_DI_th_direct .= '<th class="theadtr" style="min-width: 14.5%;">From<br>Date</th>
                                <th class="theadtr" style="min-width: 14.5%;">To<br>Date</th>
                                <th class="theadtr" style="min-width: 19.5%;">Van Type</th>';
        }
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped" width="100%">
                <thead>';
                if($invoiceType == "Contract" || $invoiceType == "Quotation" || $invoiceType == "Sales Order" || $invoiceType == "DirectIncome" || $invoiceType == "DirectItem"){   
                    $html .= '<tr>
                    <th class="theadtr" colspan="3">PREFFERD PAYMENT METHOD</th>
                    <th class="theadtr" colspan="2">REF.</th>
                    <th class="theadtr" colspan="2">JOB</th>
                </tr>
                <tr>
                    <th class="theadtr" colspan="3">Cheque AED</th><!--Cheque AED-->
                    <th class="theadtr" colspan="2">Agreed Transport Agreement</th><!--Agreed Transport Agreement-->
                    <th class="theadtr" colspan="2">Staff / Guest Transportation</th><!--Transportation-->
                </tr>';
                }
                if($invoiceType == "DirectItem"){
                    $html .= '<tr>
                        <th class="theadtr">#</th>
                        '.$col_name_gu_DI_th_direct.'
                        '.$col_name_gu_DI_th.'
                        <th class="theadtr" style="text-align: left;">' . $this->lang->line('common_description') . '</th><!--Description-->
                        <!--<th class="theadtr" style="width: 8.5%">Discount</th>-->
                        '.$grop_based_col_tax_html.'
                        <th class="theadtr" style="">Net Amount (' . $extra['master']['transactionCurrency'] . ')</th>
                    </tr>'; 
                }else{
                    $html .= '<tr>
                        <th class="theadtr" style="width: 3%">#</th>
                        '.$col_name_gu_DI_th.'
                        <th class="theadtr" style="width: 17%;text-align: left;">' . $this->lang->line('common_description') . '</th><!--Description-->
                        <!--<th class="theadtr" style="width: 8.5%">Discount</th>-->
                        '.$grop_based_col_tax_html.'
            ...
            foreach ($extra['gl_detail'] as $val) {
                ...
                if($group_based_tax==1){
                    $grop_based_col_tax_html_val.='<td style="font-size: 11px;text-align: right"> '.format_number($val['amount'],$extra['master']['transactionCurrencyDecimalPlaces']).'</td>';
                ...
                $html .= '<tr>
                        <td style="text-align:right;font-size: 11px;">' . $num . '.&nbsp;</td>';
                        if($invoiceType == "DirectIncome" || $invoiceType == "DirectItem"){                          
                            $html .= '<td style="font-size: 10px;">' . $val['serviceFromDate'] . '</td>';
                            $html .= '<td style="font-size: 10px;">' . $val['serviceToDate'] . '</td>';
                            $html .= '<td style="font-size: 10px;">' . $val['revenueGLDescription'] . '</td>';
                        }
                        $html .= '<td style="font-size: 11px;">' . $val['description'] . '</td>
            ...
            if($group_based_tax==1) {
                ...
                //$html .= '<td class="text-right sub_total" style="font-size: 11px;text-align:right;">' . format_number($amount_total_other, $extra['master']['transactionCurrencyDecimalPlaces']) . '</td>';
            }
        ...
        if (!empty($extra['delivery_order_itemwise'])) {
            ...
            <table class="table table-bordered table-striped" style="width: 100%">
                ...
                <tr>
                    ...
                    <th class="theadtr">' . $this->lang->line('common_order_total') . '</th><!--Net Amount-->
            ...
            foreach ($extra['delivery_order_itemwise'] as $val) {
                ...
                $html .= '<tr>
                        ...
                        <td style="text-align:center;font-size: 12px;">' . $val['requestedQty'] . '</td>
                        <td style="text-align:right;font-size: 12px;">' . format_number($val['unittransactionAmount'], $extra['master']['transactionCurrencyDecimalPlaces']) . '</td>
    ...
    if($group_based_tax == 1) {
        ...
        if($group_based_tax == 1 && $extra['master']['transactionCurrencyID'] != $extra['master']['companyLocalCurrencyID']) {
            ...
            if($HideOtherTaxDetails != 1){
                if($invoiceType == 'DirectIncome' || $invoiceType == 'Contract' || $invoiceType == 'Quotation' || $invoiceType == 'Sales Order' || $invoiceType == 'DirectItem'){
                    $html .= '';
                } else{
                    $html .= '<div class="table-responsive">
                                <h5 class="text-right" style="text-align:right;margin:5px 7px 3px 5px;font-size: 12px;">
    ...
    if ($extra['master']['bankGLAutoID']) {
        ...
        <tbody>
        <tr>
            <td style="width: 18%"><strong>Amount in words</strong></td><!--Account-->
            <td style="width: 2%"><strong>:</strong></td>
        ...
        if (!empty($extra['item_detail'])) {
            ...
            if (!empty($extra['item_detail'])) {
                foreach ($extra['item_detail'] as $val) {
                    ...
                    <td style="text-align:center;">' . $val['requestedQty'] . '</td>
                </tr>';
...
if(empty($extra['approvallevels'])){
    $html .= '<table class="table-responsive" style="width: 100%" border="0">
        <tbody>
            <tr>
                <td style="width: 50%; height: 50px;">
                    <p style="font-size:13px">Receiver Name</p>
                </td>
                <td style="width: 50%; height: 50px;text-align:right">
                    <p style="font-size:13px">For Gurfateh Transport by Buses L.L.C</p>
                </td>
            </tr>
            <tr>
                <td style="width: 50%; height: 50px;">
            ...
            <tr>
                <td style="width: 50%; height: 50px;">
                    <p>&nbsp;</p>
                    <p style="font-size:13px">Receiver Signature</p>
                </td>
                <td style="width: 50%; height: 50px;text-align:right">
                    <p>&nbsp;</p>
                </td>
