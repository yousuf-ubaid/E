        ...
        <table class="table table-bordered table-striped">
            ...
            foreach ($extra['item_detail'] as $val) {
                ...
                <tr>
                    ...
                    <td style="text-align:right; font-size: 12px;"><?php echo $val['itemSystemCode'] . ' - ' . $val['itemSecondaryCode']; ?></td>

                    <td style="font-size: 12px;"><?php echo ($val['contractCode'] ? $link.' - ' : '').$val['itemDescription']; ?></td>
                    ...
                    <td style="text-align:right; font-size: 12px;"><?php echo format_number($val['unittransactionAmount']+($val['taxAmount']), $extra['master']['transactionCurrencyDecimalPlaces']); ?></td>
                    ...
                    <td style="text-align:right; font-size: 12px;"><?php echo format_number(($val['unittransactionAmount']-$val['discountAmount'])+($val['taxAmount']), $extra['master']['transactionCurrencyDecimalPlaces']); ?></td>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped">
            ...
            <tr>
                ...
                <th class='theadtr' style="min-width: 12%"><?php echo $this->lang->line('common_net_amount');?><!--Net Amount--> (<?php echo $extra['master']['transactionCurrency']; ?>)</th>
            </tr>
            </thead>
            <tbody>
            <?php
            ...
            foreach ($extra['gl_detail'] as $val) { ?>
                <tr>
                    ...
                    <td style="text-align:right;">(<?php echo $val['discountPercentage'] ?> %) <?php echo format_number($val['discountAmount'], $extra['master']['transactionCurrencyDecimalPlaces']); ?></td>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;"><?php echo $val['itemSystemCode'] . ' - ' . $val['itemSecondaryCode']; ?></td>
                        <td><?php echo ($val['contractCode'] ? $link.' - ' : '').$val['itemDescription'].' - '.$val['remarks']; ?></td>
