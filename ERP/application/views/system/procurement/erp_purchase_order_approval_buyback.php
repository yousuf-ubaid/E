...
<script type="text/javascript">
    ...
    function purchase_order_table() {
        Otable = $('#purchase_order_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Procurement/fetch_purchase_order_approval_buyback'); ?>",
            "aaSorting": [[0, 'desc']],
            ...
            "columnDefs": [{"visible": true, "searchable": false, "targets": [0,5]}, {"visible": false, "targets": [9,10], "searchable": true}],
