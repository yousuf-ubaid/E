<?php echo head_page("Maintenance", false);
...
$assetName = load_asset_names_by_type();
...
<div class="row">
    <div class="col-md-12 ">
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <button type="button" class="btn btn-primary pull-right" onclick="vehiclemaintenace_model()">
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="maintenance">
                        <form role="form" id="vehicale_master_form" class="form-horizontal">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row utilizationcode hide" style="margin-top: 10px;margin-left: 25px;">
                                        <div class="form-group col-sm-2">
                                            <label class="title">Utilization Code</label>
                                        </div>
                                        <div class="form-group col-sm-4">

                                            <input type="text" name="utilizationcode" id="utilizationcode" class="form-control" readonly>
                                        </div>
                                    ...
                                    <div class="row" style="margin-top: 10px;margin-left: 25px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <span class="input-req">
                                                <?php echo form_dropdown('assettype', array('' => 'Select Asset Type', '1' => 'Asset', '2' => 'Component'), '', 'class="form-control assetType select2" id="assetType" '); ?>
                                                <span class="input-req-inner" style="z-index: 100"></span>
                                        </div>


                                        <div class="form-group col-sm-2">
                                            <label class="title">Asset Name</label>
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <span class="input-req" title="Required Field">
                                                <select class="form-control select2" id="vehicalemasterid" name="vehicalemasterid" required>
                                    ...
                                    <div class="row" style="margin-top: 10px;margin-left: 25px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            ...
                                            <input type="text" name="documentsystemcode" id="documentsystemcode" class="form-control" readonly>
                                        </div>
                                        <div class="form-group col-sm-2">
                                    ...
                                    <div class="row" style="margin-top: 10px;margin-left: 25px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <span class="input-req" title="Required Field">
                                                <div class="input-group datepic">
                                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                    <input type="text" name="maintenancedatefrom" data-inputmask="'alias': '<?php echo $date_format_policy ?>'" value="<?php echo $current_date; ?>" id="maintenancedatefrom" class="form-control">
                                                </div>
                                                <span class="input-req-inner" style="z-index: 100"></span>
                                            </span>
                                        </div>
                                        ...
                                        <div class="form-group col-sm-4">
                                            <span class="input-req" title="Required Field">
                                                <div class="input-group datepic">
                                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                    <input type="text" name="maintenancedateto" data-inputmask="'alias': '<?php echo $date_format_policy ?>'" value="<?php echo $current_date; ?>" id="maintenancedateto" class="form-control">
                                                </div>
                                                <span class="input-req-inner" style="z-index: 100"></span>
                                            </span>
                                        </div>
                                    ...
                                    <div class="row" style="margin-top: 10px;margin-left: 25px;">
                                        ...
                                        <div class="form-group col-sm-4">
                                            <textarea class="form-control" rows="3" id="commentvehicalmainte" name="commentvehicalmainte"></textarea>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row" style="margin-top: 10px;margin-left: 25px;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <span class="input-req" title="Required Field">
                                                    <div class="input-group datepic">
                                                        <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                        <input type="text" name="lastmaintenancedate" data-inputmask="'alias': '<?php echo $date_format_policy ?>'" value="<?php echo $current_date; ?>" id="lastmaintenancedate" class="form-control" readonly>
                                                    </div>
                                                    <span class="input-req-inner" style="z-index: 100"></span>
                                                </span>
                                            </div>
                                            ...
                                            <div class="form-group col-sm-4">
                                                <span class="input-req" title="Required Field">
                                                    <div class="input-group datepic">
                                                        <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                                        <input type="text" name="nextmaintenancedate" data-inputmask="'alias': '<?php echo $date_format_policy ?>'" value="<?php echo $current_date; ?>" id="nextmaintenancedate" class="form-control">
                                                    </div>
                                                    <span class="input-req-inner" style="z-index: 100"></span>
                                                </span>
                                            </div>
                                        ...
                                        <div class="row" style="margin-top: 10px;margin-left: 25px;">
                                            ...
                                            <div class="form-group col-sm-4">
                                                <span class="input-req" title="Required Field">
                                                    <div class="input-group">
                                                        <div class="input-group-addon">KM/hrs</div>
                                                        <input type="text" class="form-control " id="maintenancekm" name="maintenancekm" readonly>
                                                    </div>
                                                    <span class="input-req-inner" style="z-index: 100"></span>
                                                </span>
                                    ...
                                    <div class="row" style="margin-top: 10px;">
                                        <div class="form-group col-sm-12">
                                            <button class="btn btn-primary pull-right" type="button" id="save_btn" onclick="save_mainte_header()">Save
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row addTableView">
                            <div class="col-md-12 animated zoomIn">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <button type="button" class="btn btn-primary pull-right" id="maintenacecrewadd" onclick="add_maintenance_crew()">
                        ...
                        <div class="row addTableView">
                            <div class="col-md-12 animated zoomIn">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <button type="button" class="btn btn-primary pull-right" id="addmaintenancedetail" onclick="add_maintenance_detail()">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="vehiclemaintenace_crew_add_form" class="form-horizontal">
                    <input type="hidden" class="form-control" name="maintananceMasterIDcrew" id="maintananceMasterIDcrew">
                    <table class="table table-bordered table-condensed no-color" id="detail_vehiclemaintenace_crew_add_table">
                        <thead>
                            <tr>
                                <th>Name</th>
                                <th>Type</th>
                                <th style="width: 40px;">
                                    <button type="button" class="btn btn-primary btn-xs" onclick="add_more_maintenace_crew()">
                        ...
                        <tbody id="item_table_body_maintenance_crew">
                            <tr>
                                <td>
                                    <div class="input-group">
                                        <input type="text" class="form-control crewname" name="crewname[]" id="crewname_1">
                                        <input type="hidden" name="selectedemployee[]" id="selectedemployee_1" class="form-control selectedemployee">
                                        <span class="input-group-btn">
                                            <button class="btn btn-default btn_class_clear" type="button" title="Clear" rel="tooltip" onclick="clearEmployee(this)" data-id="1" style="height: 29px; padding: 2px 10px;"><i class="fa fa-repeat"></i></button>
                                            <button class="btn btn-default btn_class_more" type="button" title="Add Crew" rel="tooltip" onclick="link_employee_model(this)" data-id="1" style="height: 29px; padding: 2px 10px;"><i class="fa fa-plus"></i></button>
                                        </span>
                                    </div>
                                </td>
                                <td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" id="vehiclemaintenace_add_form" class="form-horizontal">
                    <input type="hidden" class="form-control" name="maintananceMasterIDdetail" id="maintananceMasterIDdetail">
                    <table class="table table-bordered table-condensed no-color" id="detail_vehiclemaintenace_add_table">
                        <thead>
                            <tr>
                                ...
                                <th>Crew Member</th>
                                <th style="width: 40px;">
                                    <button type="button" class="btn btn-primary btn-xs" onclick="add_more_maintenace()">
                                        <i class="fa fa-plus"></i></button>
                                </th>
                            </tr>
                        </thead>
                        <tbody id="item_table_body">
                            <tr>
                                ...
                                <td>
                                    <input type="text" class="form-control Qty number " name="Qty[]" onkeyup="calculatetotalamount(this)">
                                </td>
                                <td>
                                    <input type="text" class="form-control unitcost number" name="unitcost[]" value="0" onkeyup="calculatetotalamount(this)">
                                </td>
...
<div class="modal fade bs-example-modal-lg" id="emp_model" role="dialog" aria-labelledby="myLargeModalLabel">
    <div class="modal-dialog" role="document" style="z-index:1000000000">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
                <h4 class="modal-title" id="exampleModalLabel">Link Crew</h4>
                <!--Link Employee-->
            </div>
            <div class="modal-body">
                <form class="form-horizontal">
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-3 control-label">Crew Memeber Name</label>
                        <div class="col-sm-7">
                            <?php
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="fetch_employee_detail()">Save
                </button>
            </div>
        </div>
    </div>
...
<div class="modal fade bs-example-modal-sm" role="dialog" aria-labelledby="myLargeModalLabel" id="vehicale_maintenace_details_frm">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                        ...
                        <div class="skin-section extraColumns">
                            <label class="radio-inline">
                                <div class="skin-section extraColumnsgreen">
                                    ...
                                    <input id="maintenacedoneyes" type="radio" data-caption="" class="columnSelected" name="maintenacedone" value="1">
                                </div>
                            </label>
                            <label class="radio-inline">
                                <div class="skin-section extraColumnsgreen">
                                    <label for="checkbox">No&nbsp;</label>
                                    <input id="maintenacedoneno" type="radio" data-caption="" class="columnSelected" name="maintenacedone" value="0">
                                </div>
                            </label>
                        </div>
                    </div>
                ...
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="form-group col-sm-6">
                        <textarea class="form-control" rows="3" id="commentsmaintenacedetails" name="commentsmaintenacedetails"></textarea>
                    </div>
                </div>

            </div>
            <div class="modal-footer">
                <button type="submit" class="btn btn-sm btn-primary"><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span> Save
                </button>
            </div>
            </form>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group col-sm-6">
                        <span class="input-req" title="Required Field">
                            <span class="input-req" title="Required Field">
                                <div class="input-group datepic">
                                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                    <input type="text" name="stausdate" data-inputmask="'alias': '<?php echo $date_format_policy ?>'" value="<?php echo $current_date; ?>" id="stausdate" class="form-control">
                                </div>
                                <span class="input-req-inner" style="z-index: 100"></span>
                            </span>
                            <span class="input-req-inner"></span>
                ...
                <div class="row hide datestatuschange" style="margin-top: 10px;">
                    ...
                    <div class="form-group col-sm-6">
                        <span class="input-req" title="Required Field">
                            <textarea class="form-control" rows="3" id="commentstauts" name="commentstauts"></textarea>
                            <span class="input-req-inner"></span>
                        </span>
                    </div>
                </div>
                <div class="row hide datestatuschange" style="margin-top: 10px;">
                    ...
                    <div class="form-group col-sm-6">
                        <span class="input-req" title="Required Field">
                            <?php echo form_dropdown('assetstatus', $fetch_asset_status, '', 'class="form-control select2" id="assetstatus" '); ?>
                            <span class="input-req-inner"></span>
                        </span>
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <button type="button" onclick="save_status_maintenace()" class="btn btn-sm btn-primary" id="save_btn_status"><span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span> Save
                </button>
            </div>
            </form>
        </div>
...
<div class="modal" tabindex="-1" role="dialog" aria-labelledby="Employee" id="maintenace_spare_parts">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <form role="form" id="maintenace_Criteria_form" class="form-horizontal">
                        ...
                        <table class="table table-bordered table-condensed" id="addspareparts_add_table">
                            <thead>
                                <tr>
                                    ...
                                    <th>Added Y/N</th>
                                    <th style="width: 40px;">
                                        <button type="button" class="btn btn-primary btn-xs" onclick="add_more_spare_parts()" id="add_spare_parts_main"><i class="fa fa-plus"></i></button>
                                    </th>
                                </tr>
                            </thead>
                    ...
                    <div class="modal-footer">
                        <button data-dismiss="modal" class="btn btn-default" type="button"> Close</button>
                        <button class="btn btn-primary" type="button" id="save_btn_changes" onclick="save_spareparts_added();">Save changes
                        </button>
                    </div>
                </form>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        $('.headerclose').click(function() {
            fetchPage('system/Fleet_Management/fleet_maintenance_new', '', 'Maintenance');
        ...
        $('#assetType').change(function() {
            ...
            loadAssetNames(assetType);
        });

        function loadAssetNames(assetType) {
            $.ajax({
                type: 'GET',
                url: "<?php echo site_url('Fleet/get_asset_names'); ?>",
                data: {
                    asset_type: assetType
                },
                dataType: 'json',
                success: function(response) {
                    var $assetNameSelect = $('#vehicalemasterid');
                    $assetNameSelect.empty();
                    $assetNameSelect.append('<option value="">Select Asset Name</option>'); // Default option
                    $.each(response.vehiclemasterids, function(index, asset) {
                        $assetNameSelect.append($('<option>', {
                            value: asset.vehicleMasterID,
                            text: asset.vehDescription
                        }));
                    });
                },
                error: function() {
                    alert('Failed to load asset names.');
                }
            });
        }

        get_maitenance_detail_view();

    });
    $(document).on('click', '.remove-tr', function() {
        $(this).closest('tr').remove();
    });
    // Initial check if asset_name has a value when the page loads
    if ($('#vehicalemasterid').val()) {
    ...
    function get_maitenance_detail_view() {
        $.ajax({
            async: true,
            type: 'post',
            dataType: 'html',
            url: "<?php echo site_url('Fleet/load_maintenance_detail_view'); ?>",
            beforeSend: function() {
                startLoad();
            },
            success: function(data) {
                $('#maintenace_view').html(data);
                stopLoad();
            },
    ...
    function load_vehicale_master() {
        if (vehicalemasterid) {
            $.ajax({
                ...
                dataType: 'json',
                data: {
                    'vehicalemasterid': vehicalemasterid
                },
    ...
    function vehiclemaintenace_model() {
        ...
        // Set default values for asset type and vehicle master ID
        $(".assetType").val(null).trigger("change"); // Add this line for asset type
        $("#vehicalemasterid").val(''); // Make sure this matches the ID in your form
        ...
        $("#vehicalemasterid").prop('disabled', false);
        ...
        // Hide unnecessary table views
        $('.addTableView').addClass('hide');

        // Show the modal
        $("#vehicale_maintenance").modal({
            backdrop: "static"
        });
    }
    ...
    function save_mainte_header() {
        ...
        var assetNameId = $('#vehicalemasterid').val(); // Get the selected asset name ID
        data.push({
            'name': 'vehicalemasterid',
            'value': assetNameId
        });

        // Add a flag to indicate if the user confirms to proceed with unclosed maintenance
        var proceedWithUnclosed = false;

        function sendAjaxRequest() {
            // Update the proceed flag in the data
            data = data.filter(item => item.name !== 'proceedWithUnclosed'); // Remove existing proceedWithUnclosed if exists
            data.push({
                'name': 'proceedWithUnclosed',
                'value': proceedWithUnclosed ? 1 : 0 // Send as integer (1 or 0)
            });
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: data,
                url: "<?php echo site_url('Fleet/save_maintenanceheader'); ?>",
                beforeSend: function() {
                    startLoad();
                },
                success: function(data) {
                    stopLoad();
                    // Check if the response indicates unclosed maintenance with policy check
                    if (data[0] === 'w' && !proceedWithUnclosed) {
                        /* && data[1] === 'There is unclosed maintenance exist for this asset. Do you want to proceed?'  */
                        swal({
                            title: "Warning",
                            text: data[1],
                            /*  "There is unclosed maintenance existing for this asset. Are you sure you want to proceed?", */
                            type: "warning",
                            ...
                            if (isConfirm) {
                                // User clicked "Yes", set the flag to true and send the request again
                ...
                error: function(xhr, status, error) {
                    stopLoad();
                    alert('Failed to save maintenance header: ' + (xhr.responseText || status || error));
                }
            });
        }
    ...
    function load_maintenance_edit(maintenanceMasterID, type) {
        $('#vehicalemasterid').val('');
        $(".assetType").val(null).trigger("change");
        $(".maintenancecompany").val(null).trigger("change");
        ...
        if (type == 1) {
            $.ajax({
                ...
                dataType: 'json',
                data: {
                    'maintenanceMasterID': maintenanceMasterID
                },
                url: "<?php echo site_url('Fleet/fetch_maintenance_header_details'); ?>",
                beforeSend: function() {
                    startLoad();
                },
                success: function(data) {
                    // Populate and set values for asset type and asset name
                    $("#vehicalemasterid").val(data['vehicleMasterID']).change();
                    $("#assetType").val(data['assetType']).change();
                    ...
                    // Check if utilizationID exists to enable or disable fields
                    // if (data['utilizationID']) {
                    //     $("#assetType").prop('disabled', true);
                    //     $("#vehicalemasterid").prop('disabled', true);
                    // } else {
                    //     $("#assetType").prop('disabled', false);
                    //     $("#vehicalemasterid").prop('disabled', false);
                    // }
                    ...
                    // Show appropriate sections based on maintenanceBy value
                    ...
                    // Fetch and populate asset names based on asset type
                    updateAssetNames(data['assetType'], data['vehicleMasterID']);
                    ...
                    function() {
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                $("#utilizationcode").prop('disable', false);
                                // Check if utilizationID exists to enable or disable fields
                                if (data['utilizationID']) {
                                    $("#assetType").prop('disabled', true);
                                    $("#vehicalemasterid").prop('disabled', true);
                                    $('.utilizationcode').removeClass('hide');
                                } else {
                                    $("#assetType").prop('disabled', false);
                                    $("#vehicalemasterid").prop('disabled', false);
                                    $('.utilizationcode').addClass('hide');
                                }


                                $("#utilizationcode").val(data['utilaztionCode']);
                                $("#assetType").val(data['assetType']);
                                $("#vehicalemasterid").val(data['vehicalemasterid']);
                                $("#maintenancecompany").val(data['maintenanceCompanyID']).change();
                                $("#maintenancetype").val(data['maintenanceType']).change();
                                vehicalemaintenaceid = data['maintenanceMasterID'];
                                $("#maintananceMasterIDcrew").val(data['maintenanceMasterID']);
    ...
    function updateAssetNames(assetType, vehicleMasterID) {
        // Fetch asset names based on asset type
        $.ajax({
            async: true,
            type: 'post',
            dataType: 'json',
            ...
            url: "<?php echo site_url('Fleet/fetch_asset_names'); ?>",
            beforeSend: function() {
                startLoad();
            },
            success: function(data) {
                stopLoad();
                var $assetNameDropdown = $('#vehicalemasterid');
                $assetNameDropdown.empty(); // Clear existing options

                if (data.length > 0) {
                    $.each(data, function(index, item) {
                        var option = new Option(item.vehDescription, item.vehicleMasterID);
                        $assetNameDropdown.append(option);
                    });

                    // Set the selected value
                    $assetNameDropdown.val(vehicleMasterID).change();
                } else {
                    $assetNameDropdown.append('<option value="">No assets found</option>');
                }
            },
            error: function() {
                stopLoad();
                swal("Cancelled", "Failed to load asset names", "error");
            }
        });
    }
    ...
    function get_crew_details() {
        if (vehicalemaintenaceid) {
            $.ajax({
                ...
                dataType: 'html',
                data: {
                    'vehicalemaintenaceid': vehicalemaintenaceid
                },
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (!jQuery.isEmptyObject(data)) {
                        ...
                        $("#vehicale_maintenace_details_frm").modal({
                            backdrop: "static"
                        });
            ...
            swal({
                ...
                function() {
                    $.ajax({
                        ...
                        dataType: 'json',
                        data: data,
                        url: "<?php echo site_url('Fleet/save_maintenance_status_with_assetstatus'); ?>",
                        beforeSend: function() {
                            startLoad();
                        },
                        success: function(data) {
    ...
    function fetch_detail_status(maintenanceCriteriaID, maintenanceDetailID) {
        $.ajax({
            ...
            dataType: 'json',
            data: {
                'maintenacecritiria': maintenanceCriteriaID,
                'maintenanceDetailID': maintenanceDetailID
            },
    ...
    function fetch_spareparts_cost(element, itemautoid) {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: {
                'maintenanceCriteriaID': maintenanceCriteriaID,
