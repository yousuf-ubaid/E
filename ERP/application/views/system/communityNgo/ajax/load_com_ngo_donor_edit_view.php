...
if (!empty($header)) {
    ...
    <div class="row">
        ...
        <div class="col-md-3 text-right">
            <button type="button" class="btn btn-primary pull-right"
                    onclick="fetchPage('system/communityNgo/ngo_mo_donors_create',<?php echo $header['contactID'] ?>,'Edit Community Donor','CRM');">
    ...
    <input type="hidden" id="Com_MasterID" value="<?php echo $header['Com_MasterID']; ?>">
            ...
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="fileinput-new thumbnail">
                        ...
                        <?php if ($header['Com_MasterID'] != NULL || $header['Com_MasterID'] != '') { ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#frm_contact_add_notes').bootstrapValidator({
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: data,
                url: "<?php echo site_url('CommunityNgo/add_com_donor_notes'); ?>",
                beforeSend: function () {
                    startLoad();
                },
    ...
    function contact_notes() {
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('CommunityNgo/load_com_donor_all_notes'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
    ...
    function contact_attachments() {
        ...
        $.ajax({
            ...
            dataType: 'html',
            data: {contactID: contactID},
            url: "<?php echo site_url('CommunityNgo/load_com_donor_all_attachment'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
        ...
        swal({
            ...
            function () {
                $.ajax({
                    ...
                    url: "<?php echo site_url('CommunityNgo/delete_comDonor_attachment'); ?>",
                    beforeSend: function () {
                        startLoad();
                    },
                    success: function (data) {
    ...
    function profileImageUploadDonor() {
        ...
        if (Com_MasterID) {
            myAlert('e', 'Can not upload community member image !');
        }
        else{
            $.ajax({
                type: 'POST',
                ...
                cache: false,
                processData: false,
                url: "<?php echo site_url('CommunityNgo/com_donor_image_upload'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
    ...
    function fetch_donor_donationsview() {
        ...
        $.ajax({
            ...
            dataType: 'html',
            data: {'contactID':contactID},
            url: '<?php echo site_url("CommunityNgo/com_donor_donationsView"); ?>',
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
                stopLoad();
                $('#comDonation_view').html(data);
            }, error: function () {
