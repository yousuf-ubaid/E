...
if (!empty($master)) {
    ...
    <ul class="nav nav-tabs" id="main-tabs">
        ...
        <li><a href="#files" onclick="member_attachments()" data-toggle="tab"><i class="fa fa-television"></i>Attachments
            </a></li>
    </ul>
            ...
            <div class="row">
                <div class="col-sm-9">
                    <table class="table table-striped" id="profileInfoTable"
                        ...
                        <tr>
                            <td>
                                <strong id="_EDOB"><?php echo $this->lang->line('communityngo_age'); ?>: </strong>
                            </td>
                            <td>
                                <?php echo $master['Age']; ?>
                            </td>
                ...
                <div class="col-sm-3">
                    <div class="fileinput-new thumbnail">
                        ...
                        if ($master['CImage'] == '') {
                            ...
                            echo '
                        ' . $linkStart . '
                        <img class="" src="' . base_url() . 'uploads/NGO/communitymemberImage/' . $master['CImage'] . '" id="changeImg" style="width: 200px; height: 145px;">
                        ' . $linkEnd . '
                        ';
                        }
                        ?>
