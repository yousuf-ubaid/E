...
$title = $this->lang->line('communityngo_donors');
    ...
    <div class="row">
        ...
        <div class="col-md-3 text-right">
            <button type="button" class="btn btn-primary pull-right"
                    onclick="fetchPage('system/communityNgo/ngo_mo_donors_create',null,'<?php echo $this->lang->line('communityngo_add_new_donor');?>'/*Add New Donor*/,'CRM');"><i
                    class="fa fa-plus"></i> <?php echo $this->lang->line('communityngo_new_donor');?><!--New Donor-->
            </button>
        </div>
    </div>
    <div class="row">
    ...
    <script type="text/javascript">
        ...
        function getDonorManagement_tableView(filtervalue) {
            ...
            $.ajax({
                ...
                url: "<?php echo site_url('CommunityNgo/load_com_donorManage_view'); ?>",
                beforeSend: function () {
                    startLoad();
                },
            ...
            swal({
                ...
                function () {
                    $.ajax({
                        ...
                        dataType: 'json',
                        data: {'contactID': id},
                        url: "<?php echo site_url('CommunityNgo/delete_community_donor_mast'); ?>",
                        beforeSend: function () {
                            startLoad();
                        },
                        success: function (data) {
