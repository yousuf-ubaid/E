...
<div class="row">
    <div class="col-md-12 animated zoomIn">
        ...
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="form-group col-sm-4">
                <span class="input-req" title="Required Field">
                <?php echo form_dropdown('countryID', $countries_arr, '', 'class="form-control select2 valueHelp disableHelp" id="countryID"'); ?>
                    <span class="input-req-inner"></span></span>
            </div>
        </div>
        <div class="row" style="margin-top: 10px;">
        ...
        if (Com_MasterID == "" || Com_MasterID == null) {
            ...
            $.ajax({
                ...
                success: function (datum) {
                   ...
                   // $('#EconStateID').val(datum.EconStateID).change();
                    $('#dateOfBirth').val(datum.CDOB);
                    $('#FamMasterID').val(datum.FamMasterID);
                    $('#familyDetail').val(datum.familyDetail);
                    ...
                    $('#nationalIdentityCardNo').val(datum.nationalIdentityCardNo);
