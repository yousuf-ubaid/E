...
<?php
if (!empty($expense)) { ?>
    <div class="table-responsive mailbox-messages" id="expenrecid">
        <table class="table table-hover table-striped">
            ...
            <tr class="task-cat-upcoming">
                ...
                <td class="headrowtitle" style="border-bottom: solid 1px #f76f01;">GL Code Description</td>
            ...
            foreach ($expense as $val) {
                ...
                <tr>
                    ...
                    <td class="mailbox-star"><?php echo $val['GLCode']; ?></td>
                    <td class="mailbox-star"><?php echo $val['GLDescription']; ?></td>
                    <td class="mailbox-star"><?php echo $val['segmentCode'] ?></td>
                    ...
                    <td class="mailbox-attachment taskaction_td"><span class="pull-right">
                            <a onclick="edit_paymentVoucher_expense(<?php echo $val['pvDetailID'] ?>)"><span title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;<a
                                onclick="delete_paymentVoucher_expense(<?php echo $val['pvDetailID'] ?>)"><span title="Delete" rel="tooltip" class="glyphicon glyphicon-trash" style="color:rgb(209, 91, 71);"></span></a></span>
                    </td>
                </tr>
                <?php
                $x++;
    ...
    <br>
    <div class="search-no-results" id="expenrecid">NO RECORDS FOUND.</div>
    <?php
}
?>
