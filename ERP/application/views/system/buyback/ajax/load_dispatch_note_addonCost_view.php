...
if (!empty($header)) { ?>
    <div class="table-responsive mailbox-messages">
        <table class="table table-hover table-striped">
            ...
            <tr class="task-cat-upcoming">
                ...
                <td class="headrowtitle" style="border-bottom: solid 1px #f76f01;">Category</td>
            ...
            foreach ($header as $val) {
                ...
                <tr>
                    ...
                    <td class="mailbox-star" width="5%"><?php echo $val['addonCategoryName'] ?></td>
                    <td class="mailbox-star"><?php echo $val['GLCode'] ?></td>
                    <td class="mailbox-star"><?php echo $val['GLDescription'] ?></td>
                    <td class="mailbox-star pull-right"><?php echo number_format($val['total_amount'],2) ?></td>
                    <td class="mailbox-attachment"><span class="pull-right">
                            <a onclick="edit_dispatchNote_addon(<?php echo $val['dispatchAddonAutoID'] ?>)"><span
                                    title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;<a
                                onclick="delete_dispatchNote_addon(<?php echo $val['dispatchAddonAutoID'] ?>);"><span
    ...
    <br>
    <div class="search-no-results">THERE ARE NO ADDON COST TO DISPLAY.</div>
    <?php
}
?>
