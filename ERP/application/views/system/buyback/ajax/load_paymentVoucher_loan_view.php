...
<?php
if (!empty($loan)) { ?>
    <div class="table-responsive mailbox-messages" id="loanrecid">
        <table class="table table-hover table-striped">
            ...
            foreach ($loan as $val) {
                ...
                <tr>
                    ...
                    <td class="mailbox-star">Loan : <?php echo $val['comment']; ?></td>
                    <td class="mailbox-star" style="text-align: right">
                        <?php
                        if($val['isMatching'] == 0){
                    ...
                    <td class="mailbox-attachment taskaction_td">
                        <span class="pull-right">
                            <a onclick="edit_paymentVoucher_loan(<?php echo $val['pvDetailID'] ?>)"><span title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;<a
                                onclick="delete_receiptVoucher_income(<?php echo $val['pvDetailID'] ?>)"><span title="Delete" rel="tooltip" class="glyphicon glyphicon-trash" style="color:rgb(209, 91, 71);"></span></a>
                        </span>
                    </td>
                </tr>
                <?php
            ...
            <tfoot >
            <tr>
                <td style="min-width: 85%  !important" class="text-right sub_total" colspan="2">
                    Total  </td>
    ...
    <br>
    <div class="search-no-results" id="loanrecid">NO RECORDS FOUND.</div>
    <?php
}
?>
