...
if (!empty($party)) { ?>
    <div class="table-responsive mailbox-messages">
        <table class="table table-hover table-striped">
            ...
            <tr class="task-cat-upcoming">
                ...
                <td class="headrowtitle" style="border-bottom: solid 1px #f76f01;">Party Type</td>
            ...
            foreach ($party as $val) {
                ...
                <tr>
                    ...
                    <td class="mailbox-star" width="20%"><?php
                        if($val['partyType'] == 1){
                            echo "Supplier";
                        }else {
                            echo "Customer";
                    ...
                    <td class="mailbox-star" width="20%"><?php
                        if($val['partyType'] == 1){
                            echo $val['supplierSystemCode'];
                        }else {
                            echo $val['customerSystemCode'];
                        }
                        ?></td>
                    <td class="mailbox-star" width="20%"><?php
                        if($val['partyType'] == 1){
                    ...
                    <td class="mailbox-attachment">
                        <span class="pull-right"><a href="#" onclick="edit_farmParty(<?php echo $val['farmPartyAutoID'] ?>)"><span title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="delete_farmParty(<?php echo $val['farmPartyAutoID'] ?>);"><span title="Delete" rel="tooltip" class="glyphicon glyphicon-trash" style="color:rgb(209, 91, 71);"></span></a>
                        </span>
                    </td>
                </tr>
                <?php
    ...
    <br>
    <div class="search-no-results">THERE ARE NO ASSIGN PARTYS TO DISPLAY.</div>
    <?php
}
?>
