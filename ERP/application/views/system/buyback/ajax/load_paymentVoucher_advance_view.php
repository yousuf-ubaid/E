        ...
        <table class="table table-hover table-striped">
            ...
            foreach ($advance as $val) {
                ...
                <tr>
                    ...
                    <td class="mailbox-star">Advance : <?php echo $val['comment']; ?></td>
                    ...
                    <td class="mailbox-attachment taskaction_td"><span class="pull-right">
                            <a onclick="edit_paymentVoucher_advance(<?php echo $val['pvDetailID'] ?>)"><span title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;<a
