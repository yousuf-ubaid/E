<?php echo head_page('Good Receipt Note', false); ?>
...
<div class="table-responsive">
    <table id="goodReceiptNote_table" class="<?php echo table_class(); ?>">
        <thead>
        <tr>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Good Receipt Note Approval</h4>
            </div>
            <form class="form-horizontal" id="goodReceiptNote_approval_form">
                        ...
                        <div class="zx-tab-content">
                            <div class="zx-tab-pane active" id="Tab-home-v">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="hidden" name="grnAutoID" id="grnAutoID">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="tab-pane hide" id="Tab-profile-v">
                                <div class="table-responsive">
                                    ...
                                    &nbsp <strong>Donor Collection Attachments</strong>
                                    <br><br>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/buyback/grn_approval','','Good Receipt Note');
        });
        goodReceiptNote_table();

        $('#goodReceiptNote_approval_form').bootstrapValidator({
            live: 'enabled',
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: data,
                url: "<?php echo site_url('Buyback/save_goodReceiptNote_approval'); ?>",
                beforeSend: function () {
                    startLoad();
                },
    ...
    function goodReceiptNote_table() {
        Otable = $('#goodReceiptNote_table').DataTable({
            "bProcessing": true,
            "bServerSide": true,
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Buyback/goodReceiptNote_table_approval'); ?>",
            "aaSorting": [[1, 'desc']],
            ...
            "columnDefs": [{"targets": [6,7,8], "searchable": true, "visible": false, "orderable": false},{"targets": [0,2,4,5], "searchable": false}],
    ...
    function fetch_approval(grnAutoID, documentApprovedID, Level) {
        if (grnAutoID) {
            $.ajax({
                async: true,
                type: 'post',
                dataType: 'html',
                data: {'grnAutoID': grnAutoID, 'html': true,'size':1},
                ...
                success: function (data) {
                    ...
                    $('#comments').val('');
                    goodReceiptNote_attachment_View_modal('BBGRN', grnAutoID);
                    stopLoad();
                    refreshNotifications(true);
                }, error: function () {
                    stopLoad();
    ...
    function goodReceiptNote_attachment_View_modal(documentID, documentSystemCode) {
