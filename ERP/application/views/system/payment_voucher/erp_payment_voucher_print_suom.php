...
<div class="table-responsive"><br>
    <table style="width: 100%">
        ...
        <?php
        if (!empty($extra['master']['nameOnCheque']) && $extra['master']['paymentType']==1 && $extra['master']['pvType']=='Supplier') {
            ?>
            <tr>
                <td><strong>Segment</strong></td>
                <td>:</td>
                <td> <?php echo $extra['master']['segDescription']; ?> (<?php echo $extra['master']['segmentCode']; ?>)</td>
                <td><strong>Name on Cheque</strong></td>
                <td><strong>:</strong></td>
    ...
    <div class="table-responsive">
        <table class="table table-bordered table-striped table-condensed">
            ...
            if (!empty($extra['item_detail'])) {
                ...
                echo '<tr class="danger"><td colspan="4" class="text-center">' . $norecordsfound . '</td></tr>';
            } ?>
            <!--No Records Found-->
            </tbody>
            <tfoot>
            <tr>
                <td class="text-right sub_total"
                    colspan="5"><?php echo $this->lang->line('sales_markating_view_invoice_item_total'); ?>
 ...
 <?php  if (!empty($extra['PRQ'])) { ?><br>
    <div class="table-responsive">
        <table class="table table-bordered table-striped table-condensed">
            ...
            <tr>
                <th class='theadtr' style="min-width: 5%">#</th>
                <th class='theadtr' style="min-width: 10%">Code</th>
            ...
            if (!empty($extra['PRQ'])) {
                foreach ($extra['PRQ'] as $val) { ?>
                    <tr>
                        <td style="text-align:right;"><?php echo $num; ?>.&nbsp;</td>
                        <td style="text-align:left;"><?php echo $val['purchaseRequestCode']; ?> - <?php echo $val['itemSystemCode']; ?></td>
                        <td>
                            <?php echo $val['itemDescription']; ?>
                            <?php if(!empty($val['comment']) && empty($val['partNo']))
                            {
...
<div class="table-responsive">
    ...
    <div class="table-responsive">
        <table style="width: 100%">
            ...
            <tr>
                <td style="width:30%;">
                    <b><?php echo $this->lang->line('sales_markating_view_invoice_electronically_approved_by'); ?> </b>
                </td><!--Electronically Approved By-->
                <td><strong>:</strong></td>
                <td style="width:70%;"><?php echo $extra['master']['approvedbyEmpName']; ?></td>
            </tr>
            <tr>
                <td style="width:30%;">
                    <b><?php echo $this->lang->line('sales_markating_view_invoice_electronically_approved_date'); ?></b>
