...
<div id="filter-panel" class="collapse filter-panel">
    <div class="row">
        ...
        <div class="form-group col-sm-4">
            ...
            <div id="customer_div">
                <?php echo form_dropdown('customerCode[]', null, '', 'class="form-control" id="customer_array" multiple="multiple" onchange="Otable.draw()"'); ?>
            </div>
        </div>
        <!-- <div class="form-group col-sm-4">
            <label for="supplierPrimaryCode"> <?php echo $this->lang->line('common_customer');?></label><br>
...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary-new size-sm pull-right"
                onclick="fetchPage('system/receipt_voucher/erp_receipt_voucher',null,'<?php echo $this->lang->line('accounts_receivable_tr_add_new_receipt_voucher');?>','RV');"><i
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function(){
            fetchPage('system/receipt_voucher/receipt_voucher_management','','Receipt Voucher');
        });
    ...
    function payment_voucher_table(selectedID=null) {
         Otable = $('#payment_voucher_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Receipt_voucher/fetch_receipt_voucher'); ?>",
            "aaSorting": [[0, 'desc']],
            ...
            "aoColumns": [
             ...
             "columnDefs": [{"targets": [6], "orderable": false},{"visible":false,"searchable": true,"targets": [7,8,9,10,11,12,13,14] }, {"searchable": false, "targets": [0]}],
            "fnServerData": function (sSource, aoData, fnCallback) {
                aoData.push({"name": "datefrom", "value": $("#IncidateDateFrom").val()});
                aoData.push({"name": "dateto", "value": $("#IncidateDateTo").val()});
                aoData.push({"name": "status", "value": $("#status").val()});
                aoData.push({"name": "customerCode", "value": $("#customer_array").val()});
                $.ajax({
                    'dataType': 'json',
                    'type': 'POST',
                    'url': sSource,
