<div class="row">
    <div class="col-md-12">
        <div style="font-size: 16px; font-weight: 700;"><?php echo $extra['warehouseDetails']['wareHouseDescription'] . ' - ' . $extra['warehouseDetails']['wareHouseCode']  ?></div>
    </div>
</div>
<br>
<?php
foreach ($companyID as $val)
{
    ...
    $warehouseVal = get_group_warehouse_details($warehouseID, $val);
?>
    <div class="row">
