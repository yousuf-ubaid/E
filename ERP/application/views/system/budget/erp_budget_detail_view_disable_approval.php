...
<div class="col-md-12" style="">
                ...
                foreach ($maincategory as $key2 => $subcategory) {
                    ...
                    foreach ($subcategory as $value) {
                        foreach ($months_all as $monthval) {
                            ...
                            if($monthval['month'] == 1){
                                $total['month_1'] += $value['month_1'];
                            }else if($monthval['month'] == 2){
                                $total['month_2'] += $value['month_2'];
                            }else if($monthval['month'] == 3){
                                $total['month_3'] += $value['month_3'];
                            }else if($monthval['month'] == 4){
                                $total['month_4'] += $value['month_4'];
                            }else if($monthval['month'] == 5){
                                $total['month_5'] += $value['month_5'];
                            }else if($monthval['month'] == 6){
                                $total['month_6'] += $value['month_6'];
                            }else if($monthval['month'] == 7){
                                $total['month_7'] += $value['month_7'];
                            }else if($monthval['month'] == 8){
                                $total['month_8'] += $value['month_8'];
                            }else if($monthval['month'] == 9){
                                $total['month_9'] += $value['month_9'];
                            }else if($monthval['month'] == 10){
                                $total['month_10'] += $value['month_10'];
                            }else if($monthval['month'] == 11){
                                $total['month_11'] += $value['month_11'];
                            }else if($monthval['month'] == 12){
                                $total['month_12'] += $value['month_12'];;
                            }
                        ...
                        <tr>
                            ...
                            <?php foreach ($months_all as $monthval) {?>
                                ...
                                ?>
                                    ...
                                    <input class="form-control amount" type="text" disabled name="amount"
    ...
    font-weight: bold;background-color: #d4d2d2">
                    ...
                    <?php foreach ($months_all as $monthval) {
                        ...
                        ?>
                        <td style="text-align: right;padding-right: 29px; font-size: 11px"><span id="<?php echo $key.'_'.$monthval['month'] ?>"> <?php echo format_number($total['month_'.$monthval['month']],2)  ?></span></td>
                        </td>
                    <?php }?>
                </tr>
                <?php
