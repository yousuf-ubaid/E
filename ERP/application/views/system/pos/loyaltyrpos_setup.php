<?php echo head_page('Loyalty Setup - Restaurant', false);
...
<?php echo footer_page('Right foot', 'Left foot', false); ?>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="autocomplete" style="width:100%;">
                                        <input id="gc_customerTelephone" name="customerTelephone" type="text"
                                               placeholder="Telephone" class="form-control" autocomplete="off">
    ...
    <script type="text/javascript">
        ...
        $("#gc_customerTelephone").keyup(function () {
            var skey = $("#gc_customerTelephone").val();
            currentRequest = $.ajax({
                dataType: 'json',
                type: 'POST',
                data: {skey: skey},
                url: '<?php echo site_url('Pos_restaurant/get_customers_by_phone'); ?>',
                beforeSend: function () {
        ...
        function set_customer_input() {
            ...
            $("#gc_customerTelephone").val(cus_phone);
        ...
        function load_loyalty_table() {
            loyalty_table = $('#loyalty_table').DataTable({
                ...
                "bServerSide": true,
                "bDestroy": true,
                "sAjaxSource": "<?php echo site_url('Pos_restaurant/load_loyalty_table'); ?>",
                "aaSorting": [[0, 'desc']],
        ...
        function save_loyalty_card() {
            ...
            var gc_customerTelephone = $("#gc_customerTelephone").val();
            var gc_CustomerName = $("#gc_CustomerName").val();
            var customerID = $("#customerID").val();
            var cardMasterID = $("#cardMasterID").val();
        ...
        function edit_loyalty(cardMasterID) {
            $.ajax({
                ...
                url: "<?php echo site_url('Pos_restaurant/edit_loyalty'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
        ...
        function load_points_table() {
            loyalty_points = $('#points_table').DataTable({
                ...
                "bServerSide": true,
                "bDestroy": true,
                "sAjaxSource": "<?php echo site_url('Pos_restaurant/load_points_table'); ?>",
                "aaSorting": [[0, 'desc']],
                "fnDrawCallback": function (oSettings) {
                    if (oSettings.bSorted || oSettings.bFiltered) {
                        for (var i = 0, iLen = oSettings.aiDisplay.length; i < iLen; i++) {
        ...
        function add_points() {
            ...
            $.ajax({
                ...
                url: "<?php echo site_url('Pos_restaurant/add_points'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
        ...
        function update_card_active(cardSetupID) {
            var compchecked = 0;
        ...
        function fetch_customer_detail() {
            otable = $('#customer_sync').DataTable({
                ...
                "sAjaxSource": "<?php echo site_url('pos/fetch_customers_loyality'); ?>",
                language: {
                    paginate: {
                        previous: '‹‹',
                        next: '››'
        ...
        function addcustomer() {
            $.ajax({
                type: 'POST',
                url: '<?php echo site_url("pos/save_customers_loyality_card"); ?>',
                dataType: 'json',
