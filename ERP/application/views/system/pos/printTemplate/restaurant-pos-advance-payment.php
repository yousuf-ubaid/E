...
<div id="wrapper">
    ...
    <?php
    $outletID = isset($outletID) ? $outletID : get_outletID();
    $decimal = 3;
    $paymentTypes = get_bill_payment_types($masters['menuSalesID'], $outletID);
    $tmpPayTypes = '';
    ...
    if (!isset($email)) {
        ...
        <div style="height: 25px;">
            <div class="pull-right">
                ...
                <button class="btn btn-xs btn-default" onclick="print_delvry_orders()">
...
<script type="text/javascript">
    function print_delvry_orders(){
        //$("#print_contentmush").print( );
        // print will open in different tab
        var divToPrint=document.getElementById('print_contentAP');
