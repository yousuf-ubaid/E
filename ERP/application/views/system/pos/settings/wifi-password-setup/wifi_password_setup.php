                ...
                <div class="tab-pane active" id="tab_1">
                    <div class="posContainer">
                        <h4 style="font-size:16px; font-weight: 800;">
                            ...
                            <span class="btn-xs pull-right" title="Sample Specimen for wifi password">
                                <a class="btn btn-default  btn-xs"
                                   href="<?php echo base_url('images/pos/sample_wifi_password.csv') ?>"
                                   download="sample_wifi_password.csv">
