    ...
    <div class="box-body">
        ...
        <div class="row">
            ...
            <div class="col-md-3 text-right">
                <button type="button" onclick="open_warehouse_model(1)" class="btn btn-primary btn-sm pull-right"><i
                        class="fa fa-plus"></i>
        ...
        <div class="table-responsive">
            <table id="warehousemaster_table" class="<?php echo table_class(); ?>">
                ...
                <tr>
                    ...
                    <th><?php //echo $this->lang->line('common_description'); ?><!--Description-->Outlet Name</th>
...
<div class="modal" id="warehousemaster_model" role="dialog" data-keyboard="false" data-backdrop="static">
            ...
            <form role="form" id="warehousemaster_form" class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label class="col-sm-4 control-label">
                                <?php //echo $this->lang->line('common_description'); ?><!--Description--> Outlet Name</label>
                            <div class="col-sm-6">
                    ...
                    <div class="row onlyForEdit">
                        <div class="form-group">
                            <label class="col-sm-4 control-label" style="color:#ffb7b7">Common for all outlets</label>

                        </div>
                    </div>
                    <div class="row onlyForEdit">
                        <div class="form-group">
                            <label class="col-sm-4 control-label">Bill Print Template</label>
                            <div class="col-sm-6" style="">
                                <?php echo form_dropdown('printTemplateMasterID', get_bill_all_print_template(), get_bill_print_template_id(), 'class="form-control" id="printTemplateMasterID" ') ?>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data['error'] == 0) {
                        ...
                        if(data['id']){
                            openwarehousemastermodel(data['id'],0);
                        }else {
                            $("#warehousemaster_model").modal("hide")
                        }
                    } else {
    ...
    function open_warehouse_model(modal=1) {
        $(".onlyForEdit").hide();
        // alert('xx')
    ...
    function openwarehousemastermodel(id,modal=1) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#printTemplateMasterID').val(data['printTemplateMasterID']);
                if (data['warehouseImage'] != '' && data['warehouseImage'] != null) {
                    var src = data['warehouseImage'];
                } else {
