...
$customers = get_exist_erp_pos_customers(1);
?>
<style>
    .reportContainer {
...
<script>
    ...
    function loadPaymentSalesReport2() {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'html',
            url: "<?php echo site_url('Pos_restaurant/load_pos_detail_sales_report2'); ?>",
            data: {id: null},
            cache: false,
            beforeSend: function () {
    ...
    function loadPaymentSalesVoidReport_ajax2() {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'html',
            url: "<?php echo site_url('Pos_restaurant/load_pos_detail_void_report2'); ?>",
            data: data,
            cache: false,
            beforeSend: function () {
