...
<span class="pull-right">
    ...
    <a href="" class="btn btn-excel btn-xs" id="btn-excel" download="Delivery_Commission_Report.xls"
       onclick="var file = tableToExcel('printContainer_itemizedSalesReport', 'Delivery Commission Report'); $(this).attr('href', file);">
        ...
        if (!empty($deliveryPersonReport)) {
            foreach ($deliveryPersonReport as $val) {
                ...
                <tr>
                    ...
                    <td class="alin"><?php echo $val['invoiceCode'] ?></td>
