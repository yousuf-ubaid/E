                ...
                <td width="60%">
                    <table class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td class="text-right">(<?php echo number_format($voidBills['NetTotal'], $d) ?>)
                            </td>
                            <td class="text-right">
                                <?php
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td class="text-right"><strong><?php echo number_format($grossTotal, $d) ?></strong>
                            </td>
                            <td></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td class="text-right"><strong><?php echo number_format($netTotal, $d) ?></strong>
                            </td>
