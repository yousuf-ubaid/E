...
<form id="frm_till_management_rpt" method="post" class="form-inline text-center" role="form">
    ...
    <div class="col-md-3">
        ...
        <a href="" class="btn btn-excel btn-sm" id="btn-excel" download="Till_Management_Report.xls"
           onclick="var file = tableToExcel('printContainer_itemizedSalesReport', 'Till Management Report'); $(this).attr('href', file);">
...
<div class="table-responsive" id="printContainer_itemizedSalesReport">
