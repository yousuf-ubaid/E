        ...
        <table class="table table-bordered table-striped">
            ...
            if (!empty($extra['yield_detail'])) {
                foreach ($extra['yield_detail'] as $val) { ?>
                    <tr>
                        ...
                        <td class="text-right"> <?php echo number_format($val['localWacAmount'], $d); ?></td>
                        <td class="text-right"> <?php echo number_format( $val['localWacAmountTotal'],$d); ?></td>
                    </tr>
                    <?php
            ...
            <tr>
                ...
                <td style="min-width: 15% !important"
                    class="text-right total"><?php echo number_format($total, $d); ?></td>
            </tr>
            </tfoot>
        </table>
    </div>
