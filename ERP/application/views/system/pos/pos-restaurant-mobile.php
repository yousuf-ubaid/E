            ...
            <div class="col-md-8 col-md-offset-3" style="padding-right: 0px;">
                <div class="row">
                    <div class="col-xs-12 col-sm-6 col-md-5 col-lg-5">
                        ...
                        ?>">
                        <button class="btn btn-sm btn-default btn-block label-txt" style="border-radius: 0px;">
                        ...
                        <div class="order-type-btn-group">
                            <div class="btn-group btn-group-lg" style="width: 100%">
                                ...
                                foreach ($customerType as $val) {
                                    ...
                                    <button type="button"
                                            ...
                                            class="mat-btn-1 btn buttonCustomerType buttonDefaultSize <?php if ($val['isDefault'] == 1) {
                                            ...
                                            ?>  customerType" id="customerTypeID_<?php echo $val['customerTypeID']; ?>" style="width: 22%">
								...
								<?php
									...
									if ($kotBtn) {
										?>
										<button type="button" onclick="POS_SendToKitchen()" class="mat-btn-2 btn btn-lg btn-danger buttonDefaultSize"
												id="btn_pos_sendtokitchen" style="width: 22%"><i class="fa fa-cutlery" aria-hidden="true"></i> KOT
										</button>
								<?php } ?>
                            ...
                            <script>
                                $(document).ready(function (e) {
                                    ...
                                    var segmentconfig_posTemplateID = <?php echo $segmentconfig_posTemplateID; ?>;
                                    if(segmentconfig_posTemplateID=='2'){
                                        $("#pos_btnSet_dtd").hide();
                                    }
                                });
                            </script>
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data['error'] == 1) {
                        ...
                        divTmp += '<input style="width:90%;" onClick="this.select();" id="discountAmount_' + data['code'] + '" onfocus="keepTheExistingDiscountAmount.call(this)" onchange="item_wise_discount(this,\'A\',' + data['code'] + ')" name="discountAmount[' + data['code'] + ']" type="text" value="0" class="menu_discount_amount menu_qty menuItem_input numberFloat numpad"><!-- disc. amount -->';
                        divTmp += '</div>';
                        divTmp += '<div class="receiptPadding">';
                        divTmp += '<div style="width:55px; text-align: right;" class="itemCostNet menuItemTxt set-delete-2"> [' + data['sellingPrice'] + '</div> <!-- net total -->';
                        ...
                        divTmp += '<button type="button" class="btn btn-default btn-sm  itemList-delBtn c-b-20 mat-btn-close"><i class="fa fa-close closeColor"></i></button>';
                        divTmp += '</div>';
                        divTmp += '</div>';
                        divTmp += '</div>';
                        divTmp += '</div>';
        ...
        function saveBill() {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data['error'] == 0) {
                        //myAlert('s', data['message']);
                        loadPrintTemplateForPortablePos(data['invoiceID']);
        ...
        function prepareforDoubleEntry(warehouseID, counterID) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data['error'] == 0) {
                        myAlert('s', data['message']);
                        loadPrintTemplateForPortablePos();
                    } else {
                        myAlert('d', data['message']);
                    }
                },
