...
<link href="<?php echo base_url('plugins/datatables/buttons.dataTables.min.css'); ?>" rel="stylesheet">
...
<!--data table export-->
<script type="text/javascript" src="<?php echo base_url('plugins/datatables/dataTables.buttons.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo base_url('plugins/datatables/jszip.min.js'); ?>"></script>
<script type="text/javascript" src="<?php echo base_url('plugins/datatables/buttons.html5.min.js'); ?>"></script>
        ...
        oTable = $('#customer_table').DataTable({
            ...
            buttons: [
               // 'excelHtml5',
                {
                    extend: 'excelHtml5',
                    text: '<span><i class="fa fa-file-excel-o" aria-hidden="true"></i> Excel</span>',
                    className:'btn-data-excel',
                    title: null,
                    exportOptions: {
                        modifier: {
                            page: 'All',
