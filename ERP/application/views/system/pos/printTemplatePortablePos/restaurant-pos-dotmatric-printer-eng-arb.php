        ...
        <div class="myCustomPrint" style="margin:0 92px 0 -19px;width:123px;">
            ...
            <table border="0" style="width:100%" class="f fSize fWidth">
                ...
                <tr>
                    ...
                    <td style="width:20%;font-size: 8px !important; "><?php echo $this->lang->line('posr_inv_no'); ?> <!--Inv. No-->: رقم الفاتورة
                    </td>
                ...
                <tr>
                    <td style="text-align: left;font-size: 8px !important;"><?php echo $this->lang->line('common_date'); ?> : <!--Date--> التاريخ

                    </td>
                    <td style="font-size: 8px !important;"> <?php echo date('d/m/Y&\nb\sp;&\nb\sp;&\nb\sp;&\nb\sp;&\nb\sp;&\nb\sp;&\nb\sp;&\nb\sp;g:i A', strtotime($masters['createdDateTime'])) ?></td>
                </tr>

                <tr>
                    <td style="text-align: left;font-size: 8px !important;">Name : الإسم</td>
                    <?php
                    $menusalescust = '';
                    ...
                    if (!empty($deliveryInfo)) {
                        ?>
                        <td style="width:30%;font-size: 8px !important;"><?php echo !empty($deliveryInfo) ? $deliveryInfo['CustomerName'] : '-'; ?></td>
                        <?php
                    } elseif (!empty($masters['cusname'])) {
                        ?>
                        <td style="width:30%;font-size: 8px !important;"><?php echo $masters['cusname'] ?></td>
                        <?php
                    } elseif (!empty($menusalescust)) {
                        ?>
                        <td style="width:30%;font-size: 8px !important;"><?php echo $menusalescust['CustomerName'] ?></td>
                        <?php
                    } else {
                        ?>
                        <td style="width:30%;font-size: 8px !important;">Cash</td>
                        <?php
                    }
                    ?>
                </tr>
                <tr>
                    ...
                    if (!empty($deliveryInfo)) {
                        ?>
                        <td style="width:30%;font-size: 8px !important;"><?php echo !empty($deliveryInfo) ? $deliveryInfo['phoneNo'] : '-'; ?></td>
                        <?php
                    } elseif (!empty($masters['custel'])) {
                        ?>
                        <td style="width:30%;font-size: 8px !important;"><?php echo $masters['custel']; ?></td>
                        <?php
                    } elseif (!empty($menusalescust)) {
                        ?>
                        <td style="width:30%;font-size: 8px !important;"><?php echo $menusalescust['customerTelephone'] ?></td>
                        <?php
                    } else {
                        ?>
                        <td style="width:30%;font-size: 8px !important;">-</td>
                        <?php
                    }
                    ?>
                </tr>
            ...
            <table cellspacing="0" border="0" style="width:100%" class="f fWidth" id="tblListItems">
                <tr>
                    <td style="width:20%; text-align: left;"> Item | وصف</td>
                ...
                <tr>
                    <td colspan="2" style="text-align:left; font-weight:bold; padding-top:1px;font-size:8px !important;">
                        ...
                        if ($delivery) {
                            ...
                            $paidByAmount = $masters['cashReceivedAmount'];
                    ...
                    <td colspan="2"
                        ...
                        //echo number_format(abs($totalPaid), $d);
                        //$paidByAmount = $totalPaid;
                        //echo number_format(abs($paidByAmount), $d);
                        // echo number_format(abs($totalPaid), $d);
                ...
                <tr>
                    <td colspan="2" style="text-align:left; font-weight:bold; padding-top:1px;font-size:8px !important;">
                        ...
                        if ($isConfirmedDelivery) {
                            ...
                            $balanceAmount = $netTotal - $paidByAmount;
