...
<table id="itemTable" width="370px" border="0">
    ...
    foreach($invItems as $key=>$item){
      ...
      <tr>
        ...
        <td align="right">'.number_format($item['price']-$discount, $dPlace).'</td>
      </tr>';
    }
    ?>
    <tr>
        <td colspan="6" id="itemBreak">&nbsp;</td>
    </tr>
    <tr>
        <td colspan="5" class="lastTD">SUB TOTAL</td>
        <td class="lastTD" align="right"><?php echo number_format($invMaster['subTotal'], $dPlace) ?></td>
    </tr>
    <tr>
        <td colspan="5" class="lastTD">DISCOUNT</td>
    ...
    <tr>
        <td colspan="5" class="lastTD">NET TOTAL</td>
