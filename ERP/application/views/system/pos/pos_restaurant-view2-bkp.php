...
<div id="form_div" style="padding: 1%; margin-top: 40px">
    ...
    <div class="row" style="margin-top: 0px;">
            ...
            <div class="panel panel-default" style="border: 1px solid #ddd;">
                <div class="panel-body tabs" style="padding:3px;">
                    <div style="padding: 0px 0px 0px 15px;">
                        <button id="backToCategoryBtn" data-toggle="tab" class="btn btn-lg btn-default btnCategoryTab"
                                tabindex="-1"
                    ...
                    <div style="margin: 0px 0px 0px 15px;">
                        <div class="tab-content" style="overflow: scroll; height: 400px;" id="allProd">
                            <div class="tab-pane fade in active" id="pilltabCategory">
                                <!--<button type="button" tabindex="-1" data-toggle="tab" href="#pilltabAll"
                                        class="btn btn-default itemButton">
                                        <span id="proname">
                                            All
                                        </span>
                                </button>-->
                                                ...
                                                <span id="proname">
                                                        ...
                                                        if (!empty($menu['sizeDescription'])) {
                                                            if (!empty($menu['colourCode'])) {
                                                                ...
                                                                echo '<br/><h6><span style="background-color:' . $menu['bgColor'] . '; " class="label label-default">' . $menu['sizeDescription'] . '</span></h6>';
        ...
        <div class="col-md-5" style="padding-right: 0px;">
            ...
            <div style="overflow: scroll; height: 255px; width: 100%;">
        ...
        <div class="col-md-1">
            ...
            <div class="mainBtnList">
                <button type="button" class="btn btn-block btn-lg btn-default" onclick="open_void_Modal()">
