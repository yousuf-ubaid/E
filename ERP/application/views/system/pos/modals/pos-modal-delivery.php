    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <form class="form-horizontal" id="delivery_order">
                        ...
                        <input type="hidden" name="delivery_menuSalesMasterID" id="delivery_menuSalesMasterID" value="0">
                        <input type="hidden" name="delivery_wareHouseAutoID" id="delivery_wareHouseAutoID" value="0">
                        <fieldset>
            ...
            <div class="modal-footer" style="margin-top: 0px;">
                <?php  if($smsAllowed==1){ ?>
                <button class="btn btn-lg btn-default" id="delivery_sms_btn" style="display: none;" type="button"
                        onclick="delivery_dispatchOrder_sms()">
...
<script>
                        ...
                        if (data['error'] == 0) {
                           ...
                           // resetPayTypeBtn();
                            ...
                            if(<?php echo $smsAllowed ?> == 1){
                                send_rpos_dispatched_sms_chk_cus(data['menuSalesID'],data['wareHouseAutoID']);
    ...
    function print_delivery_order_payments() {
        ...
        if (invoiceID > 0) {
            $.ajax({
                ...
                data: {menuSalesID: invoiceID, outletID: outletID},
                cache: false,
                beforeSend: function () {
                    startLoad();
                },
    ...
    function load_delivery_info() {
        ...
        var invoiceID = $("#holdInvoiceID_input").val();
        $("#delivery_menuSalesMasterID").val('');
        $("#delivery_wareHouseAutoID").val('');
        if (invoiceID > 0) {
            $.ajax({
                async: true,
                type: 'post',
                ...
                success: function (data) {
                    ...
                    if (data['error'] == 0) {
                        ...
                        $("#delivery_wareHouseAutoID").val(data['wareHouseAutoID']);
                    }
    ...
    function confirm_delivery_order() {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: {phone:phone},
            url: "<?php echo site_url('Pos_delivery/get_delivery_customer_details'); ?>",
            beforeSend: function () {

            },
            success: function (data) {
                if(data!=null){
                    if(data.CustomerAddress1!=""){
                        $("#delivery_CustomerAddress1").val(data.CustomerAddress1);
                    }
                }
            }, error: function () {
    ...
    function send_rpos_dispatched_sms_chk_cus(menuSalesID,wareHouseAutoID) {
        $.ajax({
            async: true,
            type: 'post',
            dataType: 'json',
            data: {menuSalesID: menuSalesID,wareHouseAutoID: wareHouseAutoID},
            url: "<?php echo site_url('Sendsms/send_rpos_dispatched_sms_chk_cus'); ?>",
            beforeSend: function () {
                ...
                if(data[0]==true) {
                    ...
                    bootbox.confirm({
                        ...
                        callback: function (result) {
                            if(result==true){
                                send_rpos_dispatched_sms(menuSalesID, wareHouseAutoID);
                            }
                        }
                    });
                }
    ...
    function send_rpos_dispatched_sms(menuSalesID,wareHouseAutoID) {
        $.ajax({
            async: true,
            type: 'post',
            dataType: 'json',
            data: {menuSalesID: menuSalesID,wareHouseAutoID: wareHouseAutoID},
            url: "<?php echo site_url('Sendsms/send_rpos_dispatched_sms'); ?>",
            beforeSend: function () {
    ...
    function delivery_dispatchOrder_sms() {
        send_rpos_dispatched_sms_chk_cus($('#delivery_menuSalesMasterID').val(),$('#delivery_wareHouseAutoID').val())
    }

    $("#delivery_phone").focusout(function(){
        var phone=$("#delivery_phone").val();
        $.ajax({
            async: true,
            type: 'post',
