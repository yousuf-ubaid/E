...
$this->load->view('include/top-posr-new');
...
<?php $this->load->view('include/navigation_rpos', 'POS'); ?>
<div id="form_div" style="padding: 1%; margin-top: -75px;background-color: #f6ebf7;">

    <div class="row" style="margin-top: 0px;">

        <div class="col-md-11 mid-main-column">
            <div class="row">
                <div class="col-md-12">
                            ...
                            <div class="order-type-btn-group">
                                <div class="btn-group btn-group-lg" style="width: 100%;">
                                    ...
                                    ?>
                                        ...
                                        <div class="buttonCustomerType customerType <?php if ($val['isDefault'] == 1) {
                                                                                        $defaultID = $val['customerTypeID'];
                                                                                        $isDelivery = $val['isThirdPartyDelivery'];
                                                                                        $isDineIn = $val['isDineIn'];
                                                                                        echo 'btn-custype-selected';
                                                                                        //echo 'btn-default';
                                                                                    } else {
                                                                                        echo 'btn-default';
                                                                                    }
                                                                                    ?> info-item-cover" data-val="<?php echo $val['customerDescription'] ?>" onclick="updateCustomerTypeBtn(<?php echo $val['customerTypeID']; ?>,<?php echo $val['isThirdPartyDelivery'] ?>,<?php echo $val['isDineIn'] ?>)">
                                            <div class="info-item-img">
                                                <i><img src="<?php echo base_url('images/pos/' . $val['imageName']) ?>" alt="Icon"></i>
                                            </div>
                                            <div class="info-item-body">
                                                <p id="customerTypeID_<?php echo $val['customerTypeID']; ?>"><?php echo $val['displayDescription']; ?></p>
                                            </div>
                                        </div>
                                    <?php }
            ...
            <div class="row">
                <div class="col-md-6">
                    <div>
                        <div style="padding: 0px 0px 0px 15px;margin-top: 7px;margin-bottom: 7px;">
                            <button id="backToCategoryBtn" style="padding: 6px;" data-toggle="tab" class="btn btn-lg btn-default btnCategoryTab" tabindex="-1" href="#pilltabCategory">
                            ...
                            for ($i = 0; $i < 10; $i++) {
                            ?>
                                <button style="padding: 10px 14px;" onclick="updateQty_invoice(this)" class="btn btn-lg btn-primary fSizeBtn">
                                    <?php echo $i; ?>
                                </button>
                            <?php
                            }
                            ...
                            <button rel="tooltip" style="    padding: 11px 12px 9px 13px; font-weight: 600;" title="clear" onclick="updateQty_invoice(this)" class="btn btn-lg btn-default fSizeBtn">C
                            </button>
                            <button id="backToCategoryBtn" onclick="go_one_step_back_category()" style="padding: 6px;" data-toggle="tab" class="btn btn-lg btn-default btnCategoryTab">
                        ...
                        <div class="row" style="margin-left: 0px; margin-right: 0px;">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="padding-left: 15px; padding-top: 10px;">
                                <input type="text" class="form-control search-input" placeholder="Press 'F2' or 'Ctrl+F' to Search" id="searchProd" style="border-radius: 0.25rem !important;">
                            </div>

                            <!-- BARCODE READER  -->
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="padding-top: 10px;">
                                <input type="text" class="form-control search-input" placeholder="Barcode (shortcut F3)" id="barcodeInput" style="border-radius: 0.25rem !important;">
                            </div>
                        </div>
                    </div>

                    <div class="panel panel-default" style="border: 1px solid #ddd;margin-top: 15px;">
                        <div style="    padding: 5px 0px;">
                            <button onclick="menusize_dialog()" style="right: 42px;position: absolute;z-index: 999;"><span class="glyphicon glyphicon-menu-hamburger" aria-hidden="true"></span>
                            </button>
                        </div>
                        <div id="menusize_dialog" class="menusize_dialog" style="display: none;">
                            <button type="button" onclick="POS_SizeMax()" style="font-weight: bold;" class="btn btn-default btn-lg buttonDefaultSize">&nbsp;+&nbsp;
                            </button>
                            <input type="hidden" id="currentSize" value="">
                            <button type="button" onclick="POS_SizeMin()" style="font-weight: bold;" class="btn btn-default btn-lg buttonDefaultSize">&nbsp;-&nbsp;
                            </button>
                            ...
                            <div class="btn-group">
                                ...
                                if ($cctv) {
                                ?>
                                    <button type="button" onclick="open_cctv_modal();" class="btn btn-default btn-lg buttonDefaultSize" style="width: 121px;">
                        ...
                        <div class="panel-body tabs" style="padding:3px;">
                            ...
                            <div style="margin: 0px 0px 0px 15px;">
                                <div class="tab-content dynamicSizeCategory" style="overflow: scroll; height: 444px;" id="allProd">
                        ...
                        function POS_SendToKitchen() {
                            ...
                            if ($("#holdInvoiceID").val()) {
                                $.ajax({
                                    ...
                                    data: {
                                        menuSalesID: $("#holdInvoiceID").val(),
                                        KOTStartDateTime: strTime
                                    },
                                    cache: false,
                                    beforeSend: function() {
                                        startLoad();
                ...
                <div class="col-md-6" style="">
                    <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-5 col-lg-5">
                            <input type="hidden" id="pos_orderNo" value="<?php
                                                                            ...
                                                                            ?>">
                            <button class="btn btn-sm btn-default btn-block order-number-div" style="border-radius: 0px;font-size: 16px;">
                                Order : <span id="pos_salesInvoiceID_btn">
                                    <span>
                                        <?php
                                        $new = $this->lang->line('common_new');
                                        $invoiceID = isPos_invoiceSessionExist();
                            ...
                            <button class="btn btn-sm btn-primary btn-block" style="border-radius: 0px; display: none; " id="deliveryDateDiv">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                            ...
                            if ($pinBasedAccess) {
                                if ($isScreenLockButtonEnabled) {
                                    echo ' <button type="button" class="btn btn-primary btn-lg buttonDefaultSize" style="width: 105px;margin: 0px !important;height: 60px !important;border-radius: 6px !important;padding-left: 9px;"
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-2 col-lg-2">
                            ...
                            if ($showStaffButton) {
                                echo ' <button type="button" class="btn btn-warning btn-lg buttonDefaultSize" style="width: 105px;margin: 0px !important;height: 60px !important;border-radius: 6px !important;"
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3">
                            ...
                            ?>
                                <button type="button" <?php echo $kot_js ?> class="btn btn-lg btn-danger btnKot" style="width: 100%;" id="btn_pos_sendtokitchen"><i class="fa fa-cutlery" aria-hidden="true"></i>
                                    <br>Send
                                    KOT
                                </button>
                            <?php } ?>
                    ...
                    <div class="productCls">
                        <div class="row">
                            <div class="col-md-3 col-sm-2">
                                ...
                                <button class="btn btn-default btn-lg" type="button" id="table_order_btn"><i class="fa fa-life-ring"></i> <span id="current_table_description">Table</span>
                                </button>

                            </div>
                            <div class="col-md-9">
                                <div class="receiptPaddingHead">
                                    <?php echo $this->lang->line('posr_qyt'); ?>
                                    <!--Qty-->
                                </div>
                                <div class="receiptPaddingHead">@
                                    <?php echo $this->lang->line('posr_rate'); ?>
                                    <!--rate-->
                                </div>
                                <div class="receiptPaddingHead">
                                ...
                                <div class="receiptPaddingHead <?php echo $discountPolicy ? '' : 'hide' ?>"><?php echo $this->lang->line('posr_dist'); ?>
                                    .<br />
                                    <!--Dist-->%
                                </div>
                                <div class="receiptPaddingHead <?php echo $discountPolicy ? '' : 'hide' ?>">
                                    <?php echo $this->lang->line('posr_dist'); ?>
                                    <!--Dis-->
                                    .<br /><?php echo $this->lang->line('common_amount'); ?>
                                    <!--Amt-->.
                                </div>
                                <div class="receiptPaddingHead">
                                    <?php echo $this->lang->line('posr_net'); ?>
                                    <!--Net--><br />
                                    <?php echo $this->lang->line('common_total'); ?>
                                    <!--Total-->
                                </div>
                    ...
                    <div style="overflow-y: auto; max-height: 353px; width: 100%;min-height: 201px;background-color: white;padding: 0 5px;" class="dynamicSizeItemList">
                    ...
                    <form class="form_pos_receipt" method="post">
                        <div class="itemListContainer posFooterBgColor">
                            ...
                            <div class="row itemListFoot">
                                <div class="col-md-4"><span class="posFooterTxtLg"><?php echo $this->lang->line('posr_total_item'); ?>
                                        <!--Total Items--> : <span id="total_item_qty" class="posFooterTxtLg">0</span>
                                    </span>
                                </div>

                                <div class="col-md-5 ar">
                                    <input type="hidden" id="total_item_qty_input" name="total_item_qty_input" />
                                    <?php echo $this->lang->line('posr_total_amount'); ?>
                                    <!--Gross Total-->
                                    :
                                </div>
                                <div class="col-md-3 ar">
                                    <div id="gross_total">0</div>
                                    <input type="hidden" id="gross_total_amount_input" name="gross_total_amount_input" value="0" />
                            ...
                            <div class="row itemListFoot <?php if ($templateID == 2 || $templateID == 3) {
                                ...
                                <div class="col-md-3 ar">
                                    <?php echo $this->lang->line('posr_total_tax'); ?>
                                    <!--Total Tax -->
                                </div>
                            ...
                            <div class="row itemListFoot <?php if ($templateID == 2 || $templateID == 4) {
                                ...
                                <div class="col-md-5 ar">
                                    <?php echo $this->lang->line('posr_service_charge'); ?>
                                    <!--Service Charge--> :
                                </div>
                                <div class="col-md-3 ar" style="padding-bottom: 5px;">
                            ...
                            <div class="row itemListFoot">
                                ...
                                <div class="col-md-5 ar">
                                    <?php echo $this->lang->line('posr_discount'); ?>
                                    <!--Discount--> % :
                                    <input maxlength="6" class="numpad" onchange="updateDiscountPers()" type="text" style="color: black; width: 45px; font-weight: 800; text-align: right;" name="discount_percentage" id="dis_amt" value="0" readonly>
                                </div>

                                <div class="col-md-3 ar" style="border-bottom: 0px solid #ffffff; padding-bottom: 5px;">
                                    <div class="hide" id="total_discount">0.00</div>
                                    <input type="text" class="numpad" id="discountAmountFooter" onchange="backCalculateDiscount()" style="width: 100%; text-align: right; font-weight: 700; color:#2E2E2E;" value="" placeholder="0.00">
        ...
        <div class="col-xs-12 col-sm-12 col-md-1 col-lg-1" style="padding-right: 5px; padding-left: 5px;background-color: #f6ebf7;padding-top: 19px;">
            <div class="row">
                <?php
                ...
                <?php if ($isPowerButtonEnabled) { ?>
                    <div class="col-xs-3 col-sm-2 col-md-12 col-lg-12 action-items-cover">
                        <button type="button" class="btn btn-block btn-lg btn-default action-item" onclick="clickPowerOff()">

                            <figure>
                                <i><img src="<?php echo base_url('images/pos/action-icon-01.png') ?>" alt="Icon"></i>
                            </figure>
                            <figcaption><?php echo $this->lang->line('posr_power'); ?></figcaption>
                ...
                <?php if ($isOpenButtonEnabled) { ?>
                    <div class="col-xs-3 col-sm-2 col-md-12 col-lg-12 action-items-cover">
                        <button type="button" class="btn btn-block btn-lg btn-default action-item" rel="tooltip" title="short cut  Ctrl+O " onclick="open_holdReceipt()">
                            <figure>
                                <span id="wowfood_count" class="badge" style="background-color: red;color: white;vertical-align: sub;">-</span>
                                <i style="display: inline-block;"><img src="<?php echo base_url('images/pos/action-icon-02.png') ?>" alt="Icon"></i>
                            </figure>
                            <figcaption><?php echo $this->lang->line('posr_open'); ?>
                                <!--Open-->
                        </button>
                    </div>
                <?php } ?>
                ...
                <?php if ($isPayButtonEnabled) { ?>
                    <div class="col-xs-3 col-sm-2 col-md-12 col-lg-12 action-items-cover">
                        <button class="btn btn-block btn-lg action-item btn-disable-when-load" onclick="open_pos_payments_modal()">
                            <figure>
                                <i><img src="<?php echo base_url('images/pos/action-icon-03.png') ?>" alt="Icon"></i>
                            </figure>
                            <figcaption><?php echo $this->lang->line('common_pay'); ?>
                                <!--Pay--> (F1)
                            </figcaption>
                        </button>
                    </div>
                ...
                ?>
                    <?php if ($isPrintSampleButtonEnabled) { ?>
                        <div class="col-xs-3 col-sm-2 col-md-12 col-lg-12 action-items-cover">
                            <button type="button" onclick="print_sample_bill()" class="btn btn-block btn-lg btn-default action-item" style="padding: 3px 0">
                                <figure>
                                    <i><img src="<?php echo base_url('images/pos/action-icon-04.png') ?>" alt="Icon"></i>
                                </figure>
                                <figcaption>Print Sample</figcaption>
                            </button>
                        </div>
                    <?php } ?>
                <?php
                ...
                ?>
                    <div class="col-xs-3 col-sm-2 col-md-12 col-lg-12 action-items-cover">
                        <button type="button" onclick="split_bill_dialog()" class="btn btn-block btn-lg btn-default action-item" style="padding: 3px 0">
                            <figure>
                                <i><img src="<?php echo base_url('images/pos/action-icon-04.png') ?>" alt="Icon"></i>
                            </figure>
                            <figcaption>Split Bill</figcaption>
                        </button>
                    </div>
                <?php
                }
                ...
                <?php if ($isHoldButtonEnabled) { ?>
                    <div class="col-xs-3 col-sm-2 col-md-12 col-lg-12 action-items-cover">
                        <button class="btn btn-block btn-lg action-item" rel="tooltip" title="short cut  Ctrl+S " onclick="holdReceipt();">
                            <figure>
                                <i><img src="<?php echo base_url('images/pos/action-icon-05.png') ?>" alt="Icon"></i>
                            </figure>
                            <figcaption><?php echo $this->lang->line('posr_hold'); ?>
                                <!--Hold-->
                            </figcaption>
                ...
                <?php if ($isCancelButtonEnabled) { ?>
                    <div class="col-xs-3 col-sm-2 col-md-12 col-lg-12 action-items-cover">
                        <button class="btn btn-lg btn-block action-item" onclick="checkPosAuthentication(9)">
                            <figure>
                                <i><img src="<?php echo base_url('images/pos/action-icon-06.png') ?>" alt="Icon"></i>
                            </figure>
                            <figcaption><?php echo $this->lang->line('common_cancel'); ?>
                                <!--Cancel-->
                            </figcaption>
                ...
                <?php if ($isKitchenButtonEnabled) { ?>
                    <div class="col-xs-3 col-sm-2 col-md-12 col-lg-12 action-items-cover" id="btn_kitchenModal">
                        <button type="button" class="btn btn-block btn-lg btn-default action-item" rel="tooltip" title="" onclick="open_kitchen_ready()">
                            <figure>
                                <i><img src="<?php echo base_url('images/pos/action-icon-07.png') ?>" alt="Icon"></i>
                            </figure>
                            <figcaption><?php echo $this->lang->line('posr_kitchen'); ?>
                                <!--Kitchen-->
                            </figcaption>
                ...
                <?php if ($isGiftCardButtonEnabled) { ?>
                    <div class="col-xs-3 col-sm-2 col-md-12 col-lg-12 action-items-cover" id="btn_kitchenModal">
                        <button type="button" class="btn btn-block btn-lg btn-default action-item" rel="tooltip" title="" onclick="open_giftCardModal()">
                            <figure>
                                <i><img src="<?php echo base_url('images/pos/action-icon-08.png') ?>" alt="Icon"></i>
                            </figure>
                ...
                <?php if ($isClosedBillsButtonEnabled) { ?>
                    <div class="col-xs-3 col-sm-2 col-md-12 col-lg-12 action-items-cover">
                        <button type="button" class="btn btn-block btn-lg btn-default action-item" onclick="open_void_Modal()">
                            <figure>
                                <i><img src="<?php echo base_url('images/pos/action-icon-08.png') ?>" alt="Icon"></i>
                            </figure>
                            <figcaption><?php echo $this->lang->line('common_closed'); ?>
                                <!--Closed-->
                                <?php echo $this->lang->line('posr_bills'); ?>
                                <!--Bills-->
                            </figcaption>
                        </button>
                    </div>
...
<div class="modal fade" id="split_bill_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-md" role="document" style="width: 19%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="show_splitted_bill()"><?php echo $this->lang->line('common_ok'); ?></button>
                <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo $this->lang->line('common_Close'); ?> </button>
            </div>
        </div>
    </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        ?>
                                ...
                                <div class="col-md-4">
                                    <input type="button" class="btn btn-default waiterBtn" style="width: 100%;margin: 5px 0;height: 64px;" data-emp_id="<?php echo $waiter['crewMemberID']; ?>" onclick="markThisWaiterAsSelectedFromTerminal.call(this)" value="<?php echo $waiter['crewFirstName']; ?>" />
                    ...
                    <div>
                        <div style="    margin-left: 10%;">
                            <ul style="    width: 352px;padding: 0px;">
                                ...
                                <li class="num-button">
                                    <button class="btn btn-default" style="    font-size: 32px;" onclick="customNumpadClear()">Clear</button>
                                </li>
                                <li class="num-button">
                                    <button class="btn btn-default" onclick="customNumpadClick(0)">0</button>
                                </li>
                                <li class="num-button">
                                    <button class="btn btn-success" style="    font-size: 32px;" onclick="unlockButtonClick()">Enter</button>
                                </li>
                            </ul>
                        </div>
                    </div>
...
<a href="javascript:;" id="return-top" class="return-top" style="display: inline;"><span><img src="<?php echo base_url('images/pos/up-icon.svg') ?>" alt="Up"></span></a>
<?php
$data['notFixed'] = true;
...
<script type="text/javascript" src="<?php echo base_url('plugins/virtual-keyboard-mlkeyboard/jquery.ml-keyboard.js') ?>"></script>
...
<script type="text/javascript">
    ...
    function homeScreenCustomerTypeSetup(id, isDelivery) {
        if (isDelivery == 1) {
            openDeliveryModal();
            $(".deliveryRow").show();
            if ($("#owdAllowed").val() == 1) {
    ...
    $(document).on('ready', function() {
        ...
        //$('.sidebar-mini').addClass('sidebar-collapse');
        let cusType = localStorage.getItem('cusType');
        let isDelivery = localStorage.getItem('isDelivery');
        let isHomeRedirect = localStorage.getItem('isHomeRedirect');
        let buttonID = localStorage.getItem('buttonID');

        if (isHomeRedirect == '1') {
            homeScreenCustomerTypeSetup(cusType, isDelivery);
            localStorage.setItem('isHomeRedirect', '0');
            localStorage.setItem('cusType', '');
            localStorage.setItem('isDelivery', '');
            if (buttonID == 'receipt') {
        ...
        setTimeout(function() {
            ...
            $(".dynamicSizeCategory").css("height", ($(window).height() * (55 / 100)) + 'px');
        ...
        <?php } ?>
        loadCountryDetail();
        //$("#menubar-toggle-btn").trigger('click');
            ...
            success: function(data) {
                ...
                if (data['error'] == 1) {
                    ...
                    if (!jQuery.isEmptyObject(data['insuf'])) {
                        ...
                        $("#insufficientItemPOSRSingle").modal({
                            backdrop: "static"
                        });
                    }
                }
    ...
    function apply_outlet_tax_to_net_value(total_netAmount) {
        ...
        return {
            updated_net_value: total_netAmount,
            calculated_tax_amount: total_of_calculated_amounts
        };
    }
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data['error'] == 0) {
                    ...
                    if (parseInt(data['master']['isOrderPending'])) {
                        /*check order is pending and change the send to kitchen button color*/
                        $('#btn_pos_sendtokitchen').removeClass('btn-danger');
                        $('#btn_pos_sendtokitchen').addClass('btn-success');
    ...
    function deleteDiv(id) {
        $.ajax({
            ...
            data: {
                id: id,
                outletID: $("#holdOutletID_input").val()
            },
            cache: false,
            beforeSend: function() {
                numberOfRequest++;
    ...
    function clearSalesInvoiceUpdate() {
        setTimeout(function() {
            clearInvoice();
            clearPosInvoiceSession();
            $("#pos_salesInvoiceID_btnUpdate").html('<span class="label label-danger">New</span>');
    ...
    function saveBill() {
        ...
        formData.push({
            'name': 'own_delivery_setup',
            'value': own_delivery_setup
        });
        formData.push({
            'name': 'own_delivery_person',
            'value': own_delivery_person
        });
        formData.push({
            'name': 'own_delivery_percentage',
            'value': own_delivery_percentage
        });
        formData.push({
            'name': 'own_delivery_amount',
            'value': own_delivery_amount
        });
        formData.push({
            'name': 'isOwnDelivery',
            'value': isOwnDelivery
    ...
    function menusize_dialog() {
        $("#menusize_dialog").toggle();
    }

    function LoadHome() {
        window.location.href = "<?php echo site_url("restaurant/home"); ?>";
    }

    $("#pos_open_void_receipt").on("hidden.bs.modal", function() {
        if (localStorage.getItem('isHomeRedirect') == '1') {
            if ($('#pos_open_void_receipt').is(':visible') == false) {
                localStorage.setItem('isHomeRedirect', '0');
                window.location.href = "<?php echo site_url("restaurant/home"); ?>";
            }
        }
    ...
    $("#pos_open_kitchenStatus").on("hidden.bs.modal", function() {
        if (localStorage.getItem('isHomeRedirect') == '1') {
            if ($('#pos_open_kitchenStatus').is(':visible') == false) {
                localStorage.setItem('isHomeRedirect', '0');
                window.location.href = "<?php echo site_url("restaurant/home"); ?>";
            }
        }
    ...
    $("#pos_open_hold_receipt button[class='close closeTouchPad']").click(function() {
        if (localStorage.getItem('isHomeRedirect') == '1') {
            localStorage.setItem('isHomeRedirect', '0');
            window.location.href = "<?php echo site_url("restaurant/home"); ?>";
        }
    ...
    function markThisWaiterAsSelected(crewMemberID, crewFirstName) {
        ...
        if (menuSalesId != "") {
            ...
            $.ajax({
                ...
                data: {
                    menuSalesId: menuSalesId,
                    waiterId: terminalGlobalVariables.selectedWaiter
                },
                cache: false,
                beforeSend: function() {
                    startLoad();
