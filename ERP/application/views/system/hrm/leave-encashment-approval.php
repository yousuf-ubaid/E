...
$title = $this->lang->line('hrms_leave_management_leave_encashment_salary_approval');
...
<div class="row">
    ...
    <div class="col-md-3 text-center">
        <?php echo form_dropdown('approvedYN', $status_arr, '','class="form-control" id="approvedYN" required onchange="leave_encashment_table()"'); ?>
    </div>
</div>
<hr>
<div class="table-responsive">
    <table id="leave_encashment_master_table" class="<?php echo table_class() ?>">
        <thead>
        <tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function(){
            fetchPage('system/hrm/leave-encashment-approval','','HRMS');
        });

        leave_encashment_table();
    ...
    function leave_encashment_table(selectedID=null) {
        sal_advance_tb = $('#leave_encashment_master_table').DataTable({
            "language": {
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Employee/fetch_leave_encashment_on_approval'); ?>",
            "aaSorting": [[1, 'desc']],
    ...
    function load_approvalView(id, level, isApproved){
        ...
        $.ajax({
            ...
            success: function (data) {
                stopLoad();
                var doc_title = (data['doc_type'] == 1)? '<?=$this->lang->line('hrms_leave_management_leave_encashment_approval')?>': '<?=$this->lang->line('hrms_leave_management_leave_salary_approval')?>';
...
<div class="modal fade" id="leave_encashment_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document" style="width: 80%;">
        <div class="modal-content">
            ...
            <form class="form-horizontal" id="leave_encashment_form">
