...
$title = $this->lang->line('hrms_payroll_non_payroll_aprov');
        ...
        <div class="col-md-5">
            <table class="<?php echo table_class(); ?>">
                ...
                <tr>
                    ...
                    <td>
                        <span class="label label-warning" style="padding: 0px 5px ;font-size: 100%;">&nbsp;</span> <?php echo $this->lang->line('common_refer_back');?><!--Referred-back-->
                    </td>
                </tr>
                </tbody>
            </table>
    ...
    <div class="table-responsive">
        <table id="payroll_table_approval" class="<?php echo table_class(); ?>">
            ...
            <tr>
                ...
                <th style="min-width: 15%"><?php echo $this->lang->line('hrms_payroll_decu_code');?> <!--Document Code--></th>
    ...
    <div class="modal-dialog modal-lg" role="document" style="width: 90%">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('hrms_payroll_approval');?><!--Payroll Approval--> <span id="pay-sheet-month"> </span></h4>
            </div>
            <form class="form-horizontal" id="payroll_approval_form">
                <div class="modal-body">
                    ...
                    <div class="pull-right">
                        ...
                        <a class="btn btn-default btn-sm" id="payrollAccountReview" target="_blank" href="" style="">
                            <span class="glyphicon glyphicon-random" aria-hidden="true"></span> &nbsp;&nbsp;&nbsp;<?php echo $this->lang->line('hrms_payroll_account_review_ent');?><!--Account Review Entries--> </a>
                    </span>
                    </div>
                ...
                <div class="modal-footer">
                    <input type="hidden" name="isNonPayroll" value="Y" />
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.headerclose').click(function(){
            fetchPage('system/hrm/non_payroll_approval','','HRMS');
        });
    ...
    function payroll_table_approval(){
        var Otable = $('#payroll_table_approval').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Template_paysheet/fetch_non_paySheets_conformation'); ?>",
            "aaSorting": [[1, 'desc']],
    ...
    function load_paysheetApproval(payrollID , approvalLevel, payMonth, payrollCode,appYN){
        ...
        $.ajax({
            ...
            data: {'hidden_payrollID': payrollID, 'from_approval':'Y', 'isNonPayroll' :'Y'},
            dataType: 'html',
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
                ...
                $('#payrollAccountReview').attr('href', printUrl+'/' + payrollID + '/Y/' + payrollCode + '-' + payMonth);
