...
$title = $this->lang->line('hrms_payroll_split_salary_approval');
...
<div class="table-responsive">
    <table id="split_salary_table" class="<?php echo table_class() ?>">
        <thead>
        <tr>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('hrms_payroll_split_salary_approval');?><!--Split Salary Approval--></h4>
            </div>
                            ...
                            <div class="zx-tab-pane active" id="Tab-home-v">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="hidden" name="splitSalaryMasterID" id="splitSalaryMasterID">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/hrm/split_salary_approval', '', '<?php echo $this->lang->line('hrms_payroll_split_salary_approval'); ?>')
        });
        ...
        $('#po_approval_form').bootstrapValidator({
            ...
            fields: {
                ...
                splitSalaryMasterID: {validators: {notEmpty: {message: '<?php echo $this->lang->line('procurement_approval_purchase_order_id_is_required');?>.'}}},/*Purchase Order ID is required*/
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: data,
                url: "<?php echo site_url('Employee/save_split_salary_approval'); ?>",
                beforeSend: function () {
                    startLoad();
                },
    ...
    function split_salary_table() {
        Otable = $('#split_salary_table').DataTable({
            "language": {
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Employee/fetch_split_salary_approval'); ?>",
            "aaSorting": [[0, 'desc']],
            ...
            "columnDefs": [{"visible":true,"searchable": false,"targets": [0,5] }],
    ...
    function fetch_approval(splitSalaryMasterID, documentApprovedID, Level) {
        if (splitSalaryMasterID) {
            $.ajax({
                async: true,
                type: 'post',
                dataType: 'html',
                data: {'splitSalaryMasterID': splitSalaryMasterID, 'html': true,'approval':1},
                url: "<?php echo site_url('Employee/load_splitSalary_conformation'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
                    $('#splitSalaryMasterID').val(splitSalaryMasterID);
                    $('#documentApprovedID').val(documentApprovedID);
                    $('#Level').val(Level);
                    $("#purchase_order_modal").modal({backdrop: "static"});
                    $('#conform_body').html(data);
                    $('#comments').val('');
                    purchaseOrder_attachment_View_modal('SS',splitSalaryMasterID);
                    stopLoad();
                    refreshNotifications(true);
                }, error: function () {
                    stopLoad();
