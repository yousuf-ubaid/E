...
$title = $this->lang->line('hrms_contract_expiry_report');
...
$_POST['isContractRpt'] = 1; /* To get contract based employee only from the 'employee_list_by_segment' function  */
            ...
            <div class="col-sm-12">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" id="form-btn-group">
                    <button type="button" onclick="get_report(2)" class="btn btn-success btn-xs pull-right">
                        <i class="fa fa-file-excel-o"></i> <?php echo $this->lang->line('common_to_excel');?><!--To Excel-->
                    </button>
                    ...
                    <button type="button" class="btn btn-primary btn-xs pull-right" style="margin-right: 10px" onclick="get_report(0)" >
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function(){
            fetchPage('system/hrm/report/contract-renewal-report','','HRMS');
        });
    ...
    function get_report(returnType){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('Employee/contract_renewal_report') ?>",
            data: postData,
            dataType: "json",
            cache: false,
            beforeSend: function () {
    ...
    function print_btn() {
        ...
        form.target = '_blank';
        form.method = 'post';
        form.action = '<?php echo site_url('Employee/contract_renewal_report'); ?>/Print/Contract-Renewal-Report';
        form.submit();
    }
    ...
    function download_in_excel() {
        ...
        form.target = '_blank';
        form.method = 'post';
        form.action = '<?php echo site_url('Employee/contract_renewal_report_excel'); ?>/Contract-Renewal-Report';
        form.submit();
    }
