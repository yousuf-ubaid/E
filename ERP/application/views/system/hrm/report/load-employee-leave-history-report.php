...
if (!empty($details)) { ?>
    <div class="row" style="margin-top: 5px">
        <div class="col-md-12">
            ...
            if ($type == 'html') { ?>
                <div class="row" style="margin-top: 5px">
                    <div class="col-md-12">
                        <div class="pull-right"><button class="btn btn-pdf btn-xs" id="btn-pdf" type="button" onclick="generateReportPdf()">
                                <i class="fa fa-file-pdf-o" aria-hidden="true"></i> PDF
                            </button> <a href="" class="btn btn-excel btn-xs" id="btn-excel" download="Employee leave history.xls" onclick="var file = tableToExcel('leaveHistoryReport', 'Leave Report'); $(this).attr('href', file);">
    ...
    <div class="row" style="margin-top: 5px">
        <div class="col-md-12 " id="leaveHistoryReport">
...
?>
                            ...
                            ?>
                            <tr>
                                <td colspan="5" class="text-right"><b><?php echo $this->lang->line('common_remarks')?><!--Remarks-->Total Leaves </b></td>
