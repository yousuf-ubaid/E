        ...
        <div class="modal-content">
            ...
            <form role="form" id="monthlyDeductionMaster_form" class="form-horizontal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label class="col-sm-4 control-label" for="payrollType"><?php echo $this->lang->line('hrms_payroll_deduction_type');?><!--Payroll Type--> <?php required_mark(); ?></label>
                        <div class="col-sm-6">
...
<script type="text/javascript">
    ...
    $( document ).ready(function() {
        $('.headerclose').click(function(){
            fetchPage('system/hrm/monthly_salary_deduction','','HRMS');
        });
        ...
        $('#monthlyDeductionMaster_form').bootstrapValidator({
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: data,
                url: "<?php echo site_url('Employee/save_monthDeduction'); ?>",
                beforeSend: function () {
                    startLoad();
                },
