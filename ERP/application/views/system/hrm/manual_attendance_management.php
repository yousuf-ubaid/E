                    ...
                    <div class="table-responsive">
                        <table id="attendanceMasterTB" class="<?php echo table_class(); ?>">
                            ...
                            <tr>
                                ...
                                <th><?php echo $this->lang->line('hrms_attendance_attendance_time');?><!--Attendance Time--></th>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <!-- <div class="col-md-10 hide">
                        <div class="form-group">
                            <label class="control-label" for="category"><?php //echo //$this->lang->line('hrms_attendance_attendance_time');?> <?php //required_mark(); ?></label>
                            <div class="input-group bootstrap-timepicker timepicker">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>
                                <input id="attendanceTime" name="attendanceTime" type="text" class="form-control input-small">
                            </div>
                        </div>
                    </div> -->
                    <div class="col-md-12 row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label" for="category"><?php echo 'Departments'//$this->lang->line('hrms_attendance_attendance_time');?><!--Attendance Time--> <?php required_mark(); ?></label>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <?php echo form_dropdown('departments[]', $deparments, '', 'class="departments form-control" id="departments" multiple="multiple"'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label" for="category"><?php echo 'Location'//$this->lang->line('hrms_attendance_attendance_time');?><!--Attendance Time--> <?php required_mark(); ?></label>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <?php echo form_dropdown('floor', $floors_arr, '', 'class="floor form-control select2" id="floor"'); ?>
                                </div>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    function load_attendanceTB(selectedRowID=null){
        ...
        attMasterTB = $('#attendanceMasterTB').DataTable({
            ...
            "bDestroy": true,
            "StateSave": true,
            "sAjaxSource": "<?php echo site_url('Employee/fetch_attendance'); ?>",
            "aaSorting": [[3, 'asc']],
 ...
 /*   $('.table-row-select tbody').on('click', 'tr', function () {
    ...
    function open_attendanceDetailModalManualEmployee(attendance_master,$pageid){
        fetchPage('system/hrm/attendance_management_manual','Attendance Management','Attendance Management','',attendance_master,$pageid);
    }
