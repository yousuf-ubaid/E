...
$title = $this->lang->line('hrms_payroll_salary_declaration_approval');
...
<script type="text/javascript">
    ...
    function salaryDeclaration_table() {
         oTable = $('#salary_declaration_approval_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Employee/fetch_salary_declaration_approval'); ?>",
            "aaSorting": [[1, 'desc']],
    ...
    function fetch_approval(declarationMasterID, documentApprovedID, Level) {
        if (declarationMasterID) {
            $.ajax({
                ...
                type: 'post',
                dataType: 'html',
                data: {'declarationMasterID': declarationMasterID, 'html': true, isFromApproval:'Y'},
