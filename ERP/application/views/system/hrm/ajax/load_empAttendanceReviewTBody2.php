...
if (!empty($tempAttData)) {
    foreach ($tempAttData as $key => $row) {
        ...
        <tr data-code="<?php echo $datacode; ?>" style="white-space: nowrap;<?php echo $bg ?>"
            ...
            <td style="opacity: 100" class="fixed-td text-center">
                <?php echo $row['Ename2']; ?>
            ...
            <td class="fixed-td text-center"><span class="glyphicon glyphicon-trash" style="color:#c3331b;" onclick="removeTr(this)"></span></td>
        </tr>
        <?php
    }
} else {
