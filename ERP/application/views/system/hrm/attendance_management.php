...
<div class="nav-tabs-custom" style="margin-bottom: 0px; box-shadow: none;">
    <ul class="nav nav-tabs" style="border: 1px solid rgba(112, 107, 107, 0.21);">
        <li class="active"><a href="#attendanceTab" id="accountsTab" data-toggle="tab" aria-expanded="true">
                <?php echo $this->lang->line('hrms_attendance_attendance'); ?><!--Attendance--></a>
        </li>
        <li class=""><a href="#pullingTab" id="pulling" data-toggle="tab" aria-expanded="false">
                <?php echo $this->lang->line('hrms_attendance_pulling_data'); ?><!--Pulling Data--></a>
        </li>
        <li class=""><a href="#showdataTap" id="showdata" data-toggle="tab" aria-expanded="false"><?php echo $this->lang->line('hrms_showdata'); ?><!--Show Data--></a>
        </li>
    </ul>
    <div class="tab-content" style="border: 1px solid rgba(112, 107, 107, 0.21)">
                        ...
                        <tr>
                            <td>
                                <span class="label label-success"
                                      style="padding: 0px 5px ;font-size: 100%;">&nbsp;</span>
            ...
            <div class="row" style="">
                ...
                <div class="form-horizontal">
                    <div class="col-md-12">
                        ...
                        <label for="inputNumPedido" class="col-md-1 control-label" style="width: 80px;">
                            <?php echo $this->lang->line('hrms_attendance_as_of'); ?><!--As of--> </label>
                        <div class="col-md-2">
                            <div class="input-group">
                                <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                <input type="text" name="asOfDate" id="asOfDate" class="form-control dateField /">
                            </div>

                        </div>
                        <label for="inputData" class="col-md-1 control-label">
                            <?php echo $this->lang->line('hrms_attendance_floor'); ?><!--Department-->:</label>
                        <div class="col-md-2">
                            <?php echo form_dropdown('filterfloor', $floors_arr, '', ' onchange="filterAttendanceTable();" class="form-control select2" id="filterfloor" required'); ?>
                        </div>
                        <div class="col-md-2">

                            <button onclick="clearfilter()" class="btn btn-primary btn-xs" style="    margin-top: 5px;">
                ...
                <div class="col-sm-12" style="padding: 0 15px;">
                    <div class="table-responsive">
                        <table id="attendanceMasterTB" class="<?php echo table_class(); ?>">
                            ...
                            <tr>
                                <th>#</th>
                                <th><?php echo $this->lang->line('hrms_attendance_floor'); ?><!--Department--></th>
                                <th style="">
                                    <?php echo $this->lang->line('hrms_attendance_attendance_date'); ?><!--Attendance Date--></th>

                                <!-- <th>Attendance Date</th>
                                <th>Attendance Time</th>
                                <th>Is Closed</th>-->
                                <th style="width: 80px;text-align: center">
                                    <?php echo $this->lang->line('common_approved'); ?><!--Approved--></th>
        ...
        <div class="tab-pane" id="pullingTab"> <!-- Start of pullingTab -->
            <div class="row">

            </div>
            <div class="row  div-view1">
                <div class="col-md-12"> <!--Pulling attendance File-->
                    <div id="" class="box box-default " style="background-color: #f5f5f5;border: 1px solid #e3e3e3;">
                        <div id="" class="box-header with-border  " style="padding: 5px 10px">
                            <h3 class="box-title" style="font-size: 14px;">
                                <?php echo $this->lang->line('hrms_attendance_add_new_data_file'); ?><!--Add new data file--></h3>
                            <button type="button" class="btn btn-primary btn-xs pull-right"
                                    onclick="downloadExcel()"><i class="fa fa-arrow-circle-down"></i>
                                <?php echo $this->lang->line('common_download'); ?><!--Download-->
                            </button>
                        </div>
                        <?php echo form_open('', 'role="form" class="" id="attPulling_form" autocomplate="off"'); ?>
                        <div class="box-body " style="background: #ffffff;">
                            <div class="col-sm-12" style="padding:0px">
                                <div class="col-sm-2" id="floor-container" style="display: none">
                                    <div class="form-group">
                                        <label for="floorID">
                                            <?php echo $this->lang->line('hrms_attendance_floor'); ?><!--Floor--></label>
                                        <?php echo form_dropdown('floorID', $floors_arr, null, 'class="form-control" id="floorID" '); ?>
                                    </div>
                                </div>

                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label for="upload_fromDate"><?php ?>
                                            &nbsp;
                                            <?php echo $this->lang->line('common_date'); ?><!--From Date--> <?php required_mark(); ?></label>
                                        <div class="input-group">

                                            <input type="text" name="upload_fromDate"
                                                   value="<?php echo date('Y-m-d') ?>"
                                                   id="upload_fromDate" class="form-control dateField /">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-2 hide">
                                    <div class="form-group">
                                        <label for="upload_toDate"><?php echo $this->lang->line('common_to'); ?>&nbsp;
                                            <?php echo $this->lang->line('common_date'); ?><!--To Date--> <?php required_mark(); ?></label>
                                        <div class="input-group">

                                            <input type="text" name="upload_toDate" value="<?php echo date('Y-m-d') ?>"
                                                   id="upload_toDate" class="form-control dateField /">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="upload_toDate"> <?php echo $this->lang->line('hrms_attendance_manual_attendance'); ?><!--Manual Attendance--></label>
                                        <div class="input-group">
                                            <input type="checkbox" value="1" id="isManualAttendance" name="isManualAttendance" onclick="hide_upload_excel()">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label for="upload_toDate"><?php echo $this->lang->line('hrms_attendance_excel_upload'); ?><!--Excel Upload--></label>
                                        <div class="input-group">
                                            <input type="checkbox" onclick="show_upload_excel()" value="" id="isUploadExcel"
                                                   name="isUploadExcel">
                                        </div>
                                    </div>
                                </div>

                                <div class="col-sm-2" id="date-format-container" style="display: none">
                                    <div class="form-group">
                                        <label for="upload_toDate">Date Format</label>
                                        <div class="input-group">
                                            <?php echo form_dropdown('date_format', attendance_date_format_drop(), null, 'class="form-control" id="date_format"'); ?>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!--   <div class="col-sm-2">
                                        <div class="form-group">
                                            <label for="upload_toDate"><?php /*echo $this->lang->line('hrms_attendance_machine');*/ ?> <?php /*required_mark(); */ ?></label>
                                            <div class="input-group">
                                              <?php /*echo form_dropdown('machineMasterID', machine_drop(), '', 'class="form-control form1" id="machineMasterID" '); */ ?>
                                            </div>
                                        </div>
                                    </div>-->
                                ...
                                <!--                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <label for="attendanceFile"><?php /*echo $this->lang->line('hrms_attendance_file');*/ ?><?php /*required_mark(); */ ?></label>
                                            <input type="file" name="attendanceFile" class="form-control"
                                                   id="attendanceFile" placeholder="Brows Here">
                                        </div>
                                    </div>
-->                                </div>
                        </div>
                        <div class="box-footer  clearfix">
                            <button type="submit" class=" btn btn-primary btn-sm" id="sendEmail">
                                <i class="fa fa-arrow-circle-up"></i> <?php echo $this->lang->line('common_Upload'); ?>
                            </button>

                            <button type="button" onclick="upload_excel()" class=" btn btn-primary btn-sm hidden" id="exceluploadattdance">
                                <i class="fa fa-arrow-circle-up"></i> <?php echo $this->lang->line('common_Upload'); ?>
                            </button>
                        </div>
                        <?php echo form_close(); ?>
        ...
        </div><!-- End of pullingTab -->
        <div class="tab-pane" id="showdataTap"> <!-- Start of showdataTap -->
            <div class="row">
                        ...
                        <div class="box-body" style="background: #ffffff; padding: 10px 0px">
                            <div class="col-sm-12" style="padding:0px">
                                <!--<div class="col-sm-4" style="padding-right: 10px">
                                     <div class="form-group"> -->
                                        <!-- <label for="floorID">
                                            <?php //echo $this->lang->line('hrms_attendance_floor'); ?></label>
                                        <div class="input-group">
                                        <select class="form-control " name="floorID[]" id="xfloorID"  multiple>
                                            <?php
                                        ...
                                        <?php //echo form_dropdown('floorID', $floors_arr, null, 'class="form-control" id="xfloorID" '); ?>
                                    <!-- </div> 
                                </div>-->
                                <div class="col-sm-4" style="padding-right: 10px">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                            <input type="text" name="fromDate" value="<?php echo date('Y-m-d') ?>"
                                ...
                                <div class="col-sm-4" style="padding-right: 10px">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                            <input type="text" name="toDate" value="<?php echo date('Y-m-d') ?>"
            ...
            <div class="row" style="margin-bottom: 1%">
                <div class="col-sm-4 col-xs-5" style="">
                    <table class="<?php echo table_class(); ?>" style="margin-top: 3px">
                        <tr>
                            <td><span class="label"
                                      style="padding: 0px 5px ;font-size: 100%;background-color: rgba(255, 255, 0, 0.51)">&nbsp;</span>&nbsp;&nbsp;
                                <?php echo $this->lang->line('hrms_attendance_more_than_one_occurrences'); ?><!--More than one occurrences-->
                            </td>
                            <td><span class="label"
                ...
                <div class="col-sm-2 pull-right">
                    <button class="btn btn-success hide" id="btnVariableAttandance" onclick="variable_attendance_modal()">
                        <i class="fa fa-cog"></i> &nbsp Variable Attandance
                    </button>
                </div>
                <div class="col-sm-2 col-xs-3">
                    <select name="searchDate" class="form-control pull-right" id="searchDate"
                            style="max-width:120px" onchange="searchWithDate(this)">
                        <option value="" selected="selected">
                            <?php echo $this->lang->line('hrms_attendance_search_date'); ?><!--Search Date--></option>
                    </select>
                </div>
                ...
                <div class="fixHeader_Div" style="max-width: 100%;">
                    <table id="attendanceReview" class="table tb "
                        ...
                        <tr style="white-space: nowrap">
                            ...
                            <th style="width: 120px;    ">
                                <?php echo $this->lang->line('common_shift'); ?><!--Shift--></th>
                            <th style="width: 80px;">
                                <?php echo $this->lang->line('hrms_attendance_job'); ?><!--Holiday OT--></th>
                            <th style="width: 85px">Location in</th>
                            <th style="width: 85px">Location Out</th>
                            <th style="width: 120px">
                            ...
                            <th style="z-index: 10; width: 115px">
                                <?php echo $this->lang->line('hrms_attendance_clock_in_date'); ?><!--Clock In date--></th>
                            <th style="z-index: 10; width: 115px">
                            ...
                            <th style="width: 80px;">
                                <?php echo $this->lang->line('hrms_attendance_ndays_special_ot'); ?><!--NDays OT--></th>
                            <th style="width: 95px;">
            ...
            <div class="row" id="unAssignedDiv"> <!-- Un assigned div-->
                <div class="col-sm-6" id="unAssignedShift-div" style="display: none"> <!-- Shift not assigned -->
                ...
                <div class="col-sm-6" id="unAssignedMachine-div" style="display: none">
                    <div class="box box-primary direct-chat direct-chat-primary">
                        <div class="box-header with-border">
...
<div class="modal fade" id="date_job_model" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static"
     data-keyboard="false">
    <div class="modal-dialog modal-lg" style="" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="job_title">Operation Activity</h4>
            </div>

            <div class="modal-body" >
                <div id="date_job_content"></div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-sm" data-dismiss="modal">Close</button>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('.headerclose').click(function () {
            fetchPage('system/hrm/attendance_management', 'Test', 'HRMS');
        });
        ...
        $('#attFetching_form').bootstrapValidator({
            ...
            .on('success.form.bv', function (e) {
                ...
                $('#btnVariableAttandance').removeClass('hide');
            });
    ...
    function close_variable_modal(){
        $('#modal_variable_attandance').modal('hide');
    }
    ...
    function open_attendanceDetailModal(attID, obj) {
        ...
        $.ajax({
            ...
            dataType: 'html',
            data: {'attID': attID},
            url: "<?php echo site_url('Employee/load_attendanceEmployees'); ?>",
            beforeSend: function () {
                $("#overlay").show();
                attDetails_div.html('');
            },
    ...
    function variable_attendance_modal(){
        ...
        $.ajax({
            type: 'post',
            dataType: 'html',
            data: {'from_date': from_date,'to_date':to_date,'edit':1},
