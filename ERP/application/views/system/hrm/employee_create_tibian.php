                        ...
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active" id="profile">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-sm-3">
                                                <label for="shortName"><?php echo $this->lang->line('emp_secondary_code'); ?><?php echo ($empCode_isAutoGenerate != 1)? required_mark(): ''; ?></label>
                                            ...
                                            <fieldset class="scheduler-border">
                                                ...
                                                <div class="form-group col-sm-2">
                                                    <label for="secondName">
                                                        <?php echo $this->lang->line('common_emp_second_name'); ?></label>
                                                    <input type="text" class="form-control" id="secondName" name="secondName">
                                                </div>
                                                <div class="form-group col-sm-2">
                                                    <label for="thirdName">
                                                        <?php echo $this->lang->line('common_emp_third_name'); ?></label>
                                                    <input type="text" class="form-control" id="thirdName" name="thirdName">
                                                </div>
                                                <div class="form-group col-sm-2">
                                                    <label for="forthName">
                                                        <?php echo $this->lang->line('common_emp_fourth_name'); ?></label>
                                                    <input type="text" class="form-control" id="forthName" name="forthName">
                                                </div>
                                                <div class="form-group col-sm-3">
                                        ...
                                        <div class="row">
                                            <fieldset class="scheduler-border">
                                                ...
                                                <div class="form-group col-sm-2">
                                                    <label for="secondName_other">
                                                        <?php echo $this->lang->line('common_emp_second_name'); ?></label>
                                                    <input type="text" class="form-control" id="secondName_other" name="secondName_other">
                                                </div>
                                                <div class="form-group col-sm-2">
                                                    <label for="thirdName_other">
                                                        <?php echo $this->lang->line('common_emp_third_name'); ?></label>
                                                    <input type="text" class="form-control" id="thirdName_other" name="thirdName_other">
                                                </div>
                                                <div class="form-group col-sm-2">
                                                    <label for="forthName_other">
                                                        <?php echo $this->lang->line('common_emp_fourth_name'); ?></label>
                                                    <input type="text" class="form-control" id="forthName_other" name="forthName_other">
                                                </div>
                                                <div class="form-group col-sm-3">
                                ...
                                <div class="row" style="margin-top: 10px">
                                    ...
                                    <div class="form-group col-sm-2">
                                        <label for="insuranceNo"><?php echo $this->lang->line('common_insurance_no'); ?></label>
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-4">
                                        <label for="medicalInfo"><?php echo $this->lang->line('common_medical_info'); ?></label>
                                        <textarea name="medicalInfo" class="form-control" id="medicalInfo" rows="5"></textarea>
                                    </div>
                            ...
                            <div role="tabpanel" class="tab-pane" id="contact">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <fieldset class="">
                                            <legend>Homeland Address </legend>
                                            <div class="form-group col-sm-3">
                                            ...
                                            <div class="form-group col-sm-3">
                                                <label for="telNo2">
                                                    <?php echo $this->lang->line('common_land_line'); ?></label>
                                            ...
                                            <div class="form-group col-sm-3">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="tel" class="form-control " id="emp_personal_mobile" name="emp_personal_mobile">
                                                </div>
                                            </div>
                                        </fieldset>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <fieldset class="">
                                            ...
                                            <div class="form-group col-sm-3">
                                                ...
                                                <select name="ec_address4" class="form-control" id="ec_address4">
                                                <?php
                                                if (!empty($counties)) {
                                                    foreach ($counties as $key => $val) {
                                                        $output = language_string_conversion2('country_' . $val);
                                            ...
                                            <div class="form-group col-sm-3">
                                                <label for="telNo1">
                                                    <?php echo $this->lang->line('common_office_no'); ?></label>
                                                <div class="input-group">
                                                    <div class="input-group-addon"><i class="fa fa-phone" aria-hidden="true"></i></div>
                                            ...
                                            <div class="form-group col-sm-3">
                                                <label for="telNo2">
                                                    <?php echo $this->lang->line('common_office_no').' '.$this->lang->line('common_ext'); ?></label>
                ...
                <form method="post" id="frm_FamilyContactDetails" class="" autocomplete="off">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <div class="form-group col-md-3">
                                <label class="control-label" for="fam_id_no"><?php echo $this->lang->line('common_id_no');?></label>
    ...
    $(document).ready(function () {
        ...
        employee_form.bootstrapValidator({
            ...
            fields: {
                ...
                <?php } ?>
                firstName: {validators: {notEmpty: {message: '<?php echo $this->lang->line('common_first_name_is_required');?>.'}}},/*Full Name is required*/
                familyName: {validators: {notEmpty: {message: '<?php echo $this->lang->line('common_family_name_is_required');?>.'}}},/*Name is required*/
            ...
            e.preventDefault();
            var requestUrl = '<?php echo site_url('Employee/update_employee/tibian'); ?>';
...
//                    ec_address4: {validators: {notEmpty: {message: 'Current County is required.'}}}
            ...
            var requestUrl = '<?php echo site_url('Employee/contactDetails_update/tibian'); ?>';
        ...
        $.ajax({
            ...
            success: function (data) {
                if( 'thisEmpID' in data ){
                    $('#empNameWithInitial').text(data['Ename2'] +' - '+ data['EmpSecondaryCode']);
                    ...
                    $('#extension').val(data['EcExtension']);
                    $('#emp_mobile').val(data['EcMobile']);
                    $('#emp_personal_mobile').val(data['EpMobile']);
                    ...
                    $('#ep_address1').val(data['EpAddress1']); $('#ep_address2').val(data['EpAddress2']);
                    $('#ep_address3').val(data['EpAddress3']); $('#ep_address4').val(data['EpAddress4']);
                    $('#zip_code').val(data['ZipCode']); $('#ep_fax').val(data['EpFax']); $('#personalEmail').val(data['personalEmail']);

                    $('#ec_address1').val(data['EcAddress1']); $('#ec_address2').val(data['EcAddress2']); $('#ec_address3').val(data['EcAddress3']);
                    $('#ec_address4').val(data['EcAddress4']); $('#ec_po_box').val(data['EcPOBox']); $('#ec_pc').val(data['EcPC']); $('#ec_fax').val(data['EcFax']);


                    $('#pass_portNo').val(data['EPassportNO']); $('#passPort_expiryDate').val(data['EPassportExpiryDate']); $('#visa_expiryDate').val(data['EVisaExpiryDate']);
                    $('#airport_destination').val(data['AirportDestination']); $('#BloodGroup').val(data['BloodGroup']); $('#DateAssumed').val(data['DateAssumed']);
                    $('#Nationality').val(data['Nid']); $('#MaritialStatus').val(data['MaritialStatus']);

                    $('#firstName').val(data['Ename1']); $('#secondName').val(data['empSecondName']); $('#thirdName').val(data['Ename3']);
                    $('#forthName').val(data['Ename4']); $('#familyName').val(data['EFamilyName']);

                    $('#firstName_other').val(data['Enameother1']); $('#secondName_other').val(data['empSecondNameOther']); $('#thirdName_other').val(data['Enameother3']);
                    $('#forthName_other').val(data['Enameother4']); $('#familyName_other').val(data['EFamilyNameOther']);

                    $('#insuranceNo').val(data['insuranceNo']); $('#managerID').val(data['managerId']);
                    ...
                    $('#medicalInfo').val(data['medicalInfo']);
    ...
    function load_pendingData(){
        $.ajax({
            ...
            url: "<?php echo site_url('Profile/fetch_pendingEmpDataApproval/tibian'); ?>",
            beforeSend: function () {
                startLoad();
    ...
    function approve_personalData(){
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: postData,
            url: "<?php echo site_url('Profile/approve_pendingEmpData/tibian'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
    ...
    function fetch_employment() {
        ...
        $.ajax({
            ...
            type: 'post',
            dataType: 'html',
            data: {'empID': empID, 'template': 'tibian_'},
