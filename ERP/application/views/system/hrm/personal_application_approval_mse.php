...
$title = 'Personal Application Approvals MSE';
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.headerclose').click(function () {
            fetchPage('system/hrm/personal_application_approval_mse', 'Test', '<?php echo $title; ?>')
        });
        ...
        $('#PAA_approval_form').bootstrapValidator({
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: data,
                url: "<?php echo site_url('Employee/personal_application_approval_mse'); ?>",
                beforeSend: function () {
                    startLoad();
                },
    ...
    function personal_approval_table() {
        var Otable = $('#personal_application_approve_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Employee/fetch_personal_application_approval_mse'); ?>",
            "aaSorting": [[1, 'desc']],
