...
img{max-width:100%;}
 ...
 .outgoing_msg_history_employee{ overflow:hidden; margin:0px 0 0px;}

  .sent_msg_task_employeee {
           padding-left: 9%;
            width: 100%;
...
<div class="m-b-md" id="wizardControl">
    ...
    <div class="steps">
            <a class="step-wiz step--incomplete step--active" href="#step1" data-toggle="tab" onclick=" load_task_header();"> 
                <span class="step__icon"></span>
                <span class="step__label" ><?php echo $this->lang->line('crm_step_one');?> - <?php echo $this->lang->line('crm_task_header');?></span>
            </a>

            <a class="step-wiz step--incomplete step--inactive btn-wizard subtasktabehide " id="subtask" href="#step2"  onclick=" subtaskview();" data-toggle="tab">
                <span class="step__icon"></span>
        ...
        <div class="row col-md-12">
                ...
                <div class="col-md-7 ">
                    ...
                    <span class="input-req" title="Required Field"><input type="text" name="subject" id="subject"
                            ...
                            <input type="hidden" class="form-control" name="emiletypeid" id="emiletypeid">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group" style="margin-top: 10px;">
            ...
            <div class="col-md-5" style="border-left: 2px solid #d3dbd7;" >
                ...
                <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <span class="input-req" title="Required Field">
                                ...
                                <input type="hidden" id="statusID_hidden" name="statusID">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">                    
                                <div class="input-group startdateDatepic">
                                    ...
                                    <input type="text" name="startdate" value="<?php echo $current_date; ?>" id="startdate" class="form-control dateFields frm_input"
                        ...
                        <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group duedateDatepic">
                                        <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                                        <input type="text" name="duedate" data-inputmask="'alias': '<?php echo $date_format_policy ?>'"  value="<?php echo $current_date; ?>" id="duedate" class="form-control dateFields frm_input" style="z-index:1 !important">
                                    </div>
                                        ...
                                        <div class="col-md-1">
                                            <div class="skin skin-square">
                                                <div class="skin-section extraColumns"><input id="issubtask" type="checkbox"
                                                                                            ...
                                                                                            name="issubtask" value="1" checked><label
                ...
                <!--Visibility Start-->
                            <div class="row" style="margin-top: 10px;">
                                ...
                                <!-- <div class="form-group col-md-2" style="margin-left: -6%;">
            ...
            <div class="row col-md-12" id="attsection" style="display: none;">
                <div class="col-md-6">
                    ...
                    <div class="form-group navigation-buttons" style="margin-top: 10px;">
                        <a href="#" class="navigation-link" data-section="comment" onclick="chat_box_task_comment()">COMMENT</a>
                        <a href="#" class="navigation-link" data-section="history"  onclick="history_detais_load()">HISTORY</a>
                        <a href="#" class="navigation-link" data-section="attachments" onclick="task_multiple_attachemts();">ATTACHMENTS</a>
                    </div>
                        ...
                        <div id="history-section" class="section history" style="display: none;">
                            <div class="mesgs_history" style="height:350px;">
                                <div class="msg_history_employee">
                                    <div class="outgoing_msg_history_employee">
                                        <!-- <div class="incoming_msg_img pull-left">
                                            <img src="https://ptetutorials.com/images/user-profile.png" alt="sunil" align="middle">
                                        </div> -->
                                        <div class="sent_msg_task_employeee">
                                        ...
                                        <div class="sent_msg_task_employee_detis">
                                            ...
                                            <div class="change_details_employee">
                        ...
                        <div id="attachments-section" class="section" style="display: none;" >
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <button type="button" onclick="show_task_button_cmm()" class="btn btn-primary pull-right"><i
                                ...
                                <div class="form-group">
                                    <div class="fileinput fileinput-new input-group" data-provides="fileinput" style="margin-top: 8px;">
                                        <span class="input-group-addon btn btn-default btn-file">
                                            ...
                                            <input type="file" name="document_file" id="document_file" onchange="truncateFilename()">
                                        </span>
                                        <div class="form-control" data-trigger="fileinput" style="flex: 1; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;">
                                            <i class="glyphicon glyphicon-file color fileinput-exists" style="margin-right: 5px;"></i>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if(('<?php echo $admin['isSuperAdmin']?>' != 1) && ('<?php echo $isgroupadmin['adminYN']?>' != 1))
        {
    ...
    data.push({name: 'savetype', value: 1});
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (!jQuery.isEmptyObject(data['assignpermission']['assigpermission'])) {
                        if((data['assignpermission']['assigpermission'] == 0) && ('<?php echo $admin['isSuperAdmin']?>' != 1) && ('<?php echo $isgroupadmin['adminYN']?>' != 1))
                        {
                        ...
                        if((data['header']['createdUserID'] == '<?php echo $current_userid?>' && data['header']['isClosed'] == 0)){
                            ...
                            $('#statusID').val(data['header']['status']);
                            $('#statusID_hidden').val(data['header']['status']);
                            $('.btn-wizard').removeClass('disabled');
                            $('#startdate').prop('readOnly', true);
                            $('.subtasktabehide').addClass('disabled');
                            $('#duedate').prop('readOnly', true);
...
function taskecommentmail() {
        var task = $('#task_documentAutoID').val();
        $.ajax({
            async: true,
            type: 'post',
            dataType: 'json',
            ...
            url: "<?php echo site_url('Task_management/taskcommentmail'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
    ...
    function assign_validation_stop(subtaskid,taskid,sessionID,createdUserID) {
        $.ajax({
            ...
            success: function (data) {
                if (!jQuery.isEmptyObject(data['assignpermission']['assigpermission'])) {
                    if ((data['assignpermission']['assigpermission'] == 1) || ('<?php echo $admin['isSuperAdmin']?>' == 1) || ('<?php echo $isgroupadmin['adminYN']?>' == 1) || (createdUserID == '<?php echo $current_userid?>')) {
                ...
                if (data.changeData) {
                    ...
                    $.each(data.changeData, function (index, change) {
                        ...
                        changeHTML +=  '<div class="incoming_msg_img pull-left">' +
                                            '<img src="https://ptetutorials.com/images/user-profile.png" alt="sunil" align="middle">' +
                                        '</div>' +
                                         '<div class="col-md-12 detialsval_employee">' +
                    ...
                    $('#history-section .change_details_employee').html(changeHTML);
                }
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (!jQuery.isEmptyObject(data)) {
                    ...
                    edit_loadsubtask_assigne_filter(selectedItems);
                }
            }, error: function () {
                alert('<?php echo $this->lang->line('common_an_error_occurred_Please_try_again');?>.');/*An Error Occurred! Please Try Again*/
                stopLoad();
    ...
    function statuscheack(statusid)
    {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#statusID_hidden').val(selectedValue);
...
function truncateFilename() {
    ...
    function loadsubtask_assigne_filter() {
    var taskID = $('#task_documentAutoID').val();
    $.ajax({
        url: 'Task_management/subtask_assine_filter',
        type: 'POST',
        dataType: 'json',
        data: {
            taskID: taskID
        ...
        success: function(response) {
            $('#employeessubtask').empty();
            $.each(response, function(index, employee) {
                $('#employeessubtask').append($('<option>', {
                    value: employee.empID,
                    text: employee.Ename2 
                }));
            });
            $('#employeessubtask').trigger('change');
        },
        error: function(xhr, status, error) {
            console.error(error);
        }
...
function edit_loadsubtask_assigne_filter(selectedItems) {
    var taskID = $('#task_documentAutoID').val();
    $.ajax({
        url: 'Task_management/subtask_assine_filter',
        type: 'POST',
        ...
        success: function(response) {
            ...
            $('#edit_employeessubtask').empty();
            
            // Append new options
            $.each(response, function(index, employee) {
                $('#edit_employeessubtask').append($('<option>', {
                    value: employee.empID,
                    text: employee.Ename2 // Or any other property you want to display
                }));
            });
            ...
            // Trigger change event if using select2
            $('#edit_employeessubtask').trigger('change');
        },
        error: function(xhr, status, error) {
            console.error(error);
        }
...
function checkEmailTypeAndExecute() {
    var mailid = $('#emiletypeid').val();
    if (mailid == 2) {
        taskemail();
    }
}
...
function taskemail() {
    ...
    var data = $('#task_header_form').serializeArray();
    ...
    $.ajax({
        ...
        dataType: 'json',
        data: data,
        url: "<?php echo site_url('Task_management/taskmail'); ?>",
        beforeSend: function () {
            startLoad();
        },
        success: function (data) {
