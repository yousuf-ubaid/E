...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary pull-right"
                onclick="fetchPage('system/journeyplan/create_journey_plan_map_tour',null,'Add New Journey Plan',' ');"><i
...
<div class="row">
    <div class="col-md-12">
        <div class="table-responsive mailbox-messages" id="getJPmapTourview">
            <!-- /.table -->
        </div>
...
<div aria-hidden="true" role="dialog" tabindex="-1" id="jp_create_invoice" class="modal fade"
     style="display: none;">
    <div class="modal-dialog modal-lg" style="width: 40%;">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h5 class="modal-title" ><b>Create Invoice</b></h5>
            </div>
            <div class="modal-body">
                <form role="form" id="jp_create_invoice_form" class="form-horizontal">
                    <input type="hidden" name="journeyPlanMasterID" id="journeyPlanMasterID">
                    <div class="row">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" type="button" onclick="create_invoice()">Create Invoice
                </button>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function getJPmapTour(filtervalue) {
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('Journeyplan/load_journeyplan_masterview_maps_tour'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
                $('#getJPmapTourview').html(data);
                stopLoad();
            },
    ...
    function jp_createInvoice(journeyPlanMasterID) {

        $('#journeyPlanMasterID').val(journeyPlanMasterID);
        $('#jp_create_invoice').modal("show");
    }

    function create_invoice() {
        var data = $("#jp_create_invoice_form").serializeArray();
        $.ajax({
            type: 'POST',
            url: '<?php echo site_url("Journeyplan/jp_create_customer_invoice"); ?>',
            dataType: 'json',
            data: data,
            async: false,
            beforeSend: function () {
