...
$title = $this->lang->line('config_mpr_template');
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/ReportTemplate/mpr_template_setup', 'Test', 'MPR Template');
        });
    ...
    function company_report_template_table() {
        $('#company_report_template_table').DataTable({
            ...
            "fnServerData": function (sSource, aoData, fnCallback) {
                aoData.push({'name':'templateType', 'value':2});
                $.ajax({
                    'dataType': 'json',
                    'type': 'POST',
                    'url': sSource,
    ...
    function save_reportTemplateMaster(){
        ...
        data.push({'name':'templateType', 'value':2});
        $.ajax({
            async: true,
            type: 'post',
            dataType: 'json',
    ...
    function setupTemplate(id, des){
        var master_page = 'system/ReportTemplate/mpr_template_setup.php';
