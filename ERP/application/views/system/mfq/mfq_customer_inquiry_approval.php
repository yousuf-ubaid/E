    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('manufacturing_customer_inquiry_approval'); ?><!--Customer Inquiry Approval--></h4>
            </div>
                        ...
                        <div class="zx-tab-content">
                            ...
                            <div class="tab-pane hide" id="Tab-profile-v">
                                <div class="table-responsive">
                                    ...
                                    &nbsp <strong><?php echo $this->lang->line('manufacturing_customer_inquiry_attachment'); ?><!--Customer Inquiry Attachments--></strong>
                                    <br><br>
