                    ...
                    <table>
                        ...
                        <tbody><tr>
                            ...
                            <td width="50%" valign="middle" height="40">
                                <table>
                                    <tbody><tr>
                                        <th style="text-align:center;font-size: 16px">PACKING LIST</th>
                                    </tr>
                    ...
                    <table class="table table-bordered-1 table_check_list table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>                           
                                ...
                                <th style="text-align:center;background: #fce4d6;padding-bottom: 0px;padding-top: 0;height: 25px;font-size: 12px !important;width:50px">Dimension</th>
                                <th style="text-align:center;background: #fce4d6;padding-bottom: 0px;padding-top: 0;height: 25px;font-size: 12px !important;width:50px">Net Weight</th>
                            </tr>
                                                        <tr>         
                                <td style="
    text-align: center;
...
"><table><tbody><tr><td style="
    border: 0 !important;
    width: 50%;
">TOTAL NUMBER OF PACKAGES: </td><td style="
    border: 0 !important;
    width: 50%;
"></td></tr></tbody></table></td><td style="
    text-align: left;
    background: #fce4d6;
"></td>
