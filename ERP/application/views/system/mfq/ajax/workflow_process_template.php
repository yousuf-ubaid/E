...
if ($output) {
    ...
    <div class="col-md-12 bhoechie-tab-container">
        <div class="col-lg-2 bhoechie-tab-menu">
            <div class="list-group">
                ...
                foreach ($output as $key => $val) {
                    ...
                    $prevStatus = 0;
                    if ($i != 0) {
                        $prevStatus = isset($output[$key - 1]['status']) ? $output[$key - 1]['status'] : 0;
                    }
                    if ($val["status"] == 1) {
                        ?>
                    ...
                    <a href="#" id="Tab_<?php echo $i ?>"
                       onclick="get_workflow_template('<?php echo $val['pageNameLink']; ?>','workflow_template','<?php echo $val['workFlowID']; ?>','<?php echo $val['documentID']; ?>',<?php echo $type; ?>,'<?php echo $i; ?>',<?php echo $val['templateDetailID']; ?>,<?php echo $val['linkworkFlow']; ?>)"
                       class="list-group-item text-center <?php echo $active; ?> <?php if ($i != 0 && $prevStatus == 0) echo $disablebutton; ?>">
        ...
        <div class="col-lg-10 bhoechie-tab">
            ...
            ?>
            <div class="bhoechie-tab-content customer_master_style <?php echo $active; ?>" id="workflow_template">
