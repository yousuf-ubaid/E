...
$title = $this->lang->line('manufacturing_crew_master');
...
<div class="row">
    <div class="col-md-12 text-right">
        <div class="pull-right">
            <button type="button" data-text="Add" id="btnAdd" onclick="fetchPage('system/mfq/crew/manage-crew','','Crew')" class="btn btn-sm btn-default">
                <i class="fa fa-plus" aria-hidden="true"></i> <?php echo $this->lang->line('manufacturing_add_crew');?><!--Add Crew-->
            </button>
...
<div id="itemmaster" style="margin-top:20px;">
    <div class="table-responsive" id="itemMasterTbl">
        <table id="crew_table" class="table table-striped table-condensed">
            <thead>
            <tr>
                ...
                <th style="min-width: 10%"><?php echo $this->lang->line('manufacturing_linked_to_erp');?><!--LINKED TO ERP--> </th>
    ...
    <div class="modal-dialog modal-lg" style="width:80%">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
                <h4 class="modal-title"><?php echo $this->lang->line('manufacturing_crews_from_erp');?><!--Crews from ERP<--> </h4>
            </div>
            <div class="modal-body">
                ...
                <div id="sysnc">
                    <div class="table-responsive">
                        ...
                        <table id="crew_table_sync" class="table table-striped table-condensed">
                            <thead>
                            <tr>
                                <th style="min-width: 5%">&nbsp;</th>
                                <th style="min-width: 12%"><?php echo $this->lang->line('common_name');?><!--Name--></abbr></th>
                                <th style="min-width: 12%"><?php echo $this->lang->line('common_gender');?><!--GENDER--></th>
                                <th style="min-width: 12%"><?php echo $this->lang->line('common_telephone');?><!--TELEPHONE--></th>
                                <th style="min-width: 10%">@<?php echo $this->lang->line('common_email');?><!--Email--></th>
                                <th style="min-width: 5%; text-align: center !important;">
                                    <button type="button" data-text="Add" onclick="addCrews()"
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-xs" data-dismiss="modal"><th style="min-width: 10%"><?php echo $this->lang->line('common_Close');?><!--Close--></th></button>
            </div>
    ...
    <div class="modal-dialog modal-lg" style="width:80%">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Crews from ERP </h4>
            </div>
            <div class="modal-body">
                ...
                <div id="sysnc">
                    <div class="table-responsive">
                        ...
                        <table id="crew_table_link" class="table table-striped table-condensed">
                            <thead>
                            <tr>
                                <th style="min-width: 5%">&nbsp;</th>
                                <th style="min-width: 12%">Name</abbr></th>
                                <th style="min-width: 12%">Gender</th>
                                <th style="min-width: 12%">Telephone</th>
                                <th style="min-width: 10%">@Email</th>
                                <th style="min-width: 5%; text-align: center !important;">
                                    <button type="button" data-text="Add" onclick="linkcrew()"
                                            class="btn btn-xs btn-primary">
                                        <i class="fa fa-plus" aria-hidden="true"></i> Add Crew
                                    </button>
                                </th>
                            </tr>
                            </thead>
...
<script type="text/javascript">
    ...
    function crew_table() {
        oTable = $('#crew_table').DataTable({
            ...
            "bStateSave": false,
            "order": [[ 7, "desc" ]],
            "sAjaxSource": "<?php echo site_url('MFQ_CrewMaster/fetch_crew'); ?>",
            ...
            "columnDefs": [{"targets": [8], "visible": false},{"targets": [0,3,7,8], "searchable": false}],
    ...
    function sync_crew_table() {
        oTable2 = $('#crew_table_sync').DataTable({
            "ordering": false,
            "bProcessing": true,
            "bServerSide": true,
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('MFQ_CrewMaster/fetch_sync_crew'); ?>",
            //"aaSorting": [[1, 'desc']],
            language: {paginate: {previous: '‹‹', next: '››'}},
    ...
    function addCrews() {
        $.ajax({
            type: 'POST',
            url: '<?php echo site_url("MFQ_CrewMaster/add_crews"); ?>',
            dataType: 'json',
  ...
  function  link_crew_master(id)
  {
    ...
    function link_crew_table() {
        oTable2 = $('#crew_table_link').DataTable({
            "ordering": false,
            "bProcessing": true,
            "bServerSide": true,
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('MFQ_CrewMaster/fetch_link_crew'); ?>",
            //"aaSorting": [[1, 'desc']],
            language: {paginate: {previous: '‹‹', next: '››'}},
    ...
    function linkcrew()
    {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo site_url("MFQ_CrewMaster/link_crew"); ?>',
            dataType: 'json',
            data: {'selectedItemsSync': selectedVal.val(),crewID:$('#crewID').val()},
            async: false,
            success: function (data) {
                if (data['status']) {
                    refreshNotifications(true);
