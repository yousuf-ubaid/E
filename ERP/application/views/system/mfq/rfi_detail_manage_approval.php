...
// echo '<pre>'; print_r($rfiDetail); exit;
...
<div class="m-b-md" id="wizardControl">
    <a class="btn btn-primary size-sm" href="#step1" data-toggle="tab">RFI Header</a>
    <a class="btn btn-default size-sm btn-wizard" href="#step2" onclick="" data-toggle="tab">QC Response</a>
</div>
<div class="tab-content">
            ...
            <div class="row" style="margin-bottom:5%">
                <div <?php echo ($rfiDetail['rfiType'] == 7) ? 'class="hide"' : '' ?> id="div_stage">
                    ...
                    <div class="form-group col-sm-9">
                        <?php echo form_dropdown('stageID', $stageList, $rfiDetail['stageID'], 'class="form-control select2"  id="stageID"'); ?>
                    </div>
                </div>
                <div <?php echo ($rfiDetail['rfiType'] == 7) ? '' : 'class="hide"' ?> id="div_stage_comment">
                    ...
                    <div class="form-group col-sm-9">
                        <input type="text" class="form-control " id="stageComment" name="stageComment" value="<?php echo $rfiDetail['stageComment'] ?>">
                    </div>
                </div>
            </div>
    ...
    <div id="step2" class="tab-pane">
        ...
        <div class="row">
            <button class='btn btn-primary' id="btnEnter" onclick="close_rfi_request()">Close RFI</button>
        </div>
    </div>
</div>
...
<script>    
    ...
    $('.headerclose').attr('onclick',"fetchPage('system/mfq/mfq_rfi_approval','','RFI Inquiry',insert_system_audit_log_nav(1574,1,'RFI Inquiry'))");
    ...
    function load_detail_table(){
        ...
        $.ajax({
            ...
            type: 'post',
            // dataType: 'html',
            data: {'workProcessID': workProcessID,'rfiID':rfiID,'approval':1},
    ...
    function close_rfi_request(){
         ...
         swal({
                ...
                text: "<?php echo 'Are you sure you want to close this';?>",/*You want to confirm this!*/
                type: "warning",
