        ...
        $('#pv_approval_form').bootstrapValidator({
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data === 11){
                        myAlert('s', 'Customer Invoice created') ;
                        myAlert('s', 'Customer Invoice Approved') ;
                        myAlert('s', 'Asset Created for Inter Company') ;
                    }
                  
                    
                }, error: function () {
                    // Alert('<?php echo $this->lang->line('common_an_error_occurred_Please_try_again');?>.');/*An Error Occurred! Please Try Again*/
                    myAlert('e','An error occurred while processing the request');
                    stopLoad();
                    refreshNotifications(true);
                }
            });
