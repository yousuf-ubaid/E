...
$title = $this->lang->line('treasury_ap_br_bank_rec_approval');
echo head_page($title, false);



/*echo head_page('Bank Rec Approval', false); */?>
...
<div class="table-responsive">
    <table id="journal_entry_table" class="<?php echo table_class(); ?>">
        ...
        <tr>
            ...
            <th style="min-width: 10%"><?php echo $this->lang->line('treasury_common_brc_code');?> <!--BRC Code--></th>
            <th style="min-width: 20%"><?php echo $this->lang->line('treasury_common_brc_details');?><!--BRC Details--></th>
            <th style="min-width: 10%"><?php echo $this->lang->line('treasury_common_bank_name');?><!--Bank Name--></th>
            <th style="min-width: 10%"><?php echo $this->lang->line('common_gl_code');?><!--GL Code--></th>
            <th style="min-width: 10%"><?php echo $this->lang->line('treasury_common_account_number');?><!--Account Number--></th>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"> <?php echo $this->lang->line('treasury_tr_bank_rec_approval');?><!--Bank Rec Approval--></h4>
            </div>
                ...
                <div class="modal-body">
                    <div class="col-sm-1">
                        ...
                        <ul class="zx-nav zx-nav-tabs zx-tabs-left zx-vertical-text">
                            <li id="br_attachement_approval_Tabview_v" class="active"><a href="#Tab-home-v"
                                                                                         data-toggle="tab" onclick="tabView()"><?php echo $this->lang->line('common_view');?><!--View--></a></li>
                            <li id="br_attachement_approval_Tabview_a"><a href="#Tab-profile-v"
                                                                          data-toggle="tab" onclick="tabAttachement()"><?php echo $this->lang->line('common_attachment');?><!--Attachment--></a>
                            </li>
                        </ul>
                    </div>
                    <div class="col-sm-11">
                            ...
                            <div class="zx-tab-pane active" id="Tab-home-v">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="hidden" name="bankRecAutoID" id="bankRecAutoID">
                                        <input type="hidden" name="GLAutoID" id="GLAutoID">
                            ...
                            <div class="tab-pane hide" id="Tab-profile-v">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped table-condensed table-hover">
                                        ...
                                        <tbody id="br_attachment_body" class="no-padding">
                                        <tr class="danger">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/bank_rec/erp_bank_rec_approval', '', 'Bank Reconciliation Approval');
        });
        journal_entry_table();
    ...
    function journal_entry_table() {
        Otable = $('#journal_entry_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Bank_rec/fetch_bank_rec_approval'); ?>",
            "aaSorting": [[1, 'desc']],
            ...
            "columnDefs": [{"targets": [7,8], "orderable": false}, {"targets": [0], "searchable": false}, {"targets": [9,10,11], "searchable": true, "orderable": false, "visible": false}],
    ...
    function fetch_approval(bankRecAutoID, GLAutoID, documentApprovedID, Level) {
        if (bankRecAutoID) {
            $.ajax({
                async: true,
                type: 'post',
                dataType: 'html',
                data: {'bankRecAutoID': bankRecAutoID, 'GLAutoID': GLAutoID, 'html': true},
                url: "<?php echo site_url('Bank_rec/bank_rec_book_balance'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
                    $('#bankRecAutoID').val(bankRecAutoID);
                    $('#GLAutoID').val(GLAutoID);
                    $('#documentApprovedID').val(documentApprovedID);
                    $('#Level').val(Level);
                    $("#jv_modal").modal({backdrop: "static"});
                    $('#conform_body').html(data);
                    $('#comments').val('');
                    bankReconciliation_attachment_View_modal('BR', bankRecAutoID);
                    stopLoad();
                    refreshNotifications(true);
                }, error: function () {
                    stopLoad();
