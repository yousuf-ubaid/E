...
<th align="left" style="border-bottom: 1px solid black;border-top:1px solid black;width:10%" class="theadtr">Doc Date</th>
<th align="left" style="border-bottom: 1px solid black;border-top:1px solid black;width:20%" class="theadtr">Doc Type</th>
<th align="left" style="border-bottom: 1px solid black;border-top:1px solid black;width:20%" class="theadtr">Doc Number</th>
<th align="left" style="border-bottom: 1px solid black;border-top:1px solid black;width:20%" class="theadtr">Narration</th>';
                if (!empty($fieldNameDetails)) {
                    foreach ($fieldNameDetails as $val) {
                        if ($val['fieldName'] == 'transactionAmount') {
                            $html .= '<th align="left" style="border-bottom: 1px solid black;border-top:1px solid black;width:10%" class="theadtr">Currency</th>';
                            $html .= '<th align="right" style="border-bottom: 1px solid black;border-top:1px solid black" class="theadtr">Transaction Currency</th>';
                        }
                        else if($val['fieldName'] == 'companylocalAmount'){
                            $html .= '<th align="right" style="border-bottom: 1px solid black;border-top:1px solid black" class="theadtr">Local Currency</th>';
                        }
                        else if($val['fieldName'] == 'companyReportingAmount'){
                            $html .= '<th align="right" style="border-bottom: 1px solid black;border-top:1px solid black" class="theadtr">Reporting Currency</th>';
                        }
                    }
                }
                $html .= '</tr>';
