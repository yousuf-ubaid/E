                ...
                <div class="fixHeader_Div">
                    <table class="borderSpace report-table-condensed" id="tbl_report">
                        ...
                        foreach ($output as $val) {
                            ...
                            if($isTransCost) {
                                $category[$val["GLSecondaryCode"] . " - " . $val["GLDescription"]][$cus_sys_code . " - " . $cus_name][$val['currency']][] = $val;
                            } else {
                                ...
                                foreach ($mainCategory as $key2 => $subCategory) {
                                    ...
                                    if($isTransCost) {
                                        foreach ($subCategory as $key3 => $curr) {
                                            $totalTrans = array();
                                            $decimalPlace = 2;
                                            foreach ($curr as $key4 => $customer) {
                                                if ($customer['TotalRow'] != 0) {
                                                    $total = 0;
                                            ...
                                            echo "<tr>";
                                            echo "<td colspan='".$col_new."'><strong>$subtot<!--Sub Total--></strong></td>";
                        ...
                        if ($isRptCost || $isLocCost) {
                            echo "<tr>";
                            echo "<td colspan='".$col_new."'><strong>$grandt<!--Grand Total--></strong></td>";
                            if ($isRptCost) {
