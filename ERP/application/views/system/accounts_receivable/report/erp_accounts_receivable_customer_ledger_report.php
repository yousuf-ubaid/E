                ...
                <div class="fixHeader_Div">
                    <table class="borderSpace report-table-condensed" id="tbl_report">
                        ...
                        foreach ($output as $val) {
                            ...
                            if($isTransCost) {
                                $category[$val["GLSecondaryCode"] . " - " . $val["GLDescription"]]["{$cus_sys_code} - {$cus_name}"][$val['transactionCurrency']][] = $val;
                            } else {
                            ...
                            foreach ($category as $key => $glcodes) {
                                ...
                                foreach ($glcodes as $key2 => $customer) {
                                    ...
                                    if($isTransCost) {
                                        foreach ($customer as $key3 => $curr) {
                                            ...
                                            echo '<tr>';
                                            echo '<td colspan="'.$col_3.'"><b>'.$netbalance.'</b> &nbsp;</td>';
                                    ...
                                    if ($isLocCost || $isRptCost) {
                                        if ($isTransCost) {
                                            ...
                                            echo "<td colspan='".$col_1."'><div style='margin-left: 30px'>$netbalance<!--Net Balance--></div></td>";
                                        } else {
                                            ...
                                            echo "<td colspan='".$col_2."'><div style='margin-left: 30px'>$netbalance<!--Net Balance--></div></td>";
                                        }
                                    }
                                    if (!empty($fieldName)) {
                                        foreach ($fieldName as $val2) {
                                ...
                                if ($isLocCost || $isRptCost) {
                                    if ($isTransCost) {
                                        ...
                                        echo "<td colspan='".$col_4."'><div style='margin-left: 30px'><strong>$subtot<!--Sub Total--></strong></div></td>";
                                    } else {
                                        if($isSeNumber==true) {
                                            $col_5 = 7;
                                        }else{
                                        ...
                                        echo "<td colspan='".$col_5."'><div style='margin-left: 30px'><strong>$subtot<!--Sub Total--></strong></div></td>";
                                    }
                                }
                                if (!empty($fieldName)) {
                                    foreach ($fieldName as $val2) {
