...
<aside class="main-sidebar">
    <section class="sidebar">
        ...
        <div class="menu-list-pos">
            ...
            <div class="panel panel-default" style="border: 1px solid #ffffff;">
                <div class="panel-body tabs" style="padding:3px;">
                    ...
                    <div class="row" style="margin-left: 0px; margin-right: 0px;">
                        <div class="col-xs-6 col-sm-6 col-md-12 col-lg-6"
                            ...
                            <input type="text" class="form-control" autocapitalize="off" spellcheck="false" autocorrect="off" placeholder="Press 'F2' or 'Ctrl+F' to Search"
                                   id="searchProd">
                        </div>

                        <!-- BARCODE READER  -->
                        <div class="col-xs-6 col-sm-6 col-md-12 col-lg-6" style="padding-top: 10px;padding-left: 5px;padding-right: 5px;">
                    ...
                    <div style="margin: 0px 5px 0px 0px;padding-left: 5px;height: 324px;overflow: scroll;">
