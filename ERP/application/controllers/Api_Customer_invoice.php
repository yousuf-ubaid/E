...
class Api_Customer_invoice extends REST_Controller
{
    ...
    function fetch_invoices_get()
    {
        ...
        $this->datatables->add_column('edit', '$1', 'load_invoice_action(invoiceAutoID,confirmedYN,approvedYN,createdUser,confirmedYN,isDeleted,tempInvoiceID,confirmedByEmp,isSytemGenerated, isPreliminaryPrinted)');
        $this->datatables->edit_column('DT_RowClass', '$1', 'set_deleted_class(isDeleted)');
        $final_output['data'] = $Customer_invoice_list;
