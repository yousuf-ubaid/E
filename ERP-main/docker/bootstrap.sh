...
#rm /var/www/html/application/config/config.example.php
#rm /var/www/html/application/config/database.example.php
#rm /var/www/html/application/config/env.example.php
#rm /var/www/html/application/config/s3.example.php
