...
$route['privacy-policy'] = "Login/privacy_policy";
$route['subscription'] = "Company/subscription";
$route['scheduler/(:any)'] = "Scheduler_services";
$route['kot_countdown/:num'] = "Pos_kitchen/kitchen_countdown_process"; /*Manual Process */
$route['matchexceed'] = "Match_exceed/post_unmatched_inventory_exceed_item";
$route['restaurant/home'] = "Pos_restaurant/restaurant_home";
$route['credit_card_payment/(:any)'] = "Company/credit_card_payment";

$route['Datasync/(:any)'] = "Datasync/$1";

$route['error_default1'] = "SystemError/error";

$route['activity_code_table'] = 'Report/activity_code_table';
