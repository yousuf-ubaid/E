...
$navigationData = $CI->NavigationService->getNavigationHeaderLevelOne(
    current_companyID(),
    current_userID(),
                                ...
                                <div class="dropdown-content-x-lg py-3 border-light">
                                    ...
                                    if($navigationData) {
                                        ...
                                        foreach ($navigationData as $record) {
                                            ...
                                            echo '    <span class="round-50 d-flex align-items-center justify-content-center rounded bg-primary-subtle" style="--base-color: '. ($record['iconColor'] ?? "99, 91, 255") .';">';
                                            echo '        <i class="' . $record['pageIcon'] . ' text-primary fa-2x" style="color: rgba(' . ($record['iconColor'] ?? '99, 91, 255') . ', 1);"></i>';
                                            echo '    </span>';
