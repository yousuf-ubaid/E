...
<div class="wrapper">
    <header class="main-header">
        ...
        <nav class="navbar navbar-static-top" role="navigation">
            <a href="#" class="sidebar-toggle r-nav-menu" data-toggle="offcanvas" role="button" style="padding: 8px;">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <?php if ($isPayButtonEnabled) { ?>
                        <li class="dropdown user user-menu">
                            <button class="mat-pay-btn btn btn-lg btn-success btn-myCustom btn-disable-when-load"
                    ...
                    <?php if ($isOpenButtonEnabled) { ?>
                        <li class="dropdown user user-menu">
                            <button type="button" class="mat-open-btn btn btn-lg btn-default btn-myCustom"
                                    onclick="open_holdReceipt()">
                                <i class="fa fa-external-link-square text-white" aria-hidden="true"></i> <br/>
                    ...
                    <?php if ($isHoldButtonEnabled) { ?>
                        <li class="dropdown user user-menu">
                            <button class="mat-hold-btn btn  btn-lg btn-warning btn-myCustom" onclick="holdReceipt();">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle mat-btn-down" data-toggle="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-footer">
                                ...
                                <?php if ($isCancelButtonEnabled) { ?>
                                    <button class="mat-btn-down-2 btn btn-lg btn-danger btn-block dangerCustom"
                                ...
                                <?php if ($isKitchenButtonEnabled) { ?>
                                    <button type="button"
                                            class="mat-btn-down-2 btn btn-block btn-lg btn-default btn-myCustom"
                                            rel="tooltip"
                                            title=""
