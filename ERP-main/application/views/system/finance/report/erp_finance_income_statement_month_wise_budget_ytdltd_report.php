                                    ...
                                    foreach ($subCategory as $item) {
                                        ...
                                        foreach ($fieldNameDetails as $key4 => $value) {
                                            foreach ($month as $key5 => $value2) {
                                                $total += $item[$key5];
                                                $totalBudget += $item['monthwise' . $key5];
                                                $subtotal[$key5][] = (float)$item[$key5];
                                                $maintotal[$key5][] = (float)$item[$key5];
                                                $grandTotal[$key5][] = (float)$item[$key5];

                                                $subtotalBudget[$key5][] = (float)$item['monthwise' . $key5];
                                                $maintotalBudget[$key5][] = (float)$item['monthwise' . $key5];
                                                $grandTotalBudget[$key5][] = (float)$item['monthwise' . $key5];
                                                ...
                                                echo '<td class="text-right">' . number_format($item['monthwise' . $key5], $item[$value["fieldName"] . "DecimalPlaces"]) . '</td>';
                                            }
                                        }
