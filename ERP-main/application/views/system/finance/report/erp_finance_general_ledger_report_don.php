...
<div class="row">
    <div class="col-md-12">
        <?php if ($type == 'html') {
            echo export_buttons('tbl_finance_tb_excel', 'General Ledger');
        } ?>
    </div>
</div>
                ...
                <div class="fixHeader_Div">
                    <table class="borderSpace report-table-condensed" id="tbl_report">
                        ...
                        foreach ($output as $val) {
                            ...
                            $category[$val["systemGLCode"] . ' | ' . $val["GLDescription"]][] = $val;
                        }
                        if (!empty($category)) {
                            $grandTotal = 0;
                                    ...
                                    foreach ($fieldNameDetails as $key2 => $value) {
                                        if ($i == 1) {
                                            if ($value["fieldName"] == "documentSystemCode") {
                                                ...
                                                echo "<td class='" . $value["textAlign"] . "'> <div style='margin-left: 30px'>aaaaaaaaaaaaaaaaaaaaaaaaaaaaa" . $item[$value["fieldName"]] . "</div></td>";
                                            }
                                        } else {
...
<div id="tbl_finance_tb_excel" class="hide">
    <div class="row">
        <div class="col-md-12">
            <div class="text-center reportHeaderColor">
                <strong><?php echo $this->common_data['company_data']['company_name'] ?> </strong>
