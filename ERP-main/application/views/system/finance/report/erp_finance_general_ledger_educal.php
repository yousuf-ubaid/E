<!---- =============================================
-- File Name : erp_finance_general_ledger_educal.php
-- Project Name : Educal ERP
-- Module Name : Report - Finance
-- Create date : 19 - August 2020
-- Description : This file contains General Ledger (Template for Buyback (Credit/Debit/running Balance-With Group By)).
