<!---- =============================================
-- File Name : erp_finance_budget_month_wise_report.php
-- Project Name : SME ERP
-- Module Name : Report - Finance
-- Create date : 19 - December 2017
-- Description : This file contains budget Month Wise .
...
<div class="row">
    <div class="col-md-12">
        <?php if ($type == 'html') {
            echo export_buttons('tbl_finance_tb', 'Budget Month Wise ');
        } ?>
    </div>
</div>
<div id="tbl_finance_tb">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="text-center reportHeader reportHeaderColor"> Budget Month Wise</div>
            <div
