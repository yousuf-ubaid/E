                        ...
                        if (!empty($category)) {
                            ...
                            foreach ($category as $key => $mainCategory) {
                                ...
                                foreach ($mainCategory as $key2 => $subCategory) {
                                    ...
                                    foreach ($subCategory as $item) {
                                        ...
                                        foreach ($fieldNameDetails as $key4 => $value) {
                                            ...
                                            $maintotallytd[$value["fieldName"]][] = (float)$item['lytd' . $value["fieldName"]];
                                            $grandTotalBudget[$value["fieldName"]][] = (float)$item['budget' . $value["fieldName"]];
                                            $grandTotallytd[$value["fieldName"]][] = (float)$item['lytd' . $value["fieldName"]];
                                            if ($type == "html") {
                                            ...
                                            echo '<td class="text-right">' . number_format($item['lytd'.$value["fieldName"]], $item[$value["fieldName"] . "DecimalPlaces"]) . '</td>';
                                            if ($item["accountCategoryTypeID"] == 11 || $item["accountCategoryTypeID"] == 14) {
                                               ...
                                               // echo '<td class="text-right">' . ($item[$value["fieldName"]] != 0 ? round((($item['budget' . $value["fieldName"]] - $item[$value["fieldName"]]) / $item[$value["fieldName"]]) * 100, 2) : 0) . '%</td>';
                                            }
                                        }
                                ...
                                if ($key == "Cost of Goods Sold") { /*display total of Cost of Goods Sold*/
                                    ...
                                    foreach ($fieldNameDetails as $key5 => $value) {
                                        ...
                                        $sumlytd = array_sum($maintotallytd[$value["fieldName"]]);
                                        ...
                                        if ($value['fieldName'] == "companyLocalAmount") {
                                           ...
                                           echo "<td class=' text-right reportsubtotal'>" . number_format($sumlytd, $this->common_data['company_data']['company_default_decimal']) . "</td>";
                                        ...
                                        if ($value['fieldName'] == "companyReportingAmount") {
                                            ...
                                            echo "<td class=' text-right reportsubtotal'>" . number_format($sumlytd, $this->common_data['company_data']['company_reporting_decimal']) . "</td>";
                                    ...
                                    foreach ($fieldNameDetails as $key5 => $value) {
                                        ...
                                        $sumlytd = array_sum($grandTotallytd[$value["fieldName"]]);
                                        ...
                                        if ($value['fieldName'] == "companyLocalAmount") {
                                           ...
                                           echo "<td class=' text-right reporttotalblack'>" . number_format($sumlytd, $this->common_data['company_data']['company_default_decimal']) . "</td>";
                                        ...
                                        if ($value['fieldName'] == "companyReportingAmount") {
                                           ...
                                           echo "<td class=' text-right reporttotalblack'>" . number_format($sumlytd, $this->common_data['company_data']['company_reporting_decimal']) . "</td>";
                            ...
                            foreach ($fieldNameDetails as $key6 => $value) {
                                ...
                                if ($value['fieldName'] == "companyLocalAmount") {
                                    ...
                                    echo "<td class='reporttotalblack text-right'>" . number_format($sumlytd, $this->common_data['company_data']['company_default_decimal']) . "</td>";
                                ...
                                if ($value['fieldName'] == "companyReportingAmount") {
                                    ...
                                    echo "<td class='reporttotalblack text-right'>" . number_format($sumlytd, $this->common_data['company_data']['company_reporting_decimal']) . "</td>";
