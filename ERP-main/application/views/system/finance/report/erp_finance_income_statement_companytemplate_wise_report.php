<!---- =============================================
-- File Name : erp_finance_income_statement_companyTemplate_wise_report.php
...
<div id="tbl_finance_tb">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="text-center reportHeader reportHeaderColor"> Income Statement Template Wise</div>
            <div class="text-center reportHeaderColor"> <?php echo "<strong>$datefrom<!--Date From-->: </strong>" . $from . " - <strong>$dateto<!--Date To-->: </strong>" . $to ?></div>
        </div>
    </div>
    <div class="row">
            ...
            <?php if (!empty($output)) { ?>
                <div class="fixHeader_Div" style="overflow: auto">
                    <table class="borderSpace report-table-condensed" id="tbl_report">
                       ...
                       $bodydata=load_template_fm_statement_report($month,$temMasterID,$output);
