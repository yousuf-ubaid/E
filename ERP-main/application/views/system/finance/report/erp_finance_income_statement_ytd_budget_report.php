...
<div class="row">
    <div class="col-md-12">
        <?php if ($type == 'html') {
            echo export_buttons('tbl_finance_tb', 'Income Statement YTD Budget');
        } ?>
    </div>
</div>
<div id="tbl_finance_tb">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="text-center reportHeader reportHeaderColor"> <?php echo $this->lang->line('finance_rs_is_income_statement_ytd_budget');?><!--Income Statement YTD Budget--></div>
            <div
