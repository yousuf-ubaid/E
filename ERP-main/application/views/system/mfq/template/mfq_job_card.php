...
if ($linkWorkFlowID) {
    ...
    $prevJobCardID = $prevJobCard["jobcard"]["jobcardID"] ?? null;
} else {
    $linkWorkFlowID = 0;
}
$disablebutton = "";
...
<ul class="nav nav-tabs" id="main-tabs">
    ...
    <li class="btn-default-new btn-sm tab-style-one mr-1"><a href="#crew_<?php echo $documentID ?>" data-toggle="tab"><i class="fa fa-television"></i><?php echo $this->lang->line('common_crew')?><!--Crew--> </a></li>
    <li class="btn-default-new btn-sm tab-style-one mr-1"><a href="#machine_<?php echo $documentID ?>" data-toggle="tab"><i class="fa fa-television"></i>
                            ...
                            <div class="table-responsive">
                                <table id="mfq_material_consumption" class="table table-condensed">
                                    ...
                                    <tr>
                                        ...
                                        <?php if($itemBatch == 1){ ?>
                                            <th style="min-width: 3%"><?php echo 'Item Batch' ?></th>
                                        <?php } ?>

                                        <th style="min-width: 12%"><?php echo $this->lang->line('manufacturing_estimated_qty')?><!--Estimated Qty--></th>
                                        <th style="min-width: 12%"><?php echo $this->lang->line('manufacturing_current_stock')?><!--Estimated Qty--></th>
                                    ...
                                    <tfoot>
                                    <tr>
                                        <td colspan="<?php echo 4 + $itemBatch ?>">
                            ...
                            <div class="table-responsive">
                                <table id="mfq_thirdparty_service" class="table table-condensed">
                                    ...
                                    <tr>
                                        ...
                                        <th style="min-width: 12%"><?php echo $this->lang->line('manufacturing_unit_rate'); ?><!--Unit Rate--></th>
                                        <th class="hide" style="min-width: 12%"><?php echo $this->lang->line('common_usage_hours')?><!--Usage Hours--></th>
                                        <th class="hide" style="min-width: 12%"><?php echo $this->lang->line('manufacturing_total_hours'); ?><!--Total Hours--></th>
                                        <th style="min-width: 12%"><?php echo $this->lang->line('manufacturing_total_value'); ?><!--Total Values--></th>
                                        <th></th>
                                        <th style="min-width: 5%" colspan="2">
                                            <div class=" pull-right">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="" role="form" id="frm_crew_<?php echo $documentID ?>">
                            ...
                            <div class="table-responsive">
                                <table id="mfq_crew_<?php echo $documentID ?>" class="table table-condensed">
                                    ...
                                    <tr>
                                        ...
                                        <th style="min-width: 12%"><?php echo $this->lang->line('common_actual_hours_spent')?><!--Hours Spent--></th>
                                        <th style="min-width: 5%">
                                            <div class=" pull-right">
                                                <button type="button" data-text="Add"
                            ...
                            <br>
                            <?php if ($jobCardRec["status"] ?? null != 1) { ?>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="pull-right">
...
<script>
    ...
    var itemBatch = '<?php echo $itemBatch  ?>';
    var bomID = "";
    ...
    function init_bom_third_party_service_cost() {
        ...
        if(companyPolicy == 'FlowServe'){
            $('#third_party_service').append('<tr> ' +
                ...
                ' <td>' + uom + '</td>' +
                ' <td><input type="text" name="tps_hourlyRate[]" value="<?php echo number_format(0, $this->common_data["company_data"]["company_default_decimal"]); ?>" placeholder="<?php echo number_format(0, $this->common_data["company_data"]["company_default_decimal"]); ?>" onkeyup="cal_bom_third_party_service_tot_value(this)"  onkeyup="cal_bom_third_party_service_tot_value(this)" onkeypress="return validateFloatKeyPress(this,event)" class="form-control number tps_hourRate" onfocus="this.select();"> </td>'+
                ' <td class="hide"> <div class="text-right tps_usageHours1">1 <input type="hidden" name="tps_usageHours[]" value="<?php echo number_format(1, $this->common_data["company_data"]["company_default_decimal"]); ?>" class="form-control tps_usageHours"></div> </td>'+
                ' <td class="hide"><input type="text" name="tps_totalHours[]" value="0" placeholder="<?php echo number_format(0, $this->common_data["company_data"]["company_default_decimal"]); ?>" onkeyup="cal_bom_third_party_service_tot_value(this)" onkeypress="return validateFloatKeyPress(this,event)" class="form-control number tps_totalHours totalHours" onfocus="this.select();"> </td>' +
            ...
            success: function (data) {
                ...
                if (!$.isEmptyObject(data["material"])) {
                    $.each(data["material"], function (k, v) {
                        ...
                        //select box for unit of measure
                        var sel = '<select name="uom[]" class="form-control uom" onchange="change_unit_of_measure(this,'+v.uomID+')">';
                        var conversion = [];
                        ...
                        sel += '</select> <input type="hidden" class="estQty" value="'+v.qtyUsed+'"> <input type="hidden" class="materialQtyUsage" value="'+v.usageQty+'"> <input type="hidden" class="unitcostdefault" value="'+v.unitCost+'">';

                        //materialQtyUsage

                        //<input type="text" name="uom[]" class="form-control uom" readonly value="' + v.uom + '">
                        if(itemBatch == 1){
                             $('#material_consumption_body').append('<tr id="rowMC_' + v.jcMaterialConsumptionID + '"> <td>' + jobStatus + '</td> <td> <input type="text" onkeyup="clearitemAutoID(event,this)" class="form-control f_search" name="search[]" placeholder="Item ID, Item Description..." id="f_search_' + search_id + '" value="' + v.itemDescription + '"> <input type="hidden" class="form-control mfqItemID" name="mfqItemID[]" value="' + v.mfqItemID + '"> <input type="hidden" class="form-control jcMaterialConsumptionID" name="jcMaterialConsumptionID[]" value="' + v.jcMaterialConsumptionID + '"> </td> <td><input type="text" name="partNo[]" class="form-control partNo" readonly value="' + v.partNo + '"> </td> <td>'+sel+'</td> <td class="batch"><button class="button button-square button-tiny button-royal button-raised btn-batch" onclick="get_drop_down_batch($(this),'+v.mfqItemID+','+v.qtyUsed+')"><i class="fa fa-plus"></i></button><input type="hidden" name="estimated_qty[]" class="batch_qty"  value="'+v.qtyUsed+'"> <input type="hidden" name="batch[]" class="batch"  value="'+v.batchNumber+'"><div class="batch_text" id="batch_text">'+batches+'</div> </td> <td><input type="text" name="qtyUsed[]" value="' + v.qtyUsed + '" placeholder="<?php echo number_format(0, $this->common_data["company_data"]["company_default_decimal"]); ?>" onkeyup="cal_material_total(this)" onkeypress="return validateFloatKeyPress(this,event)" class="form-control number qtyUsed" onfocus="this.select();" readonly> </td> <td> <div class="text-right">'+v.currentstock+'</td> <td> <div class="text-right materialQtyUsage" onclick="load_usage_history(' + workProcessID + ',' + v.jobCardID + ',' + v.jcMaterialConsumptionID + ',1)">' + v.usageQty + '</div>  <input type="hidden" name="usageQty[]" value="' + v.usageQty + '" class="form-control usageQty"></td> <td><input type="text" name="unitCost[]" value="' + v.unitCost + '" placeholder="<?php echo number_format(0, $this->common_data["company_data"]["company_default_decimal"]); ?>" onkeyup="cal_material_total(this)" onkeypress="return validateFloatKeyPress(this,event)" class="form-control number unitCost" onfocus="this.select();" <?php echo $readUnitPrice; ?>> </td> <td>&nbsp;<span class="materialCostTxt pull-right" style="font-size: 12px;text-align: right;margin-top: 8%;">' + commaSeparateNumber(v.materialCost, <?php echo $this->common_data['company_data']['company_default_decimal']; ?>) + '</span> <input type="hidden" name="materialCost[]" value="' + v.materialCost + '" class="materialCost"> </td> <td style="width: 100px"> <div class="input-group"> <input type="text" name="markUp[]" placeholder="0" class="form-control number markupPrc" value="' + v.markUp + '" onkeyup="cal_material_total(this)" onfocus="this.select();" onkeypress="return validateFloatKeyPress(this,event)"> <span class="input-group-addon">%</span> </div> </td> <td>&nbsp;<span class="materialChargeTxt pull-right" style="font-size: 12px;text-align: right;margin-top: 8%;">' + commaSeparateNumber(v.materialCharge, <?php echo $this->common_data['company_data']['company_default_decimal']; ?>) + '</span> <input type="hidden" name="materialCharge[]" value="' + v.materialCharge + '" class="materialCharge"> </td> <td class="remove-td" style="vertical-align: middle;text-align: center"><span onclick="delete_materialConsumption(' + v.jcMaterialConsumptionID + ',' + v.jobCardID + ')" class="glyphicon glyphicon-trash" style="color:rgb(209, 91, 71);"></span></td> </tr>');
                        }else{
                             $('#material_consumption_body').append('<tr id="rowMC_' + v.jcMaterialConsumptionID + '"> <td>' + jobStatus + '</td> <td> <input type="text" onkeyup="clearitemAutoID(event,this)" class="form-control f_search" name="search[]" placeholder="Item ID, Item Description..." id="f_search_' + search_id + '" value="' + v.itemDescription + '"> <input type="hidden" class="form-control mfqItemID" name="mfqItemID[]" value="' + v.mfqItemID + '"> <input type="hidden" class="form-control jcMaterialConsumptionID" name="jcMaterialConsumptionID[]" value="' + v.jcMaterialConsumptionID + '"> </td> <td><input type="text" name="partNo[]" class="form-control partNo" readonly value="' + v.partNo + '"> </td> <td>'+sel+'</td> <td><input type="text" name="qtyUsed[]" value="' + v.qtyUsed + '" placeholder="<?php echo number_format(0, $this->common_data["company_data"]["company_default_decimal"]); ?>" onkeyup="cal_material_total(this)" onkeypress="return validateFloatKeyPress(this,event)" class="form-control number qtyUsed" onfocus="this.select();" readonly> </td> <td> <div class="text-right">'+v.currentstock+'</td> <td> <div class="text-right materialQtyUsage" onclick="load_usage_history(' + workProcessID + ',' + v.jobCardID + ',' + v.jcMaterialConsumptionID + ',1)">' + v.usageQty + '</div>  <input type="hidden" name="usageQty[]" value="' + v.usageQty + '" class="form-control usageQty"></td> <td><input type="text" name="unitCost[]" value="' + v.unitCost + '" placeholder="<?php echo number_format(0, $this->common_data["company_data"]["company_default_decimal"]); ?>" onkeyup="cal_material_total(this)" onkeypress="return validateFloatKeyPress(this,event)" class="form-control number unitCost" onfocus="this.select();" <?php echo $readUnitPrice; ?>> </td> <td>&nbsp;<span class="materialCostTxt pull-right" style="font-size: 12px;text-align: right;margin-top: 8%;">' + commaSeparateNumber(v.materialCost, <?php echo $this->common_data['company_data']['company_default_decimal']; ?>) + '</span> <input type="hidden" name="materialCost[]" value="' + v.materialCost + '" class="materialCost"> </td> <td style="width: 100px"> <div class="input-group"> <input type="text" name="markUp[]" placeholder="0" class="form-control number markupPrc" value="' + v.markUp + '" onkeyup="cal_material_total(this)" onfocus="this.select();" onkeypress="return validateFloatKeyPress(this,event)"> <span class="input-group-addon">%</span> </div> </td> <td>&nbsp;<span class="materialChargeTxt pull-right" style="font-size: 12px;text-align: right;margin-top: 8%;">' + commaSeparateNumber(v.materialCharge, <?php echo $this->common_data['company_data']['company_default_decimal']; ?>) + '</span> <input type="hidden" name="materialCharge[]" value="' + v.materialCharge + '" class="materialCharge"> </td> <td class="remove-td" style="vertical-align: middle;text-align: center"><span onclick="delete_materialConsumption(' + v.jcMaterialConsumptionID + ',' + v.jobCardID + ')" class="glyphicon glyphicon-trash" style="color:rgb(209, 91, 71);"></span></td> </tr>');
                        }
    ...
    function calculateMaterialConsumtionTotal() {
        ...
        $('#material_consumption_body tr').each(function () {
            ...
            var tot_materialCharge_value = parseFloat($('td', this).eq(10).find('input').val());
       ...
       function addStagesJobWise() {
        ...
        function update_job_stage_tbl(mfq_job_id){
            ...
            $.ajax({
                ...
                data: {'workProcessID': workProcessID,'mfq_job_id': mfq_job_id,'documentID': documentID,'templateDetailID':<?php echo $templateDetailID ?>},
                cache: false,
                beforeSend: function () {
                    startLoad();
                },
