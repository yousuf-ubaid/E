                        ...
                        <div class="form-group col-sm-4">
                            <span class="input-req"
                                  title="Required Field"><input type="text" name="jobNo" id="jobNo" class="form-control"
                                                                value="<?php echo $jobMasterRec["documentCode"] ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-4">
                            <input type="text" name="quotationRef" id="quotationRef" class="form-control"
                                   value="<?php echo  $jobMasterRec["estimateCode"] ?>">
                        </div>
                        <div class="form-group col-sm-2">
                        ...
                        <div class="form-group col-sm-4">
                            <span class="input-req"
                                  title="Required Field">
                                    ...
                                    value="<?php echo $jobMasterRec["description"] ?>">
                                <span class="input-req-inner"></span></span>
                            ...
                            <div class="table-responsive" id="tbl_stage_section">
                                <table id="mfq_crew_<?php echo $documentID ?>" class="table table-condensed">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-default" onclick="load_checklist(<?php echo $workProcessID.','.$stage_id ?>)"><i class="fa fa-doc"></i></button>
...
<script>
       function addStagesJobWise() {
        ...
        function load_checklist(workProcessID,stage_id){

            $.ajax({
                type: 'POST',
                dataType: 'json',
                url: "<?php echo site_url('MFQ_Job/load_check_list'); ?>",
                data: {'workProcessID': workProcessID,'stage_id': stage_id},
                cache: false,
                beforeSend: function () {
                    startLoad();
                },
