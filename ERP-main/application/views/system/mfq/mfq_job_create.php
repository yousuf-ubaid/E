...
<div class="m-b-md" id="wizardControl">
    ...
    <a class="btn btn-default size-sm btn-wizard" href="#step2" onclick="load_workflow_design()" data-toggle="tab">Step
        2 - Job Detail</a>
    <a class="btn btn-default size-sm btn-wizard" href="#step3" onclick="load_rfi_header()" data-toggle="tab">RFI Details</a>
</div>
<hr>
<div class="tab-content">
        ...
        <div class="row">
            <div class="col-md-6 animated zoomIn">
                ...
                <div class="row" id="estimate" style="display: none;">
                    ...
                    <div class="form-group col-sm-1" style="padding: 0px">
                        ...
                        <button type="button" name="addedItem" id="addedItem" onclick="loadItemList()"
                                class="btn btn-primary" title="Add item "><i class="fa fa-plus"
                                                                                          aria-hidden="true"></i>
                        </button>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-7">
                        <span class="input-req" title="Required Field">
                            ...
                            <?php   echo form_dropdown('ownerID',$employee_arr, '', 'class="form-control select2" id="ownerID" onchange="change_job_owner(this)" '); ?>
            ...
            <div class="col-md-6 animated zoomIn">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-7">
                <span class="input-req"
                      title="Required Field"><div class="input-group datepic" id="dateDeliveryDate">
                        <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                        <input type="text" name="deliveryDate" id="deliveryDate"
                               data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                               value="<?php echo $current_date; ?>" class="form-control deliveryDate" required>
                    </div>
                    <span class="input-req-inner"></span></span>
                    </div>
                </div>
    ...
    <div id="step2" class="tab-pane">
        <div id="" class="row review hide">
            <div class="col-md-12"><span class="no-print pull-right"> <a class="btn btn-default-new btn-sm size-sm" id="de_link"
    ...
    <div id="step3" class="tab-pane">
        <div id="" class="row review hide">
            <div class="col-md-12"><span class="no-print pull-right"> <a class="btn btn-default-new btn-sm size-sm" id="de_link"
                                                                         onclick="load_RFI_header_detail()"><span
                                class="glyphicon glyphicon-random" aria-hidden="true"></span> &nbsp;&nbsp;&nbsp;Add RFI Detail </a> </span>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12 animated zoomIn">
                ...
                <input type="hidden" id="rfi_job_number" />
            </div>
        </div>
        <br>
                    ...
                    <span class="input-req-inner"></span></span>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-7">
                                <span class="input-req"
                                    title="Required Field">
                                    <?php echo form_dropdown('location', $location_arr, $location_arr_default, 'class="form-control select2" id="location" name="location"'); ?>
                                    <span class="input-req-inner"></span></span>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-7">
                                <span class="input-req"
                                    title="Required Field">
                                    <?php echo form_dropdown('uomID', $umo, '', 'class="form-control select2" id="uomID" name="uomID"'); ?>
                                    <span class="input-req-inner"></span></span>
                            </div>
                        </div>
...
<div class="modal fade" id="item_batch_select_modal" role="dialog" aria-labelledby="myModalLabel"
     data-width="95%" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg" style="width: 60%">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Batch Select</h4>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label>Estimated Quantity  &nbsp &nbsp &nbsp</label>
                            <input class="" type="text" name="estimated_qty" id="estimated_qty" value="" />
                        </div>

                        <table id="item_batch_select_tbl" class="table table-condensed table-bordered">
                            <thead>
                            <tr>
                                <th style="width: 3%">#</th>
                            ...
                            <tbody id="item_batch_select_modal_body">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                <button type="button" class="btn btn-primary" onclick="proccedToBatchSelect()">Proceed</button>
            </div>
        </div>
    </div>
</div>

<div class="modal fade" id="modal_link_rfi_header_detail" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel">RFI Details</h4>
            </div>
            <div class="modal-body">
                <div class="col-md-12">
           
                    <?php echo form_open('', 'role="form" id="rfi_header_form"'); ?>
                    <div class="row">
                        <div class="form-group col-sm-12">
                            <label class="">JOB ID</label>
                            <span class="input-req"
                                title="Required Field">
                                <input class="form-control" type="text" name="rfiJobID" id="rfiJobID" value=""> 
                                <span class="input-req-inner"></span></span>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-sm-3">
                            ...
                            <span class="input-req"
                                title="Required Field">
                                <input type="text" class="form-control"  name="equpSerial" id="equpSerial" value=""> 
                                <span class="input-req-inner"></span></span>
                        </div>
                        <div class="form-group col-sm-3">
                            ...
                            <span class="input-req"
                                title="Required Field">
                                <input type="text" class="form-control"  name="drawingRef" id="drawingRef" value=""> 
                                <span class="input-req-inner"></span></span>
                        </div>
                        <div class="form-group col-sm-3">
                            ...
                            <span class="input-req"
                                title="Required Field">
                                <input type="text" class="form-control"  name="rfiQty" id="rfiQty" value=""> 
                                <span class="input-req-inner"></span></span>
                        </div>
                        <div class="form-group col-sm-3">
                            ...
                            <span class="input-req"
                                title="Required Field">
                                <input type="text" class="form-control"  name="clientTpi" id="clientTpi" value=""> 
                                <span class="input-req-inner"></span></span>
                        </div>
                    ...
                    <div class="row hide">
                        <div class="form-group col-sm-6">
                            <label class="">Responsible Employee</label>
                            <span class="input-req"
                                title="Required Field">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="saveRfiHeader()">Save RFI</button>
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="mfq_stage_checklist" role="dialog" aria-labelledby="myModalLabel"
     data-width="95%" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg" style="width: 60%">
        <div class="modal-content">
            <div class="modal-header">
...
<div class="modal fade" id="modal_outputitems" role="dialog" aria-labelledby="myModalLabel"
     data-width="95%" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-lg" style="width: 60%">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title">Output Items</h4>
            </div>
            <div class="modal-body">
                <div id="mfq_output_div"></div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#job_close_form').bootstrapValidator({
            ...
            fields: {
                ...
                location: {validators: {notEmpty: {message: 'Warehouse is required.'}}},
            }
        }).on('success.form.bv', function (e) {
            e.preventDefault();
            var $form = $(e.target);
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (!jQuery.isEmptyObject(data)) {
                        // localStorage.setItem('erpWarehouse',data['erpWarehouse']);
                        $("#location").val(data['erpWarehouse']);
                        ...
                        $('#jobNumber').html("<span style='color:#121826'>Job Code: </span>" + data['documentCode']);
                        $('#rfi_job_number').val(data['documentCode']);
                        $('#estimateCode').html("<span style='color:#121826'>Estimate Code: </span>" + data['estimateCode']);
                        $('#inquiryCode').html("<span style='color:#121826'>Inquiry Code: </span>" + data['ciCode']);
                        $('#qty').val(data['qty']);
    ...
    function change_job_owner(ev){
        ...
        if(ownerID){
            ...
            $.ajax({
                ...
                type: 'post',
                // dataType: 'html',
                data: {workProcessID: workProcessID,ownerID : ownerID},
                url: "<?php echo site_url('MFQ_Template/update_ownerID'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
                    stopLoad();
                    myAlert('s','Owner Updated Successfully');
    ...
    function load_RFI_header_detail(){

        var job_number = $('#rfi_job_number').val();
    
        $('#rfiJobID').val(job_number).attr('readonly',true);

        $("#modal_link_rfi_header_detail").modal('show');
    }

    function saveRfiHeader(){

        var jobID = $('#rfiJobID').val();
        var equpSerial = $('#equpSerial').val();
        var drawingRef = $('#drawingRef').val();
        var rfiQty = $('#rfiQty').val();
        var clientTpi = $('#clientTpi').val();
        var empID = $('#empID').val();
        ...
        $.ajax({
            ...
            type: 'post',
            // dataType: 'html',
            data: {'workProcessID': workProcessID,'rfiJobID':jobID,'equpSerial':equpSerial,'drawingRef':drawingRef,'rfiQty':rfiQty,'clientTpi':clientTpi,'empID':empID},
            url: "<?php echo site_url('MFQ_Job/save_rfi_header'); ?>",
            beforeSend: function () {
                startLoad();
            ...
            success: function (data) {
                stopLoad();
                load_rfi_header();
                $("#modal_link_rfi_header_detail").modal('hide');
            },
            error: function () {
                alert('An Error Occurred! Please Try Again.');
                stopLoad();
    ...
    function load_rfi_header(){

        Otable = $('#RFItbl').DataTable({
            "language": {
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('MFQ_Job/fetch_rfi_details'); ?>",
            "aaSorting": [[0, 'desc']],
    ...
    function editRfi(rfiID){
        fetchPage('system/mfq/rfi_detail_manage',null,'Add RFI details','RFI',rfiID);
    }
        ...
        swal({
            ...
            function () {
                $.ajax({
                    ...
                    // dataType: 'html',
                    data: {'id':id},
                    url: "<?php echo site_url('MFQ_Job/delete_rfi_master'); ?>",
                    beforeSend: function () {
                        startLoad();
...
function create_po_document(){
    ...
    function loadItemList(){
        $.ajax({
            ...
            // dataType: 'html',
            data: {'workProcessID':workProcessID},
            url: "<?php echo site_url('MFQ_Job/load_mfq_outputitem'); ?>",
            beforeSend: function () {
                startLoad();
            ...
            success: function (data) {
                stopLoad();
                refreshNotifications(true);
                $('#mfq_output_div').empty().html(data);
                $("#modal_outputitems").modal('show');
