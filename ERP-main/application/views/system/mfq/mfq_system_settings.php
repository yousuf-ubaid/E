...
$title = $this->lang->line('manufacturing_system_settings');
            ...
            <aside class="sidebar-left col-md-3 " style="width: 21%;">
                <ul id="list" class="nav nav-list left-sidenav">
                    <li class="documentStatus"><a onclick="configuration_page('documentStatus')" href="#"> <i
                                    class="fa fa-chevron-right pull-right"></i><?php echo $this->lang->line('manufacturing_document_status'); ?><!--Document Status--></a></li>
                </ul>
            </aside>
