                ...
                <div class="col-sm-11">
                    <div class="zx-tab-content">
                        <div class="zx-tab-pane active" id="Tab-home-v">
                            ...
                            <hr>
                            <form class="form-horizontal" id="job_approval_process_based_form">
                                        ...
                                        <div class="form-group col-sm-6">
                                            <div class="input-req" title="Required Field">
                                                <div class='input-group date filterDate' id="">
                                                    <input type='text' class="form-control" name="postingFinanceDate" id="postingFinanceDate" value="<?php echo $current_date; ?>" data-inputmask="'alias': '<?php echo $date_format_policy ?>'"/>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('.headerclose').click(function () {
            fetchPage('system/mfq/mfq_job_approval_process_based', '', 'Job');
        });
        job_table();

        $('#job_approval_process_based_form').bootstrapValidator({
            live: 'enabled',
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: data,
                url: "<?php echo site_url('MFQ_Job/save_job_approval_process_based'); ?>",
                beforeSend: function () {
                    startLoad();
                },
    ...
    function job_table() {
        var Otable = $('#job_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('MFQ_Job/fetch_job_approval_process_based'); ?>",
            "aaSorting": [[1, 'desc']],
    ...
    function fetch_approval(workProcessID, documentApprovedID, Level, jobID,finalApproval,financeDate) {
        if (workProcessID) {
            $.ajax({
                ...
                type: 'post',
                dataType: 'html',
                data: {'workProcessID': workProcessID, 'html': true},
