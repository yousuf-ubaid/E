        ...
        <div class="col-md-12">
            <div class="box-body no-padding">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <?php echo form_dropdown('status', array('' => 'Status', '1' => 'Draft', '2' => 'Confirmed', '3' => 'Deleted'), '', 'class="form-control" onchange="startMasterSearch()" id="status"'); ?>
                    </div>
...
<script type="text/javascript">
    ...
    function excel_Export() {
        var form = document.getElementById('mortality_filter_frm');
        form.target = '_blank';
        form.action = '<?php echo site_url('Buyback/export_mortality_excel'); ?>';
        form.submit();
    }
    ...
    function getMortalityManagement_tableView(pageID,uriSegment = 0) {
        ...
        var data = $('#mortality_filter_frm').serializeArray();
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: data,
            url: "<?php echo site_url('Buyback/load_mortality_Master_view'); ?>/" + uriSegment,
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
                $('#MortalityMaster_view').html(data['view']);
        ...
        swal({
            ...
            function () {
                $.ajax({
                    ...
                    dataType : 'json',
                    data : {'mortalityAutoID':id},
                    url :"<?php echo site_url('Buyback/re_open_mortality'); ?>",
                    beforeSend: function () {
                        startLoad();
                    },
                    success : function(data){
