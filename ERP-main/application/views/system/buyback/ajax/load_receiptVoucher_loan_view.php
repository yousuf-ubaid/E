        ...
        <table class="table table-hover table-striped">
            ...
            foreach ($loan as $val) {
                ...
                <tr>
                    ...
                    <td class="mailbox-star"><?php echo $val['comment']; ?></td>
                    ...
                    <td class="mailbox-attachment taskaction_td">
                        <span class="pull-right">
                            <a onclick="edit_receiptVoucher_loan(<?php echo $val['pvDetailID'] ?>)"><span title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;<a
