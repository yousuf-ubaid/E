...
<?php
if (!empty($income)) { ?>
    <div class="table-responsive mailbox-messages" id="depositrecid">
        <table class="table table-hover table-striped">
            ...
            foreach ($income as $val) {
                ...
                <tr>
                    ...
                    <td class="mailbox-star">Deposit : <?php echo $val['comment']; ?></td>
                    ...
                    <td class="mailbox-attachment taskaction_td"><span class="pull-right">
                            <a onclick="edit_receiptVoucher_single_income(<?php echo $val['pvDetailID'] ?>)"><span title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;<a
                                onclick="delete_receiptVoucher_income(<?php echo $val['pvDetailID'] ?>)"><span title="Delete" rel="tooltip" class="glyphicon glyphicon-trash" style="color:rgb(209, 91, 71);"></span></a></span>
                    </td>
                </tr>
                <?php
                $x++;
    ...
    <br>
    <div class="search-no-results" id="depositrecid">NO RECORDS FOUND.</div>
    <?php
}
?>
