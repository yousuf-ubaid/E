...
if (!empty($fieldOfficer)) { ?>
    <div class="table-responsive mailbox-messages">
        <table class="table table-hover table-striped">
            ...
            <?php
            $x = 1;
            foreach ($fieldOfficer as $val) {
                ?>
                <tr>
                    <td class="mailbox-star" width="5%"><?php echo $x; ?></td>
                    <td class="mailbox-star" width="20%"><?php echo $val['ECode']; ?></td>
                    <td class="mailbox-star" width="20%"><?php echo $val['Ename2']; ?></td>
                    <td class="mailbox-name" style="text-align: center">
                        <?php if ($val['ffoActive'] == 1) { ?>
                    ...
                    <td class="mailbox-attachment">
                        <span class="pull-right"><a href="#" onclick="edit_fieldOfficer(<?php echo $val['fieldOfficerID'] ?>)"><span title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="delete_fieldOfficer(<?php echo $val['fieldOfficerID'] ?>);"><span title="Delete" rel="tooltip" class="glyphicon glyphicon-trash" style="color:rgb(209, 91, 71);"></span></a>
                        </span>
                    </td>
                </tr>
                <?php
    ...
    <br>
    <div class="search-no-results">THERE ARE NO ASSIGN FIELD OFFICER TO DISPLAY.</div>
    <?php
}
?>
