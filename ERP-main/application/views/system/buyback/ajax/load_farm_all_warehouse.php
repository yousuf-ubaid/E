...
if (!empty($warehouse)) { ?>
        ...
        <table class="table table-hover table-striped">
            ...
            foreach ($warehouse as $val) {
                ...
                <tr>
                    ...
                    <td class="mailbox-star" width="20%"><?php echo $val['wareHouseCode']; ?></td>
                    <td class="mailbox-star" width="20%"><?php echo $val['wareHouseDescription']; ?></td>
                    ...
                    <td class="mailbox-attachment">
                        <span class="pull-right"><a href="#" onclick="edit_farmWarehouse(<?php echo $val['farmWarehouseID'] ?>)"><span
                                    title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a
                                onclick="delete_farmWarehouse(<?php echo $val['farmWarehouseID'] ?>);"><span title="Delete" rel="tooltip" class="glyphicon glyphicon-trash" style="color:rgb(209, 91, 71);"></span></a>
                        </span>
                    </td>
                </tr>
                <?php
    ...
    <br>
    <div class="search-no-results">THERE ARE NO ASSIGN WAREHOUSE TO DISPLAY.</div>
    <?php
}
?>
