<?php
if($extra['master_data']['PVtype'] == 1)
{
    $voucherCode = 'PV';
} else if($extra['master_data']['PVtype'] == 2)
{
    $voucherCode = 'RV';
} else if($extra['master_data']['PVtype'] == 3)
{
    $voucherCode = 'SV';
}else if($extra['master_data']['PVtype'] == 4)
{
    $voucherCode = 'JV';
}?>
...
<div class="table-responsive"><br>
    <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            <th class='theadtr' style="min-width: 5%"><?php echo $voucherCode;?> Type</th>
            <th class='theadtr' style="min-width: 5%">GL Type</th>
        ...
        if (!empty($extra['gl_detail'])) {
            foreach ($extra['gl_detail'] as $val) { ?>
                <tr>
                    ...
                    <td style="text-align:center;"><?php echo $val['payment_type']; ?></td>
        ...
        <tfoot>
        <tr>
            <td class="text-right sub_total" colspan="7">Double Entry Total (<?php echo $extra['currency']; ?>) </td>
