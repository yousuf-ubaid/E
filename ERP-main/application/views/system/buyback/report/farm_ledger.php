...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function(){
            fetchPage('system/buyback/report/farm_ledger','<?php echo $_POST["page_id"] ?>','<?php echo $_POST["page_name"] ?>');
        });
        ...
        if(type == 1){
            url = '<?php echo site_url('Buyback/get_farm_ledger_report'); ?>';
            urlPdf = '<?php echo site_url('Buyback/get_farm_ledger_report_pdf'); ?>';
        }else{
            url = '<?php echo site_url('Buyback/get_group_farm_ledger_report'); ?>';
            urlPdf = '<?php echo site_url('Buyback/get_group_farm_ledger_report_pdf'); ?>';
        }
        get_farm_ledger_filter();/*call filter for report method*/
    ...
    function get_farm_ledger_filter() {
        $.ajax({
            async: true,
            type: 'POST',
            dataType: 'html',
            data: {formName: "frm_filter", reportID: '<?php echo $_POST["page_id"] ?>',type:type},
            url: "<?php echo site_url('Buyback/get_farm_ledger_filter'); ?>",
            beforeSend: function () {
