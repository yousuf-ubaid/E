<?php echo head_page('Vouchers Approval', false); ?>
...
<div class="table-responsive">
    <table id="paymentVoucher_table" class="<?php echo table_class(); ?>">
        <thead>
        <tr>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Voucher Approval</h4>
            </div>
                        ...
                        <div class="zx-tab-content">
                            <div class="zx-tab-pane active" id="Tab-home-v">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="hidden" name="pvMasterAutoID" id="pvMasterAutoID">
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="tab-pane hide" id="Tab-profile-v">
                                <div class="table-responsive">
                                    ...
                                    &nbsp <strong>Voucher Attachments</strong>
                                    <br><br>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/buyback/paymentvoucher_approval','','Payment Voucher');
        });
        paymentVoucher_table();

        $('#paymentVoucher_approval_form').bootstrapValidator({
            live: 'enabled',
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: data,
                url: "<?php echo site_url('Buyback/save_paymentVoucher_approval'); ?>",
                beforeSend: function () {
                    startLoad();
                },
    ...
    function paymentVoucher_table() {
        Otable = $('#paymentVoucher_table').DataTable({
            "bProcessing": true,
            "bServerSide": true,
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Buyback/paymentVoucher_table_approval'); ?>",
            "aaSorting": [[1, 'desc']],
            ...
            "columnDefs": [{"targets": [6,7], "searchable": true, "visible": false, "orderable": false},{"targets": [0,2,4,5], "searchable": false}],
    ...
    function fetch_approval(pvMasterAutoID, documentApprovedID, Level) {
        if (pvMasterAutoID) {
            $.ajax({
                async: true,
                type: 'post',
                dataType: 'html',
                data: {'pvMasterAutoID': pvMasterAutoID, 'html': true,'size':1},
