...
echo head_page('Return Approval', false);
?>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Return Approval</h4>
            </div>
                            ...
                            <div class="zx-tab-pane active" id="Tab-home-v">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="hidden" name="ReturnAutoID" id="ReturnAutoID">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/buyback/return_approval', '', 'Return Approval')
        });
        Return_table();
        $('#pv_approval_form').bootstrapValidator({
            ...
            fields: {
                ...
                ReturnAutoID: {validators: {notEmpty: {message: 'Return Auto Id is required.'}}},/*Payment Voucher ID is required*/
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: data,
                url: "<?php echo site_url('Buyback/save_return_approval'); ?>",
                beforeSend: function () {
                    startLoad();
                },
    ...
    function Return_table() {
        Otable = $('#Return_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Buyback/fetch_return_approval'); ?>",
            "aaSorting": [[1, 'desc']],
            ...
            "aoColumns": [
                ...
                {"mData": "approved"},
                {"mData": "edit"},
                {"mData": "total_TransferCost_search"},
                {"mData": "transactionCurrency"}
            ],
            "columnDefs": [{"targets": [9,10], "searchable": true, "visible": false},{"targets": [0,5,7,8], "searchable": false}],
    ...
    function fetch_approval(Returnautoid, documentApprovedID, Level) {
        if (Returnautoid) {
            $.ajax({
                async: true,
                type: 'post',
                dataType: 'html',
                data: {'returnAutoID': Returnautoid, 'html': true, 'approval': 1},
                ...
                success: function (data) {
                    ...
                    $('#comments').val('');
                    customerInvoice_attachment_View_modal('BBDR', Returnautoid);
                    stopLoad();
