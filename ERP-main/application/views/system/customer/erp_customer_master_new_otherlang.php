...
<div class="tab-content">
    <div id="step1" class="tab-pane active">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-4">
                <label for="customerName">Customer Name others / أسماء العملاء الآخرين</label><!--Customer Name others-->
                <input type="text" class="form-control" id="customerNameothers" name="customerNameothers" required>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group col-sm-4">
                <label for="customerAddress1">Primary Address Others / العنوان الرئيسي  </label><!--Primary Address-->
                <textarea class="form-control" rows="2" id="customerAddress1others" name="customerAddress1others"></textarea>
            </div>
            <div class="form-group col-sm-4">
            ...
            <div class="form-group col-sm-4">
                <label for="customerAddress2">Secondary Address Others / العنوان الثانوي</label><!--Secondary Address-->
                <textarea class="form-control" rows="2" id="customerAddress2othres" name="customerAddress2othres"></textarea>
            </div>
            ...
            $.ajax(
                {
                    ...
                    dataType: 'json',
                    data: data,
                    url: "<?php echo site_url('Customer/save_customer_otherlang'); ?>",
                    beforeSend: function () {
                        startLoad();
                    },
                    success: function (data) {
                        ...
                        if (data['status'] == true) {
                            fetchPage('system/customer/erp_customer_master_arabic', 'Test', 'customer Master');
                        }
                    },
                    error: function () {
            ...
            $.ajax({
                ...
                success : function(data){
                    if(!jQuery.isEmptyObject(data)){
                        ...
                        $('#customerNameothers').val(data['customerNameOtherLang']);
                        ...
                        $('#customerAddress1others').val(data['customerAddress1OtherLang']);
                        $('#customerAddress2').val(data['customerAddress2']);
                        $('#customerAddress2othres').val(data['customerAddress2OtherLang']);
