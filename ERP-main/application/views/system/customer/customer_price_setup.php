...
?>
        ...
        <ul class="nav nav-tabs mainpanel">
            <li class="active">
                <a class="buybackTab" onclick="" id="" data-id="0"
                   href="#step1" data-toggle="tab"
                   aria-expanded="true"><span><i class="fa fa-cog tachometerColor" aria-hidden="true"
                                                 style="color: #50749f;font-size: 16px;"></i>&nbsp;&nbsp;<?php echo $this->lang->line('sales_maraketing_masters_price_setup');?> <!--Price Setup--></span></a>
            </li>
            <li class="">
                <a class="buybackTab" onclick="CustomerPriceListTableView()" id="" data-id="0"
                   href="#step2" data-toggle="tab"
                   aria-expanded="true"><span><i class="fa fa-list tachometerColor" aria-hidden="true"
                                                 style="color: #50749f;font-size: 16px;"></i>&nbsp;<?php echo $this->lang->line('sales_maraketing_masters_customer_price_list');?><!--Customer Price List--></span></a>
            </li>
        </ul>
    </div>
                ...
                <div class="col-md-12 animated zoomIn">
                    <div class="row" style="margin-top: 10px;">
                        ...
                        <div class="col-sm-3">
                              <button type="button" class="btn btn-primary pull-right"
                                        onclick="fetchPage('system/customer/erp_new_Customer_priceSetup',null,'<?php echo $this->lang->line('sales_maraketing_masters_add_new_customer_price_document')?>','CPS');"><!--Add New Customer Price Document--><i
                                        class="fa fa-plus"></i><?php echo $this->lang->line('common_create_new_document');?> <!-- Create New Document-->
                                </button>
                            <!--       <button type="button" class="btn btn-primary pull-right"
                                        onclick="addNewSalesPriceDocument()">
                    ...
                    <div class="row" style="margin-top: 20px;">
                        <div class="table-responsive">
                            <table id="customer_PriceSetup_table" class="<?php echo table_class(); ?>">
                                <thead>
                                <tr>
                                    <th style="width: 5%">#</th>
                                    <th style="width: 12%"><?php echo $this->lang->line('common_document_code');?> <!--Document Code--></th>
                                    <th style="width: 30%"><?php echo $this->lang->line('common_customer');?><!--Customer Name--></th>
    ...
    <script type="text/javascript">
        ...
        function CustomerPriceSetupTable() {
            Otable = $('#customer_PriceSetup_table').DataTable({
                "language": {
                ...
                "bDestroy": true,
                "StateSave": true,
                "sAjaxSource": "<?php echo site_url('Customer/fetch_customerPriceSetup'); ?>",
                "aaSorting": [[1, 'asc']],
        ...
        function CustomerPriceListTableView() {
            Otable = $('#customerWise_PriceList_table').DataTable({
                ...
                "bDestroy": true,
                "StateSave": true,
                "sAjaxSource": "<?php echo site_url('Customer/fetch_customerWisePrice'); ?>",
                "aaSorting": [[1, 'asc']],
                "fnInitComplete": function () {
        ...
        function Customer_priceSetup_DocumentView(cpsAutoID) {
            $.ajax({
                async: true,
                type: 'post',
                dataType: 'html',
