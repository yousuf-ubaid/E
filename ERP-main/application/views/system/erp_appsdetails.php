            ...
            <div class="modal-body">
                <form id="quoteform" name="quoteform" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-md-2 control-label" for="selectbasic"></label>
                        <div class="col-md-8">
                        <span class="help-block"> By checking this box and submitting my information to <?php echo EMAIL_SYS_NAME ?>
                            ,
                                I consent to being contacted by <?php echo EMAIL_SYS_NAME ?> with respect to my
