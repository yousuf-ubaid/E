            ...
            <tr>
                ...
                <td style="width:50%;">
                    <table>
                        <tr>
                            <td colspan="3">
                                <h3><strong><?php echo $this->common_data['company_data']['company_name'];?><!--Customer Name-->.</strong></h3>
                        ...
                        <?php } else if (!empty($extra['contactperson_detail'])){?>
                            <tr>
                                <td style="vertical-align: top;"><strong><strong><?php echo $this->lang->line('common_reference_number');?></strong></td><!--Reference Number-->
    ...
    <div class="table-responsive">
        <table style="width: 100%">
            ...
            <?php if (!empty($extra['customer']['customerSystemCode'])) { ?>
                ...
                <tr>
                    <td><strong><strong><?php echo $this->lang->line('common_customer_telephone');?><!-- Customer Telephone--></strong></td>
                    <td><strong>:</strong></td>
                    <td> <?php echo $extra['customer']['customerTelephone']; ?></td>
                </tr>
            <?php } ?>
            <tr>
                <td><strong> <strong><?php echo $this->lang->line('common_contact_person');?><!--Contact Person--></strong></td>
                <td><strong>:</strong></td>
                <td> <?php echo $extra['master']['contactPersonName']; ?></td>
            </tr>
            <tr>
                <td><strong><strong><?php echo $this->lang->line('sales_marketing_contact_person_tel');?></strong></td><!--Contact Person Tel-->
                <td><strong>:</strong></td>
                <td><?php echo $extra['master']['contactPersonNumber']; ?></td>
            </tr>
            <?php if(!empty($extra['master']['salesPersonID'])) { ?>
                <tr>
                    <td><strong><strong><?php echo $this->lang->line('sales_markating_transaction_sales_person');?> </strong></td><!--Sales Person -->
                    <td><strong>:</strong></td>
