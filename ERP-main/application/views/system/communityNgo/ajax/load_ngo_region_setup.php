    ...
    <div id="left" class="col-sm-12">
        <ul id="menu-group-1" class="nav menu">
            ...
            <li class="item-1 deeper parent" style="margin-top: 1%;">
                ...
                if (empty($default_data['province'])) {
                    ...
                    $stageTwo = $this->db->query("SELECT * FROM srp_erp_statemaster WHERE type = 1 AND countyID = {$level1['countryID']} AND stateID = {$default_data['province']} ORDER BY Description ASC")->result_array();
                }
                    ...
                    <ul class="children nav-child unstyled small collapse"
                        ...
                        <li class="item-2 deeper parent active">
                            <a class="" href="#">
                                ...
                                if (empty($default_data['district'])) {
                                    ...
                                    $stageThree = $this->db->query("SELECT * FROM srp_erp_statemaster WHERE type = 2 AND countyID = {$level1['countryID']} AND masterID = {$level2['stateID']} AND stateID = {$default_data['district']} ORDER BY Description ASC")->result_array();
                                }
                                    ...
                                    <ul class="children nav-child unstyled small collapse"
                                        ...
                                        <span data-toggle="collapse"
                                              ...
                                              class="sign"><i
                                                ...
                                                if (empty($default_data['DD'])) {
                                                    ...
                                                    $stageFour = $this->db->query("SELECT * FROM srp_erp_statemaster WHERE type = 3 AND countyID = {$level1['countryID']} AND masterID = {$level3['stateID']} AND ( stateID = {$default_data['DD']} OR divisionTypeCode = 'JD' )ORDER BY Description ASC")->result_array();
                                                }
                                        ...
                                        <span data-toggle="collapse"
                                              ...
                                              class="sign"><i
                                                ...
                                                style="color:white;font-size: 13px;"></i></span>
                                                                    <span
                                                                        class="lbl"><?php echo $divisionTypeCode_level4 . ' - ' . $level4['Description']; ?></span>&nbsp;<span
                                                                ...
                                                                <?php
                                                                $stageFive = $this->db->query("SELECT * FROM srp_erp_statemaster WHERE type = 4 AND countyID = {$level1['countryID']} AND masterID = {$level4['stateID']} ORDER BY divisionTypeCode ASC")->result_array();
                                                                //echo $this->db->last_query();
                                                                if ($stageFive) { ?>
                                                                    <ul class="children nav-child unstyled small collapse"
                                                                        ...
                                                                        foreach ($stageFive as $level5) {
                                                                            ...
                                                                            if($divisionTypeCode_level5 == 'GN'){
                                                                                $divisionNo = ' - [' . $level5['divisionNo'].']';
                                                                            }else{
                                                                                $divisionNo = '';
                                                                            }
                                        ...
                                        <span data-toggle="collapse"
                                              ...
                                              class="sign"><i
                                                class="fa fa-caret-right fa-lg" style="color: black;"></i></span>
                                                                                    <span
                                                                                        class="lbl"><?php echo $divisionTypeCode_level5 . " - " . $level5['Description'].$divisionNo; ?></span>&nbsp;
                                                                                    <span
