            ...
            <div class="box box-solid">
                ...
                <div class="box-body" style="margin-top:-20px;">
                    ...
                    <ul class="timeline timeline-inverse">
                        ...
                        <?php
                        $events1List= $this->db->query("SELECT srp_erp_ngo_com_uploads.ComUploadID, srp_erp_ngo_com_uploads.ComUploadType,familyUplaod, (DATE_FORMAT(UploadPublishedDate,'{$convertFormat}'))as UploadPublishedDate,ComUploader, ComUploadSubject,ComUpload_url, ComUploadDescription, (DATE_FORMAT(ComUploadExpireDate,'{$convertFormat}'))as ComUploadExpireDate,  ComUploadSubmited,srp_erp_ngo_com_uploads.CreatedDate FROM srp_erp_ngo_com_uploads WHERE srp_erp_ngo_com_uploads.companyID = {$companyID}  AND IF(familyUplaod=1 ,familyUplaod_active=1,familyUplaod_active=0) AND ComUploadType='1' AND srp_erp_ngo_com_uploads.UploadPublishedDate ='".$publisedDat."' ORDER BY srp_erp_ngo_com_uploads.ComUploadID DESC ");
                        ...
                        foreach ($resEvn1List as $res1Elist) {
                            ...
                            <?php if ($res1Elist->ComUploadType == 1) { ?>
                                ...
                                <?php if ($res1Elist->familyUplaod == 0) { ?>
                                        <div class="btn-group" role="group">
                                            <button title="Edit" rel="tooltip" class="btn btn-xs btn-default" type="button"
                                                    onclick="com_uploadEdit(<?php echo $res1Elist->ComUploadID; ?>)">
                                                <i class="fa fa-edit"></i>
                                            </button>
                                            <button class="btn btn-xs btn-danger" onclick="com_uploadDelete(<?php echo $res1Elist->ComUploadID; ?>)"
                                        ...
                                        <div class="timeline-body">
                                            <table>
                                                ...
                                                <tfoot style="border: none;"><tr style="text-align: center;"><td colspan="6">
                                                        <?php if($res1Elist->familyUplaod == 1) { ?>
                                                            <div class="blink_div"><strong
                                                                    style=" color: #8093ad;font-weight:600;">Family Upload:
                                    <?php echo $res1Elist->ComUploader; ?>     </strong></div>
                                                        <?php } else{ ?>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12" style="padding:10px;">
                        <ul class="timeline timeline-inverse">
                            <!-- timeline for general -->
                            <?php
                            $eventsList= $this->db->query("SELECT srp_erp_ngo_com_uploads.ComUploadID,familyUplaod, srp_erp_ngo_com_uploads.ComUploadType, (DATE_FORMAT(UploadPublishedDate,'{$convertFormat}'))as UploadPublishedDate,ComUploader, ComUploadSubject,ComUpload_url, ComUploadDescription, (DATE_FORMAT(ComUploadExpireDate,'{$convertFormat}'))as ComUploadExpireDate,  ComUploadSubmited,srp_erp_ngo_com_uploads.CreatedDate FROM srp_erp_ngo_com_uploads WHERE srp_erp_ngo_com_uploads.companyID = {$companyID}  AND IF(familyUplaod=1 ,familyUplaod_active=1,familyUplaod_active=0) AND ComUploadType='2' AND srp_erp_ngo_com_uploads.UploadPublishedDate ='".$publisedDat."' ORDER BY srp_erp_ngo_com_uploads.ComUploadID DESC ");
                            ...
                            foreach ($resEvnList as $resElist) {
                                ...
                                <?php if ($resElist->ComUploadType == 2) { ?>
                                    <li>
                                        ...
                                        <div class="timeline-item">
                                    <?php if ($resElist->familyUplaod == 0) { ?>
                                            <div class="btn-group" role="group">
                                                <button title="Edit" rel="tooltip" class="btn btn-xs btn-default" type="button"
                                                        onclick="com_uploadEdit(<?php echo $resElist->ComUploadID; ?>)">
                                                    <i class="fa fa-edit"></i>
                                                </button>
                                                <button class="btn btn-xs btn-danger" onclick="com_uploadDelete(<?php echo $resElist->ComUploadID; ?>)"
                                                        title="Delete" rel="tooltip" type="button">
                                                    <i class="fa fa-trash"></i>
                                                </button>
                                            </div>
    ...
    <script>
        ...
        function openUploadVideo_mod(ComUpload_url){
            ...
            $.ajax({
                ...
                url: "<?php echo site_url('CommunityNgo/load_uploadVideo'); ?>",
                beforeSend: function () {
                    startLoad();
                },
