...
if (!empty($attachment)) {
    foreach ($attachment as $row) {
        $donorAttachment = get_all_operationngo_images($row['myFileName'],'attachments/ngo/','donorAttach');
        ?>
        <div class="row">
            <div class="col-sm-12">
                <div class="past-info">
                    ...
                    <div class="post-area">
                        <article class="post">
                            <a target="_blank" class="nopjax" href="<?php echo base_url() . 'attachments/NGO/' . $row['myFileName'] ?>">
                                ...
                                <strong class="attachemnt_title">
                                    <img src="<?php echo base_url('images/crm/icon_pic.gif'); ?>"
                                         style="vertical-align:top"> &nbsp;<a target="_blank" class="nopjax"
                                                                              href="<?php echo $donorAttachment; ?>"><?php echo $row['myFileName']; ?></a>
                                    ...
                                    <div><span class="attachemnt_title"
                                        ...
                                        <span class="deleteSpan" style="display: inline-block;"><a
                                                onclick="delete_donor_attachment(<?php echo $row['attachmentID']; ?>,'<?php echo $row['myFileName']; ?>');"><span
