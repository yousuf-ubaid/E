        ...
        <div id="list-main" class="top15 ">
            <aside class="sidebar-left col-md-3 " style="width: 21%;">
                <ul id="list" class="nav nav-list left-sidenav">
                    <!-- <li class="user"><a onclick="configuration_page('user')"> <i
                                    class="fa fa-chevron-right pull-right"></i></a></li>Users -->

                    <!-- <li class="usergroup"><a onclick="configuration_page('usergroup')"><i
                                    class="fa fa-chevron-right pull-right"></i></a></li>User Group -->
                    <!-- <li class="pipelines"><a onclick="configuration_page('pipelines')"><i
...
<!--                    <li class="CampaignTypes"><a onclick="configuration_page('CampaignTypes')" href="#"> <i
                 ...
                 <!--   <li class="leadStatus"><a onclick="configuration_page('leadStatus')" href="#"> <i
                                    class="fa fa-chevron-right pull-right"></i> </a></li>--><!--Lead Status-->
                    <!-- <li class="leadSource"><a onclick="configuration_page('leadSource')" href="#"> <i
                                    class="fa fa-chevron-right pull-right"></i> </a></li>Source -->
                    <!-- <li class="product"><a onclick="configuration_page('product')" href="#"> <i
                                    class="fa fa-chevron-right pull-right"></i>  </a></li>Product -->
...
<script type="text/javascript">
    ...
    function configuration_page(sys, masterID) {
        $.ajax({
            ...
            url: "<?php echo site_url('Task_management/settings_users'); ?>",
            beforeSend: function () {
                startLoad();
            },
        ...
        swal({
            ...
            function () {
                $.ajax({
                    ...
                    dataType: 'json',
                    data: {'contactID': id},
                    url: "<?php echo site_url('Task_management/delete_contact_master'); ?>",
                    beforeSend: function () {
                        startLoad();
                    },
                    success: function (data) {
