...
if (!empty($header)) { ?>
    <div class="table-responsive mailbox-messages">
        <table class="table table-hover table-striped">
            ...
            <tr>
                ...
                <td class="headrowtitle" style="border-top: 1px solid #ffffff;">
                    <?php echo $this->lang->line('common_category'); ?><!--Category--></td>
                <td class="headrowtitle" style="border-top: 1px solid #ffffff;">DETAIL</td>
                <td class="headrowtitle" style="border-top: 1px solid #ffffff;">
                    <?php echo $this->lang->line('crm_priority'); ?><!--Priority--></td>
                <td class="headrowtitle" style="border-top: 1px solid #ffffff;">
                    <?php echo $this->lang->line('crm_progress'); ?><!--Progress--></td>
                <td class="headrowtitle" style="border-top: 1px solid #ffffff;">
                    <?php echo $this->lang->line('crm_responsible'); ?><!--Responsible--></td>
                <td class="headrowtitle" style="border-top: 1px solid #ffffff;width:15%;">Created By</td>
                <td class="headrowtitle" style="border-top: 1px solid #ffffff;color:#000 !important; ;">
                    <?php echo $this->lang->line('common_status'); ?><!--Status--></td>
                <td class="headrowtitle"
                    style="border-top: 1px solid #ffffff;text-align: center;color:#000 !important; ">
                    <?php echo $this->lang->line('common_action'); ?><!--Action--></td>
            </tr>
            <?php
            $x = 1;
            foreach ($header as $val) {
                ...
                <tr>
                    ...
                    <td class="mailbox-star" width="11%"><a href="#" class="<?php echo $textdecoration; ?>">
                            <a class="link-person noselect" href="#" class="<?php echo $textdecoration; ?>"
                               onclick="fetchPage('system/task_managment/task_edit_view','<?php echo $val['taskID'] ?>','View Task','CRM','CRM')">   <?php echo $val['documentSystemCode'] ?></a>
                    </td>
                    ...
                    <td class="mailbox-name taskaction_td">
                        ...
                        <div class="contact-box">
                            <div class="link-box"><strong class="contacttitle">Subject :<a
                                            class="link-person noselect" href="#" class="<?php echo $textdecoration; ?>"
                                            onclick="fetchPage('system/task_managment/task_edit_view','<?php echo $val['taskID'] ?>','View Task','CRM','CRM')"><?php echo $val['subject']; ?></a></strong><br><strong
                                        class="contacttitle">Start Date : </strong><a
                                        class="link-person noselect"
                                        href="#"><?php echo $val['starDate']; ?></a><br><strong
                                        class="contacttitle">Due Date : </strong><a
                                        class="link-person noselect" href="#"><?php echo $val['DueDate']; ?></a></div>
                        </div>
                    </td>
                    ...
                    <td class="mailbox-name"><a href="#" class="<?php echo $textdecoration; ?>"><?php
                            ...
                            $assignees = $this->db->query("SELECT srp_employeesdetails.Ename2 from srp_erp_task_assignees JOIN srp_employeesdetails ON srp_erp_task_assignees.empID = srp_employeesdetails.EIdNo where documentID = 2 AND companyID = " . $companyID . " AND MasterAutoID = " . $val['taskID'] . "")->result_array();
                            if (!empty($assignees)) {
                    ...
                    <td class="mailbox-name">
                        <div class="contact-box">
                            <div class="link-box"><strong class="contacttitle" style="color:#aaa;">User: </strong><a
                                        class="link-person noselect"
                                        href="#"><?php echo ucwords(trim_value($val['createdUserName'], 16)); ?></a><br>
                                <strong class="contacttitle" style="color:#aaa;"> Date: </strong><a
                                        class="link-person noselect" href="#"><?php echo $val['createdDateTime']; ?></a>
                            </div>
                        </div>
                    </td>
                    <td class="mailbox-star" width="10%"><span class="label"
                                                               style="background-color:<?php echo $val['statusBackgroundColor'] ?>; color:#000; font-size: 11px;"><?php echo $val['statusDescription'] ?></span>
                    </td>
                    <td class="mailbox-attachment taskaction_td"><span class="pull-right">
                            ...
                            <a href="#"
                               onclick="edit_task('<?php echo $val['taskID'] ?>','<?php echo $val['createdUserIDtask'] ?>','<?php echo $assignuser ?>');"><span
                                        ...
                                        class="glyphicon glyphicon-pencil glyphicon-pencil-btn"></span></a>&nbsp;&nbsp;<a
                                    onclick="delete_task(<?php echo $val['taskID'] ?>);"><span title="Delete"
                                                                                               rel="tooltip"
    ...
    <br>
    <div class="search-no-results"><?php echo $this->lang->line('crm_there_no_task_to_diplay'); ?>.
