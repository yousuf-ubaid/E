        ...
        <div>
            ...
            <div>
                ...
                <div class="panel with-nav-tabs panel-success" style="border: none;">
                    <div class="panel-heading  tab-row-inline">
                        <ul class="nav nav-tabs mainpanel d-tab">
                            <?php
                            if (!empty($dashboardTab)) {
                                ...
                                foreach ($dashboardTab as $val) {
                                    ...
                                    ?>
                                    <li class="<?php echo $zactive ?>">
                                        <a id="<?php echo $val["userDashboardID"] . $val["pageName"] ?>"
                                           data-id="0"
                            ...
                            if (!empty($dashboardTab)) {
                                ?>
                                <button type="button" class="btn btn-primary-new add-btn size-sm pull-right" style="margin-top: 8px;"
                                        onclick="modal_template_setup()"><i class="fa fa-plus text-white"></i> <?php echo $this->lang->line('dashboard_new_dashboard');?><!--New Dashboard-->
                                </button>
                                <?php
                            } else {
                                ?>
                                <button type="button" class="btn btn-primary-new add-btn size-sm pull-right"
                    ...
                    <div class="panel-body" style="background-color: #ecf0f5;">
                        <div class="tab-content dashboard-cus-select">
                            <?php
                            if (!empty($dashboardTab)) {
                                $i = 0;
                                $active = "";
                                foreach ($dashboardTab as $val) {
                                    ...
                                    <div class="tab-pane <?php echo $active ?>"
                                         id="template<?php echo $val["userDashboardID"] ?>">
                ...
                <script>
                            ...
                            success: function (data) {
                                ...
                                if (jQuery.isEmptyObject(data)) {
                                    ...
                                    $.each(data, function (index, value) {
                                        ...
                                        $("#radio_list").append('<div class="col-md-4" style="margin-top: 5px;"><label class="" style="padding: 1px;"><img data-toggle="tooltip"  title="' + value.widgetName + '" src="../images/' + value.widgetImage + '" alt="../images/no-image.png" id="imgchk_' + value.widgetID + '" style="height:100px; width: 100%;" class="img-thumbnail-widget img-check imgchkbox"><input onclick="checkimg(' + value.widgetID + ')" type="checkbox" data-widname="' + value.widgetName + '" data-image="' + value.widgetImage + '"  id="iCheck_' + value.widgetID + '" value="' + value.widgetID + '" class="hidden widgetcheck" autocomplete="off"></label></div>');
                                    });
                    ...
                    function addWidget() {
                        ...
                        if (labelimage != "") {
                            ...
                            $("#body" + position2).html('<div style="background-color: #D9D9D9;padding: 5px;text-align: center;"><label class="temp-setup-img" style="padding: 1px;"><img src="../images/' + labelimage + '" title="' + labelname + '" alt="No Image" style="height:156px; width: 100%;" class="img-check"></label> </div>');
