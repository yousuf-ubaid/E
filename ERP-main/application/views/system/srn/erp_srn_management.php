...
<div class="row">
    ...
    <div class="col-md-7 text-right">
        ...
        onclick="fetchPage('system/grv/erp_grv_new',null,'Add New Service Received Note','SRN');"><i class="fa fa-plus"></i> Create SRN
        </button><!--Create GRV-->
    </div>
</div>
<hr>
<div class="table-responsive">
    <table id="grv_table" class="<?php echo table_class(); ?>">
        ...
        <tr>
            ...
            <th style="min-width: 15%"> SRN Code </th><!--SRN Code-->
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function(){
            fetchPage('system/grv/erp_srn_management','Test','Service Received Note');
        });
