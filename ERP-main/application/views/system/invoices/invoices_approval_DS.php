...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/invoices/invoices_approval_DS', '', 'Invoice Approval');
        });
        Invoices_table();
    ...
    function Invoices_table() {
        Otable = $('#Invoices_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Invoices/fetch_invoices_approval_ds'); ?>",
            "aaSorting": [[0, 'desc']],
            ...
            "columnDefs": [{"visible":false,"searchable": true,"targets": [9], "orderable": false}, {"targets": [0,5], "searchable": false}],
