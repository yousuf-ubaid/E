...
$inv_type_drop = [
    ...
    /*'Direct' =>$this->lang->line('sales_markating_transaction_add_new_customer_direct_invoice')*/ /*'Direct Invoice'*//*,*/
    ...
    <div id="step1" class="tab-pane active">
        ...
        <div class="row">
            <div class="form-group col-sm-4">
                ...
                <?php echo form_dropdown('invoiceType', $inv_type_drop, 'Direct', 'class="form-control select2" onchange="validatenarration()" id="invoiceType" required'); ?>
            </div>
            <div class="form-group col-sm-4">
        ...
        <div class="row">
            ...
            <?php } else { ?>
                <div class="form-group col-sm-4">
                    ...
                    <?php echo form_dropdown('customerID', $customer_arr, '', 'class="form-control select2" id="customerID" required onchange="Load_customer_currency(this.value);Load_customer_details(this.value);fetch_customersegmentwiseproject();"'); ?>
                </div>
            <?php }?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('.headerclose').click(function(){
            fetchPage('system/invoices/invoices_management_CS',invoiceAutoID,'Customer Invoices');
        });
        $('.select2').select2();
        invoiceAutoID = null;
        invoiceType = null;
        ...
        $('#invoice_form').bootstrapValidator({
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: data,
                url: "<?php echo site_url('Invoices/save_invoice_header_commission'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
                    ...
                    if (data['status']) {
                        ...
                        $("#a_link").attr("href", "<?php echo site_url('Invoices/load_invoices_conformation_cs'); ?>/" + invoiceAutoID);
                ...
                function () {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if(data[0]=='s'){
                                setTimeout(function(){
                                    fetchPage('system/invoices/invoices_management_CS', invoiceAutoID, 'Invoices');
                                }, 500);
                            }
                            setTimeout(function(){
                                stopLoad();
    ...
    function load_conformation() {
        if (invoiceAutoID) {
            $.ajax({
                ...
                url: "<?php echo site_url('Invoices/load_invoices_conformation_cs'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
    ...
    function fetch_detail(type, customerID, currencyID,tab) {
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('Invoices/fetch_detail_cs'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
