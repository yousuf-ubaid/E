...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/invoices/sales_return_approval_buyback', '', 'Sales Return Approval')
        });
        salesReturn_table();
        $('#pv_approval_form').bootstrapValidator({
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: data,
                url: "<?php echo site_url('Inventory/save_sales_return_approval_buyback'); ?>",
                beforeSend: function () {
                    startLoad();
                },
    ...
    function salesReturn_table() {
        Otable = $('#salesReturn_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Inventory/fetch_sales_return_approval_buyback'); ?>",
            "aaSorting": [[1, 'desc']],
