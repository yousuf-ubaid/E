...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary pull-right" onclick="fetchPage('system/invoices/erp_invoices_insurance',null,'<?php echo $this->lang->line('sales_markating_transaction_add_new_customer_invoice')?>','PV');"><i class="fa fa-plus"></i> <?php echo $this->lang->line('sales_markating_transaction_create_invoice');?></button><!--Create Invoice-->
    </div>
</div><hr>
...
$(document).ready(function() {
    $('.headerclose').click(function(){
        fetchPage('system/invoices/invoice_insurance','','Customer Invoices');
    });
    invoiceAutoID = null;
    number_validation();
    invoice_table();
...
function invoice_table(selectedID=null){
     Otable = $('#invoice_table').DataTable({
        ...
        "bDestroy": true,
        "bStateSave": true,
        "sAjaxSource": "<?php echo site_url('Invoices/fetch_invoices_insurance'); ?>",
        "aaSorting": [[0, 'desc']],
        ...
        "columnDefs": [{"targets": [6], "orderable": false},{"visible":false,"searchable": true,"targets": [7,8,9,10,11,12,13] },{"targets": [0,2,3], "visible": true,"searchable": false}],
