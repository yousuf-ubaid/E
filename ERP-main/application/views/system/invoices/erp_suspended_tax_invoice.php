...
if (!empty($extra)) {
    ...
    $html .= '<hr>
            <div class="table-responsive">
                <div style="text-align: center">
                    <h4>SUSPENDED TAX INVOICE</h4><!--Sales Invoice -->
                </div>';
    ...
    $html .= '<tr>
    <td><strong>Customer SVAT No</strong></td>
    <td><strong>:</strong></td>
    <td>'. $extra['master']['sVatNumber'].'</td>     
       <td><strong>Our SVAT No</strong></td>
        <td><strong>:</strong></td>
        <td>'. $extra['master']['companySVatNumber'].'</td>                    
    </tr>';
    ...
    $html .= '</tr>';
        if($group_based_tax == 1 && $hideVatIn != 1){
            $html .= '
                    <tr>
                       <td><strong>&nbsp;</strong></td>
                        <td><strong>&nbsp;</strong></td>
...
if($invoiceType == 'Project') {
    ...
    if($group_based_tax == 1) {
        ...
        if($group_based_tax == 1 && $extra['master']['transactionCurrencyID'] != $extra['master']['companyLocalCurrencyID']) {
            ...
            $html .= '<div class="table-responsive">
                        <h5 class="text-right" style="text-align:right;margin:5px 9px 3px 5px;font-size: 12px;">
                        Sub Total (' . $extra['master']['transactionCurrency'] . ' )<!--Total-->
