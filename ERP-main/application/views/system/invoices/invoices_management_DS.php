...
<div id="filter-panel" class="collapse filter-panel">
    <?php echo form_open('', 'role="form" id="invoicemaster_DS_filter_form"'); ?>
        <div class="row">
...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary" onclick="fetchPage('system/invoices/erp_invoices_DS',null,'Add New Customer Invoice','PV');"><i class="fa fa-plus"></i> <?php echo $this->lang->line('sales_markating_transaction_create_invoice');?></button><!--Create Invoice-->
...
$(document).ready(function() {
    $('.headerclose').click(function(){
        fetchPage('system/invoices/invoices_management_DS','','Customer Invoices');
    });
    invoiceAutoID = null;
    number_validation();
    invoice_table();
...
function invoice_table(selectedID=null){
     Otable = $('#invoice_table').DataTable({
        ...
        "bDestroy": true,
        "bStateSave": true,
        "sAjaxSource": "<?php echo site_url('Invoices/fetch_invoices_DS'); ?>",
        "aaSorting": [[0, 'desc']],
...
function confirmReceiptVoucher(receiptVoucherAutoId){
    ...
    function excel_export() {
        var form = document.getElementById('invoicemaster_DS_filter_form');
        form.target = '_blank';
        form.method = 'post';
        form.post = $('#invoicemaster_DS_filter_form').serializeArray();
