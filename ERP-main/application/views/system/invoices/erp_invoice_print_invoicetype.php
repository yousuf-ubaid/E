...
?>
<?php
if($extra['master']['invoiceType']=='Sales Order'){
    ?>
            ...
            <table class="table table-bordered table-striped">
                ...
                foreach ($extra['item_detail'] as $val) {
                    ...
                    <tr>
                        ...
                        <td style="text-align:center; font-size: 12px;"><?php echo $val['seconeryItemCode']; ?></td>
                        <td style="font-size: 12px;"><?php echo $val['itemDescription']; ?> </td>
                        <td style="text-align:center; font-size: 12px;"> <?php echo $val['remarks']; ?></td>
                        <td style="text-align:center; font-size: 12px;"><?php echo $val['unitOfMeasure']; ?></td>
                        <td style="text-align:right; font-size: 12px;"><?php echo $val['contractQty']; ?></td>
                        <td style="text-align:right; font-size: 12px;"><?php echo format_number($val['contractAmount'], $extra['master']['transactionCurrencyDecimalPlaces']); ?></td>
                        <td style="text-align:right; font-size: 12px;"><?php echo format_number($val['contractAmount']*$val['contractQty'], $extra['master']['transactionCurrencyDecimalPlaces']); ?></td>
                        <td style="text-align:right; font-size: 12px;"><?php echo round(($reqqty['requestedQty']/ $val['contractQty'])*100,2) ?> %</td>
                        <td style="text-align:right; font-size: 12px;"><?php echo round(($val['requestedQty']/ $val['contractQty'])*100,2) ?> %</td>
                        <td style="text-align:right; font-size: 12px;"><?php echo round((($reqqty['requestedQty']/ $val['contractQty'])*100),2) +round((($val['requestedQty']/ $val['contractQty'])*100),2) ?> %</td>
                        <td style="text-align:right; font-size: 12px;"><?php echo format_number($reqqty['amount'], $extra['master']['transactionCurrencyDecimalPlaces'])  ?> </td>
...
<div class="table-responsive">
    ...
    <table style="width: 100%">
        ...
        <tr>
            ...
            <td><strong> Insurance Type</strong></td><!--Invoice Date-->
            <td><strong>:</strong></td>
