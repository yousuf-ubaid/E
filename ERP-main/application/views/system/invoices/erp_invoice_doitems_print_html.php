                ...
                foreach ($extra['delivery_order_itemwise'] as $val) {
                    ...
                    <tr>
                        ...
                        <?php } else if ($group_based_tax == 1){ ?>
                            ...
                            <?php if($retensionEnabled == 1) {?>
                                <td style="text-align:right; font-size: 12px;"><?php echo format_number(($val['retensionValue']), $extra['master']['transactionCurrencyDecimalPlaces']); ?></td>
                                <td style="text-align:right; font-size: 12px;"><?php echo format_number(((($val['unittransactionAmount']-$val['discountAmount'])*$val['requestedQty']) - $val['retensionValue']) , $extra['master']['transactionCurrencyDecimalPlaces']); ?></td>
                            <?php }?>
    ...
    <div class="table-responsive x">
        <table class="table table-bordered table-striped">
            ...
            foreach ($extra['delivery_order'] as $val) { ?>
                ...
                <?php foreach($val['items'] as $itemVal) { ?>
                    <tr>
                        <td></td>
                        <td colspan="4"><?php echo '<b>Item :</b>'.$itemVal['itemSystemCode'].' - '.$itemVal['itemDescription'] ?></td>
                        <td style="text-align:right; font-size: 12px;"><?php echo format_number($itemVal['transactionAmount'],$dPlace) ?></td>
                    </tr>
