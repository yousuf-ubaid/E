...
if(!empty($extra['item_detail'])){ ?>
    <div class="table-responsive">
        <table class="table table-bordered table-striped">
            <thead>
            <tr>
                <th class='theadtr' colspan="4"><?php echo $this->lang->line('sales_markating_view_invoice_item_details');?></th><!--Item Details-->
                <th class='theadtr' colspan="4"><?php echo $this->lang->line('common_price');?> (<?php echo $extra['master']['transactionCurrency']; ?>) </th><!--Price-->
            </tr>
            <tr>
            ...
            foreach ($extra['item_detail'] as $val) {
                ...
                <tr>
                    ...
                    <td style="text-align:right; font-size: 12px;"><?php echo $val['itemSystemCode']; ?></td>
                    <td style="font-size: 12px;">
                        <?php  if ($extra['master']['invoiceType'] == 'Sales Order') { ?>
                            <a  onclick="requestPageView_model('SO', <?php echo $val['contractAutoID'] ?>)"> <?php echo ($val['contractCode'] ? $val['contractCode'].' - ' : '')?></a> <?php echo $val['itemDescription'];?>
                        <?php  }elseif ($extra['master']['invoiceType'] == 'Contract'){  ?>
                            <a  onclick="requestPageView_model('CNT', <?php echo $val['contractAutoID'] ?>)"> <?php echo ($val['contractCode'] ? $val['contractCode'].' - ' : '')?></a> <?php echo $val['itemDescription'];?>
                        <?php }elseif ($extra['master']['invoiceType'] == 'Quotation'){  ?>
                            <a  onclick="requestPageView_model('QUT', <?php echo $val['contractAutoID'] ?>)"> <?php echo ($val['contractCode'] ? $val['contractCode'].' - ' : '')?></a> <?php echo $val['itemDescription'];?>
                        <?php }elseif($extra['master']['invoiceType'] == 'Direct'){  ?>
                            <a  onclick="requestPageView_model('DO', <?php echo $val['contractAutoID'] ?>)"> <?php echo ($val['contractCode'] ? $val['contractCode'].' - ' : '')?></a> <?php echo $val['itemDescription'];?>
                        <?php}
                         else{
                    ...
                    <td style="text-align:right; font-size: 12px;"><?php echo format_number($val['unittransactionAmount']+($txAmnt), $extra['master']['transactionCurrencyDecimalPlaces']); ?></td>
                    ...
                    <td style="text-align:right; font-size: 12px;"><?php echo format_number(($val['unittransactionAmount']-$val['discountAmount'])+($txAmnt), $extra['master']['transactionCurrencyDecimalPlaces']); ?></td>
            ...
            <tfoot>
            <tr>
                <td class="text-right sub_total" colspan="7"><?php echo $this->lang->line('sales_markating_view_invoice_item_total');?><!--Item Total -->(<?php echo $extra['master']['transactionCurrency']; ?>) </td>
        ...
        <table class="table table-bordered table-striped">
            ...
            foreach ($extra['gl_detail'] as $val) { ?>
                <tr>
                    ...
                    <td style="text-align:right; font-size: 12px;"><?php echo $val['segmentCode']; ?></td>
                    ...
                    <td style="text-align:right; font-size: 12px;"><?php echo $val['marginPercentage']; ?></td>
            ...
            <tfoot>
            <tr>
                <td class="text-right sub_total" style="font-size: 12px;" colspan="3"> <?php echo $this->lang->line('common_total');?> </td><!--Total-->
...
<div class="table-responsive"><br>
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <th  class='theadtr' style="min-width: 5%"> No Item</th>
                        <th  class='theadtr' style="min-width: 5%"> Gross Qty</th>
                        <th  class='theadtr' style="min-width: 5%"> Units</th>
                        <th  class='theadtr' style="min-width: 5%"> Deduction</th>
                    ...
                    <tr>
                        ...
                        <td style="text-align:right;"><?php echo $val['itemSystemCode']; ?></td>
                        <td><?php echo ($val['contractCode'] ? $val['contractCode'].' - ' : '').$val['itemDescription'].' - '.$val['remarks']; ?></td>
                        <td style="text-align:right;"><?php echo $val['unitOfMeasure']; ?></td>
    ...
    <script>
        ...
        a_link=  "<?php echo site_url('InvoicesPercentage/load_invoices_conformation'); ?>/<?php echo $extra['master']['invoiceAutoID'] ?>";
        de_link="<?php echo site_url('Double_entry/fetch_double_entry_customer_invoice'); ?>/" + <?php echo $extra['master']['invoiceAutoID'] ?> + '/HCINV';
