    ...
    if (!empty($extra['gl_detail'])) {
        $html .= '<br>
                <div class="table-responsive">
                    ...
                    foreach ($extra['gl_detail'] as $val) {
                        $grop_based_col_tax_html_val = '';
                        $addDiscount = $val['discountAmount'];
                        $taxDeduct = 0;
                        if($group_based_tax==1){
                        ...
                        $html .= '<tr>
                                ...
                                <td style="text-align:right;">' . format_number(($val['transactionAmount'] + $addDiscount) - $taxDeduct, $extra['master']['transactionCurrencyDecimalPlaces']) . '</td>
                                '.$grop_based_col_tax_html_val.';
        ...
        if (!empty($extra['delivery_order_itemwise'])) {
            ...
            <table class="table table-bordered table-striped" style="width: 100%">
                ...
                <tr>
                    ...
                    <th class="theadtr" style="width: 10%">Invoiced Amount</th>
                </tr>
                </thead>
                <tbody>';
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th class="theadtr" style="width: 15%">' . $this->lang->line('sales_marketing_invoiced_amount') . '</th>
                            </tr>
                            </thead>
                            <tbody>';
                        $num = 1;
