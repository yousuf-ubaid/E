    ...
    <script>
        $(document).ready(function () {
            $('.headerclose').click(function () {
                fetchPage('system/invoices/customer_price_setup_approval_new','','Customer Price Setup');
            });
            ...
            $('#CustomerPriceSetup_approval_form').bootstrapValidator({
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    data: data,
                    url: "<?php echo site_url('Customer/save_CustomerPriceSetup_approval_new'); ?>",
                    beforeSend: function () {
                        startLoad();
                    },
        ...
        function CustomerPriceSetup_table() {
            var Otable = $('#customer_PriceSetup_approval').DataTable({
                ...
                "bDestroy": true,
                "bStateSave": true,
                "sAjaxSource": "<?php echo site_url('Customer/customer_PriceSetup_approval_new'); ?>",
                "aaSorting": [[1, 'desc']],
        ...
        function fetch_approval_cps(cpsAutoID, documentApprovedID, Level) {
            if (cpsAutoID) {
                $.ajax({
                    async: true,
                    type: 'post',
        ...
        function documentPageView_modal_CPS(documentID, para1, para2, approval=1) {
            ...
            switch (documentID) {
                ...
                case "CPS": // Rental Item Issue
                    siteUrl = "<?php echo site_url('Customer/load_Customer_PriceConfirmation_new'); ?>";
