        ...
        if (!empty($extra['delivery_order'])) {
            ...
            <div class="table-responsive">
                ...
                foreach ($extra['delivery_order'] as $val) {
                    ...
                    foreach($val['items'] as $itemVal) {
                        $html .= '<tr>
                            <td></td>
                            <td colspan="4"><b>Item :</b>'.$itemVal['itemSystemCode'].' - '.$itemVal['itemDescription'].'</td>
                            <td style="text-align:right; font-size: 12px;">'.format_number($itemVal['transactionAmount'],$dPlace).'</td>
                        </tr>';
                    }
