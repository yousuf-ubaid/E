            ...
            <tr>
                ...
                <td style="width:50%;">
                    <table>
                        ...
                        <tr>
                            <td><strong>Insurance Type</strong></td><!--Sales Person -->
                            <td><strong>:</strong></td>
                            <td> <?php echo $extra['master']['insurance']; ?> </td>
                        </tr>
                    </table>
                </td>
            </tr>
        ...
        <tbody>
            ...
            $num =1;$item_total = 0;
                ...
                <tr>
                    ...
                    <td style="font-size: 12px;"><?php echo ($val['contractCode'] ? $val['contractCode'].' - ' : '').$val['itemDescription']; ?>
    ...
    <table class="table table-bordered table-striped">
        <thead>
            <tr>
                ...
                <?php if($group_based_tax == 1) { ?> 
                    <th class='theadtr' style="min-width: 10%"><?php echo $this->lang->line('common_total');?>(<?php echo $extra['master']['transactionCurrency']; ?>)</th><!--Total-->
                    <th class='theadtr' style="min-width: 10%"><?php echo $this->lang->line('sales_markating_view_invoice_tax');?>(<?php echo $extra['master']['transactionCurrency']; ?>)</th><!--Tax-->
                <?php } ?>
...
<?php } ?>
<?php $transaction_total = 0;$insuamnt = 0;$marginamnt = 0;$Local_total = 0;$party_total = 0; $disc_nettot=0;$t_extraCharge=0; if(!empty($extra['insurance_detail'])){  ?>
    <br>
    <div class="table-responsive">
        <table class="table table-bordered table-striped">
            <thead>
            <tr>
                <th class='theadtr' style="width: 5%">#</th>
                <th class='theadtr' style="min-width: 22%;text-align: left;">Supplier</th>
                <th class='theadtr' style="min-width: 22%;text-align: left;"> <?php echo $this->lang->line('common_description');?></th><!--Description-->
                <th class='theadtr' style="width: 7%"><?php echo $this->lang->line('common_segment');?></th><!--Segment-->
                <th class='theadtr' style="width: 15%"><?php echo $this->lang->line('common_amount');?> (<?php echo $extra['master']['transactionCurrency']; ?>) </th><!--Amount-->
                <th class='theadtr' style="width: 15%">Margin (%) </th>
                <th class='theadtr' style="width: 15%">Margin Amount (<?php echo $extra['master']['transactionCurrency']; ?>)</th>
                <th class='theadtr' style="width: 15%">Total Amount (<?php echo $extra['master']['transactionCurrency']; ?>)</th>
            </tr>
            </thead>
            <tbody>
            <?php
            $num =1;
            foreach ($extra['insurance_detail'] as $val) { ?>
                <tr>
                    <td style="text-align:right;"><?php echo $num; ?>.&nbsp;</td>
                    <td><?php echo $val['supplierName']; ?></td>
                    <td><?php echo $val['description']; ?></td>
                    <td style="text-align:center;"><?php echo $val['segmentCode']; ?></td>
                    <td style="text-align:right;"><?php echo format_number($val['transactionAmount']-$val['marginAmount'], $extra['master']['transactionCurrencyDecimalPlaces']); ?></td>
                    <td style="text-align:right;"><?php echo $val['marginPercentage']; ?></td>
                    <td style="text-align:right;"><?php echo format_number($val['marginAmount'], $extra['master']['transactionCurrencyDecimalPlaces']); ?></td>
                    <td style="text-align:right;"><?php echo format_number($val['transactionAmount'], $extra['master']['transactionCurrencyDecimalPlaces']); ?></td>
                </tr>
                <?php
                $num ++;
                $gran_total         += $val['transactionAmount'];
                $transaction_total  += $val['transactionAmount'];
                $insuamnt  += $val['transactionAmount']-$val['marginAmount'];
                $marginamnt  += $val['marginAmount'];
            ...
            <tfoot>
            <tr>
                <td class="text-right sub_total" colspan="4"> <?php echo $this->lang->line('common_total');?> </td><!--Total-->
                <td class="text-right sub_total"><?php echo format_number($insuamnt,$extra['master']['transactionCurrencyDecimalPlaces']); ?></td>
                <td class="text-right sub_total" colspan="2"><?php echo format_number($marginamnt,$extra['master']['transactionCurrencyDecimalPlaces']); ?></td>
                <td class="text-right sub_total"><?php echo format_number($transaction_total,$extra['master']['transactionCurrencyDecimalPlaces']); ?></td>
            </tr>
            </tfoot>
        </table>
                ...
                <td style="width:60%;padding: 0;">
                    <table style="width: 100%; " class="<?php echo table_class(); ?>">
                        ...
                        foreach ($extra['discount'] as $value) {
                            ...
                            echo '<td class="text-right">'.$value['discountPercentage'].'%</td>';
            ...
            <tr>
                <td style="width:50%;">
                    <table>
                        <tr>
                            <td>
                                <img alt="Logo" style="height: 130px" src="<?php echo base_url('images/logo/').'/'.$this->common_data['company_data']['company_logo']; ?>">
                            </td>
                        </tr>
                    </table>
                </td>
...
<script>
    ...
    a_link=  "<?php echo site_url('invoices/load_invoices_conformation_invoicetype'); ?>/<?php echo $extra['master']['invoiceAutoID'] ?>";
