...
<div class="row">
    ...
    <div class="col-md-3 text-center">
        <?php echo form_dropdown('approvedYN', array('0' => $this->lang->line('common_pending')/*'Pending'*/, '1' => $this->lang->line('common_approved')/*'Approved'*/), '', 'class="form-control" id="approvedYN" required onchange="Invoices_table_insurance()"'); ?>
    </div>
</div>
<hr>
<div class="table-responsive">
    <table id="Invoices_table_insurance" class="<?php echo table_class() ?>">
        <thead>
        <tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/invoices/invoice_approval_insurance', '', 'Invoice Approval');
        });
        Invoices_table_insurance();
    ...
    function Invoices_table_insurance() {
        var Otable = $('#Invoices_table_insurance').DataTable({
            "language": {
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Invoices/fetch_invoices_approval_insurance'); ?>",
            "aaSorting": [[0, 'desc']],
            ...
            "columnDefs": [{"visible":false,"searchable": true,"targets": [10], "orderable": false},{"searchable": false,"targets": [0,8,9], "orderable": false}],
