...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('.headerclose').click(function(){
            fetchPage('system/invoices/invoices_management_suom',invoiceAutoID,'Customer Invoices');
        });
        $('.select2').select2();
        invoiceAutoID = null;
        invoiceType = null;
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data['status']) {
                        ...
                        $("#a_link").attr("href", "<?php echo site_url('Invoices/load_invoices_conformation_suom'); ?>/" + invoiceAutoID);
                ...
                function () {
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if(data[0]=='s'){
                                setTimeout(function(){
                                    fetchPage('system/invoices/invoices_management_suom', invoiceAutoID, 'Invoices');
                                }, 500);
                            }
                            setTimeout(function(){
                                stopLoad();
    ...
    function load_conformation() {
        if (invoiceAutoID) {
            $.ajax({
                ...
                url: "<?php echo site_url('Invoices/load_invoices_conformation_suom'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
    ...
    function fetch_detail(type, customerID, currencyID,tab) {
        $.ajax({
            ...
            url: "<?php echo site_url('Invoices/fetch_detail_suom'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
    ...
    function Load_customer_details(customerid) {
      //  $('#contactPersonName').val('');
        ...
        $.ajax({
            ...
            success: function (data) {
                //$('#contactPersonName').val(data['customerName']);
    ...
    function Load_customer_details_edit(customerid) {
        ...
        $.ajax({
            ...
            success: function (data) {
               ...
               // $('#contactPersonName').val(data['detail']['customerName']);
