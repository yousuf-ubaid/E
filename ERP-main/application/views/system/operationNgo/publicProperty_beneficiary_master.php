...
$title = $this->lang->line('operationngo_public_property_beneficiary');
        ...
        <div id="filter-panel" class="collapse filter-panel">
            <div class="row">
                <div class="form-group col-sm-2">
                    ...
                    <?php echo form_dropdown('projectID', fetch_project_donor_drop(), '', 'class="form-control select2"  id="projectID" onchange="startMasterSearch()"'); ?>
                </div>
                <div class="form-group col-sm-2">
        ...
        <div class="row">
            ...
            <div class="col-md-3 text-right">
                <button type="button" class="btn btn-primary pull-right"
                        onclick="fetchPage('system/operationNgo/create_publicProperty_beneficiary',null,'<?php echo $this->lang->line('operationngo_add_new_public_property'); ?>'/*Add New Public Property Beneficiary*/,'CRM');">
                    <i
                        class="fa fa-plus"></i>
                    <?php echo $this->lang->line('operationngo_new_public_proprty_bene'); ?><!--New Public Property Beneficiary-->
                </button>
            </div>
        </div>
        <div class="row">
                            ...
                            <div class="box-tools">
                                <div class="has-feedback">
                                    <input name="searchTask" type="text" class="form-control input-sm"
                                           placeholder="Search Public Property Damages Assessment" id="searchTask">
    ...
    <script type="text/javascript">
        ...
        function getBeneficiaryManagement_tableView(filtervalue) {
            ...
            $.ajax({
                ...
                dataType: 'html',
                data: data,
                url: "<?php echo site_url('OperationNgo/load_publicPropertyManage_view'); ?>",
                beforeSend: function () {
                    startLoad();
                },
        ...
        function delete_propertyDamage(id) {
            swal({
                ...
                function () {
                    $.ajax({
                        ...
                        type: 'post',
                        dataType: 'json',
                        data: {'publicPropertyBeneID': id},
                        url: "<?php echo site_url('OperationNgo/delete_propertyDamage_master'); ?>",
                        beforeSend: function () {
                            startLoad();
                        },
                        success: function (data) {
        ...
        function get_beneficiary_province(masterid) {
            $.ajax({
                ...
                url: "<?php echo site_url('OperationNgo/fetch_beneficiary_province'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
        ...
        function get_beneficiary_area(masterid) {
            $.ajax({
                ...
                dataType: 'json',
                data: {masterid: masterid},
                url: "<?php echo site_url('OperationNgo/fetch_beneficiary_province_area'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
        ...
        function get_division(masterid) {
            $.ajax({
                ...
                dataType: 'json',
                data: {masterid: masterid},
                url: "<?php echo site_url('OperationNgo/fetch_beneficiary_division'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
        ...
        function get_sub_division(masterid) {
            $.ajax({
                ...
                dataType: 'json',
                data: {masterid: masterid},
                url: "<?php echo site_url('OperationNgo/fetch_beneficiary_sub_division'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
