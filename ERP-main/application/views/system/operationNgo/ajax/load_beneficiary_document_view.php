                    ...
                    if (!empty($docDet)) {
                        ...
                        foreach ($docDet as $doc) {
                            ...
                            if ($doc['FileName'] != '') {
                                ...
                                $linkStart = '<i class="fa fa-times-circle pull-right" aria-hidden="true" style="color: red;" onclick="delete_beneficiary_Document(' . $doc['DocDesFormID'] . ', \'' . $doc['DocDescription'] . '\')"></i>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('#empDoc_form_document').bootstrapValidator({
            ...
            $.ajax({
                ...
                dataType: 'JSON',
                data: formData,
                url: '<?php echo site_url('OperationNgo/save_beneficiary_document'); ?>',
                contentType: false,
                cache: false,
                processData: false,
                beforeSend: function () {
    ...
    function delete_beneficiary_Document(DocDesFormID, description) {
        swal({
                title: "Are you sure?",
            ...
            function () {
                $.ajax({
                    async: true,
                    url: "<?php echo site_url('OperationNgo/delete_beneficiary_document'); ?>",
                    type: 'post',
                    dataType: 'json',
