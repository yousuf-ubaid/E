    ...
    if (!empty($monthlyExpenditure)) {
        foreach ($monthlyExpenditure as $expenditure) {
            ...
            <div class="form-group col-sm-2">
                <label class="title"><?php echo $expenditure['Description']; ?></label>
            </div>
            <div class="form-group col-sm-2">
                <input type="text" name="monthlyExpenditure[<?php echo $expenditure['monthlyExpenditureID']; ?>]"
                       class="form-control number" value="<?php if (!empty($benificiaryID)) {
