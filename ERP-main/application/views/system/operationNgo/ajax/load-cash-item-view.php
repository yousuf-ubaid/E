      ...
      <div class="table-responsive mailbox-messages">
          <table class="table table-hover table-striped">
              ...
              <tr class="task-cat-upcoming">
                  ...
                  <td class="headrowtitle" style="border-bottom: solid 1px #f76f01;width: 10%">Expiry Date</td>
                ...
                foreach ($header as $val) {
                  ?>
                    <tr>
                        ...
                        <td class="mailbox-star" width=""><?php echo $val['projectName'] ?></td>
                        ...
                        <td class="mailbox-attachment taskaction_td"><span class="pull-right">
                            <a onclick="edit_income_item(<?php echo $val['commitmentDetailAutoID'] ?>)"><span title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;<a
                                        onclick="delete_commitmentDetails(<?php echo $val['commitmentDetailAutoID'] ?>,2)"><span title="Delete" rel="tooltip" class="glyphicon glyphicon-trash" style="color:rgb(209, 91, 71);"></span></a></span>
                        </td>
                    </tr>
                  <?php
                  $x++;
