    ...
    <div class="table-responsive mailbox-messages">
        <table class="table table-hover table-striped">
            ...
            <tr>
                ...
                <td class="headrowtitle tableHeader" style="border-top: 1px solid #ffffff;">Effected Person</td>
            ...
            foreach ($detail as $val) {
                ...
                <tr>
                    ...
                    <td class="mailbox-name"><a href="#"><?php echo $val['effectedPersonName']; ?></a></td>
                    ...
                    <td class="mailbox-attachment">
                        <span class="pull-right">
                            <?php
                            $status = '<span class="pull-right"><a onclick="edit_pd_human_injury_assessment('.$val['humanInjuryID'].')"><span title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil"></span></a>&nbsp;|&nbsp;<a
