...
<?php
  if (!empty($master)) {
          ...
          <table class="table table-hover table-striped">
              ...
              <tr class="task-cat noselect" style="background: white;">
                  <td class="task-cat-upcoming" colspan="10">
                      <div class="task-cat-upcoming-label"><?php echo $this->lang->line('operationngo_latest_commitments');?><!--Latest Commitments--></div>
              ...
              <tr>
                  ...
                  <td class="headrowtitle" style="border-top: 1px solid #ffffff;"><?php echo $this->lang->line('operationngo_expiry_date');?><!--Expiry Date--></td>
                ...
                foreach ($master as $val) {
                  ?>
                    <tr>
                        ...
                        <td class="mailbox-name"><a href="#"><?php echo $val['commitmentExpiryDate']; ?></a></td>
                    ...
                    <?php
                        ...
                        <td class="mailbox-attachment"><span class="pull-right">
                                 <?php if($val['confirmedYN']!=1) {
                                     ?>
                                     <a href="#" onclick="fetchPage('system/operationNgo/create_commitments.php','<?php echo $val['commitmentAutoId'] ?>','Edit Commitment')"><span title="Edit" rel="tooltip" class="glyphicon glyphicon-pencil"></span></a>&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                               <a target="_blank" href="<?php echo site_url('OperationNgo/load_donor_commitment_confirmation/') . '/' . $val['commitmentAutoId'] ?>"  ><span title="Print" rel="tooltip" class="glyphicon glyphicon-print"></span></a>
                               &nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="delete_commitment_project(<?php echo $val['commitmentAutoId'] ?>);"><span title="Delete" rel="tooltip" class="glyphicon glyphicon-trash" style="color:rgb(209, 91, 71);"></span></a></span></td>
                                   <?php
                                 }else{
                                     if ($val['createdUserID'] == trim(current_userID()) && $val['confirmedYN'] == 1) {
                                       ?>
                                         <a onclick="referback_donor_commitment(<?php echo $val['commitmentAutoId'] ?>);"><span title="Refer Back" rel="tooltip" class="glyphicon glyphicon-repeat" style="color:rgb(209, 91, 71);"></span></a>&nbsp;&nbsp;|&nbsp;&nbsp;
                                       <?php
                                     }
                                     ?>
                                       <a target="_blank" onclick="documentPageView_modal('CMT','<?php echo $val['commitmentAutoId']?>')"><span title="" rel="tooltip" class="glyphicon glyphicon-eye-open" data-original-title="View"></span></a>&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                                       <a target="_blank" href="<?php echo site_url('OperationNgo/load_donor_commitment_confirmation/') . '/' . $val['commitmentAutoId'] ?>"  ><span title="Print" rel="tooltip" class="glyphicon glyphicon-print"></span></a>
                        <?php
                                   }
                                     ?>
    ...
    <?php
      ...
      <div class="search-no-results"><?php echo $this->lang->line('operationngo_there_are_no_recors_to_display');?><!--THERE ARE NO RECORDS TO DISPLAY-->.</div>
    <?php
  }
