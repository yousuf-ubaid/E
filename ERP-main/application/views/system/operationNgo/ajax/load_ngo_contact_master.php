            ...
            foreach ($header as $val) { ?>
                <tr>
                    ...
                    <td class="mailbox-name"><div class="contact-box">
                            ...
                            <?php } ?>
                            <div class="link-box"><strong class="contacttitle"><a class="link-person noselect" href="#"  onclick="fetchPage('system/operationNgo/donor_edit_view','<?php echo $val['contactID'] ?>','View Donor','CRM')"><?php echo $val['name']; ?></a><br><?php echo $val['email'] ?></a></strong></div></div>
                    </td>
                    ...
                    <td class="mailbox-attachment"><span class="pull-right">
                            <a href="#"
                               onclick="fetchPage('system/operationNgo/create_donor','<?php echo $val['contactID'] ?>','Edit Donor','CRM')"><span
