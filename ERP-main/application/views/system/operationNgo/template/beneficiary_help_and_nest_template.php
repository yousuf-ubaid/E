...
<div class="row">
            ...
            <div class="" id="linkcontact_system">
                ...
                <div class="form-group col-sm-3">
                  <span class="input-req" title="Required Field">
                      ...
                      <input type="hidden" name="templateType" value="helpAndNest">
    ...
    <div class="row" style="margin-top: 15px;">
        ...
        <div class="form-group col-sm-4">
            <input type="text" name="totalSqFt" id="totalSqFt" class="form-control" placeholder="Total Sq Ft" value="460 x Rs : 1,410.00">
        </div>
        <div class="form-group col-sm-2">
            <label class="title">Total Cost</label>
        </div>
        <div class="form-group col-sm-4" style="width: 32%">
            <input type="text" name="totalCost" id="totalCost" class="form-control" placeholder="Total Cost" value="648,600.00 + 50,000.00 = 698,600 /=">
        </div>
    </div>
    <div class="row" style="margin-top: 15px;">
        <div class="form-group col-sm-2">
            <label class="title">Total Cost For A House</label>
        </div>
        <div class="form-group col-sm-4">
              <span class="input-req" title="Required Field">

            <input type="text" name="totalcostforahouse" id="totalcostforahouse" class="form-control number amount" title="Total Estimated Cost For A House" rel="tooltip"  onkeypress="return validateFloatKeyPress(this,event)">
              <span class="input-req-inner"></span></span>
        </div>
