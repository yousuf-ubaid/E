    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            if (p_id) {
                ...
                getBeneficiaryManagement_editView(publicPropertyBeneID);
            }
        ...
        function getBeneficiaryManagement_editView(publicPropertyBeneID) {
            $.ajax({
                async: true,
                type: 'post',
                dataType: 'html',
                data: {publicPropertyBeneID: publicPropertyBeneID},
                url: "<?php echo site_url('OperationNgo/load_publicPropertyManage_editView'); ?>",
                beforeSend: function () {
                    startLoad();
                },
