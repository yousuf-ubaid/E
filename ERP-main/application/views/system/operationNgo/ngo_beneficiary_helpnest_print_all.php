...
if (!empty($master)) {
            ...
            <table style='width: 100%'>
                ...
                <tr>
                    <td style='width:30%;'><img alt='Logo' style='height: 80px'
                     ...
                     src=".$projectlogo."></td></td></tr>
                </tbody>
            </table>
            " . $master['ppDetailDescription'] . "
  </div>";
    $mpdf->WriteHTML($html, 2);
    $mpdf->AddPage();
    $html = "<div class='table-responsive'>
    ...
    if (!empty($detail)) {
        ...
        $imageviewpp.= "<table style='width: 100%'>
        <tbody>
        <tr>
            ...
            <td width='4%'>&nbsp;&nbsp;</td>
            <td width='48%' style='border-left: 1px solid black;border-top: 1px solid black;border-right: 1px solid black;font-size: 20px;'>Photos 
        ...
        <tr>
            ...
            <table style='width: 100%'>
                ...
                <tr style='background-color: #E6EED5'>
                    ...
                    <td style='width:70%;font-size: 13px;font-family: tahoma;'>" . $rec['proposalbentotalSqFt'] . "</td>
                </tr>
                </tbody>
            </table>
       <hr><br><br>
    ...
    <table style='width: 100%;'>
        ...
        <tr><td colspan='3' style='width:100%;text-align:center;font-size: 20px;font-family: garamond;'>Jazakallah hairun!</td></tr>
        </tbody></table></div><br>
        <hr>";
    $mpdf->WriteHTML($html, 2);
} else {
