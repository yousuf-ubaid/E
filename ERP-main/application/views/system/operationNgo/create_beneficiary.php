...
<div class="m-b-md" id="wizardControl">
    <a class="btn btn-primary" href="#step1" data-toggle="tab">
        <?php echo $this->lang->line('operationngo_benificiary_header'); ?><!--Beneficiary Header--></a>
    <a class="btn btn-default btn-wizard" href="#step2" data-toggle="tab">
        <?php echo $this->lang->line('operationngo_benificiary_family_details'); ?><!--Beneficiary Family details--></a>
        ...
        <div class="row">
            <div class="col-md-12 animated zoomIn">
                <header class="head-title">
                    <h2>
                        <?php echo $this->lang->line('operationngo_benefiviary_template'); ?><!--BENEFICIARY TEMPLATE--></h2>
                </header>
    ...
    <div id="step2" class="tab-pane">
        <div class="row">
            <div class="col-md-8"><h4><i class="fa fa-hand-o-right"></i>
                    <?php echo $this->lang->line('operationngo_benefiviary_family_details'); ?><!--Beneficiary Family Details-->
                </h4></div>
            <div class="col-md-4">
                <button type="button" onclick="add_beneficiary_familyDetail()" class="btn btn-primary pull-right"><i
                            class="fa fa-plus"></i>
                    <?php echo $this->lang->line('operationngo_benefiviary_add_family_details'); ?><!--Add Family Detail-->
                </button>
            </div>
        </div>
        <div class="row">
    ...
    <div class="modal-dialog" style="width: 40%">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5>
                    <?php echo $this->lang->line('operationngo_benefiviary_add_family_details'); ?><!--Add Family Detail--></h5>
            </div>
            <div class="modal-body" id="modal_contact">
                <form method="post" name="frm_FamilyContactDetails" id="frm_FamilyContactDetails"
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" for="textinput">
                            <?php echo $this->lang->line('operationngo_nic_no'); ?><!--NIC No--></label>

                        <div class="col-md-7">
                            <input class="form-control input-md"
                                   placeholder="<?php echo $this->lang->line('operationngo_nationanalid_no'); ?>"
                                   id="idNO" name="idNO"
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/operationNgo/beneficiary_master', '', 'Beneficiary');
        });
        $('.select2').select2();
        ...
        $('#beneficiary_form').bootstrapValidator({
            ...
            fields: {
                ...
                emp_title: {validators: {notEmpty: {message: '<?php echo $this->lang->line('operationngo_benefiviary_title_is_required');?>.'}}}, /*Title is required*/
                fullName: {validators: {notEmpty: {message: '<?php echo $this->lang->line('common_full_name_is_required');?>.'}}}, /*Full Name is required*/
                nameWithInitials: {validators: {notEmpty: {message: '<?php echo $this->lang->line('operationngo_benefiviary_name_with_initial_is_required');?>.'}}}, /*Name with Initials is required*/
