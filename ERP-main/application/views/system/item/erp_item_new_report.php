...
<div class="m-b-md" id="wizardControl">
    <a class="btn btn-primary" href="#step1" data-toggle="tab"><?php echo $this->lang->line('transaction_goods_received_voucher_step_one');?> - <?php echo $this->lang->line('erp_item_master_item_header');?></a><!--Step 1--><!--Item Header-->
    <a class="btn btn-default btn-wizard" href="#step2" data-toggle="tab"><?php echo $this->lang->line('transaction_goods_received_voucher_step_two');?> - <?php echo $this->lang->line('erp_item_master_item_attachments');?></a><!--Step 2--><!--Item Attachments-->
...
<div class="tab-content">
    <div id="step1" class="tab-pane active">
        ...
        <div class="row modal-body" style="padding-bottom: 0px;">
            <div class="col-sm-3" align="" style="padding-left: 0px;">
                <div class="fileinput-new thumbnail" style="margin-bottom: 4px;width: 200px; height: 150px;">
                    ...
                    <input type="file" name="itemImage" id="itemImage" style="display: none;" disabled/>
                </div>
            ...
            <div class="col-md-9" style="padding-left: 0px;">
                <div class="row">
                    <div class="form-group col-sm-4">
                        ...
                        <?php echo form_dropdown('mainCategoryID', $main_category_arr, 'Each', 'class="form-control" id="mainCategoryID" onchange="load_sub_cat()" disabled'); ?>
                    </div>
                    <div class="form-group col-sm-4">
                        <label><?php echo $this->lang->line('transaction_sub_category');?><!--Sub Category--> <?php required_mark(); ?></label>
                        <select name="subcategoryID" id="subcategoryID" class="form-control searchbox"
                                onchange="load_sub_sub_cat(),load_gl_codes()" disabled>
                            <option value=""><?php echo $this->lang->line('transaction_select_category');?><!--Select Category--></option>
                        </select>
                    </div>
                    <div class="form-group col-sm-4">
                        <label><?php echo $this->lang->line('erp_item_master_sub_sub_category');?><!--Sub Sub Category--> </label>
                        <select name="subSubCategoryID" id="subSubCategoryID" class="form-control searchbox" disabled>
                            <option value=""><?php echo $this->lang->line('transaction_select_category');?><!--Select Category--></option>
                        </select>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-4">
                        <label><?php echo $this->lang->line('erp_item_master_short_description');?> <?php required_mark(); ?></label><!--Short Description-->
                        <input type="text" class="form-control" id="itemName" name="itemName" disabled>
                    </div>
                    <div class="form-group col-sm-8">
                        <label><?php echo $this->lang->line('erp_item_master_long_description');?> <?php required_mark(); ?></label><!--Long Description-->
                        <input type="text" class="form-control" id="itemDescription" name="itemDescription" disabled>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-sm-4">
                        <label for=""><?php echo $this->lang->line('erp_item_master_secondary_code');?><!--Secondary Code--> <?php required_mark(); ?></label>
                        <input type="text" class="form-control" id="seconeryItemCode" name="seconeryItemCode" disabled>
                    </div>
                    <div class="form-group col-sm-4">
                        <label for=""><?php echo $this->lang->line('transaction_unit_of_measure');?><!--Unit of Measure--> <?php required_mark(); ?></label>
                        <?php echo form_dropdown('defaultUnitOfMeasureID', $uom_arr, 'Each', 'class="form-control" id="defaultUnitOfMeasureID" required disabled'); ?>
                    </div>
                    <div class="form-group col-sm-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" step="any" class="form-control number" id="companyLocalSellingPrice"
                                   name="companyLocalSellingPrice" value="0" disabled>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-2" id="cls_maximunQty">
                ...
                <input type="text" class="form-control number" id="maximunQty" name="maximunQty" disabled>
            </div>
            <div class="form-group col-sm-2" id="cls_minimumQty">
                ...
                <input type="text" class="form-control number" id="minimumQty" name="minimumQty" disabled>
            </div>
            <div class="form-group col-sm-2" id="cls_reorderPoint">
                <label for=""><?php echo $this->lang->line('erp_item_master_recorder_level');?><!--Reorder Level--></label>
                <input type="text" class="form-control number" id="reorderPoint" name="reorderPoint" disabled>
            </div>
        ...
        <div class="row" id="inventry_row_div">
            <div class="form-group col-sm-4">
                ...
                <?php echo form_dropdown('revanueGLAutoID', $revenue_gl_arr, '', 'class="form-control select2" id="revanueGLAutoID" disabled'); ?>
            </div>
            <div class="form-group col-sm-4">
                <label for=""><?php echo $this->lang->line('erp_item_master_cost_gl_code');?><!--Cost GL Code--></label>
                <?php echo form_dropdown('costGLAutoID', $cost_gl_arr, '', 'class="form-control select2" id="costGLAutoID" disabled'); ?>
            </div>
            <div class="form-group col-sm-4" id="assetGlCode_div">
                ...
                <?php echo form_dropdown('assteGLAutoID', $asset_gl_arr, $this->common_data['controlaccounts']['INVA'], 'class="form-control select2" id="assteGLAutoID" disabled'); ?>
            </div>
        ...
        <div class="row hide" id="fixed_row_div">
            <div class="col-md-3">
                <div class="form-group">
                    ...
                    <?php echo form_dropdown('COSTGLCODEdes', $fetch_cost_account, '', 'class="form-control form1 select2" id = "COSTGLCODEdes" disabled'); ?>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for=""><?php echo $this->lang->line('erp_item_master_acc_dep_gl_code');?><!--Acc Dep GL Code --><?php required_mark(); ?></label>
                    <?php echo form_dropdown('ACCDEPGLCODEdes', $fetch_cost_account, '', 'class="form-control form1 select2" id = "ACCDEPGLCODEdes" disabled'); ?>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for=""><?php echo $this->lang->line('erp_item_master_dep_gl_code');?><!--Dep GL Code--> <?php required_mark(); ?></label>
                    <?php echo form_dropdown('DEPGLCODEdes', $fetch_dep_gl_code, '', 'class="form-control form1 select2" id = "DEPGLCODEdes" disabled'); ?>
                </div>
            </div>
            <div class="col-md-3">
                <div class="form-group">
                    <label for=""><?php echo $this->lang->line('erp_item_master_disposal_gl_code');?><!--Disposal GL Code--> <?php required_mark(); ?></label>
                    <?php echo form_dropdown('DISPOGLCODEdes', $fetch_disposal_gl_code, '', 'class="form-control form1 select2" id = "DISPOGLCODEdes" disabled'); ?>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    <div class="form-group" id="stockadjustment">
                        ...
                        <?php echo form_dropdown('stockadjust', $stock_adjustment, '', 'class="form-control form1 select2" id="stockadjust" disabled'); ?>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                    ...
                    <div class="skin skin-square">
                        <div class="skin-section" id="extraColumns">
                            <input id="checkbox_isActive" type="checkbox"
                                   data-caption="" class="columnSelected" name="isActive" value="1" checked disabled>
                            <label for="checkbox">
                                &nbsp;
                            </label>
                        </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label for=""><?php echo $this->lang->line('erp_item_master_is_sub_item_applicable');?><!--is Sub-item Applicable--> </label>

                    <div class="skin skin-square">
                        <div class="skin-section" id="extraColumns">
                            <input id="checkbox_isSubitemExist" type="checkbox"
                                   data-caption="" class="columnSelected" name="isSubitemExist" value="1" disabled>
                            <label for="checkbox">
                                &nbsp;
                            </label>
                        </div>
    ...
    <div id="step2" class="tab-pane">
        <div class="row">
            <div class="col-sm-8">
                <h4 class="modal-title" id="purchaseOrder_attachment_label"><?php echo $this->lang->line('erp_item_master_modal_title');?><!--Modal title--></h4>
                <br>
                    ...
                    foreach($ware_house_binlocations as $val){
                        ...
                        <tr>
                            ...
                            if(!empty($binlocations)){
                                ...
                                ?>
                                <td>
                                    <input type="hidden" id="itemBinlocationID_<?php echo $val['wareHouseAutoID'] ?>" name="itemBinlocationID[]">
                                    <select class="form-control" name="binloc[]" id="binloc_<?php echo $val['wareHouseAutoID'] ?>" disabled>
                               ...
                               <!-- <td><button class="btn btn-sm btn-primary" type="button" onclick="save_item_bin_location(<?php /*echo $val['wareHouseAutoID'] */?>)">Save</button></td>-->
                            <?php
                            }else{
                                ?>
                                <td>&nbsp;</td>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/inventory/report/item_master_report', 'Test', 'Item Master');
        });
        $('.select2').select2();
        itemAutoID = null;
        number_validation();
                    ...
                    if (!jQuery.isEmptyObject(data)) {
                       ...
                       // $('#stockadjust option:not(:selected)').prop('disabled', true);
                        ...
                        if (data['itemImage'] == 'no-image.png') {
                            ...
                            $("#changeImg").attr("src", "<?php echo base_url('uploads/itemMaster'); ?>" + '/' + data['itemImage'] + '?' + data['timestamp']);
                        }
    ...
    function save_item_bin_location(wareHouseAutoID){
        ...
        $.ajax({
            ...
            type: 'post',
            dataType: 'json',
            data: ({binLocationID: binLocationID,itemBinlocationID: itemBinlocationID,itemAutoID: itemAutoID,wareHouseAutoID: wareHouseAutoID}),
