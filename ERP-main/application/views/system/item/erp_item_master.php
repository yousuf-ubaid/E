...
<div class="row">
    <div class="col-md-6">
        <table class="<?php echo table_class(); ?>">
            <tr>
                <td><span class="label label-success">&nbsp;</span>&nbsp;<?php echo $this->lang->line('common_active'); ?>
                </td><!--Active-->
                <td><span class="label label-danger">&nbsp;</span>&nbsp;<?php echo $this->lang->line('common_in_active'); ?>
                </td><!--Inactive-->
            </tr>
        </table>
    </div>
    ...
    <div class="col-md-6">
        ...
        <button type="button" class="btn btn-success size-sm "
        ...
        <?php } else if ($usergroupcompanywiseallow != 0) { ?>
            <button type="button" class="btn btn-primary size-sm"
                    onclick="fetchPage('system/item/erp_item_new',null,'Add New Item','SUP');"><i class="fa fa-plus"></i>
                <?php echo $this->lang->line('transaction_create_item'); ?>
            </button>
        <?php }?>
...
<div class="row supply_master_style" style="padding-left: 2%">
    <ul class="nav nav-tabs" id="main-tabs">
        <li class="btn-default-new size-sm tab-style-one mr-1 active"><a href="#items" data-toggle="tab" onclick="Otable.draw()"><?php echo $this->lang->line('transaction_items');?></a></li>
        <li class="btn-default-new size-sm tab-style-one"><a href="#deleted" data-toggle="tab" onclick="ODeltable.draw()"><?php echo $this->lang->line('erp_item_master_deleted_items');?></a></li>
    </ul>
</div>
<br>
        ...
        <div class="table-responsive">
            <table id="item_table" class="<?php echo table_class(); ?>">
                ...
                <tr>
                    ...
                    <th style="min-width: 10%"><?php echo $this->lang->line('item_master_img'); ?></th>
                    <th style="min-width: 10%"><?php echo $this->lang->line('transaction_main_category'); ?></th>
                    <!--Main Category-->
                    <th style="min-width: 10%"><?php echo $this->lang->line('transaction_sub_category'); ?></th>
                    <!--Sub Category-->
                    <th style="min-width: 10%"><?php echo $this->lang->line('erp_item_master_sub_sub_category'); ?></th>
                    <!--Sub Sub Category-->
                    <th style="min-width: 20%"><?php echo $this->lang->line('common_description'); ?></th><!--Description-->
                    <th style="min-width: 10%"><?php echo $this->lang->line('erp_item_master_secondary_code'); ?></th>
                    <!--Secondary Code-->
                    <th style="min-width: 13%"><?php echo $this->lang->line('common_price'); ?></th>
                    <!--Price-->
    ...
    <div class="tab-pane" id="deleted">
        <div class="table-responsive">
            <table id="deleted_item_table" class="<?php echo table_class(); ?>">
                ...
                <tr>
                    <th style="min-width: 5%">#</th>
                    <th style="min-width: 10%"><?php echo $this->lang->line('item_master_img'); ?></th><!--imagee-->
                    <th style="min-width: 10%"><?php echo $this->lang->line('transaction_main_category'); ?></th>
                    <!--Main Category-->
                    <th style="min-width: 10%"><?php echo $this->lang->line('transaction_sub_category'); ?></th>
                    <!--Sub Category-->
                    ...
                    <th style="min-width: 10%"><?php echo $this->lang->line('erp_item_master_secondary_code'); ?></th>
                    <!--Secondary Code-->
                    <th style="min-width: 20%"><?php echo $this->lang->line('common_price'); ?></th>
                    <!--Price-->
                    <th style="min-width: 10%"><?php echo $this->lang->line('transaction_current_stock'); ?></th>
                    <!--Current Stock-->
                    <?php if($hideWacAmount != 1) {?>
                        ...
                        <table class="<?php echo table_class(); ?>" id="itemmultipletableserver" >
                            <thead>
                                <tr>
                                    ...
                                    <?php if($secondaryUOM==1){ ?>
                                        <td>Secondary Unit of Measure<?php required_mark(); ?></td>
                                    <?php } ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        hideWacAmount = '<?php echo $hideWacAmount; ?>';
        ...
        if(hideWacAmount == 1)
         ...
         Otable = $('#item_table').DataTable({
                ...
                "aoColumns": [
                    ...
                    {"mData": "price"},
                    {"mData": "CurrentStock"},
                    {"mData": "itemApprovalStatus"},
                    {"mData": "edit"},
                    {"mData": "partNo"}
                ],
                "columnDefs": [
                    {"targets": [0], "searchable": false},{"targets": [2, 3], "orderable": false},
                    {"targets": [11], "searchable": true, "visible": false, "orderable": false}
                ],
                "fnServerData": function (sSource, aoData, fnCallback) {
                    ...
                    aoData.push({"name": "activeStatus", "value": $("#status_filter_item").val()});
            ...
            Otable = $('#item_table').DataTable({
                ...
                "columnDefs": [
                    {"targets": [0], "searchable": false},{"targets": [2, 3], "orderable": false},
                    {"targets": [12], "searchable": true, "visible": false, "orderable": false}
                ],
                "fnServerData": function (sSource, aoData, fnCallback) {
                    aoData.push({"name": "mainCategory", "value": $("#mainCategoryID").val()});
                    aoData.push({"name": "subcategory", "value": $("#subcategoryID").val()});
        ...
        if(hideWacAmount == 1)
         {
            ...
            "columnDefs": [{"targets": [2, 3], "orderable": false},{"targets": [10], "searchable": true, "visible": false, "orderable": false}],
            "fnServerData": function (sSource, aoData, fnCallback) {
                aoData.push({"name": "mainCategory", "value": $("#mainCategoryID").val()});
                aoData.push({"name": "subcategory", "value": $("#subcategoryID").val()});
                aoData.push({"name": "subsubcategoryID", "value": $("#subsubcategoryID").val()});
            ...
            "columnDefs": [{"targets": [2, 3], "orderable": false},{"targets": [11], "searchable": true, "visible": false, "orderable": false}],
            "fnServerData": function (sSource, aoData, fnCallback) {
                aoData.push({"name": "mainCategory", "value": $("#mainCategoryID").val()});
                aoData.push({"name": "subcategory", "value": $("#subcategoryID").val()});
                aoData.push({"name": "subsubcategoryID", "value": $("#subsubcategoryID").val()});
    ...
    function saveMultipleItemMaster(){
        ...
        var count = 0 ;
            ...
            $('select[name="secondaryUnitOfMeasureID[]"] option:selected').each(function () {
                data.push({'name': 'uomSecondary[]', 'value': $(this).text()})
            });
            ...
            $('.secondaryUnitOfMeasureID').each(function () {
                if (this.value == '' || this.value == 0) {
                    $(this).closest('tr').css("background-color", '#ffb2b2 ');
                    count=count+1;
                }else{
    ...
    function applyToAllColsUOMSecondary(element) {
        swal({
                title: "Are you sure?",
                text: "You want to apply this to all",
                type: "warning",
            ...
            function () {
                var secondaryUnitOfMeasureID = $(element).closest('tr').find('.secondaryUnitOfMeasureID').val();
                var elementTr = $(element).closest('tr').index();
                var elementTd = $(element).closest('td').index();
                var totalTr = $('#itemmultipletableserver tr').length - 1;
                for (var i = elementTr; i <= totalTr; i++) {
                    $(".commonrow" + i).find('.secondaryUnitOfMeasureID').val(secondaryUnitOfMeasureID).change();
                   // var oldval = $(elementTd+i).find('.mainCategoryID').val(mainCategoryID).change();
                }
            });
    }
    ...
    function uploadExcelItemMasterServerdide(){
        ...
        if (!jQuery.isEmptyObject(mainCategoryIDselect)) {
            var  secondaryUOMPolicy="<?php echo getPolicyValues('SUOM', 'All') ?>";
            if(secondaryUOMPolicy==1){
                Otables = $('#itemmultipletableserver').DataTable({
                    ...
                    "aoColumns": [
                        ...
                        {"mData": "secondaryUnitOfMeasureIDdrp"},
                    ...
                    "columnDefs": [{"targets": [1], "orderable": false}, { className: "inventry_row_div tdCol", "targets": [15,16] },{ className: "inventry_row_div assetGlCode_div tdCol", "targets": [17] },{ className: "fixed_row_div tdCol", "targets": [18,19,20,21] },{ className: "stockadjustment tdCol", "targets": [18,19,20,22] },{ className: "cls_maximunQty tdCol", "targets": [12] },{ className: "cls_minimumQty tdCol", "targets": [13] },{ className: "cls_reorderPoint tdCol", "targets": [14] },{ className: "tdCol", "targets": [2,3,7,8] }],
                    "fnServerData": function (sSource, aoData, fnCallback) {
                        /* aoData.push({"name": "mainCategory", "value": $("#mainCategoryID").val()});
                        aoData.push({"name": "subcategory", "value": $("#subcategoryID").val()});
                        aoData.push({"name": "subsubcategoryID", "value": $("#subsubcategoryID").val()});*/
    ...
    function excel_export() {
        ...
        var form = document.getElementById('itemmaster_filter_form');
        form.target = '_blank';
        form.method = 'post';
        form.post = $('#itemmaster_filter_form').serializeArray();
        form.action = '<?php echo site_url('ItemMaster/export_excel_item_master'); ?>';
        form.submit();
    }


    function referback_item(id) {
        ...
        swal({
            ...
            function () {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    data: {'itemAutoID': id},
                    url: "<?php echo site_url('ItemMaster/referback_item'); ?>",
                    beforeSend: function () {
                        startLoad();
                    },
                    success: function (data) {
