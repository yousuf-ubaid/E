...
<div class="m-b-md" id="wizardControl">
    <a class="btn btn-primary" href="#step1" data-toggle="tab">
        ...
        <?php echo $this->lang->line('hrms_expanse_claim_expense_claim_header'); ?><!--Expense Claim Header--></a>
    <a class="btn btn-default btn-wizard" href="#step2" onclick="fetch_EC_detail_table()" data-toggle="tab">
        <?php echo $this->lang->line('common_step'); ?><!--Step--> 2 -
        <?php echo $this->lang->line('hrms_expanse_claim_expense_claim_detail'); ?><!--Expense Claim Detail--></a>
    <a class="btn btn-default btn-wizard" href="#step3" onclick="load_conformation();" data-toggle="tab">
        ...
        <?php echo $this->lang->line('hrms_expanse_claim_expense_claim_confirmation'); ?><!--Expense Claim Confirmation--></a>
</div>
<hr>
    ...
    <div id="step1" class="tab-pane active">
        ...
        <div class="row">
            <div class="form-group col-sm-4">
                <label for="segment">
                    <?php echo $this->lang->line('hrms_expanse_claim_employee'); ?><!--Employee--> <?php required_mark(); ?></label>
                <?php echo form_dropdown('claimedByEmpID', $employee_arr, current_userID() . '|' . current_user(), 'class="form-control select2" onchange="load_segemnt()" id="claimedByEmpID" required'); ?>
            </div>
            <div class="form-group col-sm-4">
                <label for="">
                    <?php echo $this->lang->line('hrms_expanse_claim_expanse_claim_date'); ?><!--Expense Claim Date--> <?php required_mark(); ?></label>
    ...
    <div id="step2" class="tab-pane">
        <div class="row">
            <div class="col-md-8"><h4><i class="fa fa-hand-o-right"></i>
                    <?php echo $this->lang->line('hrms_expanse_claim_expense_claim_detail'); ?><!--Expense Claim Detail-->
                </h4><h4></h4></div>
            <div class="col-md-4">
        ...
        <table class="table table-bordered table-striped table-condesed">
            ...
            <tr>
                ...
                <th style="min-width: 10%">
                    <?php echo $this->lang->line('hrms_expanse_claim_expanse_claim_category'); ?><!--Expense Claim Category--></th>
                <th style="min-width: 25%" class="text-left">
                    <?php echo $this->lang->line('common_description'); ?><!--Description--></th>
                <th style="min-width: 5%">
                    <?php echo $this->lang->line('hrms_expanse_claim_expanse_doc_ref'); ?><!--Doc Ref--></th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <h5 class="modal-title">
                    <?php echo $this->lang->line('hrms_expanse_claim_add_item_detail'); ?><!--Add Item Detail--></h5>
            </div>
                    ...
                    <table class="table table-bordered table-condensed no-color" id="ec_detail_add_table">
                        ...
                        <tr>
                            <th style="width: 200px;">
                                <?php echo $this->lang->line('hrms_expanse_claim_expanse_claim_category'); ?><!--Expense Claim Category --><?php required_mark(); ?></th>
                            <th style="width: 150px;">
                                <?php echo $this->lang->line('common_description'); ?><!--Description--> <?php required_mark(); ?></th>
                            <th style="width: 100px;">
                                <?php echo $this->lang->line('hrms_expanse_claim_expanse_doc_ref'); ?><!--Doc Ref --><?php required_mark(); ?></th>
                        ...
                        <tr>
                            ...
                            <td><?php echo form_dropdown('segmentIDDetail[]', $segment_arr_detail, current_user_segemnt(true), 'class="form-control select2 segmentIDDetail" id="segmentIDDetail" required'); ?></td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
                <h5 class="modal-title">
                    <?php echo $this->lang->line('hrms_expanse_claim_edit_item_detail'); ?><!--Edit Item Detail--></h5>
            </div>
            <div class="modal-body">
                <form role="form" id="expense_claim_detail_edit_form" class="form-horizontal">
                    <table class="table table-bordered table-condensed no-color" id="po_detail_edit_table">
                        ...
                        <tr>
                            ...
                            <td><?php echo form_dropdown('segmentIDDetailEdit', $segment_arr_detail, current_user_segemnt(true), 'class="form-control select2" id="segmentIDDetailEdit" required'); ?></td>
                            ...
                            <td><input type="text" name="transactionAmountEdit"
                                       class="form-control numeric transactionAmountEdit" style="text-align: right;"
                                       onkeypress="return validateFloatKeyPress(this,event)" id="transactionAmountEdit"
            ...
            <div class="modal-footer">
                <button data-dismiss="modal" class="btn btn-default" type="button">
                    <?php echo $this->lang->line('common_Close'); ?><!--Close--></button>
                <button class="btn btn-primary" type="button" onclick="updateExpenseClaimDetails()">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('.headerclose').click(function () {
            fetchPage('system/expenseClaim/expense_claim_management_hrms', expenseClaimMasterAutoID, 'Expense Claim Master');
        });
        ...
        $('#expense_claim_form').bootstrapValidator({
            ...
            excluded: [':disabled'],
            fields: {
                expenseClaimDate: {validators: {notEmpty: {message: '<?php echo $this->lang->line('hrms_expanse_claim_expense_claim_date_is_required');?>.'}}},/*Expense Claim Date is required*/
                comments: {validators: {notEmpty: {message: '<?php echo $this->lang->line('common_description_is_required');?>.'}}},/*Description is required*/
            ...
            $('#claimedByEmpID').prop('disabled',false);
            var $form = $(e.target);
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (jQuery.isEmptyObject(data['detail'])) {
                        $('#table_body').append('<tr class="danger"><td colspan="8" class="text-center"><b></span> <?php echo $this->lang->line('common_no_records_found');?><!--No Records Found--></b></td></tr>');
                    } else {
                        tot_amount = 0;
            ...
            $.ajax({
                    ...
                    success: function (data) {
                        if (!jQuery.isEmptyObject(data)) {
                            ...
                            $('#claimedByEmpID').val(data['claimedByEmpID'] + '|' + data['claimedByEmpName']).change();
        ...
        if (expenseClaimMasterAutoID) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    stopLoad();
                    refreshNotifications(true);
                    attachment_modal_expenseClaim(expenseClaimMasterAutoID, "<?php echo $this->lang->line('common_expense_claim');?>", "EC");/*Expense Claim*/
                }, error: function () {
                    stopLoad();
    ...
    function checkDetail() {
        //var claimedByEmpID=$('#claimedByEmpID').val();
        $.ajax({
            async: true,
            type: 'post',
            dataType: 'json',
            data: {'expenseClaimMasterAutoID': expenseClaimMasterAutoID},
            url: "<?php echo site_url('ExpenseClaim/checkDetailexsist'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
                ...
                if (data[0] == 'w') {
                    //myAlert(data[0], data[1]);
                    $('#claimedByEmpID').prop('disabled',true);
                }else{
                    $('#claimedByEmpID').prop('disabled',false);
                }
    ...
    function load_segemnt(){
        $.ajax({
            async: true,
            type: 'post',
            dataType: 'json',
            data: {'empid': $('#claimedByEmpID').val()},
            url: "<?php echo site_url('ExpenseClaim/get_user_segemnt'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
