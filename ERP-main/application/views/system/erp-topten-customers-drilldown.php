    ...
    <div class="row" style="margin-top: 5px;">
        <div class="col-md-12 " id="toptencustomersdrilldown">
            ...
            <div class="reportHeader reportHeaderColor" style="text-align: center">
                <strong>Top Ten Customers Drill Down - <?php echo $customername;?></strong></div>
            ...
            <div style="height: 600px">
                <table id="tbl_rpt_toptencustomers" class="borderSpace report-table-condensed" style="width: 100%">
                    ...
                    }else
                    {
                        ...
                        foreach ($toptencustomerdd as $val) {
                            $total += $val["transactionAmount"];
                            ?>
                            <tr>
                                <td width="200px"><a href="#" class="drill-down-cursor"
                                                     onclick="documentPageView_modal('<?php echo $val["documentID"] ?>',<?php echo $val["docmasterID"] ?>)"><?php echo $val["documentsystemcode"] ?></a></td>
