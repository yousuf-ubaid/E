...
<div class="row">
                        ...
                        <div class="box-body">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div id="closed_label_div" style="display: none;">
                                            <label for="closed_label">
                                                <?php echo $this->lang->line('common_status'); ?><!--Status-->:</label>
                                            <span id="closed_label" class="label label-text-size"
                                                  style="background-color: red; margin-right: 5px;"><?php echo $this->lang->line('common_closed'); ?><!--Closed--></span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 mpo_based" style="width:100%;padding-left:0px;padding-right:0px;margin-top:50px;">
                                    ...
                                    <div class="col-sm-12 mpo_based" style="width:100%;margin-left:15px;">
                                ...
                                <!-- purpose -->
                                    ...
                                    <h4 class="col-sm-12 mpo_based" style="width:100%;margin-left:15px;"><u><b>LIST OF MEASURED DUTIES TO BE PERFORMED (MAJOR TASK)</b></u></h4>


                                <div id="report_view">
                                    <h3 id="report_header" style="text-align: center;display: none;">Performance Appraisal</h3>
                                    <div class="col-md-12">
                                        <div class="col-md-12">
                                            ...
                                            ?>"><span class="lbl1" style="font-weight: 600;display:none;"><?php echo $this->lang->line('appraisal_marked_by_you'); ?><!--Marked By You--></span>
                                            </div>
                                            <!--........................................................................................-->
                                    ...
                                    <div class="col-md-12 grade_base" style="margin-top:30px;<?php
                                        $isHideMarkedByEmpShow = hide_marks_marked_by_employee();
                                        if ($isHideMarkedByEmpShow) {
                                            echo 'display:none';
                                        }
                                        ...
                                        <div class="col-md-12">
                                            <div style="margin-top: 15px;"><span class="lbl1"
                                                                                 style="font-weight: 600;display:none;"><?php echo $this->lang->line('appraisal_marked_by_employee'); ?><!--Marked By Employee--></span>
                                            </div>
                                    ...
                                    ?>">
                                        ...
                                        <div class="col-md-4 last_update_emp_div" style="margin-top: 7px;">
                                            <?php echo $this->lang->line('common_last_updated'); ?><!--Last updated-->:
                                    ...
                                    <!-- <div class="col-md-12 mpo_based">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="manager_comment_label">
                                                    <u><i>&nbsp;. Manager Comments on ASSESSMENT</i></u>
                                                </label>
                                    ...
                                    <!--below, grade base fields. but mpo based also should have.....................................-->

                                    
                                    <div class="col-md-12 common_based">
                                            <div class="row">
                                                <div class="form-group col-sm-2 md-offset-2">
                                                    <label class="title">Manager comment</label>
                                                </div>
                                                <div class="form-group col-sm-10">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-3">
                                        <button id="btn_save_manager_comments_as_draft"
                                                ...
                                                onclick="btn_save_manager_comments_as_draft.call(this)"><?php echo $this->lang->line('common_save_as_draft'); ?>
                                            <!--Save as Draft-->
                                        </button>
                                    </div>
                                    <div class="col-md-3">
                                        <button id="btn_save_manager_comments"
                                                ...
                                                onclick="btn_save_manager_comments.call(this)">
                                            <?php echo $this->lang->line('common_save_and_confirm'); ?><!--Save & Confirm-->
                                        </button>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function print_report() {
            ...
            var link = "<?php echo base_url('index.php/appraisal/print_pa_report'); ?>?config_goal_id="+config_goal_id+"&emp_id="+emp_id;
        ...
        function btn_save_manager_comments_as_draft() {
            var begin_with_the_end_in_mind = $("#begin_with_the_end_in_mind").val();
            var miscellaneous_worth_mentioning = $("#miscellaneous_worth_mentioning").val();
            var bench_mark_objective_assessment = $("#bench_mark_objective_assessment").val();
        ...
        function validation_before_confirm() {
            ...
            var miscellaneous_worth_mentioning = $("#miscellaneous_worth_mentioning").val();
            var bench_mark_objective_assessment = $("#bench_mark_objective_assessment").val();
            var manager_assessment_undertaking = $("#manager_assessment_undertaking").val();
            ...
            //mpo base validations
            if (begin_with_the_end_in_mind == "") {
                is_valid = false;
                show_error('begin_with_the_end_in_mind_error', 'begin with the end in mind field is required.');
            } else {
                hide_error('begin_with_the_end_in_mind_error');
            }

            if (miscellaneous_worth_mentioning == "") {
                is_valid = false;
                show_error('miscellaneous_worth_mentioning_error', 'miscellaneous worth mentioning field is required.');
            } else {
                hide_error('miscellaneous_worth_mentioning_error');
            }

            if (bench_mark_objective_assessment == "") {
                is_valid = false;
                show_error('bench_mark_objective_assessment_error', 'bench mark objective assessment field is required.');
            } else {
                hide_error('bench_mark_objective_assessment_error');
            }

            if (bench_mark_objective_assessment == "") {
                is_valid = false;
                show_error('manager_assessment_undertaking_error', 'manager assessment undertaking field is required.');
            } else {
                hide_error('manager_assessment_undertaking_error');
            }

            //grade base validations
            if (manager_comment == "") {
                is_valid = false;
        ...
        function fetch_employee_skills_performance_appraisal() {
            ...
            $.ajax({
                ...
                if(data.markingType == 2){  //....................................................................MPO base template (markingType == 2)
                                ...
                                tbl +=' <table id="soft_skill_MPO_table_mngr" class="<?php echo table_class(); ?>">';
                                        ...
                                        hd_item.sub.forEach(function(sub_item, index){
                                            ...
                                            tbl +=' <tr>';
                                                ...
                                                tbl +=' <td><input type="text" name="measuredPoint" style="width:100%" id="measuredPoint_'+ sub_item.performance_area_id +'" placeholder="0" class="measuredPoint1 number" onkeyup="calculate_total_measurePoints(this, '+ sub_item.parent_id  +')" ';
                                                tbl +=' onchange="" value="'+ mpoint +'" readonly></td> ';

                                                tbl +=' <td><input type="text" name="empmeasuredPoint" style="width:100%" id="empmeasuredPoint_'+ sub_item.performance_area_id +'" placeholder="0" class="empmeasuredPoint1 number" onkeyup="calculate_total_measurePoints(this, '+ sub_item.parent_id  +')" ';
                                                tbl +=' onchange="save_measurepoint('+ sub_item.performance_area_id +', this.value)" value="'+ emp_point +'" readonly></td> ';
                                                tbl +=' <td><input type="text" name="mngrmeasuredPoint" style="width:100%" id="mngrmeasuredPoint_'+ sub_item.performance_area_id +'" placeholder="0" class="mngrmeasuredPoint1 number" onkeyup="calculate_total_measurePoints(this, '+ sub_item.parent_id  +')" ';
                                                tbl +=' onchange="" value="'+ mngr_point +'"></td> ';
                                            tbl +=' </tr>';
                                            ...
                                            tbl +=' <tr style="background-color:rgb(221,210,0,0.6);">';
                                                ...
                                                tbl +=' <td><input type="text" value="'+ total_measure +'" style="width:100%;background-color:rgb(221,210,0,0.6);" id="total_'+ hd_item.performance_area_id +'" placeholder="0" class="number" readonly></td>';
                                                tbl +=' <td><input type="text" value="'+ total_employee +'" style="width:100%;background-color:rgb(221,210,0,0.6);" id="emptotal_'+ hd_item.performance_area_id +'" placeholder="0" class="number" readonly></td>';
                                                tbl +=' <td><input type="text" value="'+ total_manager +'" style="width:100%;background-color:rgb(221,210,0,0.6);" id="mngrtotal_'+ hd_item.performance_area_id +'" placeholder="0" class="number" readonly></td>';
                                            tbl +=' </tr>';
                    ...
                    var percentage_employee = ( (100/grand_total_measure) * grand_total_employee ).toFixed(2) + '%';
                    var percentage_manager = ( (100/grand_total_measure) * grand_total_manager ).toFixed(2) + '%';
                        ...
                        tottbl +=' <table id="soft_skill_MPO_grandTotal_table" class="<?php echo table_class(); ?>">';
                            tottbl +=' <tbody>';
                                ...
                                tottbl +=' <tr style="background-color:rgba(255,163,34,0.67);">';
                                    ...
                                    tottbl +=' <td style="min-width: 15%"><input type="text" value="'+percentage_employee+'" style="width:100%;background-color:rgba(255,163,34,0.67);" id="" placeholder="0" class="number" readonly></td>';
                                    tottbl +=' <td style="min-width: 15%"><input type="text" value="'+percentage_manager+'" style="width:100%;background-color:rgba(255,163,34,0.67);" id="" placeholder="0" class="number" readonly></td>';
                                tottbl +=' </tr>';
                            tottbl +=' </tbody>';
                        tottbl +=' </table>';
                    tottbl +=' </div>';
                    ...
                    // if(data.begin_with_the_end_in_mind){
                    //     $('#begin_with_the_end_in_mind').text(data.begin_with_the_end_in_mind);
                    //     $('#miscellaneous_worth_mentioning').text(data.miscellaneous_worth_mentioning);
                    //     $('#benchmark_objective_assessment').text(data.benchmark_objective_assessment);
                    // }
                    ...
                    data.miscellaneous_worth_mentioning ? $('#miscellaneous_worth_mentioning').text(data.begin_with_the_end_in_mind) : $('#miscellaneous_worth_mentioning').text('');
                    data.benchmark_objective_assessment ? $('#benchmark_objective_assessment').text(data.begin_with_the_end_in_mind) : $('#benchmark_objective_assessment').text('');
                    ...
                    /**....................................................................set tinyMCE areas */
                        ...
                        if(data.career_and_training_action_plan){
                        ...
                        if(data.manager_assessment_undertaking){
                ...
                else{   //........................................................Grade base (markingType == 1) - template
                    ...
                    // div that containing Marked By You table...........
                    $("#softskills_template").html('');
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data.markingType != 2){
                        ...
                        // div that containing Marked By Employee table..........
                        $("#softskills_template_emp_self").html("");
                        ...
                        $("#template_tablebody_self_eval").html('');
        ...
        function save_measurepoint(id, value) {
            ...
            $.ajax({
                type: 'POST',
                dataType: "json",
                url: "<?php echo site_url('Appraisal/save_emp_measurepoint'); ?>",
