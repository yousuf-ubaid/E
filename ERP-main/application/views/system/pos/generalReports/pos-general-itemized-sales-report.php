...
<span class="pull-right">
    ...
    <a href="" class="btn btn-excel btn-xs" id="btn-excel" download="Item_Wise_Sales_Report.xls"
       onclick="var file = tableToExcel('printContainer_itemizedSalesReport', 'Item Wise Sales Report'); $(this).attr('href', file);">
