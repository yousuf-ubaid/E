        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <button onclick="open_add_taxModal('<?php echo !empty($id) && isset($id) ? $id : 0; ?>')"
                            class="btn btn-xs btn-primary" type="button"><i class="fa fa-check" aria-hidden="true"></i> Apply VAT
                    </button>
                </div>
