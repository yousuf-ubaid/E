                ...
                <div class="dropdown pull-right" style="padding-right: 15px;">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        foreach ($outlets as $outlet) {
                            ...
                            $outlet['wareHouseLocation'] = str_replace('\'', '', $outlet['wareHouseLocation']);
                            $outlet['wareHouseDescription'] = str_replace('\'', '', $outlet['wareHouseDescription']);
...
<div class="tab-content">
    <div id="step1" class="tab-pane active">
        <div class="col-md-7" style="padding-top: 7px;">
            ...
            <div class="box box-warning hidden" style="background-color: rgba(244, 244, 244, 0.47);">
                <div class="box-header boxHeaderCustom">
                    REVPASH
