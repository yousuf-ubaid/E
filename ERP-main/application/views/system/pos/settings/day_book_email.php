    ...
    function loadEmailList() {
        var Otable = $('#tbl_dayBookEmail').DataTable({
            ...
            "fnServerData": function (sSource, aoData, fnCallback) {
                aoData.push({"name": "posType", "value": "rpos"});
                $.ajax({
                    'dataType': 'json',
                    'type': 'POST',
                    'url': sSource,
    ...
    function edit_email() {
        ...
        if (validate_email_edit_form()) {
            $.ajax({
                ...
                type: 'post',
                dataType: 'json',
                data: {name: name, email: email, posType: 'rpos', id: app.current_id},
    ...
    function save_email() {
        ...
        if (validate_email_form()) {
            $.ajax({
                ...
                type: 'post',
                dataType: 'json',
                data: {name: name, email: email, posType: 'rpos'},
