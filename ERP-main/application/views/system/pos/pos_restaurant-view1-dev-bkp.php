    ...
    <div class="row" style="margin-top: 0px;">
        <div class="col-md-6">
            ...
            <div class="btn-group">
                ...
                if ($cctv) {
                    ?>
                    <button type="button" onclick="open_cctv_modal();" class="btn btn-default btn-lg buttonDefaultSize">
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data['error'] == 1) {
                    ...
                    divTmp += '</div>';
                    divTmp += '<div class="receiptPadding">';
                    divTmp += '<div style="width:55px; text-align: right;" class="itemCostNet menuItemTxt"> [' + data['sellingPrice'] + '</div> <!-- net total -->';
                    ...
                    divTmp += '<button type="button" class="btn btn-default btn-sm  itemList-delBtn"><i class="fa fa-close closeColor"></i></button>';
                    divTmp += '</div>';
                    divTmp += '</div>';
                    divTmp += '</div>';
                    divTmp += '</div>';
