<div>
    ...
    <div id="print_content<?php echo $uniqueID; ?>">
        ...
        <table style="width: 100%">
            <tr>
                ...
                <td style="width:20%; "><?php echo $this->lang->line('posr_inv_no') . ':'; ?><!--Inv. No--> asdhjgghgfds</td>
                <td style="width:25%;"
            ...
            if (!empty($invoiceList)) {
                ...
                foreach ($invoiceList as $item) {
                    ...
                    if ($kotID == 0 || $kotID != $item['kotID']) {
                        ...
                        <tr>
                            <td colspan="4" class="kitchenHeader"><?php echo $item['kitchenName'] ?></td>
                        </tr>
                        <tr>
                            <td colspan="4">
                                <div class="vLineKOT">&nbsp;</div>
    ...
    <?php if ($print) { ?>
        ...
        <div id="bkpos_wrp">
            <button type="button" onclick="print_KOTpaymentReceipt();"
