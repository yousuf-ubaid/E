        ...
        function print_paymentReceipt(parameter = null) {
            ...
            if (screenWidth < 768) {
                ...
                if(split_qty!=null){
                    ...
                    let print_copy = "";
                    while (i<split_qty){
                        print_copy += '<div class="pagebreak"> </div>'+print_content;
                        //print_copy += print_content;
                        i++;
                    }
        ...
        <div class="myCustomPrint" style="margin:0 92px 0 -19px;width:123px;">
            ...
            <table border="0" style="width:100%" class="f fSize fWidth">
                ...
                <tr>
                    <td width="100%" class="ac">
                        ...
                        <?php if (!isset($from_up_coming)) { ?>
                            <div style=" padding: 0px; font-size:7px;">WELCOME TO</div>
                        <?php } ?>
                        <div class="headerTxt" style="font-size:13px !important; text-align: center;">
            ...
            <table border="0" style="width:100%" class="f fSize fWidth">
                ...
                <tr>
                    ...
                    <td style="width:20%;font-size: 8px !important; "><?php echo $this->lang->line('posr_inv_no'); ?><!--Inv. No-->:
                    </td>
                    <td style="width:25%;font-size: 8px !important;"
                        class="ar"><?php echo get_pos_invoice_code($masters['menuSalesID'], $masters['wareHouseAutoID']) ?> </td>
                </tr>
                <tr>
                    <td style="text-align: left;font-size: 8px !important;"><?php echo $this->lang->line('common_date'); ?><!--Date-->:
                    </td>
                    <td class="al" style="font-size: 8px !important;"> <?php echo date('d/m/Y&\nb\sp;&\nb\sp;&\nb\sp;&\nb\sp;&\nb\sp;&\nb\sp;&\nb\sp;&\nb\sp;g:i A', strtotime($masters['createdDateTime'])) ?></td>
                </tr>
                <tr>
                    <td style="text-align: left;font-size: 8px !important;"> Remarks</td>
                    <td class="al" colspan="3" style="font-size: 8px !important;">
                        <strong> <?php echo trim($masters['holdRemarks'] ?? ''); ?></strong>
                    </td>
                </tr>

                <tr>
                    <td style="text-align: left;font-size: 8px !important;">Name :</td>
                    <?php
                    $menusalescust = '';
                    ...
                    if (!empty($deliveryInfo)) {
                        ...
                        ?>
                        <td style="width:30%;font-size: 8px !important;" class="al"><?php echo $masters['cusname'] ?></td>
                        <?php
                    } elseif (!empty($menusalescust)) {
                        ?>
                        <td style="width:30%;font-size: 8px !important;" class="al"><?php echo $menusalescust['CustomerName'] ?></td>
                        <?php
                    } else {
                        ?>
                ...
                <tr>
                    <td style="text-align: left;font-size: 8px !important;">Mobile :</td>
                    <?php
                    if (!empty($deliveryInfo)) {
                        ?>
                        <td style="width:30%;font-size: 8px !important;"
                            class="al"><?php echo !empty($deliveryInfo) ? $deliveryInfo['phoneNo'] : '-'; ?></td>
                        <?php
                    } elseif (!empty($masters['custel'])) {
                        ?>
                        <td style="width:30%;font-size: 8px !important;" class="al"><?php echo $masters['custel']; ?></td>
                        <?php
                    } elseif (!empty($menusalescust)) {
                        ?>
                        <td style="width:30%;font-size: 8px !important;" class="al"><?php echo $menusalescust['customerTelephone'] ?></td>
                        <?php
                    } else {
                        ?>
                        <td style="width:30%;font-size: 8px !important;" class="al">-</td>
                        <?php
                    }
                    ?>
                </tr>
...
//                        $taxAmount = (number_format($netTotal, $d) / 100) * number_format($item->taxPercentage, $d);
                ...
                if (!empty($masters['discountPer']) && $masters['discountPer'] > 0 || true) {
                    ...
                    if ($discount > 0) {
                        ?>
                        <tr>
                            <td colspan="2" style="text-align:left; font-weight:bold; padding-top:1px;font-size:8px !important;">
...
//                                $taxAmounttt = (number_format($netTotaltt, $d) / 100) * number_format($taxItem->taxPercentage, $d);
                ...
                <tr>
                    ...
                    <td colspan="2"
                        style="padding-top:1px; text-align:right; font-weight:bold;font-size:8px !important;">
                        <?php
//                        if ($isConfirmedDelivery) {
...
//                        }
                        ...
                        $totalPaid = get_paidAmount($masters['menuSalesID']);
                      //$totalPaid = get_cashReceivedAmount($masters['menuSalesID']);
                        //echo number_format(abs($totalPaid), $d);
                    ...
                    <td colspan="2"
                        ...
                        if ($isConfirmedDelivery) {
                            ...
                            if ($masters['balanceAmount'] != 0) {
                                ...
                                $balanceAmount = $netTotal - $totalPaid;
                                //$balanceAmount = $totalPaidAmount - $totalPaid;
                            }
