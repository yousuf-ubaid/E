                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <form class="form-horizontal" method="post">
                        ...
                        <div class="form-group">
                            <label class="col-md-4 control-label" for="cs_amount">Amount </label>
                            <div class="col-md-4">
                                <input readonly type="text" id="cs_amount" name="amount"
                                       class="form-control ar amountStyle" placeholder="0.00"><!--numPad -->
                            </div>
                        </div>

                        <div class="row">
                            <?php
                            $cr_customers = get_creditCustomers();
                            ?>
