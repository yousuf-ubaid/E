...
<span class="pull-right">
    ...
    <a href="" class="btn btn-excel btn-xs" id="btn-excel" download="Product_Mix.xls"
       onclick="var file = tableToExcel('printContainer_itemizedSalesReport', 'Product Mix'); $(this).attr('href', file);">
