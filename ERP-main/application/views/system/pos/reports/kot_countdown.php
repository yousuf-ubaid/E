<?php echo head_page('<i class="fa fa-bar-chart"></i> KOT Countdown Report', false);
...
?>
<form id="form_kotContdown_report" method="post" class="form-inline" role="form">
    <input type="hidden" id="kot_outletID" name="outletID" value="0"/>
    ...
    <div class="form-group">
        <label class="col-md-5 control-label">Cashier</label>
        <div class="col-md-12">
...
<hr>
<div id="kotCountdown_report" class="reportContainer">
...
<script>
    $(document).ready(function (e) {
        ...
        $("#form_kotContdown_report").submit(function (e) {
            loadKotContdownReport();
            return false;
        });
        loadCashier();
    });
    ...
    function loadKotContdownReport() {
        $.ajax({
            type: 'POST',
            dataType: 'html',
            url: "<?php echo site_url('Pos_restaurant_report/load_kotCountdown_report'); ?>",
            data: $("#form_kotContdown_report").serialize(),
            cache: false,
            beforeSend: function () {
               $("#kotCountdown_report").html('<div style="text-align: center;"> <i class="fa fa-refresh fa-spin fa-2x"></i> <?php echo $this->lang->line('posr_loading_print_view');?> </div>');
            },
            success: function (data) {
                $("#kotCountdown_report").html(data);
            },
