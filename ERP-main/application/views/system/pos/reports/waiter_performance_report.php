                                ...
                                <div class="col-sm-12">
                                    ...
                                    if($isSuperAdmin) {
                                        ...
                                        <div class="col-sm-3">
                                            ...
                                            <select class=" filters" multiple required name="outletID_f[]"
                                                    id="outletID_f"
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <label class="" for="">
                                                <?php echo $this->lang->line('posr_waiter'); ?><!--Waiter--> </label>
                                            <span id="cashier_option">
                                <?php echo form_dropdown('waiter[]', get_cashiers(), '', 'multiple required id="waiter"  class="form-control input-sm"'); ?>
                            </span>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <label class="" for="">
                                                <?php echo $this->lang->line('posr_waiter'); ?> </label>
...
<script>
    $(document).ready(function (e) {
        ...
        * */
        ...
        $("#customer3").multiselect2('deselectAll', true);
    ...
    function loadPaymentSalesReport_ajax2() {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'html',
            url: "<?php echo site_url('Pos_restaurant/load_pos_detail_sales_report_with_waiters'); ?>",
            data: data,
            cache: false,
            beforeSend: function () {
                $("#pos_modalBody_posPayment_sales_report2").html('<div style="text-align: center;"> <i class="fa fa-refresh fa-spin fa-2x"></i>  <?php echo $this->lang->line('posr_loading_print_view');?></div>');
    ...
    function loadPaymentSalesVoidReport_ajax2() {
        ...
        $.ajax({
            type: 'POST',
            dataType: 'html',
            url: "<?php echo site_url('Pos_restaurant/load_pos_detail_void_report_with_waiters'); ?>",
            data: data,
            cache: false,
            beforeSend: function () {
    ...
    function loadCashier() {
        $.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo site_url('Pos_restaurant/get_outlet_waiter'); ?>",
    ...
    function loadCashier_voidbill() {
        $.ajax({
            type: 'POST',
            dataType: 'json',
            url: "<?php echo site_url('Pos_restaurant/get_outlet_waiter_voidbills'); ?>",
