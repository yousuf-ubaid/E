...
<span class="pull-right">
    <button type="button" id="btn_print_itemizedSales" onclick="printReport()" class="btn btn-default btn-xs">
    ...
    <a href="" class="btn btn-excel btn-xs" id="btn-excel" download="Franchise_Report.xls"
       onclick="var file = tableToExcel('printContainer_Franchise_Report', 'Franchise Report'); $(this).attr('href', file);">
        <i class="fa fa-file-excel-o" aria-hidden="true"></i> Excel
    </a>
</span>
<div id="printContainer_Franchise_Report">
...
-->
    ...
    <table class="" style="width: 100%; " border="1">
        ...
        <tr style="font-size:12px !important;" class="t-foot">
            ...
            $EatInQtyd = $EatInQty==0? 0 : $EatInQty / $i;
            $EatInTotald = $EatInTotal==0?0: $EatInTotal / $i;
            $TakeAwayQtyd =$TakeAwayQty==0?0: $TakeAwayQty / $i;
            $TakeAwayTotald =$TakeAwayTotal==0?0: $TakeAwayTotal / $i;
            $DeliveryOrdersQtyd =$DeliveryOrdersQty==0?0: $DeliveryOrdersQty / $i;
            $DeliveryOrdersTotald =$DeliveryOrdersTotal==0?0: $DeliveryOrdersTotal / $i;
            $netQtyd =$netQty==0?0: $netQty / $i;
            $NetTotald =$NetTotal==0?0: $NetTotal / $i;
            ?>
            <td colspan="3" style="padding-right:2px;font-weight: bold; text-align: right"><strong>
