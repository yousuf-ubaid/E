        ...
        <div class="col-md-12 animated zoomIn">
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <span class="input-req" title="Required Field">
                    ...
                    <input type="hidden" name="customerCountryId" id="customerCountryId">
                    <span class="input-req-inner"></span>
                </span>
                </div>
            </div>
        ...
        <div class="col-md-12 animated zoomIn">
            ...
            <div class="row" style="margin-top: 10px;">
                ...
                <span class="input-req" title="Required Field">
                    ...
                    <input type="text" name="customerCountryCode" id="customerCountryCode" class="form-control"
...
<script type="text/javascript">
        ...
        if (posCustomerAutoID > 0) {
            $.ajax({
                ...
                success: function (data) {
                    if (data['error'] == 0) {
                        myAlert('s', data['message']);
                        $("#submitCustomerBtn").html('<i class="fa fa-pencil"></i> Update Customer');
    ...
    $('#country-select').on('change','#customerCountry',function (e) {
        ...
        if(code && countryId){
            ...
            $('#customerCountryId').val(countryId);
        }
    });
</script>