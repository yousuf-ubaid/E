...
$title = $this->lang->line('salescommision_payment');
echo head_page($_POST['page_name'], false);
/*echo head_page('Commision Payment',true);*/
...
<div class="row">
    <div class="col-md-5">
        <table class="<?php echo table_class(); ?>">
            <tr>
                ...
                <td><span class="label label-warning">&nbsp;</span> <?php echo $this->lang->line('salescommision_refer_back');?><!--Refer-back-->
                </td>
            </tr>
        </table>
    </div>
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary-new size-sm pull-right" onclick="fetchPage('system/sales/commision_payment_new',null,'<?php echo $this->lang->line('salescommision_add_new_commision_payment');?>'/*Add New Commision Payment*/,'CP');"><i class="fa fa-plus"></i> <?php echo $this->lang->line('salescommision_create_commision_payment');?><!--Create Commision Payment--> </button>
    </div>
</div><hr>
<div class="table-responsive">
    <table id="payment_voucher_master_table" class="<?php echo table_class(); ?>">
        ...
        <tr>
            ...
            <th style="min-width: 15%"><?php echo $this->lang->line('salescommision_pv_code');?></th><!--PV Code-->
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('.headerclose').click(function () {
            fetchPage('system/sales/commision_payment', '', 'Commision Payment');
        });
    ...
    function payment_voucher_table(selectedID=null){
        Otable = $('#payment_voucher_master_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Payment_voucher/fetch_commission_payment'); ?>",
            "aaSorting": [[0, 'desc']],
        ...
        swal({
            ...
            function () {
                $.ajax({
                    ...
                    dataType : 'json',
                    data : {'payVoucherAutoId':id},
                    url :"<?php echo site_url('Payment_voucher/re_open_commisionpayment'); ?>",
                    beforeSend: function () {
                        startLoad();
                    },
                    success : function(data){
