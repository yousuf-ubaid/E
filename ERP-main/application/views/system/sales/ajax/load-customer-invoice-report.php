    ...
    <div class="row" style="margin-top: 5px">
        <div class="col-md-12 " id="salesOrderReport">
            ...
            <div class="reportHeader reportHeaderColor" style="text-align: center">
                <strong><?php echo $this->lang->line('sales_markating_revenue_details'); ?><!--Revenue Details--></strong></div>
            <div style="">
                <table id="tbl_rpt_salesorder" class="borderSpace report-table-condensed" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->lang->line('common_amount'); ?><!--Invoice Amount--></th>
                        <th><?php echo $this->lang->line('common_tax') . ' ' . $this->lang->line('common_amount'); ?><!--Tax Amount--></th>
                       <th><?php echo $this->lang->line('sales_markating_return_amount'); ?><!--Return Amount--></th>
                       <th><?php echo $this->lang->line('sales_markating_receipt/Credit_note_amount'); ?><!--Receipt/Credit Note Amount--></th>
                       <th><?php echo $this->lang->line('common_balance'); ?><!--Balance--></th>
                        ...
                        foreach ($details as $value) {                            
                            ...
                            foreach ($value as $val) {                                
                                ...
                                <tr>
                                    ...
                                    <?php
                                    if (($type == 'html') && ($val["documentCode"]!='POS')) {
                                        ?>
...
//                                        $balance=($val["total_value"]/$exchangerate);
                                    ...
                                    <td style="text-align: right"><?php 
                                        if($val["documentCode"]=='SLR' || $val["documentCode"]=='CN') {
                                            $val['taxAmount'] = $val['taxAmount'] * -1;
                                        }
                                        echo number_format(($val['taxAmount']), $decimalPlace);
                                        ?></td>
                                    <?php
                                    if($return>0 && ($val["documentCode"]!='POS')){
                                        ?>
                                    ...
                                    if($credittot>0){
                                        ?>
                                        <td style="text-align: right"><a href="#" class="drill-down-cursor" onclick="openrecreditDD(<?php echo $val["documentMasterAutoID"] ?>)"><?php echo number_format($credittot, $decimalPlace) ?></a></td>
                                        <?php
                                    }
                                    else if ($val["documentCode"]=='RV')
                                    {
                                        echo "<td style='text-align: right'>".number_format($balance + $val['taxAmount'], $decimalPlace)."</td>";
                                    }
                                    ...
                                    if($val['taxAmount'] && $val["documentCode"] != 'RV' && $val["documentCode"] != 'SLR') {
                                        $bal += $val['taxAmount'];
                                    }
                            ...
                            <tr>
                                ...
                                <td class="text-right reporttotal"><?php echo number_format($taxTot,$decimalPlace) ?></td>
