...
<table id="sales_detail_report_table" class="<?php echo table_class() ?> customTbl">
        <thead>
        <tr>
        ...
        if (!empty($reportData)) {
            ...
            foreach ($reportData as $item) {
                ...
                <tr>
                    ...
                    <td><a href="#" class="drill-down-cursor" onclick="documentPageView_modal('<?php echo $item["documentCode"] ?>',<?php echo $item["documentAutoID"] ?>)"><?php echo $item["documentSystemCode"] ?></a></td>
