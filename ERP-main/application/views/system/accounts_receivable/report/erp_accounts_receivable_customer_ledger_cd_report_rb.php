<!---- =============================================
-- File Name : erp_accounts_receivable_customer_ledger_cd_report_rb.php
                                ...
                                foreach ($category as $key => $glcodes) {
                                    ...
                                    foreach ($glcodes as $key2 => $customer) {
                                        ...
                                        foreach ($customer as $key3 => $type) {
                                            ...
                                            if($isTransCost) {
                                                foreach ($type as $key4 => $currPDC) {
                                                    $transTotalCre = array();
                                                    $transTotalDeb = array();
                                                    $decimalPlace = 2;
                                                    foreach ($currPDC as $key5 => $val) {
                                                        ...
                                                        if (!empty($fieldName)) {
                                                            foreach ($fieldName as $val2) {
                                                                ...
                                                                if ($val2 == 'transactionAmount') {
                                                                    ...
                                                                    if ($key3 == 2) {
                                                                        $transammnt = format_number($val[$val2] * -1, $val[$val2 . "DecimalPlaces"]);
                                                                    } else {
                                                                    ...
                                                                    if ($transammnt < 0) {
                                                                        ...
                                                                        $transTotalCre[$val2][] = $pdctotal;
                                                                        $transTotalDeb[$val2][] = (float)0;
                                                                        echo "<td class='text-right'>" . format_number(0, $val[$val2 . "DecimalPlaces"]) . "</td>";
                                                                        echo "<td class='text-right'>" . $transammnt . "</td>";
                                                                    } else {
                                                                        $transTotalDeb[$val2][] = (float)$val[$val2];
                                                                        $transTotalCre[$val2][] = (float)0;
                                                                        echo "<td class='text-right'>" . $transammnt . "</td>";
                                                                        echo "<td class='text-right'>" . format_number(0, $val[$val2 . "DecimalPlaces"]) . "</td>";
                                                                    }
                                                                } else {
                                                    ...
                                                    echo "<td colspan='5'><div style='margin-left: 30px'><b>Sub Total</b> &nbsp;</div></td>";
                                                    if (!empty($fieldName)) {
                                                        foreach ($fieldName as $val2) {
                                                            if ($val2 == "transactionAmount") {
                                                                echo "<td class='text-right reporttotal'>" . format_number(array_sum($transTotalDeb[$val2]), $decimalPlace) . "</td>";
                                                                echo "<td class='text-right reporttotal'>" . format_number(array_sum($transTotalCre[$val2]), $decimalPlace) . "</td>";
                                                            }
                                                            if ($val2 == "companyLocalAmount") {
                                                                echo "<td>&nbsp</td>";
                                                                echo "<td>&nbsp</td>";
                                            ...
                                            if ($isLocCost || $isRptCost) {
                                                if ($isTransCost) {
                                                    echo "<td colspan='7'><div style='margin-left: 30px'>&nbsp;</div></td>";
                                                } else {
                                            ...
                                            if ($isLocCost || $isRptCost) {
                                                if ($isTransCost) {
                                                    echo "<td colspan='7'><div style='margin-left: 30px'>$netbalance<!--Net Balance--></div></td>";
                                                } else {
                                    ...
                                    if ($isLocCost || $isRptCost) {
                                        if ($isTransCost) {
                                            echo "<td colspan='7'><div style='margin-left: 30px'><strong>$subtot<!--Sub Total--></strong></div></td>";
                                        } else {
                ...
                <?php if (!empty($output)) { ?>
                    <div class="fixHeader_Div">
                        <table class="borderSpace report-table-condensed" id="tbl_report">
                            ...
                            foreach ($output as $val) {
                                if ($isTransCost) {
                                    $category[$val["GLSecondaryCode"] . " - " . $val["GLDescription"]][$val["customerSystemCode"] . " - " . $val["customerName"]][$val['transactionCurrency']][] = $val;
                                } else {
                            ...
                            if (!empty($category)) {
                                foreach ($category as $key => $glcodes) {
                                    ...
                                    foreach ($glcodes as $key2 => $customer) {
                                        ...
                                        $runningBalReprt = 0;
                                        if ($isTransCost) {
                                            foreach ($customer as $key3 => $curr) {
                                                $transTotalDeb = array();
                                                $transTotalCre = array();
                                                $decimalPlace = 2;
                                                foreach ($curr as $key4 => $val) {
                                                    echo "<tr class='hoverTr'>";
                                                    if (input_format_date($val["documentDate"], $date_format) == '1970-01-01') {
                                                        echo "<td><div style='margin-left: 30px;color: #ffffff;opacity: 0'>" . $val["documentDate"] . "</div></td>";
                                                    } else {
...
//                                                        $transammnt=format_number($val[$val2], $val[$val2 . "DecimalPlaces"]);
                                                                if ($val[$val2] < 0) {
                                                                    $transTotalCre[$val2][] = (float)$val[$val2];
                                                                    $transTotalDeb[$val2][] = (float)0;
                                                                    echo "<td class='text-right'>" . format_number(0, $val[$val2 . "DecimalPlaces"]) . "</td>";
                                                ...
                                                echo "<tr>";
                                                $netbalance=$this->lang->line('accounts_payable_reports_vl_net_balance');/*Net balance language*/
                                                echo "<td colspan='5'><div style='margin-left: 30px'><b>Net Balance</b> &nbsp;</div></td>";
                                                if (!empty($fieldName)) {
                                                    foreach ($fieldName as $val2) {
                                                        if ($val2 == "transactionAmount") {
                                                            echo "<td class='text-right reporttotal'>" . format_number(array_sum($transTotalDeb[$val2]), $decimalPlace) . "</td>";
