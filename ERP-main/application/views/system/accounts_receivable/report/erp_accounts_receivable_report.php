...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function(){
            fetchPage('system/accounts_receivable/report/erp_accounts_receivable_report','<?php echo $_POST["page_id"] ?>','<?php echo $_POST["page_name"] ?>');
        });
    ...
    function generateDrilldownReport(customerID,customerName,currency,age, SubCustomers, groupbycus, documentCurrency = null) {
        var fieldNameChk = [];
        $("input[name=fieldName]:checked").each(function () {
            fieldNameChk.push({name: "fieldNameChk[]", value: $(this).val()});
        });
        ...
        finalArray.push({name:"documentCurrency",value:documentCurrency});
        $.ajax({
            async: true,
            type: 'POST',
            dataType: 'html',
