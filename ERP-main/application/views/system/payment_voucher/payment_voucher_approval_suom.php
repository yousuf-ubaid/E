...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/payment_voucher/payment_voucher_approval_suom', '', 'Payment Voucher Approval');
        });
    ...
    function payment_voucher_table() {
        Otable = $('#payment_voucher_approval_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Payment_voucher/fetch_payment_voucher_approval_suom'); ?>",
            "aaSorting": [[1, 'desc']],
            ...
            "columnDefs": [{"targets": [7,8], "orderable": false},{"targets": [0,5,7,8], "searchable": false},{"targets": [9,10,11,12], "searchable": true, "orderable": false, "visible": false}],
