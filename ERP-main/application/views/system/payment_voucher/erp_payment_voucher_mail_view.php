    ...
    <div class="tab-content">
        <div class="tab-pane active" id="tab_1">
            <div class="modal-body">
                ...
                <div class="append_data_nw">
                    <div class="row removable-div-nw" id="mr_1" style="margin-top: 10px;">
                        ...
                        <div class="col-sm-8">
                            <input type="email" name="email" id="email" class="form-control" value="<?php echo $supplierEmail?>"
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" onclick="Send_pv_Mail()">Send Email</button>
