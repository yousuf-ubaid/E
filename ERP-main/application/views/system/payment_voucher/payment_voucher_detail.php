                                ...
                                <div class="table-responsive">
                                    <div class="col-md-12" style="font-size:13px;color: #4a8cdb">
                                        <div class="col-md-12" style="text-align: right;"><strong>Utilized
                                                Amount</strong>&nbsp;
                                            <span id="total_invoice_total"><?php echo format_number($totalamountreceipt['totalamounttransaction'] ?? 0, $master['transactionCurrencyDecimalPlaces']); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <div class="col-md-12" style="font-size:13px;color: #4a8cdb">
                                        <div class="col-md-12" style="text-align: right;"><strong>Balance</strong>&nbsp;
                                            <span id="grandtotal_amount"><?php echo format_number(($master['settlementTotal'] - $totalamountreceipt['totalamounttransaction'] ?? 0), $master['transactionCurrencyDecimalPlaces']); ?></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
