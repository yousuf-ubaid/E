        ...
        <form method="post" id="Send_Email_form">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <input type="hidden" name="payVoucherAutoId" id="email_payVoucherAutoId" value="">
...
<div class="modal fade" id="modify_payments" tabindex="1" role="dialog" aria-labelledby="myModalLabel" style="z-index: 1051">
...
<div class="modal fade" id="modify_invoice_allocation" tabindex="1" role="dialog" aria-labelledby="myModalLabel" style="z-index: 1051">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
...
<script type="text/javascript">
    ...
    function payment_voucher_table(selectedID=null) {
        Otable = $('#payment_voucher_master_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Payment_voucher/fetch_payment_voucher'); ?>",
            "aaSorting": [[0, 'desc']],
    ...
    function sendemail_pv(payVoucherAutoId) {
        $('#email_payVoucherAutoId').val(payVoucherAutoId);
        $.ajax({
            async: true,
            type: 'post',
            dataType: 'html',
            ...
            url: "<?php echo site_url('Payment_voucher/load_email_pv'); ?>",
            beforeSend: function() {
                startLoad();
            },
            success: function(data) {
        ...
        swal({
            ...
            function() {
                $.ajax({
                    ...
                    dataType: 'json',
                    data: form_data,
                    url: "<?php echo site_url('Payment_voucher/send_pv_email'); ?>",
                    beforeSend: function() {
                        startLoad();
                    },
                    success: function(data) {
                        ...
                        if (data[0] == 's') {
                            ...
                            save_document_email_history(data[2], 'PV', data[3]);
                        }
                    },
                    error: function() {
                        stopLoad();
    ...
    function load_mail_history() {
        var Otables = $('#mailhistory').DataTable({
            ...
            "bDestroy": true,
            "StateSave": true,
            "sAjaxSource": "<?php echo site_url('Payment_voucher/load_mail_history'); ?>",
            aaSorting: [
                [0, 'desc']
            ],
            "bFilter": false,
            ...
            "fnServerData": function(sSource, aoData, fnCallback) {
                aoData.push({
                    "name": "payVoucherAutoId", "value": $("#email_payVoucherAutoId").val()
                });
                $.ajax({
                    'dataType': 'json',
                    'type': 'POST',
    ...
    function generate_receipt_voucher(id){

        swal({
                title: "Are You Sure?",
                text: "You Want To Genearate Receipt Voucher for this voucher",
                type: "warning",
                showCancelButton: true,
                confirmButtonColor: "#DD6B55 ",
                confirmButtonText: "Yes",
        ...
        function() {
            $.ajax({
                ...
                dataType: 'json',
                data: {'id':id},
                url: "<?php echo site_url('Payment_voucher/generate_receipt_voucher'); ?>",
                beforeSend: function() {
                    startLoad();
                },
                success: function(data) {
