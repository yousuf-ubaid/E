...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary pull-right"
                onclick="fetchPage('system/payment_voucher/erp_payment_voucher_suom',null,'Add New Payment Voucher','PV');">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/payment_voucher/payment_voucher_management_suom', '', 'Payment Voucher');
        });
        $('.select2').select2();
    ...
    function payment_voucher_table(selectedID=null) {
        Otable = $('#payment_voucher_master_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Payment_voucher/fetch_payment_voucher_suom'); ?>",
            "aaSorting": [[0, 'desc']],
            ...
            },{"visible":true,"searchable": false,"targets": [0,1,3] }],
