...
echo "str3 :$str3 <br/>";*/
?>
<div style="border: 1px solid white;width: 605px;height: 272px;position: absolute;left: 6cm;" ><!--position: absolute;left: 6cm; rotate: 90;-->
    <table style="margin-top: 26px;">
        <tr>
            ...
            <td style="vertical-align: bottom;top: 50px;left: 575px;position: absolute;">
                <table style="margin-left:10px;">
                    ...
                    <tr>
                        ...
                        <td style=" height: 30px;width:30px; font-weight: bold; font-size: 1em;  text-align: center; visibility:hidden"><?php //echo $year[0]; ?></td>
                        <td style=" height: 30px;width:30px; font-weight: bold; font-size: 1em;  text-align: center; visibility:hidden"><?php //echo $year[1]; ?></td>
    ...
    <table style="margin-top:2px;">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        if (in_array($extra['master']['pvType'],$chequetype)){
                            ...
                            ?>
                            <td style="font-size: 1em;font-weight: bold;vertical-align: top;padding-bottom: 16px;position: absolute;left: 125px;top: 115px;"><?php echo $extra['master']['partyName']; ?> </td>
                        <?php
                        }else{
                            ?>
                            <td style="font-size: 1em;font-weight: bold;vertical-align: top;padding-bottom: 16px;position: absolute;left: 125px;top: 115px;"><?php echo
        ...
        <tr>
            <td style="width:67%; vertical-align: top; padding-top: -3px;padding-right: 30px;">
                <table>
                    <tbody>
                    <tr>
                        <td style="width: 40px;"><strong class="hidden">Rupees :- </strong></td>
                        <td style="font-weight: bold;font-size: 0.9em;top: 153px;left: 70px;position: absolute;"><?php echo  $str1 ?></td>
                    </tr>
                    <tr>
            ...
            <td style="width: 33%;padding-top:6px; padding-right: 25px;">
                <table style="border: 1px solid white;">
                    <tbody>
                    <tr>
                        <td
                            style="font-weight: bold;text-align: center;height: 50px;font-size: 0.9em;top: 185px;left: 560px;position: absolute;">
    ...
    <table style="font-weight: bold;  position: absolute;left: 100px;top: 220px;">
        <tbody>
        <tr>
            <td>
    ...
    <table style="text-align: center; margin-left:200px; width:100%; margin-top: 35px;">
        <tbody>
        <tr>
            <?php
            for ($x = 0; $x < $extra['signature']['authourizedSignatureLevel']; $x++) {
                ...
                <td style="text-align:center">
                    <span>_______________________________________________</span><br><span> Director</span>
                </td>
