...
echo head_page('Employee Job History', false);
?>
<style>
    .bgc {
...
<div>
    <fieldset class="scheduler-border">
        ...
        <?php echo form_open('login/loginSubmit', ' name="frm_job_history_report" id="frm_job_history_report" class="form-group" role="form"'); ?>
        <input type="hidden" id="grouptyp" name="grouptyp">
            <div class="col-md-12">
                ...
                <div class="form-group col-sm-1">
                    ...
                    <button style="margin-top: 5px" type="button" onclick="get_emp_job_history_report()"
...
<script type="text/javascript">
    ...
    $('.headerclose').click(function () {
        fetchPage('system/operations/reports/employee_job_history_report.php', '', 'Employee Job History')
    });
    $(document).ready(function (e) {

        get_emp_job_history_report();

    });

    function get_emp_job_history_report() {
        var data = $("#frm_job_history_report").serialize();
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('Operation/get_emp_job_history_report') ?>",
            data: data,
            dataType: "html",
            cache: false,
            beforeSend: function () {
    ...
    function generateReportPdf() {
        var form = document.getElementById('frm_job_history_report');
        form.target = '_blank';
        form.action = '<?php echo site_url('Operation/get_emp_job_history_report_pdf'); ?>';
        form.submit();
    }
