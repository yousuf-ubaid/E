...
<body>
    ...
    <?php echo form_open('', 'role="form" id="checklist_log_form"'); ?>
        ...
        <input type="hidden" name="printtype" id="printtype" value="html" />
        <input type="hidden" name="companyID" id="companyID" value="<?php echo $companyID ?>" />
        <div id="checklist_view"></div>
    </form>
    </div>
...
<script type="text/javascript">
    ...
    function load_check_list(){
        ...
        var data = $("#checklist_log_form").serializeArray();
    ...
    function myAlert(type,message){
        myAlert_topPosition(type,message);
    }

    function refreshNotifications(){
        myAlert_topPosition('s','Updated Successfully');
    }
