                ...
                <div class="table-responsive" style="background:#fff;">
                    <table class="table">
                        ...
                        <tbody><tr>
                            ...
                            <td valign="middle" height="30" style="border-top: 0;"></td>
                            <td valign="middle" height="30" style="border-top: 0;">Supervisor:</td>
                            <td valign="middle" height="30" style="border-top: 0;"></td>
                        </tr>
                    </tbody></table>
                </div>
            ...
            <div class="col-12 col-md-12">  
                <div class="table-responsive" style="background:#fff;">
                    <table class="table table-bordered-0">
                        ...
                        <tr>
                            <td scope="col" valign="middle" height="30" style="padding: 0;">Operator:</td>
                            <td scope="col" valign="bottom" height="30" style="padding: 0;"></td>
                            <td scope="col" valign="middle" height="30" style="padding: 0;">Floor Hand:</td>
                            <td scope="col" valign="bottom" height="30" style="padding: 0;"></td>
                        </tr>
                        <tr>
                            <td scope="col" valign="middle" height="30" style="padding: 0;">Assistant Operator:</td>
                            <td scope="col" valign="bottom" height="30" style="padding: 0;"></td>
                            <td scope="col" valign="middle" height="30" style="padding: 0;">Floor Hand:</td>
                            <td scope="col" valign="bottom" height="30" style="padding: 0;"></td>
                        </tr>
                        <tr>
                            <td scope="col" valign="middle" height="30" style="padding: 0;">Derrick Man:</td>
                            <td scope="col" valign="bottom" height="30" style="padding: 0;"></td>
                            <td scope="col" valign="middle" height="30" style="padding: 0;">Assistant Floor Hand:</td>
                            <td scope="col" valign="bottom" height="30" style="padding: 0;"></td>
                        </tr>
                        <tr>
                            <td scope="col" valign="middle" height="30" style="padding: 0;">Floor Hand:</td>
