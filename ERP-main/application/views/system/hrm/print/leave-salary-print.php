...
<div class="row" style="margin: 10px 15px;">
    <table class="table table-bordered table-striped">
        ...
        <tr>
            <th class="theadtr"> # </th>
            <th class="theadtr" style=""> <?php echo $this->lang->line('common_employee_name');?> </th>
            <th class="theadtr" style="width: 100px"> <?php echo $this->lang->line('common_month');?> </th>
            <th class="theadtr" style="width: 105px"> <?php echo $this->lang->line('common_amount');?> </th>
        ...
        if(!empty($details)){
            foreach ($details as $row){
                ...
                echo '<tr>
                          <td style="text-align: right; width: 15px">'.$i.'</td>
                          <td >'.$row['empName'].'</td>  
