...
if (!empty($empIDs)) {
    foreach ($empIDs as $empID) {
        ...
        if (array_key_exists($empID, $details['salaryDec_A'])) {
            $bassal='';
            $brsal=0;
            foreach ($details['salaryDec_A'][$empID] as $salDecs) {
            ...
            //echo '<pre>';print_r($details['salaryDec_A'][$empID]); echo '</pre>'; die();
            if(!empty($bassal)){
                $amt=$bassal+$brsal;
                $html .= '<tr>
                            <th class="paySheetDet_TD dot_matrix_font">Basic+BR Allowance</th>
                            <th class="paySheetDet_TD dot_matrix_font" align="right">' .number_format($amt, $default_dPlace)  . '</th>
                          </tr>';
            }
        ...
        $html .= '<tr>
                    ...
                    <th align="right" class="sub_total dot_matrix_font"><div style="font-size: 12px; ">' . number_format($addTot, $default_dPlace) . '</div></th>
                  </tr>';
        ...
        $html .= '<tr>
                    ...
                    <th align="right" class="pull-right sub_total"><div style="font-size: 12px;">' . number_format($dedTot, $default_dPlace) . '</div></th>
                  </tr>';
