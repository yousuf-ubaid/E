...
<div class="table-responsive">
    <table class="<?php echo table_class(); ?>" style="width: 100%; margin-top: 2%">
        ...
        <tr>
            ...
            <th class="theadtr" style="width: 30%"><?php echo $this->lang->line('common_name'); ?></th>
            <th class="theadtr" style="width: 30%"><?php echo $this->lang->line('common_description'); ?><!--Description--></th>
        ...
        if( !empty($details) ) {
            ...
            foreach ($details as $det) {
                ...
                if ($det['transactionCurrency'] != $last_currency) {
                    echo '<tr> <th class="theadtr" colspan="6">' . $det['transactionCurrency'] . '</th></tr>';
                    $last_currency = $det['transactionCurrency'];
                }

                $description =($det['description'] == null)? $det['declarationDes']  : $det['description'];
                ...
                echo '<tr>
                    ...
                    <td class="paySheetDet_TD">' . $description . '</td>
                ...
                if (array_key_exists($m, $details)) {
                    ...
                    if ($next != $last_currency) {
                        if ($n > 1) {
                            echo '<tr><th class="" style="font-size: 10px" colspan="5">'.$this->lang->line('common_total').'</th><th class="theadtr" align="right">' . number_format($currTot, $dPlace) . '</th></tr>';
                        }
                        $n = 0;
                        $currTot = 0;
                    }
