...
$title = $this->lang->line('hrms_payroll_salary_declaration');
...
<div class="table-responsive">
    <table id="declaration_master_table" class="<?php echo table_class() ?>">
        ...
        <tr>
            ...
            <th style="min-width: 10%"><?php echo $this->lang->line('common_payroll_group');?></th>
            ...
            <form class="" id="declaration_form" autocomplete="off">
                ...
                <div class="modal-body">
                    ...
                    <div class="row" style="margin-left: 2px">
                        ...
                        <div class="form-group col-sm-2">
                            <label><?php echo $this->lang->line('common_payroll_group');?> </label>
                        </div>
                        <div class="form-group col-sm-3">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function(){
            fetchPage('system/hrm/salary_declaration_multiple_insertion_period_base','','HRMS');
        });
        ...
        $('#declaration_form').bootstrapValidator({
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: data,
                url: "<?php echo site_url('Employee/save_employee_declaration_master/period_base'); ?>",
                beforeSend: function () {
                    startLoad();
                },
    ...
    function salary_declaration_table(selectedID=null) {
        dec_tbl = $('#declaration_master_table').DataTable({
            ...
            "bDestroy": true,
            "StateSave": true,
            "sAjaxSource": "<?php echo site_url('Employee/fetch_declaration_employees_master/period_base'); ?>",
            "aaSorting": [[1, 'desc']],
    ...
    function load_details(id, template){
        let page = 'system/hrm/salery_declaration_new';
        if(template == 2){
            page = 'system/hrm/ajax/salary_declaration_multiple_insertion_ajax'
        }
        fetchPage(page, id,'HRMS', 'period_base');
    }

    function view_modal( docID ){
        documentPageView_modal('SD-C2', docID)
    }
    ...
    function print_SD(docID, docCode, template){
        ...
        window.open(url+'/'+docID+'/'+docCode, "blank");
    }
</script>
