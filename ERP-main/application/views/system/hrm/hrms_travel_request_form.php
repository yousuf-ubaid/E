    ...
    <div id="step1" class="tab-pane active">
        ...
        <div class="row">
            ...
            <div class="col-md-3 form-group">
               ...
               <!-- <select id="empName" name="empName" required onchange="getEmpDet(this)">
                    ...
                    <?php echo form_dropdown('empID', $emp, '', 'class="form-control select2" id="empID" onchange="fetch_employee_detail_travel_by_id(this)"'); ?>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 form-group">
                ...
                <!-- <span class="text-danger" id="meal-error"></span> -->
            </div>
    ...
    <input type="hidden" name="requestid" id="requestid" class="requestid">
        ...
        <table class="table table-bordered table-striped table-condesed ">
                ...
                <tr>
                    ...
                    <th id="detailtblFamName"><?php echo $this->lang->line('common_family_name'); ?></th>
                    ...
                    <table class="table table-bordered table-condensed no-color" id="requesttbl">
                        <thead>
                            <tr>
                                ...
                                <th><?php echo $this->lang->line('commom_trip_start_date'); ?> <?php required_mark(); ?></th>
                                <th><?php echo $this->lang->line('commom_trip_end_date'); ?> <?php required_mark(); ?></th>
                                <!-- <th><?php echo $this->lang->line('commom_trip_country'); ?> <?php required_mark(); ?></th> -->
                                <th><?php echo $this->lang->line('commom_from_destination'); ?> <?php required_mark(); ?></th>
                                <th><?php echo $this->lang->line('commom_to_destination'); ?> <?php required_mark(); ?></th>
                                <th><?php echo $this->lang->line('commom_currency'); ?> <?php required_mark(); ?></th>
                                <!-- <th><?php echo $this->lang->line('common_type'); ?> <?php required_mark(); ?></th> -->
                                <!-- <th><?php echo $this->lang->line('commom_travel_advance'); ?> <?php required_mark(); ?></th> -->
                                <th><?php echo $this->lang->line('commom_reason'); ?> <?php required_mark(); ?></th>
                            </tr>
                        </thead>
                        ...
                        <input type="hidden" id="editemployeeid" name="editemployeeid">
                            <tr>
                                ...
                                <!-- <td>
                                <select name="edit_country" id="edit_country" class="form-control  edit_country" required >
                                ...
                                <td>
                                    <select name="edit_cy" id="edit_cy" class="form-control  edit_cy" required >
...
<script>
    $(document).ready(function () {
        ...
        $('.headerclose').click(function () {
            fetchPage('system/hrm/travel_request.php');
        });
    ...
    function validateForm() {
        ...
        // var tripCountries = $('.trip_country').map(function() {
        //     return $(this).val();
        // }).get();
        ...
        $.ajax({
            ...
            data: {
                ...
                // trip_country: tripCountries,
                // city: cities,
                to_destination:to_destination,
                currency_code: currencyCodes,
                travel_advance: travelAdvances,
    ...
    // function cancelform() {
    //     popup.classList.remove("container-open");
    //     overlay.style.display = "none";
    //     document.getElementById('btnsavedetail').disabled = false;

    //     var form = document.getElementById("detail_tbl");
    ...
    //     var firstRowInputs = rows[0].getElementsByTagName("input");
    ...
    //     var citySelect = row.find('.edit_cy');
    ...
    //         url: "<?php echo site_url('Employee/fetch_city'); ?>",
    //         beforeSend: function () {
    //             startLoad();
    //         },
    //         success: function (data) {
    ...
    //                 var option = $('<option></option>').attr('value', city.destinationID).text(city.City);
    ...
    function updatedetail() {
        ...
        // var tripCountry = $('.edit_country').val();
        // var city = $('.edit_cy').val();
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                ...
                myAlert('e','Error occurred while saving data.');
            },
            complete: function() {
                document.getElementById('btnupdatedetail').disabled = false;
            }
    ...
    function save_draft() {
        ...
        if (requestid) {
            swal({
                ...
                function () {
                    fetchPage('system/hrm/travel_request', requestid, 'Travel Request');
                });
        }
    }
            ...
            $.ajax({
                    ...
                    success: function (data) {
                        if (!jQuery.isEmptyObject(data)) {
                            ...
                            $('#leaveID').val(data['leaveMasterID']).change();
    ...
    function get_Leave_by_emp(leaveMaster = null) {
        var empID = $('#empID').val();
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.length > 0) {
                    ...
                    if (leaveMaster) {
                        $('#leaveID').val(leaveMaster).change();
                    }
