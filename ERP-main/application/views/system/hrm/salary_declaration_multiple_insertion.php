...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function(){
            fetchPage('system/hrm/salary_declaration_multiple_insertion','','HRMS');
        });
        ...
        on('success.form.bv', function (e) {
            ...
            data.push({'name': 'declaration_template', 'value': 2});
            $.ajax({
                async: true,
                type: 'post',
                dataType: 'json',
    ...
    function salary_declaration_table(selectedID=null) {
        dec_tbl = $('#declaration_master_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Employee/fetch_declaration_employees_master'); ?>",
            "aaSorting": [[2, 'desc']],
            ...
            "fnDrawCallback": function (oSettings) {
                ...
                for (var i = tmp_i; (iLen + tmp_i) > i; i++) {
                    ...
                    if (parseInt(oSettings.aoData[x]._aData['salarydeclarationMasterID']) == selectedRowID) {
    ...
    function load_details(id){
        fetchPage('system/hrm/ajax/salary_declaration_multiple_insertion_ajax',id,'HRMS');
    }
    ...
    function print_SD(docID, docCode){
        window.open("<?php echo site_url('Employee/load_salary_approval_confirmation_view'); ?>/"+docID+'/'+docCode, "blank");
    }
</script>
