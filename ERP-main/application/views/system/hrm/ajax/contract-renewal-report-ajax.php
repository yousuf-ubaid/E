        ...
        <div style="height: 400px">
            <table id="report-tb" class="<?php echo table_class() ?>">
                ...
                <tr>
                    ...
                    <th class="<?=$th_class?>" ><?php echo $this->lang->line('common_contract_type');?></th>
                    <th class="<?=$th_class?>" ><?php echo $this->lang->line('emp_contract_ref_no');?></th>
                    <th class="<?=$th_class?>" ><?php echo $this->lang->line('emp_contract_start_date');?></th>
                    <th class="<?=$th_class?>" ><?php echo $this->lang->line('emp_contract_end_date');?></th>
                </tr>
                </thead>
                ...
                if(!empty($detail)) {
                    ...
                    echo '<tr>
                          <td colspan="9" style="text-align: center">'.$this->lang->line('common_no_records_found').'</td>
                      </tr>';
                }
                ?>
                </tbody>
