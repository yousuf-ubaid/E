                        ...
                        <fieldset style="margin-top: -10px;">
                            ...
                            <div class="container">
                                <div class="row row-centered">
                                    <div class="col-sm-offset-3 col-sm-2 col-xs-5">
                                        <label><?php echo $this->lang->line('common_month');?></label>
                                        <div class="input-group" style="">
                                            <span class="input-group-addon" style="padding: 0px">
                                                <input type="number" name="payYear" class="input-group-addon form-control payDate"
                                                       id="payYear" value="<?php echo date('Y'); ?>"/>
                                            </span>
                                            <?php echo form_dropdown('payMonth', $payrollCalender_arr, '', 'class="form-control payDate" id="payMonth" required'); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-2 col-xs-6 col-centered">
                                        <label>
                                            <abbr title="<?php echo $this->lang->line('common_leave_days');?>"> <?php echo $this->lang->line('hrms_leave_management_leave_days');?> </abbr>
                                        </label>
                                        <input name="no_of_leave_days" class="form-control number" id="no_of_working_days"
                                    ...
                                    <div class="form-group col-sm-1 col-xs-1">
                                        <label>&nbsp;</label>
                                        <button class="btn btn-primary btn-sm pull-right" style="font-size:12px; position: absolute; margin-top: 22px;" onclick="addAllRows()" type="button">
...
<script type="text/javascript">
    ...
    function addAllRows(){
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: postData,
            url: "<?php echo site_url('Employee/add_leave_salary_employees'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
