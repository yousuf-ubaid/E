        ...
        <div class="col-md-12">
            ...
            <table class="<?php echo table_class() ?> drill-table" >
                ...
                <tr>
                    ...
                    <th style="width: 90px"> Increment % </th>
...
<script type="text/javascript">
            ...
            function () {
                ...
                if(detList !== ''){
                    $.ajax({
                        ...
                        data: {'masterID':SD_masterID, 'detList':detList, 'percent': per},
                        dataType: "json",
                        cache: false,
                        beforeSend: function () {
                            startLoad();
    ...
    function inline_update_ajax(empID, detID, incrementAmount, percentage){
        $.ajax({
            ...
            data: {'empID':empID, 'masterID':SD_masterID, 'detID':detID, 'incrementAmount':incrementAmount, 'percentage':percentage},
            dataType: "json",
            cache: false,
            beforeSend: function () {
            },
    ...
    function dateChange(empID, detID, ty, obj){
        ...
        $.ajax({
            ...
            data: {'masterID':SD_masterID, 'detID':detID, 'dateOf':ty, 'selectedDate': selectedDate},
            dataType: "json",
            cache: false,
            beforeSend: function () {
            },
