...
$salaryCategories_drop = salaryCategories_drop($masterID);
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('.headerclose').click(function () {
            ...
            switch (policy_id) {
                case 'standard':
                    page = 'system/hrm/salery_declaration';
                    break;
                case 'period_base':
    ...
    function confirm_salaryDeclaration(salaryControlCheckPass=0){
        $.ajax({
            ...
            data: {'masterID': SD_masterID, 'salaryControlCheckPass': salaryControlCheckPass},
            dataType: "json",
            cache: false,
            beforeSend: function () {
                startLoad();
        ...
        swal({
            ...
            function () {
                $.ajax({
                    ...
                    type: 'post',
                    dataType: 'json',
                    data: {'detailID': detailID, 'masterID': SD_masterID},
        ...
        swal({
            ...
            function () {
                $.ajax({
                    ...
                    type: 'post',
                    dataType: 'json',
                    data: {'empID': empID, 'masterID': SD_masterID},
