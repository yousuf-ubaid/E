...
$floors_arr = floors_drop(1, 1);
$department_arr = fetch_emp_departments(true, 1);
?>
...
<div class="row">
    <div class="col-sm-3">
        ...
        <input type="hidden" name="attendanceDateToView" id="attendanceDateToView" value="<?php echo $attendanceDate ?>" />
        <input type="hidden" name="floorIDToView" id="floorIDToView" value="<?php echo $floorID ?>" />
    ...
    <div class="col-sm-9">
        <div class="pull-right">
            <form method="post" target="_blank" action="<?php echo site_url('Employee/attendance_export_excel'); ?>">
                ...
                <button type="button"
                    class="btn btn-default btn-sm pull-right" onclick="get_variable_approve()">
                    <i class="fa fa-file-excel-o"></i> &nbsp Variable Payments
                </button>
            </form>
        </div>
    </div>

    <div class="col-sm-6" style="padding-top: 10px;margin-left:130px;">
    ...
    <table id="attendanceReview" class="table">
        <thead>
            <tr style="white-space: nowrap">
                ...
                <th style="z-index: 10;"><?php echo 'Project'; ?><!--Emp Name--></th>
                <th style="z-index: 10;"><?php echo 'Job'; ?><!--Emp Name--></th>
                <th style="z-index: 10;"> <?php echo $this->lang->line('common_date'); ?><!--Date--></th>
                <th style="z-index: 10;">Location in </th>
                <th style="z-index: 10;">Location out </th>
                <th style="z-index: 10;"><?php echo $this->lang->line('hrms_payroll_on_duty_time'); ?><!--On Duty Time--></th>
                <th style="z-index: 10;">Grace period</th>
                <th style="z-index: 10;"><?php echo $this->lang->line('hrms_payroll_off_duty_time'); ?><!--Off Duty Time--></th>
                ...
                <th style="z-index: 10;"><?php echo $this->lang->line('hrms_attendance_late'); ?><!--Late--></th>

                <th style="z-index: 10;"><?php echo $this->lang->line('hrms_attendance_early'); ?><!--Early--></th>

                <th style="z-index: 10;"><?php echo $this->lang->line('hrms_payroll_over_time'); ?><!--OT Time--></th>
                <th style="z-index: 10;"><?php echo $this->lang->line('hrms_attendance_work_time'); ?><!--Work Time--></th>
                <th style="z-index: 10;"><?php echo $this->lang->line('hrms_attendance_att_time'); ?><!--ATT_Time--></th>
                <th style="z-index: 10;"><?php echo $this->lang->line('hrms_payroll_normal_day'); ?><!--NDay--></th>
                <th style="z-index: 10;"><?php echo $this->lang->line('hrms_payroll_weekend'); ?><!--Weekend--></th>
                <th style="z-index: 10;"><?php echo $this->lang->line('hrms_payroll_holiday'); ?><!--Holiday--></th>
                <th style="z-index: 10;"><?php echo $this->lang->line('hrms_payroll_ndays_ot'); ?><!--NDays OT--></th>
                <th style="z-index: 10;"><?php echo $this->lang->line('hrms_payroll_weekend_ot'); ?><!--Weekend OT--></th>
                <th style="z-index: 10;"><?php echo $this->lang->line('hrms_payroll_holiday_ot'); ?><!--Holiday OT--></th>
                <th style="z-index: 10;"><?php echo $this->lang->line('hrms_payroll_ot_amount'); ?><!--OT Amount--></th>
                <th style="z-index: 10;"><?php echo $this->lang->line('hrms_payroll_no_pay_amount'); ?><!--No Pay Amount--></th>
                <th style="z-index: 10;"><?php echo $this->lang->line('hrms_payroll_no_pay_non_payroll_amount'); ?><!--No Pay non Payroll Amount--></th>
        ...
        <tbody>
            ...
            ?>
                    <tr data-code="<?php echo $attrib ?>" style="white-space: nowrap;<?php echo $bg; ?>"
                        ...
                        <td class="fixed-td"><?php echo $row['contractCode']; ?></td>

                        <?php
                        $job_ref = ($row['job_code']) ? $row['job_code'] . '|' . $row['job_name'] : '';
                        $flowserveLanguagePolicy = getPolicyValues('LNG', 'All');
                        ?>
                        <td class="fixed-td">
                            <input type="hidden" name="job_ref[]" value="<?php echo $job_ref; ?>" />

                            <?php if ($flowserveLanguagePolicy == 'FlowServe') { ?>
                                <?php
                                $job_select = '<a class="btn btn-primary btn-outline" onclick="change_job_select(\'' . $row['attendanceDate'] . '\', ' . $row['empID'] . ')"><i class="fa fa-sort-alpha-asc" aria-hidden="true"></i></a>';
                                echo $job_select; ?>
                        </td>
                    <?php } else { ?>
                        <?php echo $job_ref; ?></td>
                    ...
                    ?>
                    <td align="right"><?php makeTimeTextBox('lateHours', $lateHoursarr, $booldisabled)/*echo $lateHours*/; ?></td>
                    <td align="right"><?php makeTimeTextBox('earlyHours', $earlyHoursarr, $booldisabled)/*echo $lateHours*/; ?></td>
                    <td align="right"><?php makeTimeTextBox('OTHours', $OTHoursarr, true)/*echo $lateHours*/; ?></td>
                    ...
                    <td align="center">
                        <input <?php echo $disabled ?> onchange="updateOthers(this)" type="text" name="normalDay"
                            class="normalDay trInputs number inputdisabled" style="width:60px" value="<?php echo $row['normalDay'] ?>">
                    </td>
                    <td align="center">
                        <input <?php echo $disabled ?> onchange="updateOthers(this)" type="text" name="weekend"
                            class="weekend trInputs number inputdisabled" style="width:60px" value="<?php echo $row['weekend'] ?>">
                    </td>
                    <td align="center">
                        <input <?php echo $disabled ?> onchange="updateOthers(this)" type="text" name="holiday"
                            class="holiday trInputs number inputdisabled" style="width:60px" value="<?php echo $row['holiday'] ?>">
                    </td>

                    <!--    <td align="center"><input type="text" name="nDaysOT[]" class="trInputs number" value=""></td>-->

                    <?php $ot_disable = ($booldisabled) ? $booldisabled : (($row['NDaysOT'] == 0) ? true : false); ?>
                    <td align="center"><?php makeTimeTextBox('NDaysOT', $NDaysOTsarr, $ot_disable); ?></td>

                    <?php $ot_disable = ($booldisabled) ? $booldisabled : (($row['weekendOTHours'] == 0) ? true : false); ?>
                    <td align="center"><?php makeTimeTextBox('weekendOTHours', $weekendOTHoursarr, $ot_disable); ?></td><!-- $weekendOTHours -->

                    <?php $ot_disable = ($booldisabled) ? $booldisabled : (($row['holidayOTHours'] == 0) ? true : false); ?>
                    <td align="center"><?php makeTimeTextBox('holidayOTHours', $holidayOTHoursarr, $ot_disable); ?></td>
                    <td align="right"><span class="paymentOT"><?php echo $row['paymentOT'] ?></span></td>
                    <td align="right"><span class="noPayAmount"><?php echo $row['noPayAmount'] ?></span></td>
                    <td align="right"><span
                            class="noPaynonPayrollAmount"><?php echo $row['noPaynonPayrollAmount'] ?></span></td>
                    <?php if ($hideedit) { ?>
            ...
            <input type="hidden" name="select_arr" id="select_arr" value="<?php echo isset($base_id_arr) ?  implode(',', $base_id_arr) : '' ?>" />
        </tbody>
    </table>
</div>
<div class="well emp_title_container" style="padding: 10px 10px;font-weight: bold; margin-bottom: 0px; display: none;">
...
<div class="modal fade" id="modal_variable_attandance" role="dialog" aria-labelledby="myModalLabel" data-backdrop="static"
    data-keyboard="false">
    <div class="modal-dialog modal-lg" style="" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" onclick="close_variable_modal()" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="">Variable Payments</h4>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="col-md-4">
                        <label for="inputCodforn" class="col-md-2 control-label"><?php echo $this->lang->line('common_department'); ?> </label>
                        <?php echo form_dropdown('filterDepartment', $department_arr, '', ' onchange="get_variable_approve();" class="col-md-12 form-control select2" id="filterDepartment" '); ?>
                    </div>
                    <div class="col-md-4">
                        <label for="inputCodforn" class="col-md-2 control-label"><?php echo $this->lang->line('common_segment'); ?> </label>
                        <?php echo form_dropdown('filterSegment', $segment_arr, '', ' onchange="get_variable_approve();" class="col-md-12 form-control select2" id="filterSegment" '); ?>
                    </div>
                    <div class="col-md-4">
                        <label for="filterLocation" class="col-md-2 control-label"><?php echo $this->lang->line('common_location'); ?> </label>
                        <?php echo form_dropdown('filterLocation', $floors_arr, '', ' onchange="get_variable_approve();" class="col-md-12 form-control select2" id="filterLocation" '); ?>
                    </div>
                </div>
            </div>

            <div class="modal-body" id="attandance_va_view">



            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default btn-sm" onclick="close_variable_modal()">Close</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function close_variable_modal() {
        $('#modal_variable_attandance').modal('toggle');
    }
    ...
    function get_variable_approve() {

        var select_arr = $('#select_arr').val();
        var filterDepartment = $('#filterDepartment :selected').val();
        var filterSegment = $('#filterSegment :selected').val();
        var location = $('#filterLocation :selected').val();
    ...
    function filterAttendanceEditTable() {
        ...
        $.ajax({
            ...
            dataType: 'html',
            data: {
                attendanceDate: $('#attendanceDateToView').val(),
                floorID: $('#floorIDToView').val(),
                emp_arr: $('#emp_arr').val(),
                col: 'attDate',
    ...
    function change_job_select(date, empID) {
