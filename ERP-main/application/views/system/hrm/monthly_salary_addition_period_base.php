    ...
    <div class="table-responsive">
        <table id="additionMaster_table" class="<?php echo table_class(); ?>">
            <thead>
                <tr>
                    <th style="width: 5%">#</th>
                    <th style="width: 8%"><?php echo $this->lang->line('common_code');?><!--Code--></th>
                    <th style="width: 15%"><?php echo $this->lang->line('common_type');?></th>
                    <th style="width: 15%"><?php echo $this->lang->line('common_payroll_group');?></th>
                    <th style="width: 25%"><?php echo $this->lang->line('common_description');?><!--Description--></th>
...
<script type="text/javascript">
    ...
    $( document ).ready(function() {
        $('.headerclose').click(function(){
            fetchPage('system/hrm/monthly_salary_addition_period_base', '','HRMS');
        });
        ...
        .on('success.form.bv', function (e) {
            ...
            data.push({'name': 'doc_type', 'value': 'MA'});
    ...
    function open_additionModel() {
        ...
        $(".modal-title").text('New Monthly Addition');
