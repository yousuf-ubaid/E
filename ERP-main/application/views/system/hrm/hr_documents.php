...
echo head_page($this->lang->line('common_hr_documents') ,false);
...
<div class="row">
    <div class="col-md-7 pull-right">
        <button type="button" class="btn btn-primary btn-sm pull-right" onclick="openDocument_modal()" >
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('hrms_others_master_add_hr_documents');?><!--Add HR Documents--></h4>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('.headerclose').click(function(){
            fetchPage('system/hrm/hr_documents','Test','HRMS');
        });
        ...
        $('#add-documents-form').bootstrapValidator({
            ...
            $.ajax({
                ...
                dataType: 'JSON',
                data: formData,
                url: '<?php echo site_url('Employee/hr_document_save'); ?>',
                contentType: false,
                cache: false,
                processData: false,
                beforeSend: function () {
    ...
    function removeDocument(id, description){
        swal({
            ...
            function () {
                $.ajax({
                    async : true,
                    url :"<?php echo site_url('Employee/delete_hrDocument'); ?>",
                    type : 'post',
                    dataType : 'json',
                    data : {'hidden-id':id},
                    beforeSend: function () {
    ...
    function updateDocument(){
        ...
        $.ajax({
            type: 'post',
            url: '<?php echo site_url('Employee/edit_hrDocument'); ?>',
            data: postData,
            dataType: 'json',
            beforeSend: function () {
                startLoad();
