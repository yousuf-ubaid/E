...
<div class="tab-content">
    <div id="step1" class="tab-pane active">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-4">
                <label for="actionDate"><?php echo $this->lang->line('common_date'); ?><?php required_mark(); ?></label>
    ...
    <div id="step3" class="tab-pane">
        ...
        <div class="row">
                <hr>
                <h4 class="modal-title" id="purchaseOrder_attachment_label">Personal Action Attachments</h4>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $('.headerclose').click(function () {
            fetchPage('system/hrm/personal_application', actionMasterAutoID, 'Purchase Order');
        });
        ...
        $('#persional_action_header_form').bootstrapValidator({
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: data,
                url: "<?php echo site_url('Employee/save_personal_action_header'); ?>",
                beforeSend: function () {
                    startLoad();
                },
    ...
    function fetch_persional_view(){
        if (actionMasterAutoID) {
            $.ajax({
                    ...
                    url: "<?php echo site_url('Employee/fetch_personal_action_type_view'); ?>",
                    beforeSend: function () {
                        startLoad();
                    },
                    success: function (data) {
    ...
    function fetch_personal_action_head() {
        if (actionMasterAutoID) {
            $.ajax({
                    ...
                    dataType: 'json',
                    data: {'id': actionMasterAutoID},
                    url: "<?php echo site_url('Employee/fetch_personal_Action_header'); ?>",
                    beforeSend: function () {
                        startLoad();
                    },
                    success: function (data) {
            ...
            swal({
                ...
                function () {
                    $.ajax({
                        ...
                        dataType: 'json',
                        data: {'id': actionMasterAutoID},
                        url: "<?php echo site_url('Employee/personal_action_confirmation'); ?>",
                        beforeSend: function () {
                            startLoad();
                        },
                        success: function (data) {
                            ...
                            if (data[0] == 's') {
                                fetchPage('system/hrm/personal_application', actionMasterAutoID, 'Personal Action');
                            }
                        }, error: function () {
