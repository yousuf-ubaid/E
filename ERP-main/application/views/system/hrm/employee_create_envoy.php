...
<div class="tab-content">
    <div id="step1" class="tab-pane active">
        ...
        <div class="row">
            <div class="form-group col-sm-3">
                <label for="empDob">Confirmed date</label>
        ...
        <div class="text-right m-t-xs">
            ...
            <button class="btn btn-default-new size-lg" type="button" data-type="disabled" style="display: none;" id="editBtn">
                <?php echo $this->lang->line('emp_edit'); ?>
            </button> <!--Edit -->
            <button class="btn btn-primary-new size-lg submitBtn" id="saveBtn" type="submit">Save</button>
            <button class="btn btn-primary-new size-lg submitBtn updateBtn" id="updateBtn" type="submit" style="display:none">
                <?php echo $this->lang->line('emp_update'); ?>
            </button>
            <button type="button"  class="btn btn-primary-new size-lg" id="reJoinBtn" style="display: none;" data-toggle="modal" data-target="#rejoin-modal">
                Rejoin
            </button>
            <button class="btn btn-success-new size-lg submitBtn updateBtn" id="confirmBtn" type="button" style="display:none" onclick="confirm_employee()" data-value="1">
    ...
    <div id="step2" class="tab-pane">
        ...
        <div class="row" style="margin-top: 10px">
            <div class="col-md-12">
                <button class="btn btn-xs btn-primary pull-right" id="save_itm_btn" type="button"
                        onclick="copy_permanent_details();">Copy Detail
                </button>
            </div>
        </div>
        ...
        <div class="row" style="margin-bottom: 2%">
            <div class="col-md-12">
                <div class="text-right m-t-xs">
                    <button class="btn btn-default-new size-lg" id="contact-update"
        ...
        <div class="row">
            <fieldset class="scheduler-border">
                ...
                <div class="col-sm-12" style="margin-bottom: 10px">
                    <button class="btn btn-primary-new size-sm pull-right" onclick="add_emergencyContact()">
                    <i class="fa fa-plus text-white"></i> <?php echo $this->lang->line('common_add_emergency_contact'); ?>
                    </button>
                </div>
    ...
    <div id="discharged_tab" class="tab-pane">
        ...
        <div class="row" style="">
            <div class="col-md-11">
                <div class="text-right m-t-xs">
                    <button class="btn btn-primary-new size-lg" id="dischargeUpdate" onclick="dischargedUpdate()"
    ...
    function employee_details(empID) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#confirmDate').val(data['empConfirmDate']);
    ...
    function fetch_family_attachment_details(empfamilydetailsID, selectedID=null) {
        Otable = $('#family_attachment_table').DataTable({
            ...
            "fnDrawCallback": function (oSettings) {
                $("[rel=tooltip]").tooltip();
                var selectedRowID = (selectedID == null) ? parseInt('<?php echo $empID; ?>') : parseInt(selectedID);
