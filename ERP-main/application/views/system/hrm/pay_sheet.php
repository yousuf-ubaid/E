...
$segment_arr = fetch_segment(false, false);
$currency_arr = all_currency_new_drop(false); //all_currency_drop(false, 'ID');>
$supplier_arr = visa_supplier_drop();
$visaType_arr = visa_supplier_type_drop(true);
        ...
        <?php echo form_open('', ' id="paySheetForm" role="form" autocomplete="off"'); ?>
            <div class="row" style="/*margin: 2%; margin-bottom: 1%*/ margin-top: 1%;">
                <div class="col-sm-12" style="padding:0px">
                    <div class="col-sm-2" id="date-container" style="padding-right:0px">
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            ...
                            &nbsp;
                            <button type="button" class="btn btn-primary btn-sm hideBtn pull-right-btn" id="printBtn" onclick="print_btn_csv()"
                                    style=""> <?php echo $this->lang->line('common_print');?><!--Print-->
                            </button>
                            &nbsp;
                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-4 col-xs-4 select-container">
                                <label for="segment"> <?php echo 'Visa Type'//$this->lang->line('common_segment');?><!--Segment--> </label>
                                <?php echo form_dropdown('visapartytype[]', $visaType_arr, '', 'class="form-control" id="visaPartyType" onchange="visa_party_type_change($(this))"  multiple="multiple"'); ?>
                            </div>
                            <div class="form-group col-sm-6 col-xs-6 select-container hide" id="visaPartyID_Sec">
                                <label for="segment"> <?php echo 'Visa Sponsor Company'//$this->lang->line('');?><!--Segment--> </label>
                                <?php echo form_dropdown('visapartyid[]', $supplier_arr, '', 'class="form-control" id="visaPartyID"  multiple="multiple"'); ?>
                            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <h3 style="margin-top: -10px; font-size: 16px; font-weight: bold;" id="pending-commission-title">
                    <?php echo 'Pending Commissions';?><!--Pending Claims-->
                </h3>
                <table class="<?php echo table_class();?>" id="commissionData">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th><?php echo $this->lang->line('common_code');?><!--Code--></th>
                            ...
                            <th><?php echo $this->lang->line('common_amount');?><!--Amount--></th>
                            <th>
                                <input type="checkbox" onclick="changeExpStatus(this, '.commissionCls')" id="allCheckBox2"/>
                            </th>
                        </tr>
                    </thead>
...
<script type="text/javascript">
    ...
    $('.headerclose').click(function () {
        fetchPage('system/hrm/all_pay_sheets', autoID, 'HRMS');
    });
    ...
    function print_btn_csv() {
        ...
        if (templateId != '' && payrollID != '') {
            ...
            form.target='_blank';
            form.method='post';
            form.action='<?php echo site_url('Template_paysheet/paySheetPrint_segmentWise_csv/'); ?>'+payrollID + "/" + templateId + "/N/" + payrollHeaderDet;
            form.submit();
        }
    ...
    function create_payroll(withExpenseClaim=null) {
        ...
        if(withExpenseClaim == 'withExpenseClaim'){
            ...
            var selectedCommission = [];
            $('.commissionCls:checked').each(function(){
                selectedCommission.push( $(this).val() );
            });
            postData.push({'name':'selectedCommission', 'value':selectedCommission});
                ...
                if (data[0] == 's') {
                    ...
                    if('2' in data){
                        if( data[2].trim() == 'isNeed_model_error'){
                            ...
                            $('#allCheckBox, #allCheckBox1, #allCheckBox1').prop('checked', false);
                            ...
                            $('#commissionData > tbody').empty();
                            if( data['commission'] != ''){
                                $('#pending-commission-title').show();
                                $('#commissionData').append(data['commission']).show();
                            }else{
                                $('#commissionData, #pending-claims-title').hide();
                            }
                    ...
                    $('#progress-bar-message').text('Something went wrong..!');
                    close_progress_bar();
                }
            ...
            xhr: function() {
                ...
                xhr.addEventListener("progress", function(event) {
                    ...
                    if(percentComplete != '0%'){
                        ...
                        $('#progress-amount').html(percentComplete);
                    }
    ...
    function visa_party_type_change(ev){

        var visa_party_type_val = ev.val();
        if(visa_party_type_val){
            if(visa_party_type_val.indexOf('2') != -1){
    ...
    function load_employeeForModal2(){
    ...
    function load_employeeForModal(){
        $('#emp_modalTB').DataTable({
            ...
            "sAjaxSource": "<?php echo site_url('Template_paysheet/getEmployeesDataTable'); ?>",
            "aaSorting": [[1, 'asc']],
            "aLengthMenu": [[10, 25, 50, 100,200, 5000], [10, 25, 50, 100,200, "All"]],
            "iTotalRecords": 10000,
            "aoColumnDefs": [{"bSortable": false, "aTargets": [0,4,5,6]}],
            "fnInitComplete": function () {
            ...
            "fnServerData": function (sSource, aoData, fnCallback) {
                ...
                aoData.push({'name':'payYear', 'value':$('#payYear').val()});
                aoData.push({'name':'payMonth', 'value':$('#payMonth').val()});
                aoData.push({'name':'visaPartyType', 'value':$('#visaPartyType').val()});
                aoData.push({'name':'visaPartyID', 'value':$('#visaPartyID').val()});
                aoData.push({'name':'isNonPayroll', 'value':'N'});
