...
$title = $this->lang->line('hrms_leave_management_leave_adjustment');
...
<div class="row">
    ...
    <div class="col-md-12 text-right">
        <button type="button" class="btn btn-primary pull-right" onclick="fetchPage('system/hrm/new_leave_adjustment','','Add Leave Adjustment','Leave Adjustment');"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('hrms_leave_management_create_new');?><!--Create New--> </button>
    </div>
</div><hr>
<div class="table-responsive">
    <table id="leave_Group_table" class="<?php echo table_class(); ?>">
        ...
        <!--    <th style="min-width: 15%">Period</th>-->
            <th style="min-width: 8%"><?php echo $this->lang->line('common_month');?><!--Month--></th>
...
<script type="text/javascript">
    ...
    function leave_Group_table(){
        var Otable = $('#leave_Group_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Employee/leaveAdjustmentMaster'); ?>",
            "aaSorting": [[1, 'desc']],
        ...
        swal({
            ...
            function () {
                $.ajax({
                    ...
                    dataType : 'json',
                    data : {'masterID':id},
                    url :"<?php echo site_url('Employee/delete_leaveAdjustment'); ?>",
                    beforeSend: function () {
                        startLoad();
                    },
