...
$saveUrl = site_url('Employee/save_leaveAccrual');
$updateUrl = site_url('Employee/update_leave_annualAccrual');
?>
<div id="filter-panel" class="collapse filter-panel"></div>
<div class="m-b-md" id="wizardControl">
    <a class="btn btn-primary" href="#step1" data-toggle="tab"><?php echo $this->lang->line('common_step');?><!--Ste--> 1 -<?php echo $this->lang->line('hrms_leave_management_leave_accrual_header');?><!-- Leave Accrual Heade--></a>
    <a class="btn btn-default btn-wizard" href="#step2" onclick="loanSettlementTable()" data-toggle="tab"><?php echo $this->lang->line('common_step');?> 2
        -<?php echo $this->lang->line('hrms_leave_management_leave_accrual_detail');?><!-- Leave Accrual Detai--></a>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group col-sm-4">
                    <label for=""><?php echo $this->lang->line('common_description');?><!--Descriptio--></label>
                    <input type="text" class="form-control " id="description" name="description">
                </div>

                <div class="form-group col-sm-4">
                    <label for="period"><?php echo $this->lang->line('common_month');?><!--Month--> <?php required_mark(); ?></label>
                ...
                <div class="form-group col-sm-4">
                    <label for="JVType"><?php echo $this->lang->line('hrms_leave_management_leave_group');?><!-- Leave Grou--> <?php required_mark(); ?></label>
...
-->
        ...
        <div class="text-right m-t-xs">
            <button class="btn btn-primary btnhide" type="submit"><?php echo $this->lang->line('common_generate');?><!--Save & Nex--></button>
        ...
        <div class="modal-dialog" style="width: 50%">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    ...
                    <h5 class="modal-title"><?php echo $this->lang->line('hrms_leave_management_group_detail');?><!--Group Detai--></h5>
                </div>
                <form role="form" id="jv_detail_form" class="form-horizontal">
                    <input type="hidden" id="xJVDetailAutoID" name="JVDetailAutoID">
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="col-sm-4 control-label"><?php echo $this->lang->line('hrms_leave_management_leave_type');?><!--Leave Typ--> <?php required_mark(); ?></label>
                            <div class="col-sm-6">
                                <?php echo form_dropdown('leaveTypeID', leavemaster_dropdown(), '', 'class="form-control select2" id="leaveTypeID" required'); ?>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-4 control-label"><?php echo $this->lang->line('hrms_leave_management_no_of_day');?><!--No of Day--> <?php echo $this->lang->line('common_monthly');?><!--(Monthl-->y)</label>
                            <div class="col-sm-6">
                    ...
                    <div class="modal-footer">
                        <button data-dismiss="modal" class="btn btn-default" type="button"><?php echo $this->lang->line('common_Close');?><!--Clos--></button>
                        <button class="btn btn-primary" type="submit" id="save_btn"><?php echo $this->lang->line('common_save_change');?><!--Save change--></button>
                    </div>
                </form>
            </div>
        </div>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (!jQuery.isEmptyObject(data)) {
                            ...
                            $("#period").val(data['month']+'-'+data['year']);
                            $('.btnhide').hide();
                            $("#description").attr('disabled',true);
                            $("#leaveGroupID").attr('disabled',true);
                            $("#period").attr('disabled',true);
