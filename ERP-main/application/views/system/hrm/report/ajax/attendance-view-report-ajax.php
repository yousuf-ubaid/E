        ...
        if (!empty($att_rec)) {
            foreach ($att_rec as $key => $row) {
                ...
                <tr data-detail="<?php echo $attrib ?>" style="white-space: nowrap;<?php echo $bg?>" data-id="<?php echo $i; ?>" data-masterid="<?php echo $row['ID'] ?>"
                    ...
                    <?php
                        $lateHoursarr = array(
                            'h' => gmdate("H", (int)$row['lateHours'] * 60), 
                            'm' => gmdate("i", (int)$row['lateHours'] * 60)
                        );
                        $earlyHoursarr = array(
                            'h' => gmdate("H", (int)$row['earlyHours'] * 60), 
                            'm' => gmdate("i", (int)$row['earlyHours'] * 60)
                        );
                        $OTHoursarr = array(
                            'h' => gmdate("H", (int)$row['OTHours'] * 60),
                            'm' => gmdate("i", (int)$row['OTHours'] * 60)
                        );
                        $weekendOTHoursarr = array(
                            'h' => gmdate("H", (int)$row['weekendOTHours'] * 60),
                            'm' => gmdate("i", (int)$row['weekendOTHours'] * 60)
                        );
                        $holidayOTHoursarr = array(
                            'h' => gmdate("H", (int)$row['holidayOTHours'] * 60),
                            'm' => gmdate("i", (int)$row['holidayOTHours'] * 60)
                        );
                        $NDaysOTsarr = array(
                            'h' => gmdate("H", (int)$row['NDaysOT'] * 60),
                            'm' => gmdate("i", (int)$row['NDaysOT'] * 60)
                        );
                    ?>
                    <td align="right"><?php echo gmdate("H:i", (int)$row['lateHours'] * 60); ?></td>
                    <td align="right"><?php echo gmdate("H:i", (int)$row['earlyHours'] * 60); ?></td>
                    <td align="right"><?php echo gmdate("H:i", (int)$row['OTHours'] * 60); ?></td>
                    ...
                    <td align="center"><?php echo gmdate("H:i", (int)$row['NDaysOT'] * 60); ?></td>
                    <td align="center"><?php echo gmdate("H:i", (int)$row['weekendOTHours'] * 60); ?></td>
                    <td align="center"><?php echo gmdate("H:i", (int)$row['holidayOTHours'] * 60); ?></td>
                </tr>
                <?php
            }
        } ?>
