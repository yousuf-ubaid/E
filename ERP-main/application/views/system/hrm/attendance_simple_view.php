                    ...
                    <div id="" class="box box-default " style="background-color: #f5f5f5;border: 1px solid #e3e3e3;">
                        ...
                        <div class="box-body " style="background: #ffffff;">
                            <div class="col-sm-12" style="padding:0px">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <label for="upload_fromDate"><?php echo $this->lang->line('common_from'); ?>
                                            &nbsp;
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="checkbox" value="" id="isManualAttendance" name="isManualAttendance" onclick="hide_upload_excel()">
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    function loadDataFromTemptable() {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: postData,
            url: '<?php echo site_url('Employee/load_empAttDataViewSimple'); ?>',
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
