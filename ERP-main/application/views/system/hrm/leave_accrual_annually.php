...
$title = $this->lang->line('hrms_leave_management_annual_leave_accrual');
...
<div class="row">
    ...
    <div class="col-md-12 text-right">
        <button type="button" class="btn btn-primary pull-right" onclick="fetchPage('system/hrm/new_leave_annually_accrual','','Add Annual Leave Accrual','Leave Annual Accrual');"><i class="fa fa-plus"></i> <?php echo $this->lang->line('hrms_leave_management_create_new');?><!--Create New--> </button>
    </div>
</div><hr>
...
<script type="text/javascript">
    ...
    function leave_Group_table(){
        var Otable = $('#leave_Group_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Employee/leaveannualaccrualMaster'); ?>",
            "aaSorting": [[1, 'desc']],
