...
$masterData = $this->db->query("SELECT * FROM srp_erp_salarydeclarationmaster WHERE salarydeclarationMasterID={$masterID}")->row_array();
        ...
        <tr>
            ...
            <td style="width:60%;" valign="top">
                <table border="0px">
                    ...
                    <tr>
                    <td><h4 style="margin-bottom: 0px"><?php echo $this->lang->line('hrms_loan_salary_declaration')?> </td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <div class="col-md-12">
        <div style="overflow: auto">
            <table class="<?php echo table_class() ?> drill-table" >
                ...
                <th style="width: 90px"> <!--Increment--><?php echo $this->lang->line('hrms_loan_increment')?> % </th>
                    <th style="width: 100px"><?php echo $this->lang->line('hrms_loan_new_amount')?> <!--New Amount--> </th>
                <th style="width: 100px"> <?php echo $this->lang->line('hrms_loan_increment_amount')?> <!--Increment Amount--> </th>
                    <th style="width: 80px"> <?php  echo  $this->lang->line('hrms_loan_balance_amount');?> <!--Balance Amount--> </th>
                </tr>
                </thead>
                    ...
                    foreach ($detailTable as $empID=>$row){
                        ...
                        foreach ($row as $key=>$det){
                            ...
                            echo '<tr>
                                    ...
                                    <td class="right-align inc_amn_'.$empID.'" id="inc_amn_'.$detID.'">'.number_format($amount, $dPlace).'</td>
                                    <td class="right-align balance_amn_'.$empID.'" id="balance_amn_'.$detID.'">'.number_format($empBalance, $dPlace).'</td>                                    
                                  </tr>';
                        }
                        ...
                        echo '<tr>
                                ...
                                <td class="right-align total-sd"></td>
                                <td class="right-align total-sd" id="new-tot-'.$empID.'">'.number_format($newAmountTot, $dPlace).'</td>
                                <td class="right-align total-sd" id="increment-tot-'.$empID.'">'.number_format($incAmountTot, $dPlace).'</td>                                        
                                <td class="right-align total-sd" id="balance-tot-'.$empID.'">'.number_format($empBalanceTot, $dPlace).'</td>                                                                       
                              </tr>';
