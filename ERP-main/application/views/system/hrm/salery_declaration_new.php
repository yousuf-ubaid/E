...
if( !empty($this->input->post('page_id')) ){
    $employee_drop = getEmployeesDeclaration($this->input->post('page_id'));
        ...
        <div class="modal-content">
            <form class="" id="declaration_save_detail_form" autocomplete="off">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('hrms_payroll_salary_declaration_detail');?><!--Salary Declaration Detail--></h4>
                </div>
