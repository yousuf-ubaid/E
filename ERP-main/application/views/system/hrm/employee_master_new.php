...
$alphas = range('A', 'Z');
$checkPolicy = getPolicyValues('ESCAL', 'All');
...
$emp=current_userID();
$Employeeinapproval=getEmployeeInApproval($emp);

$checkLanguagePolicy = getPolicyValues('LNG', 'All');
?>
<style>
    #menu ul {
                        ...
                        <div class="col-md-12 alpha-tab-container">
                            ...
                            <div class="col-lg-11 col-xs-9 alpha-tab">
                                <div class="alpha-tab-content active scroll_emp scroll_style" id="">
                                    <div id="employee-list" style="padding-right: 1%; padding-left: 3%;">
                ...
                <div class="row">
                    <div class="col-sm-12">
                                ...
                                <?php }
                                    ...
                                    <div class="input-group" style="width: 100%; ">
                                        <input type="text" class="form-control input-sm" value="" id="initial" name="initial"
                                            placeholder="<?php echo $this->lang->line('common_initial'); ?>" style="width: 80px"/><!--Initial-->
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-4">
                                <?php if($checkLanguagePolicy == 'Default'){ ?>
                                    <label for="emp_email"><?php echo $this->lang->line('emp_primary_e-mail'); ?><?php required_mark(); ?></label>
                                <?php }else{ ?>
                                    <label for="emp_email">Company Email<?php required_mark(); ?></label>
                                <?php } ?>
                                <div class="input-group">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#employee_form").bootstrapValidator({
            ...
            e.preventDefault();
            var requestUrl = '<?php echo site_url('Employee/new_empSave'); ?>';
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data[0] == 's') {
                        ...
                        $('#EmpSecondaryCode').val(data['ECode']);
                    }
                },
    ...
    function edit_empDet(empID) {
        fetchPage('system/hrm/employee_create_new', empID, 'HRMS', '', '');
    }
