...
$emp_arr = employee_list_by_segment(1);
        ...
        <div class="row">
            ...
            <div class="col-md-2" style="padding-left: 0px;">
                ...
                $groupBy_arr = [
                    ...
                    '2' => $this->lang->line('common_location_and_employee')
                ];
                echo form_dropdown('groupby', $groupBy_arr,'1', ' onchange="changeGroupBy(this); filterAttendanceTable();" class="form-control select2" id="groupby" '); ?>
            </div>
        </div>
        
        <div class="row">
            <div class="col-md-4 hide" style="padding-left: 0px;" id="div_employee_select">
                <label for="inputData" class="col-md-3 control-label">
                    <?php echo $this->lang->line('hrms_payroll_employee'); ?><!--Group By-->:</label>
                    <div class="col-md-4">
                        <?php
                        echo form_dropdown('emp_arr', $emp_arr, '', 'class="form-control" id="emp_arr" onchange="filterAttendanceTable();"  multiple="multiple"'); ?>
                    </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" onclick="approvaldata()"
                        ...
                        <?php echo $this->lang->line('common_approve'); ?><!--Save changes-->
                    </button>
                </div>
    ...
    <script type="text/javascript">
        ...
        function load_attendanceTB(selectedRowID = null) {
            ...
            attMasterTB = $('#attendanceMasterTB').DataTable({
                ...
                "bDestroy": true,
                "StateSave": true,
                "sAjaxSource": "<?php echo site_url('Employee/attendanceMachineTableApproval'); ?>",
                "aaSorting": [[1, 'ASC']],
                ...
                "fnServerData": function (sSource, aoData, fnCallback) {
                    ...
                    aoData.push({"name": "emp_arr", "value": emp_arr});
                    $.ajax({
                        'dataType': 'json',
                        'type': 'POST',
                        'url': sSource,
        ...
        function changeGroupBy(ev){
            var selected = $(ev).val();
            if(selected == 2){
                $('#div_employee_select').removeClass('hide');
            }else{
                $('#div_employee_select').addClass('hide');
            }
        }
