        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <table class="table table-striped table-condensed table-hover">
                    <thead>
                    <tr>
                        <th colspan="6"><?php echo $this->lang->line('common_approved_details'); ?><!-- Approved Details --></th>
                    </tr>
                    <tr>
                        <th>#</th>
                ...
                <table class="table table-striped table-condensed table-hover">
                    <thead>
                    <tr>
                        <th colspan="4"><?php echo $this->lang->line('common_closed_details'); ?><!-- Closed Details --></th>
                    </tr>
                    <tr>
                        <th>#</th>
                        <th><?php echo $this->lang->line('common_name'); ?><!--Name--></th>
                        <th><?php echo $this->lang->line('common_closed_date'); ?><!-- Closed Date --></th>
                        <th><?php echo $this->lang->line('procurement_reson'); ?><!-- Reason --></th>
                    </tr>
                    </thead>
                    <tbody id="closed_user_body" class="no-padding">
                    <tr class="danger">
                        <td colspan="4" class="text-center"><?php echo $this->lang->line('common_document_not_closed_yet'); ?>.<!-- Document not closed yet --></td>
                    </tr>
                    </tbody>
                </table>
            </div>
...
<script type="text/javascript">
    ...
    function close_PR_Document(id)
    {
        if (id) {
            $.ajax({
                ...
                dataType: 'json',
                data: {'purchaseRequestID': id},
                url: "<?php echo site_url('PurchaseRequest/validate_close_prq'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
    ...
    function fetch_approval_closed_user_modal(documentID, documentSystemCode) {
        $.ajax({
            ...
            success: function (data) {
                $('#closed_user_label').html('<span aria-hidden="true" class="glyphicon glyphicon-hand-right"></span> &nbsp; <?php echo $this->lang->line('common_closed_user'); ?>');
    ...
    function po_version_View_modal(documentID, para1){
        ...
        $.ajax({
            ...
            type: 'post',
            dataType: 'html',
            data: {'purchaseRequestID': para1,'html': true,'versionhide': true},
            url: "<?php echo site_url('PurchaseRequest/load_purchase_request_conformation'); ?>",
            beforeSend: function () {
                startLoad();
            },
        ...
        if(id){
            ...
            function () {
                $.ajax({
                    ...
                    dataType : 'json',
                    data : {'masterID':id},
                    url :"<?php echo site_url('PurchaseRequest/add_quotation_version_po'); ?>",
                    beforeSend: function () {
                        startLoad();
                    },
                    success : function(data){
                        ...
                        Otable.draw();
                        // fetchPage('system/PurchaseRequest/erp_purchase_request','','Purchase Request','');
