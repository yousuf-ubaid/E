...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary pull-right"
                onclick="fetchPage('system/PurchaseRequest/erp_purchase_request_new_employee',null,'<?php echo $this->lang->line('procurement_approval_add_purchase_request');?>','PRQ');"><!--/*Add Purchase Request*/--><i
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/PurchaseRequest/erp_purchase_request_employee', 'Test', 'Purchase Request');
        });
    ...
    function purchase_request_table(selectedID=null) {
         Otable = $('#purchase_request_table').DataTable({
            ...
            "bDestroy": true,
            "StateSave": true,
            "sAjaxSource": "<?php echo site_url('PurchaseRequest/fetch_purchase_request_employee'); ?>",
            "aaSorting": [[0, 'desc']],
         /*   "columnDefs": [
            ...
            "columnDefs": [{"targets": [7], "orderable": false},{"visible":false,"searchable": true,"targets": [7,8,9,10,11,12] }, {"targets": [0,2,3,4,5,6], "searchable": false}],
