...
<div class="tab-content">
    <div id="step1" class="tab-pane active">
        ...
        <div class="row">
            <div class="form-group col-sm-12">
                ...
                <br>
                <button class="btn btn-primary" type="button" onclick="open_all_notes()"><i class="fa fa-bookmark"
                                                                                            aria-hidden="true"></i>
                </button>
                <hr>
            </div>
    ...
    <div id="step2" class="tab-pane">
        ...
        <div class="text-right m-t-xs">
            ...
            <button class="btn btn-primary-new size-lg next" onclick="load_conformation();">
                <?php echo $this->lang->line('common_save_and_next'); ?><!--Save & Next--></button>
        </div>
    </div>
                    ...
                    if (jQuery.isEmptyObject(data['detail'])) {
                        ...
                        $.each(data['detail'], function (key, value) {
                            ...
                            if (purchaseOrderType == 'PR'){
                                ...
                                $('#table_body').append('<tr><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td>' + purchaseRequestCode + '</td><td><b>Description :</b> ' + value['Itemdescriptionpartno'] + ' <br> <b>comment :</b> ' + value['comment'] + '</td><td class="text-center">' + value['unitOfMeasure'] + '</td><td class="text-center">' + value['requestedQty'] + '</td><td class="text-right">' + (parseFloat(value['unitAmount']) + parseFloat(value['discountAmount'])).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right" style="width: 80px;">' + parseFloat(value['discountAmount']).formatMoney(currency_decimal, '.', ',') + ' (' + parseFloat(value['discountPercentage']).toFixed(2) + '%) </td><td class="text-right">' + parseFloat(value['unitAmount']).formatMoney(currency_decimal, '.', ',') + '</td> <td class="text-left lintax">' + value['lineTaxDesc'] + '</td><td class="text-right lintax">' + taxCalAmount + '</td><td class="text-right">' + parseFloat(tot_amount_line).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right"><a onclick="edit_item(' + value['purchaseOrderDetailsID'] + ',' + value['prQty'] + ');"><span class="glyphicon glyphicon-pencil"></span></a> &nbsp;&nbsp;<a onclick="delete_item(' + value['purchaseOrderDetailsID'] + ',' + value['totalAmount'] + ');"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td></tr>');
                            } else{
                                $("#pr_code").attr('style','display:none');
                              
                                if(purchaseRequestCode == 'BQUT'){
                                    $('#table_body').append('<tr class="lineitem"><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td><b>Description :</b> ' + value['Itemdescriptionpartno'] + ' <br> <b>comment :</b> ' + value['comment'] + '</td><td class="text-center">' + value['unitOfMeasure'] + '</td><td class="text-center">' + value['requestedQty'] + '</td><td class="text-right">' + (parseFloat(value['unitAmount']) + parseFloat(value['discountAmount'])).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right" style="width: 80px;">' + parseFloat(value['discountAmount']).formatMoney(currency_decimal, '.', ',') + ' (' + parseFloat(value['discountPercentage']).toFixed(2) + '%) </td><td class="text-right">' + parseFloat(value['unitAmount']).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right">' + parseFloat(tot_amount_line).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right">'+commision_percentage+'</td><td class="text-right">'+(parseFloat(commision_value)).formatMoney(currency_decimal, '.', ',')+'</td><td colspan="2" class="text-right"><a class='+hide_edit+' onclick="edit_item(' + value['purchaseOrderDetailsID'] + ',' + value['prQty'] + ');"><span class="glyphicon glyphicon-pencil"></span></a> &nbsp;&nbsp;<a class="hide" onclick="delete_item(' + value['purchaseOrderDetailsID'] + ',' + value['totalAmount'] + ');"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td></tr>');
                                }else{
                                    $('#table_body').append('<tr class="lineitem"><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td><b>Description :</b> ' + value['Itemdescriptionpartno'] + ' <br> <b>comment :</b> ' + value['comment'] + '</td><td class="text-center">' + value['unitOfMeasure'] + '</td><td class="text-center">' + value['requestedQty'] + '</td><td class="text-right">' + (parseFloat(value['unitAmount']) + parseFloat(value['discountAmount'])).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right" style="width: 80px;">' + parseFloat(value['discountAmount']).formatMoney(currency_decimal, '.', ',') + ' (' + parseFloat(value['discountPercentage']).toFixed(2) + '%) </td><td class="text-right">' + parseFloat(value['unitAmount']).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right">'+commision_percentage+'ss</td><td class="text-right">'+(parseFloat(commision_value)).formatMoney(currency_decimal, '.', ',')+'</td><<td class="text-right">' + parseFloat(tot_amount_line).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right"><a class='+hide_edit+' onclick="edit_item(' + value['purchaseOrderDetailsID'] + ',' + value['prQty'] + ');"><span class="glyphicon glyphicon-pencil"></span></a> &nbsp;&nbsp;<a onclick="delete_item(' + value['purchaseOrderDetailsID'] + ',' + value['totalAmount'] + ');"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td></tr>');
                                }
                                //$('#table_body').append('<tr><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td><b>Description :</b> ' + value['Itemdescriptionpartno'] + ' <br> <b>comment :</b> ' + value['comment'] + '</td><td class="text-center">' + value['unitOfMeasure'] + '</td><td class="text-center">' + value['requestedQty'] + '</td><td class="text-right">' + (parseFloat(value['unitAmount']) + parseFloat(value['discountAmount'])).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right" style="width: 80px;">' + parseFloat(value['discountAmount']).formatMoney(currency_decimal, '.', ',') + ' (' + parseFloat(value['discountPercentage']).toFixed(2) + '%) </td><td class="text-right">' + parseFloat(value['unitAmount']).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right lintax">' + parseFloat(value['totalAmount']).formatMoney(currency_decimal, '.', ',') + '</td> <td class="text-left lintax">' + value['lineTaxDesc'] + '</td><td class="text-right lintax">' + taxCalAmount + '</td><td class="text-right">' + parseFloat(tot_amount_line).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right"><a onclick="edit_item(' + value['purchaseOrderDetailsID'] + ',' + value['prQty'] + ');"><span class="glyphicon glyphicon-pencil"></span></a> &nbsp;&nbsp;<a onclick="delete_item(' + value['purchaseOrderDetailsID'] + ',' + value['totalAmount'] + ');"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td></tr>');
                            }
                            ...
                            var ex_date='<div class="input-group " ><input type="date" onchange="set_po_detail_delivery_date(this,' + value['purchaseOrderDetailsID'] + ')" name="detailDate" data-inputmask="alias: '+date_format_policy+'" value="'+ex_date_val+'" id="' + value['purchaseOrderDetailsID'] + '" class="form-control "></div>';
                            //var ex_date='<div class="input-group " ><div class="input-group-addon"><i class="fa fa-calendar"></i></div><input type="date" onchange="set_po_detail_delivery_date(this,' + value['purchaseOrderDetailsID'] + ')" name="detailDate" data-inputmask="alias: '+date_format_policy+'" value="'+ex_date_val+'" id="' + value['purchaseOrderDetailsID'] + '" class="form-control datepic_item"></div>';
                        ...
                        // $('.datepic_item').datetimepicker({
                        //     useCurrent: false,
                        //     format: date_format_policy,
                        // }).on('dp.change', function (ev) {
                        //     var last_date = ev.target.lastChild.value;
                        //     var masterIDDEt =ev.target.lastChild.id;
                        //     set_po_detail_delivery_date(last_date,masterIDDEt);
                        // });
                        ...
                        if (purchaseOrderType == 'PR'){
                            if ($("#documentTaxType").val() == 0) {
                                ...
                                $('#table_tfoot').append('<tr><td colspan="13" class="text-right">Total ( ' + data['currency']['transactionCurrency'] + ' )</td><td class="text-right total">' + parseFloat(tot_amount).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right" >&nbsp;</td></tr>');
                            }
                        } else{
                          
                             if(purchaseOrderType == 'BQUT'){
                                if ($("#documentTaxType").val() == 0) {
                                    $('#table_tfoot').append('<tr><td colspan="6" class="text-right">Total ( ' + data['currency']['transactionCurrency'] + ' )</td><td class="text-right total">' + parseFloat(tot_amount).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right" >Total Commission ( ' + data['currency']['transactionCurrency'] + ' )</td><td class="total">'+ parseFloat(commission_amount).formatMoney(currency_decimal, '.', ',') +'</td></tr>');
                                } else {
                                    $('#table_tfoot').append('<tr><td colspan="8" class="text-right">Total ( ' + data['currency']['transactionCurrency'] + ' )</td><td class="text-right total">' + parseFloat(tot_amount).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right" >Total Commission ( ' + data['currency']['transactionCurrency'] + ' )</td><td class="total">'+ parseFloat(commission_amount).formatMoney(currency_decimal, '.', ',') +'</td></tr>');
                                }
                            }else{
                                if ($("#documentTaxType").val() == 0) {
                                    $('#table_tfoot').append('<tr><td colspan="8" class="text-right">Total ( ' + data['currency']['transactionCurrency'] + ' )</td><td class="text-right total">' + parseFloat(tot_amount).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right" >&nbsp;</td></tr>');
