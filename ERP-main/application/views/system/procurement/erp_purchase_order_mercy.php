                    ...
                    <table>
                        <tr>
                            <td colspan="3">
                                ...
                                <p style="font-size: 12px"><?php echo $this->common_data['company_data']['company_address1'].', '.$this->common_data['company_data']['company_address2'].', '.$this->common_data['company_data']['company_city'].', '.$this->common_data['company_data']['company_country']; ?></p>
    ...
    <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            if($extra['master']['documentTaxType']==1){
                ?>
                <th style="min-width: 10%" class='theadtr'>Tax amount</th>
                <?php
            }
            ?>
        ...
        if (!empty($extra['detail'])) {
            foreach ($extra['detail'] as $val) { ?>
                <tr>
                    ...
                    <td class="text-right" style="font-size: 12px;"><?php echo  number_format($val['discountAmount'],$extra['master']['transactionCurrencyDecimalPlaces']) . ' (' . $val['discountPercentage'] . '%)'; ?></td>
                ...
                <td style="width:60%;padding: 0;">
                    ...
                    if (!empty($extra['tax_detail'])) { ?>
                        <table style="width: 100%" class="<?php echo table_class(); ?>">
                            <thead>
                            <tr>
                                <td class='theadtr' colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;<strong>Tax Details</strong>
                                </td>
                            </tr>
                            <tr>
                                <th class='theadtr'>#</th>
                                <th class='theadtr'>Detail</th>
                                <th class='theadtr'>Amount <span
