...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary pull-right"
                onclick="fetchPage('system/receipt_voucher/erp_receipt_voucher_suom',null,'<?php echo $this->lang->line('accounts_receivable_tr_add_new_receipt_voucher');?>','RV');"><i
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function(){
            fetchPage('system/receipt_voucher/receipt_voucher_management_suom','','Receipt Voucher');
        });
    ...
    function payment_voucher_table(selectedID=null) {
         Otable = $('#payment_voucher_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Receipt_voucher/fetch_receipt_voucher_suom'); ?>",
            "aaSorting": [[0, 'desc']],
            ...
            "aoColumns": [
             ...
             "columnDefs": [{"targets": [6], "orderable": false},{"visible":false,"searchable": true,"targets": [7,8,9,10,11,12] }, {"searchable": false, "targets": [0,2,4,5]}],
