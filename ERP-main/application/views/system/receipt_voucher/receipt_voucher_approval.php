...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/receipt_voucher/receipt_voucher_approval', '', 'Receipt Voucher Approval');
        });
    ...
    function receipt_voucher_table() {
        Otable = $('#receipt_voucher_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Receipt_voucher/fetch_Receipt_voucher_approval'); ?>",
            "aaSorting": [[1, 'desc']],
            ...
            "columnDefs": [{"targets": [2], "orderable": false},{"targets": [9,10], "orderable": false, "visible": false, "searchable": true}],
