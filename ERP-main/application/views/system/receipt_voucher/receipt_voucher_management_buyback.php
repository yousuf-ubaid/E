...
$title = $this->lang->line('accounts_receivable_ap_rv_receipt_voucher');
echo head_page($title, true);

/*echo head_page('Receipt Voucher', true);*/
...
?>
    ...
    <div id="filter-panel" class="collapse filter-panel">
        <div class="row">
            ...
            <div class="form-group col-sm-4">
                <label for="supplierPrimaryCode"> <?php echo $this->lang->line('common_customer');?><!--Customer--></label><br>
    ...
    <div class="row">
        ...
        <div class="col-md-3 text-right">
            <button type="button" class="btn btn-primary pull-right"
                    ...
                    onclick="fetchPage('system/receipt_voucher/erp_receipt_voucher_buyback',null,'<?php echo $this->lang->line('accounts_receivable_tr_add_new_receipt_voucher');?>','RV');"><i
                    class="fa fa-plus"></i> <?php echo $this->lang->line('accounts_receivable_tr_create_receipt_voucher');?><!--Create Receipt Voucher-->
            </button>
        </div><!--Add New Receipt Voucher-->
    </div>
    <hr>
    <div class="table-responsive">
        <table id="payment_voucher_table" class="<?php echo table_class(); ?>">
            <thead>
            <tr>
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Receipt Voucher Template</h4>
            </div>
            <div class="modal-body">
                <input type="hidden" id="receiptvoucher_ID">
                <div class="row">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-sm" onclick="print_rv_temp()">Print</button>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            $('.headerclose').click(function(){
                ...
                fetchPage('system/receipt_voucher/receipt_voucher_management_buyback','','Receipt Voucher');
            });
        ...
        function payment_voucher_table(selectedID=null) {
            Otable = $('#payment_voucher_table').DataTable({
                "language": {
                ...
                "sAjaxSource": "<?php echo site_url('Receipt_voucher/fetch_receipt_voucher_buyback'); ?>",
                "aaSorting": [[0, 'desc']],
        ...
        function delete_Rv_item(id, value) {
            swal({
                ...
                function () {
                    $.ajax({
                        ...
                        url: "<?php echo site_url('Payment_voucher/delete_Rv'); ?>",
                        beforeSend: function () {
                            startLoad();
                        },
        ...
        function referback_receipt_voucher(id,issysgen) {
            if(issysgen!=1)
            {
                swal({
                        title: "<?php echo $this->lang->line('common_are_you_sure');?>",/*Are you sure?*/
                    ...
                    function () {
                        $.ajax({
                            ...
                            type: 'post',
                            dataType: 'json',
                            data: {'receiptVoucherId': id},
                            url: "<?php echo site_url('Receipt_voucher/referback_receipt_voucher'); ?>",
                            beforeSend: function () {
                                startLoad();
                            },
                            success: function (data) {
            ...
            swal({
                ...
                function () {
                    $.ajax({
                        ...
                        dataType: 'json',
                        data: {'receiptVoucherId': id},
                        url: "<?php echo site_url('Receipt_voucher/delete_receipt_voucher'); ?>",
                        beforeSend: function () {
                            startLoad();
                        },
                        success: function (data) {
            ...
            swal({
                ...
                function () {
                    $.ajax({
                        ...
                        dataType : 'json',
                        data : {'receiptVoucherId':id},
                        url :"<?php echo site_url('Receipt_voucher/re_open_receipt_voucher'); ?>",
                        beforeSend: function () {
                            startLoad();
                        },
                        success : function(data){
        ...
        function traceDocument(cinvID,DocumentID){
            $.ajax({
                ...
                url: "<?php echo site_url('Tracing/trace_rv_document'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
        ...
        function load_printtemp(receiptvoucherID)
            {
        $('#printSize').val(1);
        $('#receiptvoucher_ID').val(receiptvoucherID);
        $('#print_temp_modal').modal('show');


         }
         function print_rv_temp(){
        var printSize =  $('#printSize').val();
        var receiptvoucher_ID =   $('#receiptvoucher_ID').val();

        if(receiptvoucher_ID==''){
            myAlert('e', 'Select Print Type');
        }else{
            window.open("<?php echo site_url('Receipt_voucher/load_rv_conformation_buyback') ?>" +'/'+ receiptvoucher_ID +'/'+ printSize +'/'+1);
        }
