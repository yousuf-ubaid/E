    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs pull-right">
            ...
            <?php if($RVType == 'Invoices' || $RVType == 'CustomerInvoices' || $RVType == 'InvoicesItem') { ?>
                ...
                <li class="tab_7_Item <?php if($RVType == 'CustomerInvoices') { echo 'active';}?> <?php if($RVType == 'InvoicesItem') { echo 'hide';}?>">
                    <a data-toggle="tab" class="boldtab" href="#tab_7" aria-expanded="false">
                        <?php echo $this->lang->line('accounts_receivable_common_payment_invoices'); ?><!--Invoices--></a></li>
            <?php } ?>
            <?php if($RVType == 'Invoices' || $RVType == 'CustomerInvoices' || $RVType == 'InvoicesItem') { ?>
                        ...
                        <table class="table table-bordered table-striped table-condesed ">
                            ...
                            <tr>
                                <th colspan="4">
                                    <?php echo $this->lang->line('accounts_receivable_common_invoice_details'); ?><!--Invoice Details--></th>
                                <th colspan="2">
                                        <?php echo $this->lang->line('common_amount'); ?><!--Invoice Details--></th>
                        ...
                        <table class="table table-bordered table-striped table-condesed ">
                            ...
                            <tr>
                                ...
                                <th style="width: 15%">
                                    <?php echo $this->lang->line('accounts_receivable_common_reference_no'); ?><!--Reference No--></th>
                                <th style="width: 15%">
                                    <?php echo $this->lang->line('accounts_receivable_common_invoice_currency'); ?><!--Reference No--></th>
                                <th style="width: 15%">
                                    <?php echo $this->lang->line('accounts_receivable_common_invoice_total'); ?><!--Invoice Total--></th>
                                <th style="width: 15%">
                                    <?php echo $this->lang->line('accounts_receivable_common_balance'); ?><!--Balance--></th>
                                <th style="width: 15%">
                                    <?php echo $this->lang->line('accounts_receivable_common_invoice_total'); ?><!--Balance--></th>
                                <th style="width: 15%">
                                    <?php echo $this->lang->line('accounts_receivable_common_invoice_balance'); ?><!--Balance--></th>
                                <th style="width: 20%">
                                    <?php echo $this->lang->line('common_amount'); ?><!--Amount--></th>
                            </tr>
                            </thead>
                            ...
                            if (!empty($customer_inv)) {
                                ...
                                for ($i = 0; $i < count($customer_inv); $i++) {
                                    ...
                                    if (round($balance,$master['transactionCurrencyDecimalPlaces']) > 0) {
                                        ...
                                        echo "<td>" . $customer_inv[$i]['invoiceDate'] . "</td>";
                                        echo "<td>" . $customer_inv[$i]['referenceNo'] . "</td>";
                                        echo "<td>" . $customer_inv[$i]['transactionCurrency'] . "</td>";
                                        echo "<td class='text-right'>" . number_format($customer_inv[$i]['transactionAmount'], $master['transactionCurrencyDecimalPlaces']) . "</td>";
                                        echo "<td class='text-right'><span class='receiptvoucherdetails'>" . number_format($balance, $master['transactionCurrencyDecimalPlaces']) . "&nbsp;<a class='hoverbtn invoiceaddbtn'  onclick='total_calculation(),applybtn(this,". $customer_inv[$i]['invoiceAutoID']. ",".round($balance,$master['transactionCurrencyDecimalPlaces']).")'></a></span></td>";
                                        echo "<td class='text-right'><span class='receiptvoucherdetails'>" . number_format($customer_inv[$i]['total_amount_converted'],5) . "&nbsp;<a class='hoverbtn invoiceaddbtn'  onclick='total_calculation(),applybtn(this,". $customer_inv[$i]['invoiceAutoID']. ",".round($customer_inv[$i]['total_amount_converted'],5).")'></a></span></td>";
                                        echo "<td class='text-right'><span class='receiptvoucherdetails'>" . number_format($customer_inv[$i]['balanced_amount_converted'],5) . "&nbsp;<a class='hoverbtn invoiceaddbtn'  onclick='total_calculation(),applybtn(this,". $customer_inv[$i]['invoiceAutoID']. ",".round($customer_inv[$i]['balanced_amount_converted'],5).")'><i class='fa fa-arrow-circle-right' aria-hidden='true'></i></a></span></td>";

                                        echo '<td ><input style="width: 88%;" type="text" name="amount[]" id="amount_' . $customer_inv[$i]['invoiceAutoID'] . '" onkeyup="total_calculation(),select_check_box(this,' . $customer_inv[$i]['invoiceAutoID'] . ',' . round($customer_inv[$i]['balanced_amount_converted'],$master['transactionCurrencyDecimalPlaces']) . ')" class="number amountadd">&nbsp;&nbsp;<i class="fa fa-times" onclick="clear_invoice_selected(this,' . $customer_inv[$i]['invoiceAutoID'] .')" aria-hidden="true"></i>

                                            <input type="hidden" class="InvoiceAutoID" value="' . $customer_inv[$i]['invoiceAutoID'] . '">
                                            <input type="hidden" class="transactionCurrency" value="' . $customer_inv[$i]['transactionCurrency'] . '">
                                            <input type="hidden" class="transactionCurrencyID" value="' . $customer_inv[$i]['transactionCurrencyID'] . '">
                                        </td>';
                                        echo '<td class="text-right" style="display:none;"><input class="checkbox" id="check_' . $customer_inv[$i]['invoiceAutoID'] . '" type="checkbox" value="' . $customer_inv[$i]['invoiceAutoID'] . '"></td>';
                                        echo "</tr>";
                                        $x ++;
                ...
                <div class="modal-body">
                    <table class="table table-bordered table-striped table-condesed ">
                        ...
                        <tr>
                            ...
                            <th style="width: 15%">
                                    <?php echo $this->lang->line('accounts_receivable_common_creditnote_total'); ?><!--Balance--></th>
                            <th style="width: 15%">
                                    <?php echo $this->lang->line('accounts_receivable_common_creditnote_balance'); ?><!--Balance--></th>
                        ...
                        if (!empty($credit_note)) {
                            ...
                            foreach ($credit_note as $val) {
                                $dif = $val['transactionAmount'] - $val['invoiceAmountTotal'];
                                if ($dif > 0) {
                                    echo "<tr>";
                                    echo "<td>" . ($i + 1) . "</td>";
                                    ...
                                    echo '<td class="text-right" id="bal_'.$val['creditNoteMasterAutoID'].'">' . number_format($dif, $d) . ' </td>';
                                    echo "<td class='text-right'>" . number_format($val['total_amount_converted'], $d) . "</td>";
                                    echo "<td class='text-right'>" . number_format($val['balanced_amount_converted'], $d) .'<i class="fa fa-arrow-circle-right" style="color: #3c8dbc;" onclick="setQty(\''.$val['creditNoteMasterAutoID'].'\',\''.$val['balanced_amount_converted'].'\')" aria-hidden="true"></i> '. "</td>";
                                    $onclickVal = 'this,' . $val['creditNoteMasterAutoID'] . ',' . $val['balanced_amount_converted'];
                                    ?>
                                    <td>
                                        <input type="hidden"
                            ...
                            echo '<tr class="danger"><td colspan="10" class="text-center"><b>' . $norecfounds . '<!--No Records Found--></b></td></tr>';
                        }
                        ?>
                        </tbody>
                    </table>
        ...
        if((rebetval ==1)){
            ...
            if (!jQuery.isEmptyObject(selected)) {
                ...
                $.ajax({
                    ...
                    type: 'post',
                    dataType: 'json',
                    data: {'invoiceAutoID': selected, 'receiptVoucherAutoId': receiptVoucherAutoId, 'amount': amount,'settlementAmount':totalsettlement,'INVamount':INVamount,'rebetamount':rebetamount},
    ...
    function fetch_rv_details(tab) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#gl_table_body,#gl_table_body_expense,#item_table_body,#invoice_table_body,#advance_table_body,#creditNote_table_body').empty();
