...
<?php if ((!empty($mailbox)&&($mailbox['successYN']==1))) { ?>
    <button type="button" onclick="compose_email_contact_lead()" class="btn btn-primary pull-right"><i
...
<script type="text/javascript">
    ...
    function getInboxMails(page, uriSegment = 0) {
        ...
        $.ajax({
            ...
            type: 'post',
            dataType: 'json',
            data: {pageID: page, folder: 'INBOX','leadID':leadID},
            url: "<?php echo site_url('CrmMailbox/getInboxMailsleadwise'); ?>/" + uriSegment,
            beforeSend: function () {
                startLoad();
            },
