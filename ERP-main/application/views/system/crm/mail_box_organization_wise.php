...
<script type="text/javascript">
    ...
    function pagination(obj) {
        ...
        getInboxMailsorganization(data_pagination, uriSegment);
    }
    ...
    function getInboxMailsorganization(page, uriSegment = 0) {
        var organizationID = <?php echo $organizationID ?>;
        $.ajax({
            async: true,
            type: 'post',
            dataType: 'json',
            data: {pageID: page, folder: 'INBOX','organizationID':organizationID},
            url: "<?php echo site_url('CrmMailbox/getInboxMailsorganizationwise'); ?>/" + uriSegment,
            beforeSend: function () {
                startLoad();
            },
    ...
    function readMails_inbox_organization(emailid) {
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('CrmMailbox/getReadMailinbox_sent_organization'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
