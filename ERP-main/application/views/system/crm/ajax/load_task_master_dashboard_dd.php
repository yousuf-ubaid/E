        ...
        <table class="table table-hover table-striped">
            ...
            foreach ($header as $val) {
                ...
                <tr>
                    ...
                    <td class="mailbox-star" width="11%"><?php echo $val['documentSystemCode'] ?> </td>
                    ...
                    <td class="mailbox-name taskaction_td"><a href="#" class="<?php echo $textdecoration; ?>" onclick="task_edit_view('system/crm/task_edit_view','<?php echo $val['taskID'] ?>','View Task','CRM','CRM')"><?php echo $val['subject'] ?></a></td>
                    <?php if($type == 1){ ?> <!--Cheack if it is project or a opportunitie  1 for project 2 for opportunities-->
                        <td class="mailbox-name taskprojecteditview"><a href="#" class="<?php echo $textdecoration; ?>" onclick="task_edit_view('system/crm/task_edit_view','<?php echo $val['taskID'] ?>','View Task','<?php echo $val['projectID'] ?>','ProjectsTask')"><?php echo $val['subject'] ?></a></td>
                    <?php }else if($type == 2){?>
                        <td class="mailbox-name taskprojecteditview"><a href="#" class="<?php echo $textdecoration; ?>" onclick="task_edit_view('system/crm/task_edit_view','<?php echo $val['taskID'] ?>','View Task','<?php echo $opportunityID ?>','opportunitie')"><?php echo $val['subject'] ?></a></td>
                    <?php }?>
