                ...
                <tr>
                    ...
                    <td class="mailbox-name" style="width: 22%;">
                        <div class="contact-box">
                            <div class="link-box"><strong class="contacttitle"><?php echo $val['documentSystemCode'] ?><br><a
                                        class="link-person noselect" href="#"
                                        onclick="pro_edit_view('system/crm/project_edit_view','<?php echo $val['projectID'] ?>','View Project','CRM')"><?php if(!empty($val['organizationName'])){ echo $val['organizationName']."<br>"; } echo $val['projectName'] ?>
