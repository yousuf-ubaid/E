            ...
            foreach ($header as $val) {
                ...
                <tr>
                    ...
                    <td class="mailbox-star" width="11%"><a href="#" class="<?php echo $textdecoration; ?>">
                                    <a class="link-person noselect" href="#" class="<?php echo $textdecoration; ?>" onclick="fetchPage('system/crm/task_edit_view','<?php echo $val['taskID'] ?>','View Task','CRM','CRM')" >   <?php echo $val['documentSystemCode'] ?></a>
                    ...
                    <td class="mailbox-name taskaction_td">
                        ...
                        <div class="contact-box">
                            <div class="link-box"><strong class="contacttitle">Subject :<a
                                            class="link-person noselect" href="#" class="<?php echo $textdecoration; ?>" onclick="fetchPage('system/crm/task_edit_view','<?php echo $val['taskID'] ?>','View Task','CRM','CRM')"><?php echo $val['subject']; ?></a></strong><br><strong class="contacttitle">Start Date : </strong><a
