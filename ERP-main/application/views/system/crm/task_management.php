   ...
   var per_page = 10;
    ...
    function getTaskManagement_tableView(pageID,uriSegment = 0) {
        ...
        $.ajax({
            ...
            type: 'post',
            dataType: 'json',
            data: {'searchTask': searchTask, status: status, priority: priority, assignees: assignees, category:category,'pageID':pageID,createdby:createdby},
            url: "<?php echo site_url('crm/load_taskManagement_view'); ?>/" + uriSegment,
            beforeSend: function () {
                startLoad();
            },
