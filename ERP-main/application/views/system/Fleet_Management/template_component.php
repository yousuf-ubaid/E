...
if ($checklists)
{
    ...
    { ?>
        <tr>
            ...
            <td style="min-width: 10%"><button type="button" onclick="deletecomponent_line_record('<?php echo $val['id'] ?>')"><i class="glyphicon glyphicon-trash" style="color: red;"></i></button> <span></span><button type="button" onclick="editcomponent_line_record('<?php echo $val['id'] ?>')"><i class="glyphicon glyphicon-pencil" style="color: green;"></i></button></button> <button type="button" onclick="checklist_record('<?php echo $val['id'] ?>')"><i class="glyphicon glyphicon-list-alt" style="color: green;"></i></button></td>
        </tr>
<?php
    }
} ?>