...
$title = $this->lang->line('fleet_asset_utilization');
    ...
    <div class="row">
        <div class="col-md-7">
            <table class="<?php echo table_class(); ?>">
                <tr>
                    <!-- <td><span class="label label-success">&nbsp;</span> <?php echo $this->lang->line('common_confirmed');?>/ <?php echo $this->lang->line('common_approved');?></td>
                    <td><span class="label label-danger">&nbsp;</span> <?php echo $this->lang->line('common_not_confirmed');?> / <?php echo $this->lang->line('common_not_approved');?></td>
        ...
        <div class="col-md-5 text-right">
            <button type="button" class="btn btn-primary pull-right"
                    onclick="fetchPage('system/Fleet_Management/fleet_utilization_new','','<?php echo $this->lang->line('fleet_new_utilization');?>','Fleet');">
                <i class="fa fa-plus"></i> <?php echo $this->lang->line('fleet_new_utilization');?>
            </button>
        </div>
    </div>
    <hr>
    <div class="table-responsive">
        <table id="utilization_table" class="<?php echo table_class() ?>">
            <thead>
            <tr>
                <th style="min-width: 5%">#</th>
                <th style="min-width: 20%"><?php echo $this->lang->line('fleet_document_no'); ?></th>
...
<?php echo footer_page('Right foot', 'Left foot', false); ?>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            asset_utilization_table();

        });
        

        function asset_utilization_table() {
            Otable = $('#utilization_table').DataTable({

                    "bProcessing": true,
                    "bServerSide": true,
                    "bDestroy": true,
                    "bStateSave": true,
                    "sAjaxSource": "<?php echo site_url('Fleet/fetch_uti_table'); ?>",
                    "aaSorting": [[0, 'desc']],
                ...
                "columnDefs": [{"searchable": false, "targets": [0,4,5]}],
        ...
        function delete_uti(id) {
          swal({
              ...
              function () {
                  $.ajax({
                      async: true,
                      url: "<?php echo site_url('Fleet/delete_uti'); ?>",
                      type: 'post',
                      dataType: 'json',
                      data: {'id': id},
                      beforeSend: function () {
