        ...
        <div class="col-sm-10" style="margin-left: 3%">
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="documentID" name="documentID" value="MNT">
                                ...
                                <strong class="attachemnt_title">
                                    ...
                                    <div><span class="attachemnt_title"
                                        ...
                                        <span class="deleteSpan" style="display: inline-block;"><a
                                                    onclick="delete_maintenace_attachment(<?php echo $row['attachmentID']; ?>,'<?php echo $row['myFileName']; ?>');"><span
