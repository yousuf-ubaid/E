...
<div class="row" style="margin:0 auto;max-width:600px">
    <table role="presentation" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td style="word-wrap:break-word;font-size:0;padding:0 454px 2px" align="left">
        ...
        <table role="presentation" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td style="word-wrap:break-word;font-size:0;padding:10px 20px 5px" align="left">
                    <div style="font-family:Helvetica,Arial,sans-serif;font-size:14px;line-height:22px;font-weight:bold;text-align:left">Transaction ID - <?= $master_data['TransRefNo'] ?></div>
                </td>
            </tr>
            <tr>
                <td style="word-wrap:break-word;font-size:0;padding:0 20px 10px" align="left">
                                        ...
                                        <table cellpadding="0" cellspacing="0" style="font-family:Helvetica,Arial,sans-serif;font-size:14px;line-height:22px;table-layout:auto" width="100%" border="0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="65px" align="right" style="font-size:16px;font-weight:bold;color:#263238">
                                                        <?=($inv_pay_amount != null)? number_format($inv_pay_amount, $dPlace): number_format($total, $dPlace);?> 
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <tr>
                                            <td style="padding-bottom:4px;color:#546e7a;font-size:16px">Transaction Status</td>
                                                <?php if($results =='Success'){?>
                                                    <td align="right" style="color:green;font-size:16px">&nbsp; <?=$results ?></td>

                                                <?php }else {?>
                                                    <td align="right" style="color:red;font-size:16px">&nbsp; <?=$results ?></td>
