...
$title = $this->lang->line('accounts_payable_ma_supplier_category');
echo head_page($title, false);

/*echo head_page('Supplier Category', false); */?>
...
<div class="row table-responsive">
    ...
    <div class="col-md-7 text-right">
        <button type="button" style="" class="btn btn-primary-new size-sm pull-right" onclick="opensuppliercategorymodel()"><i
                class="fa fa-plus"></i> <?php echo $this->lang->line('accounts_payable_ma_create_category');?><!--Create Category-->
        </button>
    </div>
</div>
<hr>
...
<script type="text/javascript">
    ...
    function supplier_category_table_table() {
        var Otable = $('#supplier_category_table').DataTable({
            ...
            "bDestroy": true,
            "StateSave": true,
            "sAjaxSource": "<?php echo site_url('supplier/fetch_supplier_category'); ?>",
            "aaSorting": [[0, 'desc']],
    ...
    function saveCategory() {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: data,
            url: "<?php echo site_url('supplier/saveCategory'); ?>",
            beforeSend: function () {
                startLoad();
            },
    ...
    function editsuppliercategory(partyCategoryID) {
        $.ajax({
            ...
            url: "<?php echo site_url('supplier/getCategory'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
                ...
                if (data) {
                    ...
                    $('#categoryHead').html('<?php echo $this->lang->line('accounts_payable_ma_edit_category');?>');/*Edit Category*/
    ...
    function opensuppliercategorymodel() {
        $('#partyCategoryID').val('');
        $('#categoryHead').html('<?php echo $this->lang->line('accounts_payable_ma_add_new_category');?>');/*Add New Category*/
    ...
    function delete_category(partyCategoryID) {
        swal({
                ...
                text: "<?php echo $this->lang->line('accounts_payable_ma_you_want_to_delete_this_category');?>",/*You want to delete this Category!*/
                type: "warning",
            ...
            function () {
                $.ajax({
                    ...
                    dataType: 'json',
                    data: {'partyCategoryID': partyCategoryID},
                    url: "<?php echo site_url('supplier/delete_category'); ?>",
                    beforeSend: function () {
                        startLoad();
                    },
                    success: function (data) {
