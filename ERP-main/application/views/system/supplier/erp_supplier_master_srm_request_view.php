...
<div class="tab-content">
    ...
    <div id="step3" class="tab-pane">
        ...
        <div class="text-right m-t-xs" >
            <a class="btn btn-danger-new size-lg mr-1" onclick="company_request_referback_level_approval()" id="" type="button">Save Refer Back</a>
            <a class="btn btn-primary-new size-lg headerclose " id="supplier_btn" >Close</a>
        </div>
            ...
            <div class="col-sm-12">
                    ...
                    <div class="row hide" id="existSupplierView">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                            <textarea class="form-control" id="system_comment" name="system_comment" rows="2"></textarea>
                            </div>
                    ...
                    <div class="row hide" id="newSupplierDetailAdd">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-4">
                                    <label for="liabilityAccount"><?php echo $this->lang->line('accounts_payable_sm_liability_account');?> <?php required_mark(); ?></label>
                                    <input type="hidden" name="liabilityAccount" id="liabilityAccount">
                                    <?php echo form_dropdown('liabilityAccount_see', $gl_code_arr, $this->common_data['controlaccounts']['APA'], 'class="form-control select2" id="liabilityAccount_see" required'); ?>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-4">
                                    ...
                                    <textarea class="form-control" id="add_comment" name="add_comment" rows="2"></textarea>
                                </div>
                            </div>
...
<div class="modal fade" id="company_request_doc_approve_modal_approve" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            ...
            <form class="form-horizontal" id="company_doc_reject_form_approve">
                <div class="modal-body">
                    <div id="conform_body"></div>
               
                    <input type="hidden" name="requestDocID_approve" id="requestDocID_approve">
                    <input type="hidden" name="typeReq_approve" id="typeReq_approve">
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-2 control-label"><?php echo $this->lang->line('common_comments');?><!--Comments--></label>
                        <div class="col-sm-8">
                            <textarea class="form-control" rows="3" name="comments_approve" id="comments_approve" required></textarea>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo $this->lang->line('common_Close');?><!--Close--></button>
                    <!-- <button type="submit" class="btn btn-primary">Submit</button> -->
                    <a onclick="saveCompanyDocumentRejectRequestApprove()" class="btn btn-primary">Submit</a>
                </div>
            </form>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function load_supplier_company_request_header() {
        ...
        var acc = <?php echo json_encode($this->common_data['controlaccounts']['APA']?$this->common_data['controlaccounts']['APA']:''); ?>;
        if (p_id) {
            $.ajax({
                async: true,
                type: 'post',
                    ...
                    if (!jQuery.isEmptyObject(data)) {
                        ...
                        if(dataSub){
                            $.each(dataSub, function (key, value) {
                                var new_comment = value.comment?value.comment:'-';
                                if(value.url!=null){
                                    if(value.isApprovalLevelReferBack ==1){
                                        htqty='<tr><td style="min-width: 3%">'+(key+1)+'</td><td style="min-width: 40%">'+value.documentName+'</td><td style="min-width: 40%">'+new_comment+'</td><td style="min-width: 20%"><span class="label label-danger">Refer Back</span></td><td style="min-width: 20%"><a href="'+value.url+'" target="_blank"> <span title="View" rel="tooltip" class="glyphicon glyphicon-eye-open glyphicon-eye-open-btn" ></span></a></td></tr>';
                                    }else{
                                        htqty='<tr><td style="min-width: 3%">'+(key+1)+'</td><td style="min-width: 40%">'+value.documentName+'</td><td style="min-width: 40%">'+new_comment+'</td><td style="min-width: 20%"><span class="label label-primary">Submitted</span></td><td style="min-width: 20%"><a href="'+value.url+'" target="_blank"> <span title="View" rel="tooltip" class="glyphicon glyphicon-eye-open glyphicon-eye-open-btn" ></span></a>&nbsp;&nbsp;<a onClick="resubmit_approve_vendor_company_document_request('+value.reqDocID+',1)" class=""> <span title="" rel="tooltip" class="glyphicon glyphicon-repeat" data-original-title="Approve"></span></a></td></tr>';
                                        // if(value.approveYN==1){
                                        //     htqty='<tr><td style="min-width: 3%">'+(key+1)+'</td><td style="min-width: 40%">'+value.documentName+'</td><td style="min-width: 40%">'+new_comment+'</td><td style="min-width: 20%"><span class="label label-primary">Approved</span></td><td style="min-width: 20%"><a href="'+value.url+'" target="_blank"> <span title="View" rel="tooltip" class="glyphicon glyphicon-eye-open glyphicon-eye-open-btn" ></span></a>&nbsp;&nbsp;<a onClick="resubmit_approve_vendor_company_document_request('+value.reqDocID+',1)" class=""> <span title="" rel="tooltip" class="glyphicon glyphicon-repeat" data-original-title="Approve"></span></a></td></tr>';
                                        // }else if(value.approveYN==2){
                                        //     htqty='<tr><td style="min-width: 3%">'+(key+1)+'</td><td style="min-width: 40%">'+value.documentName+'</td><td style="min-width: 40%">'+new_comment+'</td><td style="min-width: 20%"><span class="label label-success">Rejected</span></td><td style="min-width: 20%"><a href="'+value.url+'" target="_blank"> <span title="View" rel="tooltip" class="glyphicon glyphicon-eye-open glyphicon-eye-open-btn" ></span></a>&nbsp;&nbsp;<a onClick="resubmit_approve_vendor_company_document_request('+value.reqDocID+',1)" class=""> <span title="" rel="tooltip" class="glyphicon glyphicon-repeat" data-original-title="Approve"></span></a></td></tr>';
                                        // }

                                        // else if(value.approveYN==0){
                                        //     htqty='<tr><td style="min-width: 3%">'+(key+1)+'</td><td style="min-width: 40%">'+value.documentName+'</td><td style="min-width: 40%">'+new_comment+'</td><td style="min-width: 20%"><span class="label label-info">Submitted</span></td><td style="min-width: 20%"><a href="'+value.url+'" target="_blank"> <span title="View" rel="tooltip" class="glyphicon glyphicon-eye-open glyphicon-eye-open-btn" ></span></a>&nbsp;&nbsp;<a onClick="resubmit_approve_vendor_company_document_request('+value.reqDocID+',1)" class=""> <span title="" rel="tooltip" class="glyphicon glyphicon-repeat" data-original-title="Approve"></span></a></td></tr>';
                                        // }
                                    }
                                }else{
                                    if(value.isApprovalLevelReferBack ==1){
                                        ...
                                        htqty='<tr><td style="min-width: 3%">'+(key+1)+'</td><td style="min-width: 40%">'+value.documentName+'</td><td style="min-width: 40%">'+new_comment+'</td><td style="min-width: 20%"><span class="label label-warning">Not Submitted</span></td><td style="min-width: 20%"><a href="'+value.url+'" target="_blank"> <span title="View" rel="tooltip" class="glyphicon glyphicon-eye-open glyphicon-eye-open-btn" ></span></a>&nbsp;&nbsp;<a onClick="resubmit_approve_vendor_company_document_request('+value.reqDocID+',1)" class=""> <span title="" rel="tooltip" class="glyphicon glyphicon-repeat" data-original-title="Approve"></span></a></td></tr>';
                                    }
                                   
                                }
                               
                                // if(value.url!=null){
                                    // htqty='<tr><td style="min-width: 3%">'+(key+1)+'</td><td style="min-width: 40%">'+value.documentName+'</td><td style="min-width: 20%"><a href="'+value.url+'" target="_blank"> <span title="View" rel="tooltip" class="glyphicon glyphicon-eye-open glyphicon-eye-open-btn" ></span></a>&nbsp;&nbsp;<a onClick="approve_vendor_company_document_request('+value.reqDocID+',1)" class=""> <span title="" rel="tooltip" class="glyphicon glyphicon-ok glyphicon-ok-btn" data-original-title="Approve"></span></a>&nbsp;&nbsp;<a onClick="approve_vendor_company_document_request('+value.reqDocID+',2)" class=""> <span title="" rel="tooltip" class="glyphicon glyphicon-remove fa-envelope-btn" data-original-title="Reject"></span></a></td></tr>';
                                //     if(value.approveYN==1){
                        ...
                        if(dataMaster['approveYN']==0 || dataMaster['approveYN']==4){
                        ...
                        //  //financial details
                         ...
                         $('#liabilityAccount_see').val(acc).change();
                         $('#liabilityAccount').val(acc);
                         $("#liabilityAccount_see").prop("disabled", true);
                         ...
                         $("#nameOnCheque1").val(dataMaster['providerName']);
    ...
    function resubmit_approve_vendor_company_document_request(id,type){
        $('#requestDocID_approve').val(id);
        $('#typeReq_approve').val(type);

        if(type==1){
            $("#company_request_doc_approve_modal_approve").modal("show");
        }
    }
    ...
    function saveCompanyDocumentRejectRequestApprove(){
            var data = $('#company_doc_reject_form_approve').serializeArray();
            ...
            $.ajax(
                {
                    ...
                    dataType: 'json',
                    data: data,
                    url: "<?php echo site_url('Srm_master/vendor_company_request_document_reject_approve'); ?>",
                    beforeSend: function () {
                        startLoad();
                    ...
                    success: function (data) {
                        ...
                        if(data[0]=="s"){
                            $("#company_request_doc_approve_modal_approve").modal("hide");
                            load_submit_attachment();
                        }
    ...
    function company_request_referback_level_approval(){
       var  r_id = <?php echo json_encode(trim($this->input->post('page_id'))); ?>;
        $.ajax({
                async: true,
                type: 'post',
                dataType: 'json',
                data: {"masterID":r_id},
                url: "<?php echo site_url('Srm_master/company_request_referback_level_approval'); ?>",
                beforeSend: function () {
                    startLoad();
                ...
                success: function (data) {
                    ...
                    if(data[0]=="s"){
                        fetchPage('system/srm/srm_vendor_company_request', '', 'Vendor Registration')
                    }
