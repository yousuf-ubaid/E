                                        ...
                                        <div class="caption">
                                            ...
                                            if($sup['supplierQty']>0){
                                                ...
                                                <div class="skin skin-square position-top-right">
                                                    <div class="skin-section extraColumns"><input class ="re_check"
                ...
                <table class="table table-hover table-striped order-review-style-tbl">
                    <tbody>
                        ...
                        <tr class="fw-500">
                            ...
                            <?php if($submit_value){ ?>
                                <td class="text-right" style="border-bottom: 1px solid #eee;background: rgb(138 98 124 / <?php echo $bg; ?>%);<?php if($submit_value['isSelected']==0){ ?>background: #f29a7f !important <?php } ?>">
                                    <div class="dropdown">
                                        <button class="btn btn-xs dropdown-toggle btn-d" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <td class="text-right" style="border-bottom: 1px solid #eee;background: rgb(138 98 124 / <?php echo $bg; ?>%);<?php if($submit_value['isSelected']==0){ ?>background: #f29a7f !important <?php } ?>"> <?php echo number_format($submit_value['supplierDiscount'],2) ?> (<?php echo $submit_value['supplierDiscountPercentage'] ?>%)</td>
                                <td class="text-right" style="border-bottom: 1px solid #eee;background: rgb(138 98 124 / <?php echo $bg; ?>%);<?php if($submit_value['isSelected']==0){ ?>background: #f29a7f !important <?php } ?>"> <?php echo number_format($submit_value['supplierTax'],2) ?> (<?php echo $submit_value['supplierTaxPercentage'] ?>%)</td>
                                <td class="text-center" style="border-bottom: 1px solid #eee;background: rgb(138 98 124 / <?php echo $bg; ?>%);<?php if($submit_value['isSelected']==0){ ?>background: #f29a7f !important <?php } ?>">
                                ...
                                <td class="text-right" style="border-bottom: 1px solid #eee;background: rgb(138 98 124 / <?php echo $bg; ?>%);<?php if($submit_value['isSelected']==0){ ?>background: #f29a7f !important <?php } ?>"> <?php echo number_format($submit_value['supplierPrice']*$submit_value['supplierQty'],2) ?> </td>
                            <?php }else{ ?>
    ...
    function technicalSpecification_modal_open(id){
        ...
        $.ajax({
            ...
            success: function(data1) {
                ...
                if(data1[0]=='s'){
                    $('#techText_view').text("");
                    $('#techText_view').text(data1[1]['supplierTechnicalSpecification']);
                    $('#vendor_specification_view').modal('show');
                }else{
                    $('#techText_view').text("");
                    $('#techText_view').text('No data Found');
                    $('#vendor_specification_view').modal('show');
                }
            ...
            success: function(data1) {
                ...
                if(data1[0]=='s'){
                   ...
                   // $('#term_ref_supplier').html(tech_action);
                    $('#techText11_view').text(data1[1]['terms']);
                    $('#vendor_terms_view').modal('show');
                }else{
                    $('#techText11_view').text("");
                    $('#techText11_view').text('No data Found');
                    $('#vendor_terms_view').modal('show');
                }
        ...
        if (inquiryMasterID) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#attachment_model_supplier_view').modal('show');
                },
