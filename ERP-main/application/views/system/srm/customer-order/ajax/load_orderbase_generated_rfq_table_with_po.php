            ...
            foreach ($header as $val) {
               // print_r($val);exit;
                ...
                <tr>
                    ...
                    <?php
                        if ($val['isOrderReviewConfirmYN'] == 1) { ?>
                            <span class="pull-right"><div class="actionicon"><a target="_blank" onclick="view_rfq_printModel(<?php echo $val['inquiryMasterID']; ?>,<?php echo $val['supplierID']; ?>)"><span title="" rel="tooltip" class="glyphicon glyphicon-eye-open" data-original-title="View" style="color: white;"></span></a></div> <span class="pull-right">
                        <?php } else { ?>
                        <?php
