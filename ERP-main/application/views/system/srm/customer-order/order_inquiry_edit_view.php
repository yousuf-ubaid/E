...
<div id="orderInquiry_editView"></div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        if (p_id) {
            inquiryID = p_id;
            getOrderInquiry_editView(inquiryID);
        }
    ...
    function getOrderInquiry_editView(inquiryID) {
        $.ajax({
            async: true,
            type: 'post',
            dataType: 'html',
            data: {inquiryID: inquiryID},
            url: "<?php echo site_url('Srm_master/load_OrderInquiry_editView'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
                $('#orderInquiry_editView').html(data);
                stopLoad();
            },
