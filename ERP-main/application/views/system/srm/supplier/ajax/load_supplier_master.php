                    ...
                    <td class="mailbox-name" style="text-align: center">
                        <span class="label "
                            ...
                            <?php if ($val['isActive'] == 1) {
                                ...
                                echo '<span class="label" style="color: #0ab39c; background-color: rgba(10,179,156,.1); font-size: 11px;">'.$active.'<!--Active--></span>';
                            } else {
                                $not_active=$this->lang->line('srm_not_active');/*Language*/
                                echo '<span class="label" style="color: #f06548; background-color: rgba(240,101,72,.1); font-size: 11px;">'.$not_active.'<!--Not Active--></span>';
                            } ?>
                    ...
                    <td class="mailbox-name" style="text-align: center">
                        &nbsp; <a
                            ...
                            <span title="" rel="tooltip" class="glyphicon glyphicon-pencil"
                                  data-original-title="Edit"></span></a>&nbsp;&nbsp;<a onclick="load_supplier_items_details(<?php echo $val['supplierAutoID'] ?>);"><i
                                title="" rel="tooltip" class="fa fa-list" data-original-title="Add"></i></a>&nbsp;&nbsp;<a onclick="delete_supplier(<?php echo $val['supplierAutoID'] ?>);"><span title="Delete" rel="tooltip" class="glyphicon glyphicon-trash" style="color:rgb(209, 91, 71);"></span></a>&nbsp;
