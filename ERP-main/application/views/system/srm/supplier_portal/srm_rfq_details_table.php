...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <th style="min-width: 10%;max-width:15% ;text-align:left;color: #585858;font-family: tahoma;font-weight: 600;border-bottom: 2px solid #ffffff;"
                class='tableth'>item
            </th>
            ...
            <th style="width: 15%;text-align:center;color: #585858;font-family: tahoma;font-weight: 600;border-bottom: 2px solid #ffffff;"
        ...
        <tr>
            ...
            <td class="text-right tablethcol2" style="width: 10%"><label
                    ...
                    <label></td>
            <td class="text-right tableth" style="width: 10%"><label
                        style="color:#636363ad;font-family: inherit;font-weight: 100;font-size: 13px;"><div class="input-group datepic"><div class="input-group-addon"><i class="fa fa-calendar"></i></div><input type="text" name="expectedDeliveryDate[]"  value="" class="form-control expectedDeliveryDate"> </div><label>
            </td>
            <td class="text-right tableth" style="width: 10%"><label
                        style="color:#636363ad;font-family: inherit;font-weight: 100;font-size: 13px;"><input type="text" name="unitcost[]" placeholder="0.00"  class="form-control number unitcost" onkeyup="calculateTotal(this),rawmaterialCostTotal(),rawmaterialCostTotal_discount(),grandtotal(),rawmaterialCostTotal_Tax();" onkeypress="return validateFloatKeyPress(this,event)" onfocus="this.select();" ><label>
            </td>
            <td class="text-right tableth" style="width: 10%"><label
                        style="color:#636363ad;font-family: inherit;font-weight: 100;font-size: 13px;"><input type="text" name="Qty[]" placeholder="0.00" class="form-control number Qty" onkeyup="calculateTotal(this),rawmaterialCostTotal(),rawmaterialCostTotal_discount(),grandtotal(),rawmaterialCostTotal_Tax();" onkeypress="return validateFloatKeyPress(this,event);" onfocus="this.select();"><label>
            </td>
            <td class="text-right tableth" style="width: 10%"><label
                        style="color:#636363ad;font-family: inherit;font-weight: 100;font-size: 13px;"><input type="hidden" name="discountamountcal[]" onkeypress="return validateFloatKeyPress(this,event);" onkeyup="cal_discount_amount(this),rawmaterialCostTotal_discount(),grandtotal(),rawmaterialCostTotal_Tax();" class="form-control number discountamountcal" onfocus="this.select();" ><input type="text" name="discount[]" onkeyup="cal_discount(this),rawmaterialCostTotal_discount(),grandtotal(),rawmaterialCostTotal_Tax();"  onkeypress="return validateFloatKeyPress(this,event)" placeholder="0.00" class="form-control number discount" onfocus="this.select();" ><input type="hidden" name="discountamt[]" placeholder="0.00" class="form-control number discountamt" onfocus="this.select();" ><label>
            </td>
            <td class="text-right tableth" style="width: 10%"><label
                        style="color:#636363ad;font-family: inherit;font-weight: 100;font-size: 13px;"><input type="text" placeholder="0.00" name="item_taxPercentage[]" onkeypress="return validateFloatKeyPress(this,event);" class="form-control number item_taxPercentage" onkeyup="cal_discount(this),rawmaterialCostTotal_discount(),grandtotal(),rawmaterialCostTotal_Tax();" focus="this.select();"><input type="hidden" name="taxamt[]" class="form-control number taxamt"  onfocus="this.select();" ><input type ="hidden" name="ItemTax[]" class="form-control ItemTax"><label>
            </td>
            <td class="text-right tablethcoltotal" style="width: 15%"><label
                        style="color:#636363ad;font-family: inherit;font-weight: 100;font-size: 13px;"><input type="hidden" class="form-control totalwithoutdedu" name="totalwithoutdedu[]"><input type="text" name="totalcost[]"    class="form-control number totalcost" onfocus="this.select();" readonly><label>
            </td>
        ...
        <tfoot>
        <tr>
            <!-- <td style="min-width: 20%;border-bottom: 2px solid #ffffff;color:#636363ad;font-family: inherit;font-weight: 500;font-size: 13px;"
                class="text-right">&nbsp;
            </td> -->
            ...
            <td style="min-width: 30%;border-bottom: 1px solid #f7f4f4;color:#636363ad;font-family: inherit;font-weight: 500;font-size: 13px;"
                class="text-right" colspan="3">
                <input type="hidden" name="subt" id="subt">
                <div id="tot_totalValue" style="text-align: right">0.00</div>
                <!-- <?php echo number_format($subtotal, $company['company_default_decimal']) ?> -->
            </td>
        </tr>
        <tr>
            <!-- <td style="min-width: 20%;border-bottom: 2px solid #ffffff;color:#636363ad;font-family: inherit;font-weight: 500;font-size: 13px;"
            ...
            <td style="min-width: 20%;border-bottom: 1px solid #f7f4f4;color:#636363ad;font-family: inherit;font-weight: 500;font-size: 13px;"
                class="text-right" colspan="3">
                <input type="hidden" name="dist" id="dist">
                <div id="tot_totalValuediscount" style="text-align: right">0.00</div>
                <!-- <?php echo number_format($discountamt, $company['company_default_decimal']) ?> -->
            </td>
        </tr>
        <tr>
            <!-- <td style="min-width: 20%;border-bottom: 2px solid #ffffff;color:#636363ad;font-family: inherit;font-weight: 500;font-size: 13px;"
        ...
        <tr style="border-bottom: 2px solid #ffffff;">
            ...
            <td style="min-width: 85%;border-bottom: 1px solid #ffffff;color:#565555;font-family: tahoma;font-weight: bold;font-size: 13px;"
                ...
                <!-- <?php echo number_format($grandTotal, $company['company_default_decimal']) ?> -->
            </td>
        </tr>
        </tfoot>
    </table>
    ...
    function calculateTotal(element) {
        ...
        if(discount > 0)
        {
            ...
            if(taxamount){
                ...
                total = ((parseFloat(expectedQty) * parseFloat(amount)) - parseFloat(discountamt)); 
            }
    ...
    function cal_discount(element) {
        ...
        if (element.value < 0 || element.value > 100 || element.value == '') {
            ...
            if (estimatedAmount) {
                ...
                $(element).closest('tr').find('.totalcost').val(((parseFloat(estimatedAmount) - parseFloat(discountamount))+ parseFloat(taxamount)).toFixed(currency_decimal));
    ...
    function   grandtotal() {
        ...
        $('#salesquotation_body tr').each(function () {
            ...
            if(tot_valueta){
                ...
                tot_grandtotal += ((parseFloat(tot_valuesub) - parseFloat(tot_valuedis)));
            }
        ...
        if (element.value > total) {
            ...
            if (total) {
                ...
                if(taxamount){
                    ...
                    total1 = ((parseFloat(expectedQty) * parseFloat(amount)) - parseFloat(discountamt));
                }
                
                $(element).closest('tr').find('.discount').val(((parseFloat(element.value) / total) * 100).toFixed(3))

                $(element).closest('tr').find('.totalcost').val(parseFloat(total1).toFixed(currency_decimal));
            }
        }
    }
