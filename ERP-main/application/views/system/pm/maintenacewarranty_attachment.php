...
?>
<div class="row">
    <?php echo form_open_multipart('', 'id="mw_attachment_form" class="form-inline"'); ?>
    <div class="col-sm-12" style="margin-left: 3%">
        <div class="col-sm-4">
            <div class="form-group">
                <input type="text" class="form-control" id="mwattachmentDescription"
                       name="attachmentDescription" placeholder="Description..." style="width: 240%;">
                <input type="hidden" class="form-control" id="mw_documentID" name="documentID" value="PROMW">
                <input type="hidden" class="form-control" id="mw_document_name" name="document_name"
                       value="COMPLETION CERTIFICATE ATTACHMENTT">
                <input type="hidden" class="form-control" id="mw_documentSystemCode" name="documentSystemCode" value="<?php echo $headerID ?>">
        ...
        <div class="col-sm-4" style="margin-top: -8px;">
            ...
            <button type="button" class="btn btn-default" onclick="document_uplode_mw()"><span
