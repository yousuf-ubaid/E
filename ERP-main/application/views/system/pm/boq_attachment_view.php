...
<br>
<div class="row">
    <?php echo form_open_multipart('', 'id="boq_attachment_form" class="form-inline"'); ?>
    <div class="col-sm-12" style="margin-left: 3%">
        <div class="col-sm-4">
            <div class="form-group">
                <input type="text" class="form-control" id="boqattachmentDescription"
                       name="attachmentDescription" placeholder="Description..." style="width: 240%;">
                <input type="hidden" class="form-control" id="boq_documentID" name="documentID" value="PROBOQ">
                <input type="hidden" class="form-control" id="boq_document_name" name="document_name"
                       value="BOQ ATTACHMENTS">
                <input type="hidden" class="form-control" id="boq_documentSystemCode" name="documentSystemCode" value="<?php echo $headerID ?>">
        ...
        <div class="col-sm-4" style="margin-top: -8px;">
            ...
            <button type="button" class="btn btn-default" onclick="document_uplode_boq()"><span
    ...
    <div class="col-sm-8" style="margin-left: 3%">
        ...
        { 
            ...
            $link = base_url().$val['myFileName'];
                    ...
                    <a target="_blank" href="<?php echo $link?>" ><i class="fa fa-download" aria-hidden="true"></i></a> &nbsp; | &nbsp; <a onclick="delete_eoi_attachment('<?php echo $val['attachmentID']?> . ','<?php echo $val['myFileName']?>')"><span title="" rel="tooltip" class="glyphicon glyphicon-trash" style="color:rgb(209, 91, 71);" data-original-title="Delete"></span></a></td>
...
<script type="text/javascript">
    function document_uplode_boq()
    {
        var formData = new FormData($("#boq_attachment_form")[0]);
        $.ajax({
            type: 'POST',
            dataType: 'JSON',
