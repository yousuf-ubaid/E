...
$title = $this->lang->line('sales_markating_transaction_contract');
...
$documenttype = fetch_contract_type();
?>
...
<div id="filter-panel" class="collapse filter-panel">
    <div class="row">
        ...
        <div class="form-group col-sm-2">
            ...
            <?php echo form_dropdown('contractType[]', $documenttype, '', 'class="form-control" id="contractType" onchange="Otable.draw();" multiple="multiple"'); ?>
          </div>
        <div class="form-group col-sm-4">
...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary-new size-sm pull-right" onclick="fetchPage('system/quotation_contract/erp_quotation_contract_job',null,'Add New Quotation or Contract','CNT');"><i class="fa fa-plus"></i> <?php echo $this->lang->line('sales_markating_transaction_create');?> </button><!--Create-->
    </div>
</div><hr>
...
$(document).ready(function() {
    ...
    $('.headerclose').click(function(){
        fetchPage('system/quotation_contract/quotation_contract_job_management','','Contracts');
    });
...
function quotation_contract_table(selectedID=null){
    Otable = $('#quotation_contract_table').DataTable({
        ...
        "fnServerData": function (sSource, aoData, fnCallback) {
            ...
            aoData.push({"name": "contractType", "value": ''});
            aoData.push({"name": "contractView", "value": 'advance'});
            aoData.push({"name": "isAdvance", "value": 1});
            $.ajax({
                'dataType': 'json',
                'type': 'POST',
                'url': sSource,
