...
<div class="table-responsive">
    <table id="quotation_contract_approval_table" class="<?php echo table_class() ?>">
        ...
        <tr>
            ...
            <th style="min-width: 30%"> Reference Number</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/quotation_contract/quotation_contract_approval_NH', '', 'Quotation / contract');
        });
        ...
        $('#quotation_contract_approval_form').bootstrapValidator({
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: data,
                url: "<?php echo site_url('Quotation_contract/save_quotation_contract_approval_nh'); ?>",
                beforeSend: function () {
                    startLoad();
                },
    ...
    function quotation_contract_table() {
         Otable = $('#quotation_contract_approval_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Quotation_contract/fetch_quotation_contract_approval_nh'); ?>",
            "aaSorting": [[0, 'desc']],
