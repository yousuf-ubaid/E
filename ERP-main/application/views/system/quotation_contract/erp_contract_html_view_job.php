...
<div class="table-responsive">
    <table class="table table-bordered table-striped">
        ...
        <tr>
            ...
            ?>
            <th style="min-width: 50%" class='theadtr' colspan="11"><?php echo $this->lang->line('sales_markating_view_invoice_item_details');?> </th><!--Item Details-->
                <?php
            }else{
            ?>
            ...
            <?php  if($extra['master']['isGroupBasedTax'] == 1){ ?>
                <th style="min-width: 50%" class='theadtr' colspan="11"><?php echo $this->lang->line('common_price');?><!--Price --><?php echo '( ' . $extra['master']['transactionCurrency'] . ' )'; ?></th>
            <?php }else{ ?>
        ...
        <tr>
            ...
            <th style="min-width: 30%" class="text-left theadtr">Product/Service</th>
            <th style="min-width: 30%" class="text-left theadtr">Main Category</th>
            <th style="min-width: 30%" class="text-left theadtr">Sub Category </th>
            <th style="min-width: 30%" class="text-left theadtr">Revenue GL Code </th>
            <th style="min-width: 30%" class="text-left theadtr">Cost GL Code</th>
        ...
        if (!empty($extra['detail'])) {
            foreach ($extra['detail'] as $val) { ?>
                <tr>
                    ...
                    <td><?php echo $val['itemReferenceNo'] . ' - ' . $val['comment']; ?></td>

                    <?php if($val['pOrService'] ==1){ ?>

                        <td><?php echo "Product" ?></td>
                    <?php } elseif($val['pOrService'] ==2){ ?>
                    ...
                    <td><?php echo $val['revanuedes'] ?></td>
                    <td><?php echo $val['costdes'] ?></td>
                    ...
                    <?php  if($extra['master']['isGroupBasedTax'] == 1){ ?>
                        ...
                        <td class="text-right">
                            <?php echo ' <a onclick="open_tax_dd(null,'.$val['contractAutoID'].',\'CNT\','. $extra['master']['transactionCurrencyDecimalPlaces'].' ,'. $val['contractDetailsAutoID'].', \'srp_erp_contractdetails\',\'contractDetailsAutoID\',0,1) ">'. number_format($val['taxAmount'], $extra['master']['transactionCurrencyDecimalPlaces']).'</a>';
        ...
        <!-- <tr>
            ...
            if($extra['master']['showImageYN']==1){ 
                if($extra['master']['isGroupBasedTax'] == 1){?>
                    <td style="min-width: 85%  !important" class="text-right sub_total" colspan="11"><?php echo $this->lang->line('common_total');?><?php echo '( ' . $extra['master']['transactionCurrency'] . ' )'; ?></td>
            <?php 
                }else{ ?>
                ...
                if($extra['master']['isGroupBasedTax'] == 1){?>
                    <td style="min-width: 85%  !important" class="text-right sub_total" colspan="10"><?php echo $this->lang->line('common_total');?> <?php echo '( ' . $extra['master']['transactionCurrency'] . ' )'; ?></td>
            <?php 
                } else { ?>
...
<div class="table-responsive">
    <!-- <h5 class="text-right"> <?php echo $this->lang->line('common_total');?> (<?php echo $extra['master']['transactionCurrency']; ?> )
