...
<table style="width: 100%">
    ...
    $html .= '<tr>
            ...
            <tr>
                ...
                <td><strong>:</strong></td>
                <td> '. $extra['master']['wareHouseDescription'].'</td>
            </tr>
            <tr>
                ...
                <td colspan="4"> 
                     <table>
                           <tr>
                               <td>'. str_replace(PHP_EOL, '<br /> ',  $extra['master']['contractNarration']).'</td>
                           </tr>
                     </table>
                </td>
            </tr>
        ...
        if($extra['master']['showImageYN']==1){
            $hedcolspan="6";
            $imagede='<th class="theadtr" style="width: 7%">Item Image</th>';
        }else{
            $hedcolspan="5";
            $imagede='';
        }
...
$html .= '
    <table class="table" style="width: 100%;">
        ...
        <tr>
         ...
         $html .= '</tr>
        <tr>
               $html .= <th style="width: 4%" class="theadtr">#</th>
            '.$imagede.'
            ...
            <th style="width: 5%" class="theadtr">'. $this->lang->line('common_qty').'</th><!--Qty-->
            ...
            foreach ($extra['detail'] as $val) {
                if($extra['master']['showImageYN']==1){
                    if(!empty($val['itemImage'])){
                        $imagetd='<td class="text-center"><a class="thumbnail_custom"><img style="width:300px;" src="'.$this->s3->createPresignedRequest('uploads/itemMaster/'.$val['itemImage'], '1 hour').'" class="imgThumb img-rounded"/></a></td>';
                    }else{
                        $imagetd='<td class="text-center"><a class="thumbnail_custom"><img style="width:300px;" src="'.$this->s3->createPresignedRequest('images/item/no-image.png', '1 hour').'" class="imgThumb img-rounded"/></a></td>';
                    }
                }else{
                    $imagetd='';
                }
                $html .= '<tr>
                    ...
                    '.$imagetd.'
                    <td class="text-center" style="font-size: 12px;">'. $val['itemSystemCode'].'</td>
                    <td style="font-size: 12px;">'. wordwrap($val['itemDescription'],50,"<br>\n") .' - '. $val['comment'].'</td>
