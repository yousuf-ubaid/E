...
$html .= '
    <table class="table" style="width: 100%;">
        ...
        <tr>
            ...
            <th style="width: 5%" class="theadtr">Product/Service</th>
            <th style="width: 5%" class="theadtr">Main Category </th>
            <th style="width: 5%" class="theadtr">Sub Category </th>
            <th style="width: 5%" class="theadtr">Revenue GL Code </th>
            <th style="width: 5%" class="theadtr">Cost GL Code</th>
    ...
    if (!empty($extra['detail'])) {
        foreach ($extra['detail'] as $val) {
            ...
            '.$imagetd.'
            <td class="text-center" style="font-size: 12px;width:15%" >'. $val['typeItemName'].'</td>
            <td style="font-size: 12px;width:30%">'. wordwrap($val['itemReferenceNo'],250,"<br>\n") .' - '. $val['comment'].'</td>

            <td class="text-center" style="font-size: 12px;">'. $porservice.'</td>
            <td class="text-center" style="font-size: 12px;">'. $val['mainCategory'].'</td>
            <td class="text-center" style="font-size: 12px;">'. $val['subCategory'].'</td>
            <td class="text-center" style="font-size: 12px;">'. $val['revanuedes'].'</td>
            <td class="text-center" style="font-size: 12px;">'. $val['costdes'].'</td>
