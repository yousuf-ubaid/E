...
<script type="text/javascript">
    ...
    function generatePvvoucher(voucherid, transactionAmount, vouchername, type) {
            ...
            function () {
                $.ajax({
                    ...
                    type: 'post',
                    dataType: 'json',
                    data: {'iouvoucherid': voucherid,'type':'1'},
                    url: "<?php echo site_url('Iou/save_iou_voucher_pv_approval'); ?>",
                    beforeSend: function () {
                        startLoad();
                    },
                    success: function (data) {
                        stopLoad();
                        if(data){
                            myAlert('s', 'Payemnt voucher saved successfully.');
                            getiouvouchertable();
                            refreshNotifications(true);
                        
                        }else{
                            myAlert('w', 'Something went wrong.');
                        }
