...
echo head_page($this->lang->line('iou_booking_approval'), false);
?>
...
<div class="table-responsive">
    <table id="Return_table" class="<?php echo table_class() ?>">
        ...
        <tr>
            ...
            <th style="min-width: 20%"><?php echo $this->lang->line('iou_booking_date'); ?></th>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('iou_expense_approval'); ?></h4>
            </div>
                    ...
                    <div class="col-sm-1">
                      ...
                      <!--  <ul class="zx-nav zx-nav-tabs zx-tabs-left zx-vertical-text">
                            <li id="slr_attachement_approval_Tabview_v" class="active">
                                <a href="#Tab-home-v" data-toggle="tab" onclick="tabView()"><?php /*echo $this->lang->line('common_view');*/?></a>
                            </li>-->
                            <!--<li id="slr_attachement_approval_Tabview_a">
                                <a href="#Tab-profile-v" data-toggle="tab" onclick="tabAttachement()"> <?php /*echo $this->lang->line('common_attachment');*/?></a>
                            </li>-->
                       <!-- </ul>-->
                    </div>
                    <div class="col-sm-11">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/iou/iou_booking_approval', '', '<?php echo $this->lang->line('iou_booking_approval') ?>')
        });
        Return_table();
        $('#iou_booking_form').bootstrapValidator({
            ...
            fields: {
                ...
                ioubookingid: {validators: {notEmpty: {message: "<?php echo $this->lang->line('iou_booking_auto_id_is_required'); ?>"}}},
