...
<div class="m-b-md" id="wizardControl">
    <a class="btn btn-primary" href="#step1" data-toggle="tab"><?php echo $this->lang->line('iou_step_one'); ?> - <?php echo $this->lang->line('iou_iou_voucher_header');?></a>
    <a class="btn btn-default btn-wizard" href="#step2" data-toggle="tab" onclick="load_voucher_expences();"><?php echo $this->lang->line('iou_step_two'); ?> -
        <?php echo $this->lang->line('iou_iou_voucher_expenses'); ?></a>
        ...
        <div class="row">
            <div class="col-md-12 animated zoomIn">
                ...
                <div class="row paymentType hide" style="margin-top: 10px;">
                    ...
                    <div class="form-group col-sm-4">
                        <span class="input-req" title="<?php echo $this->lang->line('iou_required_field'); ?>">
                               <?php echo form_dropdown('paymentType', array('' => $this->lang->line('common_select_type')/*'Select Type'*/, '1' => $this->lang->line('common_cheque') , '2' => $this->lang->line('common_bank_transfer')), ' ', 'class="form-control select2" id="paymentType" onchange="show_payment_method(this.value)" disabled'); ?>
                            <span class="input-req-inner"></span></span>
                    </div>
                ...
                <div class="row" style="margin-top: 10px;">
                    ...
                    <div class="form-group col-sm-2">
                        <label class="title"><?php echo $this->lang->line('common_reference_no'); ?></label>
                    </div>
                    <div class="form-group col-sm-4">
    ...
    <div class="modal-dialog" style="width: 50%;">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-primary" type="button" onclick="save_Voucher_details()"><?php echo $this->lang->line('common_save_change') ?>
                </button>
            </div>
    ...
    <div class="modal-dialog modal-lg" style="width: 80%" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('iou_view_expenses_detail') ?><span class="myModalLabel"></span>
                </h4>
            </div>
            <div class="modal-body">
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('.headerclose').click(function () {
            fetchPage('system/iou/iou_booking_employee', '', '<?php echo $this->lang->line('iou_voucher') ?>' )
        });
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (!jQuery.isEmptyObject(data)) {
                        ...
                        $('#save_btn').html('<?php $this->lang->line('common_update') ?>');
