...
$total= is_decimal($extra['transferedAmount']);
...
<div style="border: 1px solid white;width: 690px; height: 340px;position: absolute;left: 6cm; rotate: 90;" ><!--position: absolute;left: 6cm; rotate: 90;-->
        ...
        <tr>
            ...
            <td style="width:30%;">
                <table >
                    ...
                    <tr>
                        <?php
                        if($extra['accountPayeeOnly'] == 1){/*$extra['accountPayeeOnly']*/
                            ?>
            ...
            <td colspan="9" style="">
                <table>
                    ...
                    <tr>
                        ...
                        <td style="font-size: 1em;font-weight: bold;vertical-align: top;padding-bottom: 16px;"><?php echo $extra['nameOnCheque']; ?> </td>
                    </tr>
                    </tbody>
                </table>
            </td>
    ...
    <table style="text-align: center; margin-left:250px; width:60%; margin-top: 35px;">
        <tbody>
        <tr>
            <?php
