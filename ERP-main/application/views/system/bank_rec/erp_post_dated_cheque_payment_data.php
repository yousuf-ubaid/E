...
echo export_buttons('table1_Issued', 'Issued Postdated cheques', True, False);
?>

<div class="page-header"><h4><?php echo $this->lang->line('treasury_tr_lm_issued_post_dated_cheques');?><!--Issued Postdated cheques--></h4></div>
<table id="table1_Issued" class="<?php echo table_class() ?>">
    <thead>
                    ...
                    if ($reciptHeader['bankGLAutoID'] == $value['bankGLAutoID']) {
                        ...
                        <td style=" width:30px;text-align: center;font-weight: bold">
                          ...
                          $date=date('Y-m-d');
                           ...
                           /* if ($value['chequeDate'] > $value['remainingDays']) { */?>
                                <div style="width:10px; float: right" class="pull-right blink"><i style="color: #b62d34"
