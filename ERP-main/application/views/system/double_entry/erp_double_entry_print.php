                    ...
                    <td style="width:40%;">
                        <table>
                         ...
                         <?php if (!empty($extra['customername'])) {?>
                            ...
                            <?php }?>
                            <?php if (!empty($extra['suppliernamemaster'])) {?>
                                <tr>
                                    <td><strong><?php echo $suppliername; ?></strong></td>
                                    <td><strong>:</strong></td>
                                    <td><?php echo $extra['suppliernamemaster']; ?></td>
                                </tr>
                            <?php }?>
                        </table>
                </td>
    ...
    <table class="table table-bordered table-striped">
        ...
        <?php
            ...
            if (!empty($extra['gl_detail'])) {
                ...
                <tr>
                    ...
                    <td style="text-align:right;"><?php echo format_number(abs((float)$val['gl_dr']), $extra['decimal_places']); ?></td>
                    <td style="text-align:right;"><?php echo format_number(abs((float)$val['gl_cr']), $extra['decimal_places']); ?></td>
                </tr>
                <?php
                    $num ++;
                    $dr_total +=abs((float)$val['gl_dr']);
                    $cr_total +=abs((float)$val['gl_cr']);
                }
            }else{
        ...
        <tfoot>
            <tr>
                ...
                <td class="text-right total" style="text-align:right;"><?php echo format_number($dr_total,$extra['decimal_places']); ?></td>
                <td class="text-right total" style="text-align:right;"><?php echo format_number($cr_total,$extra['decimal_places']); ?></td>
            </tr>
        </tfoot>
    </table>
</div>