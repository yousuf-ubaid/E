                    ...
                    <tr>
                        <td>
                            <table>
                                ...
                                <tr>
                                    <td class="td"
                                        style="text-align: center; padding-left: 0;padding-right: 0; background:#ddd;font-family: arial; font-size: 15px; color: #333;font-weight: 800;">
                                        <strong>Journey Plan Details</strong></td>
                                </tr>
                                </tbody>
                            </table>
                        </td>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td height="25" class="td"
                                        style="text-align: center; background: #ddd;font-weight: 800;"><img
                                                alt="passengers" style="height: 25px"
                                                src="<?php echo base_url("images/journeyplan/passenger.png") ?>">
                                        <strong style="font-family: arial; font-size: 13px; color: #333;"> Number Of
                    ...
                    <tr>
                        <td>
                            <table>
                                <tbody>
                                <tr>
                                    <td class="td" style="text-align: center; background: #ddd;"><strong
                                                style="font-family: arial;font-weight: 800; font-size: 15px; color: #333;">
                    ...
                    <tr>
                        <td>
                            <table>
                                <tbody>
                                <tr>
                                    <td class="td" style="text-align: center; background: #ddd;font-weight: 800;"><img
                                                alt="passengers" style="height: 25px"
                                                src="<?php echo base_url("images/journeyplan/passenger.png") ?>">
                                        <strong style="font-family: arial; font-size: 13px; color: #333;"> Name of
                                            Passaengers</strong></td>
                                </tr>
                    ...
                    <tr>
                        <td>
                            <table>
                                ...
                                <tr>
                                    <td class="td" style="text-align: center; background: #ddd;font-weight: 800;"><img
                                                alt="passengers" style="height: 25px;text-align: left;"
                                                src="<?php echo base_url("images/journeyplan/ringjm.png") ?>"> <strong
                                                style="font-family: arial; font-size: 13px; color: #333;"> Ring Journey
                                            Manager</strong></td>
                                </tr>
                                </tbody>
                            </table>
                    ...
                    <tr>
                        <td>
                            <table>
                                <tbody>
                                <tr>
                                    <td class="td" style="text-align: center; background: #ddd;font-weight: 800;">
                                        <strong style="font-family: arial; font-size: 13px; color: #333;"> Journey
                                            Manager Remarks</strong></td>
                                </tr>
                                </tbody>
                            </table>
                        </td>
                        ...
                        <tr>
                            <td style='border-width:thin;height:40px;border: 1px solid #ddd;border-top: 0;'>
                                <table>
                                    ...
                                    <tr>
                                        <td style="font-size: 11px;font-weight: 800;"><b>Counselling for Drivers</b>
                                        </td>
                                        <td>:</td>
                        ...
                        <tr>
                            <td style='border-width:thin;height:30px;border: 1px solid #ddd;;'>
                                <table>
                                    <tbody>
                                    <tr>
                                        <td style="font-size: 9px;font-weight: 800;"><b>if you speed,death may overtake
                                                you.</b></td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 9px;font-weight: 800;"><b>Ensure that seat belts are worn
                                                by all.</b></td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 9px;font-weight: 800;"><b>Road signs must be obeyed.</b>
                                        </td>
                                    </tr>
                    ...
                    <tr>
                        <td>
                            <table>
                                ...
                                <tr>
                                    <td class="td" style="text-align: center; background: #ddd;font-weight: 800;">
                                        <strong style="font-family: arial; font-size: 13px; color: #333;"> Comment For
                                            Drivers</strong></td>
                                </tr>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td style="font-size: 11px;font-weight: 800;">
                                            <b><?php echo $extra['detail']['commentsForDriver'] ?></b></td>
                                    </tr>
                        ...
                        <tr>
                            <td style='border-width:thin;height:10px;border: 1px solid #ddd;;'>
                                <table>
                                    ...
                                    <tr>
                                        <td style="font-size: 11px;font-weight: 800;text-align: center;"><b>...................................................</b>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="font-size: 11px;font-weight: 800;text-align: center;"><b>Drivers
                                                Signature</b></td>
                                    </tr>
                                    </tbody>
                                </table>
                    ...
                    <tr>
                        <td>
                            <table>
                                <tbody>
                                <tr>
                                    <td height="25" class="td" style="text-align: center; background: #ddd;"><strong
                                                style="font-family: arial;font-weight: 800; font-size: 15px; color: #333;">
                                            Reasons for Night Driving</strong></td>
                                </tr>
                        ...
                        <tr>
                            <td style='border-width:thin;height:40px;border: 1px solid #ddd;border-top: 0;'>
                                <table>
                                    ...
                                    <tr>
                                        <td class="td"
                                            style=" font-weight: 800;">  <?php echo $extra['detail']['reasonForNightDriving'] ?></td>
                                    </tbody>
                                </table>
                            </td>
                        </tr>
