...
<div class="row">
    <div class="col-md-12 animated zoomIn">
        ...
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="form-group col-sm-4">
                        <span class="input-req" title="Required Field">
                <?php echo form_dropdown('tourType', $tour_arr, '', 'class="form-control select2" id="tourType" required disabled'); ?>
        ...
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="form-group col-sm-4">
                <div class="input-group pickuptimePicker">
                    <input type="text" class="form-control " name="pickupTime" id="pickupTime" readonly /><span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>
                </div>
            </div>
        </div>
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="form-group col-sm-4">
                <input type="text" class="form-control" id="guestName" name="guestName" placeholder="Guest Name" readonly>
            </div>
            ...
            <div class="form-group col-sm-4">
                       ...
                       <input type="text" class="form-control" id="noofpassengers" name="noofpassengers"
                              placeholder="No Of Passengers" readonly>
                           <span class="input-req-inner" style="z-index: 100"></span></span>
            </div>
        </div>
        <div class="row" style="margin-top: 10px;">
        ...
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="form-group col-sm-4">
                        <span class="input-req" title="Required Field">
              <input type="text" class="form-control" id="guideName" name="guideName" placeholder="Guide Name" readonly>
                            <span class="input-req-inner"></span>
            </div>
            <div class="form-group col-sm-2">
            ...
            <div class="form-group col-sm-4">
                <input type="text" class="form-control" id="guideNumber" name="guideNumber" placeholder="Guide Phone Number" readonly>
                <span class="input-req-inner"></span>
            </div>
        </div>
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="form-group col-sm-4">
                <input type="text" class="form-control" id="villaHost" name="villaHost" placeholder="Villa Host OR Agent Name" readonly>
            </div>
            <div class="form-group col-sm-2">
                <label class="title">Room No</label>
            </div>
            <div class="form-group col-sm-4">
                <input type="text" class="form-control" id="roomNo" name="roomNo" placeholder="Guide Phone Number" readonly>
            </div>
        </div>
        <div class="row" style="margin-top: 10px;">
            <div class="form-group col-sm-2">
        ...
        <div class="row" style="margin-top: 10px;">
            ...
            <div class="form-group col-sm-4">
                <?php echo form_dropdown('transactionCurrencyID', $currency_arr, '', 'class="form-control select2" id="transactionCurrencyID" disabled required'); ?>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12" >
                <fieldset>
                    ...
                    <div class="col-md-3"><label>Vehicle Number</label>

                            <input type="text" class="form-control" id="vehiclenumber" name="vehiclenumber" required readonly>
                ...
                success: function (data) {
                    ...
                    if (!jQuery.isEmptyObject(data)) {
                        ...
                        if (data["vehicleID"] > 0) {
                            ...
                            $('#vehiclenumber').val(data['vehicleNumber']);
                            $("#ivmsnumber").html(data['ivmsNumber']);
                        }
