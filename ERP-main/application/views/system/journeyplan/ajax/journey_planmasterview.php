            ...
            <tr>
                ...
                <td class="mailbox-name"><a href="#">
                      <?php if($val['approvedYN']!=1 && $val['confirmedYN'] != 1){?>
                        ...
                        <a href="#"
                           onclick="fetchPage('system/journeyplan/create_journey_plan','<?php echo $val['journeyPlanMasterID'] ?>','Edit Journey Plan')"><span
                        ...
                        <?php if($val['approvedYN'] == 1 || $val['confirmedYN'] == 1){?>
                            <a href="#"
                               onclick="fetchPage('system/journeyplan/create_journey_plan_approval','<?php echo $val['journeyPlanMasterID'] ?>','View Journey Plan')"><span
                       ...
                       &nbsp;<a target="_blank" href="<?php echo site_url('Journeyplan/load_jp_view/') . '/' . $val['journeyPlanMasterID'] ?>"><span
