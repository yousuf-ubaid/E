...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/journeyplan/journey_plan_approval', '', 'Journey Plan Approval')
        });
        Return_table();
    ...
    function Return_table() {
        Otable = $('#Return_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Journeyplan/jp_approval'); ?>",
            "aaSorting": [[1, 'desc']],
    ...
    function fetch_approval(jurneyplanid, documentApprovedID, Level) {
        if (jurneyplanid) {
            $.ajax({
                async: true,
                type: 'post',
