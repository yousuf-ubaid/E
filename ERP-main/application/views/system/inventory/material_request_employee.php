...
$title = $this->lang->line('transaction_material_request');
...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary pull-right" onclick="fetchPage('system/inventory/erp_material_request_employee',null,' <?php echo $this->lang->line('inventory_add_new_material_request');?>','MR');"><i class="fa fa-plus"></i> <?php echo $this->lang->line('inventory_create_material_request');?><!--Create Material Request--></button>
    </div>
</div><hr>
...
$(document).ready(function() {
    $('.headerclose').click(function(){
        fetchPage('system/inventory/erp_material_request_employee','Test','Material Request');
...
function material_request_table(selectedID=null){
     Otable = $('#material_request_master_table').DataTable({
        ...
        "bDestroy": true,
        "bStateSave": true,
        "sAjaxSource": "<?php echo site_url('Inventory/fetch_material_request_employee'); ?>",
        "aaSorting": [[0, 'desc']],
        ...
        "columnDefs": [{"targets": [5], "orderable": false},{"visible":false,"searchable": false,"targets": [6,7,8,9,10] }, {"searchable": false, "targets": [0]},{"visible":false,"searchable": true,"targets": [11] }],
