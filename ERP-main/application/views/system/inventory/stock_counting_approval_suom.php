...
echo head_page('Stock Counting Approval', false);
...
<div class="table-responsive">
    <table id="stock_counting_table" class="<?php echo table_class() ?>">
        ...
        <tr>
            ...
            <th style="min-width: 10%"> SCNT Code </th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/inventory/stock_counting_approval_suom', 'Test', 'Stock Counting Approval');
        });
    ...
    function stock_counting_table() {
         Otable = $('#stock_counting_table').DataTable({
            ...
            "aoColumns": [
             ...
             "columnDefs": [{"targets": [7], "orderable": false},{"visible":false,"searchable": true,"targets": [8,9,10] }],
    ...
    function fetch_approval(stockCountingAutoID, documentApprovedID, Level) {
        if (stockCountingAutoID) {
            $.ajax({
                ...
                url: "<?php echo site_url('StockCounting/load_stock_counting_approval_conformation_suom'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
