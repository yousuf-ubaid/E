...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary pull-right" onclick="fetchPage('system/inventory/erp_material_request',null,' <?php echo $this->lang->line('inventory_add_new_material_request');?>','MR');"><i class="fa fa-plus"></i> <?php echo $this->lang->line('inventory_create_material_request');?><!--Create Material Request--></button>
    </div>
</div><hr>
