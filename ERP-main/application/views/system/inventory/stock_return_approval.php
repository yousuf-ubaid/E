...
$title = $this->lang->line('transaction_purchase_return_approval');
echo head_page($title, false);


/*echo head_page('Purchase Return Approval', false); */?>
...
<div class="table-responsive">
    <table id="stock_return_table" class="<?php echo table_class() ?>">
        <thead>
        <tr>
            <th style="min-width: 5%">#</th>
            <th style="min-width: 10%"> <?php echo $this->lang->line('transaction_sr_transfer');?> </th><!--SR Code-->
...
<div class="modal fade" id="stock_return_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                        aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('transaction_purchase_return_approval');?></h4><!--Purchase Return Approval-->
            </div>
                ...
                <div class="modal-body">
                    <div class="col-sm-1">
                        ...
                        <ul class="zx-nav zx-nav-tabs zx-tabs-left zx-vertical-text">
                            ...
                            <li id="po_attachement_approval_Tabview_a"><a href="#Tab-profile-v" data-toggle="tab" onclick="tabAttachement()"><?php echo $this->lang->line('common_attachment');?></a><!--Attachment-->
                            </li>
                        </ul>
                    </div>
                    <div class="col-sm-11">
                        <div class="zx-tab-content">
                            <div class="zx-tab-pane active" id="Tab-home-v">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="hidden" name="stockReturnAutoID" id="stockReturnAutoID">
                            ...
                            <div class="tab-pane hide" id="Tab-profile-v">
                                <div class="table-responsive">
                                    ...
                                    &nbsp <strong><?php echo $this->lang->line('transaction_purchase_return_attachment');?></strong><!--Purchase Return Attachments-->
                                    <br><br>
                                    <table class="table table-striped table-condensed table-hover">
                                        ...
                                        <tbody id="sr_attachment_body" class="no-padding">
                                        <tr class="danger">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/inventory/stock_return_approval', 'Test', 'Purchase Return Approval');
        });
        stock_return_table();
        $('#MI_approval_form').bootstrapValidator({
            ...
            fields: {
                ...
                stockReturnAutoID: {validators: {notEmpty: {message: '<?php echo $this->lang->line('transaction_purchase_return_id');?>.'}}},/*Purchase Return ID is required*/
    ...
    function stock_return_table() {
        Otable = $('#stock_return_table').DataTable({
            "language": {
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Inventory/fetch_stock_return_approval'); ?>",
            "aaSorting": [[1, 'desc']],
    ...
    function fetch_approval(stockReturnAutoID, documentApprovedID, Level) {
        if (stockReturnAutoID) {
            $.ajax({
                async: true,
                type: 'post',
                dataType: 'html',
                data: {'stockReturnAutoID': stockReturnAutoID, 'html': true,'approval': 1},
                url: "<?php echo site_url('Inventory/load_stock_return_conformation'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
                    $('#stockReturnAutoID').val(stockReturnAutoID);
                    $('#documentApprovedID').val(documentApprovedID);
                    $('#Level').val(Level);
                    $("#stock_return_modal").modal({backdrop: "static"});
                    $('#conform_body').html(data);
                    $('#comments').val('');
                    purchaseReturn_attachment_View_modal('SR', stockReturnAutoID);
                    stopLoad();
                    refreshNotifications(true);
                }, error: function () {
                    stopLoad();
    ...
    function purchaseReturn_attachment_View_modal(documentID, documentSystemCode) {
        $("#Tab-profile-v").removeClass("active");
        $("#Tab-home-v").addClass("active");
        $("#sr_attachement_approval_Tabview_a").removeClass("active");
        $("#sr_attachement_approval_Tabview_v").addClass("active");
        if (documentSystemCode) {
            $.ajax({
                ...
                success: function (data) {
                    $('#sr_attachment_body').empty();
                    $('#sr_attachment_body').append('' +data+ '');
