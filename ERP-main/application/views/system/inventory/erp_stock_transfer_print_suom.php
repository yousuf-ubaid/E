...
<div class="table-responsive">
    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            if (!empty($extra['detail'])) {
                ...
                <tr>
                    ...
                    <td style="text-align:right;"><?php echo $val['unitOfMeasure']; ?> &nbsp; <?php echo $val['transfer_QTY']; ?>  <br> <?php echo $val['secuom']; ?> &nbsp; <?php echo $val['SUOMQty']; ?> </td>
        ...
        <tfoot>
            <tr>
                <td class="text-right sub_total" colspan="5"><?php echo $this->lang->line('transaction_common_item_total');?> (<?php echo $extra['master']['companyLocalCurrency']; ?>)</td><!--Item Total-->
