...
echo head_page('Stock Counting', true);
...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary pull-right"
                onclick="fetchPage('system/inventory/erp_stock_counting_suom',null,'Create Stock Counting','SCNT');"><i
                class="fa fa-plus"></i> Create Stock Counting
        </button>
</div>
</div>
<hr>
<div class="table-responsive">
    <table id="stock_counting_table" class="<?php echo table_class(); ?>">
        ...
        <tr>
            ...
            <th style="min-width: 15%">SCNT Code</th>
            <th style="min-width: 10%">Date </th>
            <th style="min-width: 25%">Location </th>
            <th style="min-width: 20%">Comments</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/inventory/stock_counting_management_suom', 'Test', 'Stock Counting');
        });
    ...
    function stock_counting_table(selectedID=null) {
         Otable = $('#stock_counting_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('StockCounting/fetch_stock_counting_table_suom'); ?>",
            "aaSorting": [[0, 'desc']],
