...
<!--            <div class="form-group col-sm-4">
            ...
            <div class="form-group col-sm-4">
                <label
                    for=""><?php echo $this->lang->line('common_date');?><!--Requested Date--><?php required_mark(); ?></label>
        ...
        <div class="row">
            <div class="form-group col-sm-4">
                <label
                    for=""><?php echo $this->lang->line('common_from_date');?><!--Requested Date--><?php required_mark(); ?></label>
                <div class="input-group datepic">
                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                    <input type="text" name="fromDate" data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                           value="<?php echo $current_date; ?>" id="fromDate"
                           class="form-control" required>
                </div>
            </div>
            <div class="form-group col-sm-4">
                <label
                    for=""><?php echo $this->lang->line('common_to_date');?><!--Requested Date--><?php required_mark(); ?></label>
                <div class="input-group datepic">
                    <div class="input-group-addon"><i class="fa fa-calendar"></i></div>
                    <input type="text" name="toDate" data-inputmask="'alias': '<?php echo $date_format_policy ?>'"
                           value="<?php echo $current_date; ?>" id="toDate"
                           class="form-control" required>
                </div>
            </div>
            ...
            <div class="form-group col-sm-4">
                <label for="transactionCurrencyID">
                    <?php echo $this->lang->line('common_currency'); ?><!--Supplier Currency--> <?php required_mark(); ?></label>
                <?php echo form_dropdown('transactionCurrencyID', $currency_arr, '', 'class="form-control select2" id="transactionCurrencyID" onchange=""') ?>
            </div>
    ...
    <div id="step2" class="tab-pane">
        ...
        <table class="<?php echo table_class(); ?>">
            ...
            <tr>
                ...
                <th style="min-width: 10%"><?php echo $this->lang->line('common_price');?> </th><!--UOM-->
                <th style="min-width: 10%"><?php echo $this->lang->line('common_comment');?> </th><!--UOM-->
<!--                <th style="min-width: 10%">WAC </th>
    ...
    <div id="step3" class="tab-pane">
        ...
        <hr>
        <div class="hide" id="conform_body_attachement">
                ...
                <form role="form" id="item_detail_form" class="form-horizontal">
                    <table class="table table-bordered table-condensed no-color" id="MaterialIssue_detail_add_table">
                        ...
                        <tr>
                            ...
                            <th style="width: 200px;"><?php echo $this->lang->line('common_price'); ?> <!--Comment--> </th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="input-group" style="width: 100%">
                                    <input type="text" name="salesPrice[]" class="form-control salesPrice" required>
                                </div>
                            </td>
                ...
                <form role="form" id="edit_item_detail_form" class="form-horizontal">
                    <table class="table table-bordered table-condensed no-color" id="MaterialIssue_detail_edit_table">
                        ...
                        <tr>
                            ...
                            <th style="width: 150px;"><?php echo $this->lang->line('common_price'); ?>
                            <th style="width: 200px;"><?php echo $this->lang->line('common_comment'); ?> <!--Comment--> </th>
                        </tr>
                        </thead>
                        <tbody>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" name="salesPrice[]"
                                           class="form-control" id="salesPrice" required readonly>
                                </div>
                            </td>
<!--                            <td>
                ...
                <form role="form" id="edit_all_item_detail_form" class="form-horizontal">
                    <table class="table table-bordered table-condensed no-color" id="MaterialIssue_detail_all_edit_table">
                        ...
                        <tr>
                            <th style="width: 250px;"><?php echo $this->lang->line('transaction_common_item_code'); ?> <!--Item Code-->  <?php required_mark(); ?></th>
                            <th style="width: 150px;"><?php echo $this->lang->line('common_uom'); ?> <!--UOM --> <?php required_mark(); ?></th>
                            <th style="width: 150px;"><?php echo $this->lang->line('transaction_price'); ?> <!--Requested Qty-->  <?php required_mark(); ?></th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        if (p_id) {
            mrAutoID = p_id;
            load_inventory_catalogue_header();
            $("#a_link").attr("href", "<?php echo site_url('Inventory/load_inventory_catalogue_conformation'); ?>/" + mrAutoID);
        ...
        $('#material_request_form').bootstrapValidator({
            ...
            $.ajax({
                ...
                dataType: 'json',
                data: data,
                url: "<?php echo site_url('Inventory/save_inventory_catalogue_header'); ?>",
                beforeSend: function () {
                    startLoad();
                },
    ...
    function load_inventory_catalogue_header() {
        if (mrAutoID) {
            $.ajax({
                ...
                url: "<?php echo site_url('Inventory/load_inventory_catalogue_header'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
    ...
    function fetch_material_request_detail() {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: {'mrAutoID': mrAutoID},
            url: "<?php echo site_url('Inventory/fetch_inventory_catalogue_details'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
                ...
                if (jQuery.isEmptyObject(data['detail'])) {
                    ...
                    $.each(data['detail'], function (key, value) {
                        ...
                        if (value['isSubitemExist'] == 1) {
                            ...
                            string = '<tr><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td>' + value['itemDescription'] + comment + '</td><td class="text-center">' + value['unitOfMeasure'] + '</td><td class="text-right">' + parseFloat(value['transactionAmount']).formatMoney(currency_decimal, '.', ',') + '</td><td class="text-right">' + value['comments'] + '</td><td class="text-right"> &nbsp;&nbsp;<a onclick="edit_item(' + value['mrDetailID'] + ',this);"><span class="glyphicon glyphicon-pencil"></span></a> &nbsp;&nbsp; |&nbsp;&nbsp; <a onclick="delete_item(' + value['mrDetailID'] + ');"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td></tr>';
                        } else {
...
/*                $('#table_tfoot').html('<tr> <td class="text-right" colspan="4"><?php echo $this->lang->line('common_total');?></td><td class="text-right total">' + total.formatMoney(currency_decimal, '.', ',') + '</td><td></td></tr>');*/
    ...
    function load_conformation() {
        if (mrAutoID) {
            $.ajax({
                ...
                url: "<?php echo site_url('Inventory/load_inventory_catalogue_conformation'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
            ...
            swal({
                ...
                function () {
                    $.ajax({
                        ...
                        dataType: 'json',
                        data: {'mrAutoID': mrAutoID},
                        url: "<?php echo site_url('Inventory/inventory_catalogue_confirmation'); ?>",
                        beforeSend: function () {
                            startLoad();
                        },
                        success: function (data) {
                            ...
                            refreshNotifications(true);
                            if(data) {
                                fetchPage('system/inventory/inventory_catalogue_management','Test','Inventory Catalogue');
                            }
    ...
    function save_draft() {
        if (mrAutoID) {
            swal({
                ...
                function () {
                    fetchPage('system/inventory/inventory_catalogue_management', mrAutoID, 'Inventory Catalogue');
                });
        }
    }
            ...
            swal({
                ...
                function () {
                    $.ajax({
                        ...
                        dataType: 'json',
                        data: {'mrDetailID': id},
                        url: "<?php echo site_url('Inventory/delete_inventory_catalogue_item'); ?>",
                        beforeSend: function () {
                            startLoad();
                        },
                        success: function (data) {
    ...
    function saveMaterialIssue_addItem() {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: data,
            url: "<?php echo site_url('Inventory/save_inventory_catalogue_detail_multiple'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
