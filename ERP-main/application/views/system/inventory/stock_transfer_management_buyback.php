...
echo head_page('Stock Transfer - Buyback', true);
...
<div class="row">
    ...
    <div class="col-md-3 text-right">
        <button type="button" class="btn btn-primary pull-right"
                onclick="fetchPage('system/inventory/erp_stock_transfer_buyback',null,'Add New Stock Transfer','GRV');"><i
    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Stock Transfer Template</h4>
            </div>
            <div class="modal-body">
                <input type="hidden" id="stockTransferAutoID">
                <div class="row">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-sm" onclick="print_stocktransfer_temp()">Print</button>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/inventory/stock_transfer_management_buyback', 'Test', 'Stock Transfer - Buyback');
        });
        grvAutoID = null;
        number_validation();
    ...
    function stock_transfer_table(selectedID=null) {
         Otable = $('#stock_transfer_master_table').DataTable({
            ...
            "bDestroy": true,
            "bStateSave": true,
            "sAjaxSource": "<?php echo site_url('Inventory/fetch_stock_transfer_buyback'); ?>",
            "aaSorting": [[0, 'desc']],
    ...
    function load_printtemp(stockTransferAutoID)
    {
        $('#printSize').val(1);
        $('#stockTransferAutoID').val(stockTransferAutoID);
        $('#print_temp_modal').modal('show');
    }
    function print_stocktransfer_temp(){
        var printSize =  $('#printSize').val();
        var stockTransferAutoID =   $('#stockTransferAutoID').val();

        if(stockTransferAutoID==''){
            myAlert('e', 'Select Print Type');
        }else{
            window.open("<?php echo site_url('Inventory/load_stock_transfer_conformation_buyback') ?>" +'/'+ stockTransferAutoID +'/'+ printSize +'/'+1);
        }
    }
</script>