...
<div class="tab-content">
    <div id="step1" class="tab-pane active">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-4">
                <label><?php echo $this->lang->line('transaction_common_narration');?> <?php required_mark(); ?></label><!--Narration-->
    ...
    <div id="step2" class="tab-pane">
        ...
        <table class="<?php echo table_class(); ?>">
            ...
            <tr>
                ...
                <th style="min-width: 10%">Net Weight</th><!--QTY-->
                    ...
                    <table class="table table-bordered table-condensed no-color" id="StockTransfer_detail_add_table">
                        ...
                        <tr>
                            ...
                            <td><input type="text" onfocus="this.select();" name="noOfItems[]"
                                                         onkeyup="checkCurrentStock_buyback(this)" placeholder="0.00"
                                                         class="form-control number input-mini noOfItems" required>
                            </td>
                            <td><input type="text" onfocus="this.select();" name="grossQty[]"
                                                         onkeyup="checkCurrentStock_buyback(this),cal_deduction_netQty(this)" placeholder="0.00"
                ...
                <form role="form" id="edit_item_detail_form" class="form-horizontal">
                    <table class="table table-bordered table-condensed no-color" id="StockTransfer_detail_edit_table">
                        ...
                        <tr>
                            ...
                            <td><input type="text" onfocus="this.select();" name="grossQty"
                                                         onkeyup="checkCurrentStock_buyback(this),cal_deduction_netQtyEdit_buyback(this)" placeholder="0.00"
                                                         class="form-control number input-mini grossQty" id="edit_grossQty" required>
                            </td>
                            <td><input type="text" onfocus="this.select();" name="noOfUnits"
                                                         onkeyup="checkCurrentStock_buyback(this),cal_deduction_netQtyEdit_buyback(this)" placeholder="0.00"
                                                         class="form-control number input-mini noOfUnits" id="edit_noOfUnits" required>
                            </td>
                           <!-- <td><input type="text" onfocus="this.select();" name="deduction"
                                                         onkeyup="cal_deduction_netQty(this),cal_deduction_netQtyEdit_buyback()" placeholder="0.00"
                                                         class="form-control number input-mini deduction" id="edit_deduction" required>
                            </td>-->
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/inventory/stock_transfer_management_buyback', stockTransferAutoID, 'Stock Transfer');
        });
        $('.select2').select2();
        number_validation();
        type = 'Inventory';
        ...
        if (p_id) {
            ...
            $("#a_link").attr("href", "<?php echo site_url('Inventory/load_stock_transfer_conformation_buyback'); ?>/" + stockTransferAutoID);
        ...
        $('#stock_transfer_form').bootstrapValidator({
            ...
            data.push({'name': 'transferType', 'value': 'standard'});
            $.ajax({
                async: true,
                type: 'post',
                dataType: 'json',
        ...
        if (stockTransferAutoID) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (jQuery.isEmptyObject(data)) {
                        ...
                        $.each(data, function (key, value) {
                            if (value['isSubitemExist'] == 1) {
                                ...
                                string = '<tr><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td>' + value['itemDescription'] + '</td><td class="text-center">' + value['unitOfMeasure'] + '</td><td class="text-right">' + value['grossQty'] + '</td> <td class="text-right">' + value['noOfUnits'] + '</td> <td class="text-right">' + value['deduction'] + '</td><td class="text-right">' + value['transfer_QTY'] + '</td><td class="text-right">' + parseFloat(value['currentlWacAmount']).formatMoney(descm, '.', ',') + '</td><td class="text-right">' + parseFloat(value['totalValue']).formatMoney(descm, '.', ',') + '</td><td class="text-right"><a style="' + colour + '" onclick="load_itemMasterSub_config_modal(' + value['stockTransferDetailsID'] + ',\'ST\',' + value['from_wareHouseAutoID'] + ')"><i class="fa fa-list"></i></a> &nbsp;&nbsp; | &nbsp;&nbsp; <a onclick="edit_item(' + value['stockTransferDetailsID'] + ');"><span class="glyphicon glyphicon-pencil"></span></a>  &nbsp;&nbsp; | &nbsp;&nbsp;<a onclick="delete_stock_transferDetails(' + value['stockTransferDetailsID'] + ');"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td></tr>';
                            } else {

                                string = '<tr><td>' + x + '</td><td>' + value['itemSystemCode'] + '</td><td>' + value['itemDescription'] + '</td><td class="text-center">' + value['unitOfMeasure'] + '</td><td class="text-right">' + value['grossQty'] + '</td> <td class="text-right">' + value['noOfUnits'] + '</td> <td class="text-right">' + value['deduction'] + '</td><td class="text-right">' + value['transfer_QTY'] + '</td>  <td class="text-right">' + parseFloat(value['currentlWacAmount']).formatMoney(descm, '.', ',') + '</td><td class="text-right">' + parseFloat(value['totalValue']).formatMoney(descm, '.', ',') + '</td><td class="text-right"><a onclick="edit_item(' + value['stockTransferDetailsID'] + ');"><span class="glyphicon glyphicon-pencil"></span></a> &nbsp;&nbsp; | &nbsp;&nbsp;<a onclick="delete_stock_transferDetails(' + value['stockTransferDetailsID'] + ');"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td></tr>';
                    ...
                    $('#item_table_tfoot').html('<tr> <td class="text-right" colspan="9"> <?php echo $this->lang->line('common_total');?> </td><td class="text-right total">' + total.formatMoney(descm, '.', ',') + '</td><td></td></tr>')
                    stopLoad();<!--Total-->
  ...
  /*  function cal_deduction_netQty(element) {
        ...
        var deduction = parseFloat($(element).closest('tr').find('.deduction').val());
        if (grossQty) {
            $(element).closest('tr').find('.transferqty').val((parseFloat(grossQty - deduction).toFixed(2)));
    ...
    function cal_deduction_netQty(element) {
        ...
        if (grossQty) {
            $(element).closest('tr').find('.transferqty').val((parseFloat(grossQty - (noOfUnits * deduction)).toFixed(2)));
    ...
    function load_conformation() {
        if (stockTransferAutoID) {
            $.ajax({
                ...
                url: "<?php echo site_url('Inventory/load_stock_transfer_conformation_buyback'); ?>",
                beforeSend: function () {
                    startLoad();
                },
                success: function (data) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data['error'] == 1) {
                                ...
                                fetchPage('system/inventory/stock_transfer_management_buyback', 'Test', 'Stock Transfer');
                            }
    ...
    function saveStockTransfer_addItem() {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: data,
            url: "<?php echo site_url('Inventory/save_stock_transfer_detail_multiple_buyback'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
    ...
    function updateStockTransfer_addItem() {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: data,
            url: "<?php echo site_url('Inventory/save_stock_transfer_detail_buyback'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
    ...
    function checkCurrentStock_buyback(det){
    ...
    function checkCurrentStockEdit_buyback(){
                ...
                success: function (data) {
                    ...
                    if (jQuery.isEmptyObject(data)) {
                        ...
                        $.each(data['details'], function (key, value) {
                            ...
                            var string = '<tr> <td> <input type="text" onkeyup="clearitemAutoID(event,this)" value="' + value['itemDescription'] + ' (' + value['itemSystemCode'] + ')" class="form-control search f_search" name="search[]" placeholder="Item ID,Item Description..." id="f_search_'+ x +'"> <input type="hidden" class="form-control itemAutoID" name="itemAutoID[]" value="' + value['itemAutoID'] + '"> <input type="hidden" class="form-control stockTransferDetailsID" name="stockTransferDetailsID[]" value="' + value['stockTransferDetailsID'] + '"> <input type="hidden" class="form-control currentStock" name="currentStock[]"></td> <td>'+ UOM +'</td> <td> <div class="input-group"> <input type="text" name="currentWareHouseStockQty[]"class="form-control currentWareHouseStock" value="' + value['wareHouseStock'] + '" required readonly> </div> </td> <td>'+ Segment +'</td><td><input type="text" onfocus="this.select();" name="noOfItems[]" onkeyup="checkCurrentStock_buyback(this)" placeholder="0.00" class="form-control number input-mini noOfItems" id="edit_noOfItems" value="' + value['noOfItems'] + '" required></td><td><input type="text" onfocus="this.select();" name="grossQty[]" onkeyup="checkCurrentStock_buyback(this),cal_deduction_netQty(this)" placeholder="0.00" class="form-control number input-mini grossQty" id="edit_grossQty"  value="' + value['grossQty'] + '"  required></td><td><input type="text" onfocus="this.select();" name="noOfUnits[]" onkeyup="checkCurrentStock_buyback(this)" placeholder="0.00"class="form-control number input-mini noOfUnits" id="edit_noOfUnits" value="' + value['noOfUnits'] + '"   required></td><td><input type="text" onfocus="this.select();" name="deduction[]" onkeyup="cal_deduction_netQty(this),cal_deduction_netQtyEdit_buyback()" placeholder="0.00" class="form-control number input-mini deduction" id="edit_deduction"  value="' + value['deduction'] + '"  required></td> <td style="width: 100px"> <input type="text" name="transfer_QTY[]" onfocus="this.select();" onkeyup="checkCurrentStock(this)" value="' + value['transfer_QTY'] + '" class="form-control number transferqty"required> </td><td class="remove-td"><a onclick="delete_stock_transferDetailsEdit(' + value['stockTransferDetailsID'] + ',this);"><span style="color:rgb(209, 91, 71);" class="glyphicon glyphicon-trash"></span></a></td></tr>';
    ...
    function updateStockTransfer_edit_all_Item() {
        ...
        $.ajax({
            ...
            dataType: 'json',
            data: data,
            url: "<?php echo site_url('Inventory/save_stock_transfer_detail_edit_all_multiple_buyback'); ?>",
            beforeSend: function () {
                startLoad();
            },
            success: function (data) {
    ...
    function cal_deduction_netQtyEdit_buyback() {
        ...
        if (grossQty) {
            $('#transferqty_edit').val((parseFloat(grossQty - (deduction * edit_noOfUnits)).toFixed(2)));
