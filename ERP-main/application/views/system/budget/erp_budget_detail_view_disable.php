...
/*
                        ...
                        <tr>
                            ...
                            <?php foreach ($months_all as $monthval) {?>
                                <td class="tdIn">
                                    ...
                                    ?>
                                    <input class="form-control amount" disabled type="text" name="amount"
    ...
    font-weight: bold;background-color: #d4d2d2">
                    ...
                    <?php foreach ($months_all as $monthval) {
                        ...
                        ?>
                        <td style="text-align: right;padding-right: 29px; font-size: 11px"><span id="<?php echo $key.'_'.$monthval['month'] ?>"> <?php echo format_number($total['month_'.$monthval['month']])  ?></span></td>
                        </td>
                    <?php }?>
                </tr>
                <?php
