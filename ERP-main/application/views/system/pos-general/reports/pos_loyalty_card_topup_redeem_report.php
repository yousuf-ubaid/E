...
if (!isset($pdf)) {
    ...
    <button type="button" id="btn_print_sales2" class="btn btn-default btn-xs"> <i
        ...
        <a href="" class="btn btn-excel btn-xs" id="btn-excel" download="Gift_Card_Report.xls"
           onclick="var file = tableToExcel('container_loyalty_card_report2', 'Loyalty Card Report'); $(this).attr('href', file);">
            <i class="fa fa-file-excel-o" aria-hidden="true"></i> Excel
        </a>
</span>
<?php } ?>
<div id="container_loyalty_card_report2">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <?php //echo $this->lang->line('posr_filtered_date'); ?><!--Filtered Date--> <strong>
                ...
                if (!empty($tmpFilterDateFrom)) {
                    echo '  <i> From: </i><span id="to_date">'.$tmpFilterDateFrom.'</span>';
                }

                if (!empty($tmpFilterDateTo)) {
                    echo '  <i> To: </i><span id="to_date">'.$tmpFilterDateTo.'</span>';
                }
                ?>
            </strong>
        </div>
...
<script>
    ...
    $(document).ready(function (e) {
        $("#btn_print_sales2").click(function (e) {
            $.print("#container_loyalty_card_report2");
        });
        var date = new Date,
            hour = date.getHours(),
    ...
    $("#container_loyalty_card_report2").on('click', '.show-card-details', function (e) {
