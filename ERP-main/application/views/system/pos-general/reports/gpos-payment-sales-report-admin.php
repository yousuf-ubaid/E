...
<div id="container_sales_report3">
    ...
    <div style="margin-top:20px; border:1px solid #a3a3a3; padding:5px;">
        ...
        <div class="row">
            <div class="col-xs-7 col-sm-7 col-md-7 col-lg-7">
                <div class="subHeadingTitle">Summary</div>
                <table class="<?php echo table_class_pos(5) ?>">
                    ...
                    <tr>
                        ...
                        <td class="text-right"><?php echo isset($totalBills['countTransaction']) ? $totalBills['countTransaction'] : 0; ?></td>
                        <td class="text-right"></td>
                        <td class="text-right"><?php echo number_format($totalBills['NetTotal'], $d) ?></td>
                        <td class="text-right"><?php echo $totalBills['NetTotal'] > 0 ? number_format(($totalBills['NetTotal'] / $totalBills['NetTotal']) * 100, 2) . '%' : 0;
                            ?>  </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="text-right">
                            <?php
                            echo $voidBills['NetTotal'] > 0 ? number_format(($voidBills['NetTotal'] /$totalBills['NetTotal']) * 100, 2) . '%' : 0;
                            ?> </td>
                    </tr>
                    </tbody>

                    <?php
                    if($totalBills['NetTotal']>0){
                        $ttBills=$totalBills['NetTotal'];
                    }else{
                        $ttBills=0;
                    }

                    if($voidBills['NetTotal']>0){
                        $vidBills=$voidBills['NetTotal'];
                    }else{
                        $vidBills=0;
                    }

                    $grossTotal=$ttBills-$vidBills;
                    ?>
                    <tr>
                    ...
                    if (!empty($lessAmounts)) {
                        foreach ($lessAmounts as $less) {
                            if ($less['lessAmount'] > 0) {
                                ...
                                <tr>
                                    ...
                                    <td></td>
                                    <td class="text-right"><?php echo number_format(($less['lessAmount'] / ($ttBills)) * 100, 2) . '%' ?> </td>
                                </tr>
                                <?php
                            }
                        }
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <strong><?php echo $totalBill > 0 ? number_format(($lessTotal / ($ttBills)) * 100, 2) . '%' : 0; ?></strong>
                            </td>
                        </tr>
                    ...
                    if($voidBills['countTransaction']>0){
                        $vidbilcunt=$voidBills['countTransaction'];
                    }else{
                        $vidbilcunt=0;
                    }
                    if($totalBills['countTransaction']>0){
                        $totbilcnt=$totalBills['countTransaction'];
                    }else{
                        $totbilcnt=0;
                    }

                    $netsalescount=$totbilcnt-$vidbilcunt;
                    ?>



                    <tr>
                        <td><strong>Net Sales (excluding refund)</strong></td>
                        <td class="text-right"><?php echo $netsalescount ?></td>
                        <td></td>
                        <td class="text-right"><strong><?php echo number_format($grossTotal-$lessTotal, $d) ?></strong></td>
                        <td class="text-right"><?php echo $totalBill > 0 ? number_format((($grossTotal-$lessTotal) / $totalBills['NetTotal']) * 100, 2) . '%' : 0; ?></td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td class="text-right">
                            <strong><?php echo $netsalescount > 0 ? number_format((($grossTotal-$lessTotal) / $netsalescount), $d) : 0; ?></strong>
                        </td>
                        <td></td>
                    </tr>
            ...
            <div class="col-xs-5 col-sm-5 col-md-5 col-lg-5">
                ...
                <div class="subHeadingTitle" style="margin-top: 19px;">Return Sales</div>
                <table class="<?php echo table_class_pos(5) ?>">
                    <thead>
                    <tr>
                        <th>Return Type</th>
                    ...
                    <?php
                    $refund=0;
                    if (!empty($returnBills)) {
                        foreach ($returnBills as $returnBill) {
                            if($returnBill['returnMode']==2){
                                $refund = $returnBill['NetTotal'];
                            }
                            ?>
                            <tr>
                                <td>
                                    <?php echo $returnBill['returnModeDescription'] ?>
                                </td>
                                <td class="text-right">
                                    <?php echo $returnBill['countTransaction'] ?>
                                </td>
                                <td class="text-right">
                                    <?php echo $returnBill['NetTotal']; ?>
                                </td>
                            </tr>
                            <?php
                        }
    ...
    <div style="margin-top:20px; border:1px solid #a3a3a3; padding:5px;">
        ...
        <div class="subHeadingTitle hidden"><strong> Gift Card Top-up</strong></div>
        <div>
            ...
            <table class="<?php echo table_class_pos(5) ?>">
                ...
                <tr>
                    <td>
                        <strong>Total Cash Collection (Cash-Refund)</strong>
                    </td>
                    <td class="text-right"><strong><?php echo number_format(($totalCashSales-$refund), $d) ?></strong></td>
                </tr>
                </thead>
            </table>
...
<script>
    ...
    function generatePaymentSalesReportPdf() {
        ...
        form.target = '_blank';
        form.action = '<?php echo site_url('Pos_general_report/sales_report_pdf'); ?>';
        form.submit();
    }
