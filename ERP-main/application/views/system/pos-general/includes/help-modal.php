            ...
            <div class="modal-body">
                <table class="table table-bordered table-condensed table-striped customTbl">
                    ...
                    <tr>
                        <td class="ac">F12</td>
                        <td>
                            <strong>Pay in Cash : </strong>  This process will skip the payment window and it will directly pay the bill using cash and print the receipt.
                        </td>
                    </tr>
                    <tr>
