...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        $('.headerclose').click(function () {
            fetchPage('system/accounts_payable/supplier_invoices_management_buyback', InvoiceAutoID, 'Supplier Invoices');
        });
        $('.select2').select2();
        InvoiceAutoID = null;
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (!jQuery.isEmptyObject(data)) {
                        ...
                        setTimeout(function(){ $("#supplierID").val(data['supplierID']).change(); }, 500);
