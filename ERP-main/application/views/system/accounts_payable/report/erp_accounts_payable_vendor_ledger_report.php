                ...
                <div class="fixHeader_Div">
                    <table class="borderSpace report-table-condensed" id="tbl_report">
                        ...
                        <tr>
                            ...
                            <th>Doc Due Date<!--Doc Date--></th>
                            <th>Supplier Invoice Code<!--Doc Date--></th>
                        ...
                        if (!empty($category)) {
                            foreach ($category as $key => $glcodes) {
                                ...
                                foreach ($glcodes as $key2 => $suppliers) {
                                    ...
                                    $subtotal = array();
                                    if ($isTransCost) {
                                        foreach ($suppliers as $key3 => $currency) {
                                            $subtotalTrans = array();
                                            $decimalPlace = 2;
                                            foreach ($currency as $key4 => $val) {
                                                ...
                                                if (!empty($fieldName)) {
                                                    foreach ($fieldName as $val2) {
                                                        ...
                                                        $subtotalTrans[$val2][] = (float)$val[$val2];
                                            ...
                                            echo "<td colspan='7'><div style='margin-left: 30px'> <b>Sub Total</b><!--Net Balance--></div></td>";
                                            if (!empty($fieldName)) {
                                                foreach ($fieldName as $val2) {
                                                    if ($val2 == "transactionAmount") {
                                                        echo "<td class='text-right reporttotal'>" . format_number(array_sum($subtotalTrans[$val2]), $decimalPlace) . "</td>";
                                                    }
                                ...
                                if ($isLocCost || $isRptCost) {
                                    ...
                                    if ($isTransCost) {
                                        ...
                                        echo "<td colspan='8'><div style='margin-left: 30px'><strong>$gran<!--Grand Total--></strong></div></td>";
                                    } else {
