                ...
                <div class="fixHeader_Div">
                    <table class="borderSpace report-table-condensed" id="tbl_report">
                            ...
                            foreach ($category as $key => $mainCategory) {
                                ...
                                foreach ($mainCategory as $key2 => $subCategory) {
                                    ...
                                    if($isTransCost) {
                                        foreach ($subCategory as $key3 => $curr) {
                                            ...
                                            foreach ($curr as $key4 => $supplier) {
                                                ...
                                                $grandTotal_PDC["PDCtoal"][] = $supplier["transactionAmountPDC"];
                                                $grandTotal_pdc_new["PDCtoalNew"][] = $supplier["transactionAmountPDC"];
                                                $transTotal["PDCtoalNew"][] = $supplier["transactionAmountPDC"];
                                                ...
                                                echo "<td class='text-right'>" . number_format($supplier['transactionAmountPDC'], $supplier["DecimalPlaces"]) . "</td>";
                                                echo "</tr>";
                                            ...
                                            echo "<td class='text-right reporttotal'>" . format_number(array_sum($transTotal["PDCtoalNew"]), $decimalPlace) . "</td>";
                                            echo '</tr>';
                                        }
                                    } else {
                                        foreach ($subCategory as $key3 => $supplier) {
                                            ...
                                            if($isRptCost)
                                            {
                                                $total_pdc +=$supplier["companyReportingAmountPDCcheque"];
                                            }
                                            if($isLocCost)
                                            {
                                                $total_pdc +=$supplier["companyLocalAmountPDCcheque"];
                                            }
                                            if($isTransCost)
                                            {
                                                $total_pdc +=$supplier["transactionAmountPDC"];
                                            ...
                                            if($isRptCost)
                                            {
                                                $grandTotal_PDC["PDCtoal"][] = $supplier["companyReportingAmountPDCcheque"];
                                                $grandTotal_pdc_new["PDCtoalNew"][] = $supplier["companyReportingAmountPDCcheque"];
                                            }
                                            if($isLocCost)
                                            {
                                                $grandTotal_PDC["PDCtoal"][] =$supplier["companyLocalAmountPDCcheque"];
                                                $grandTotal_pdc_new["PDCtoalNew"][] =$supplier["companyLocalAmountPDCcheque"];
                                            }
                                            if($isTransCost)
                                            {
                                                $grandTotal_PDC["PDCtoal"][] = $supplier["transactionAmountPDC"];
                                            ...
                                            if($isRptCost)
                                            {
                                                echo "<td class='text-right'>" . number_format($supplier['companyReportingAmountPDCcheque'], $supplier["DecimalPlaces"]) . "</td>";
                                            }
                                            if($isLocCost)
                                            {
                                                echo "<td class='text-right'>" . number_format($supplier['companyLocalAmountPDCcheque'], $supplier["DecimalPlaces"]) . "</td>";
                                            }
                                            if($isTransCost)
                                            {
                                                echo "<td class='text-right'>" . number_format($supplier['transactionAmountPDC'], $supplier["DecimalPlaces"]) . "</td>";
                                    ...
                                    if ($isRptCost || $isLocCost) {
                                        ...
                                        if ($isRptCost) {
                                            echo "<td class='text-right reporttotal'>" . format_number(array_sum( $grandTotal_PDC["PDCtoal"]), $this->common_data['company_data']['company_reporting_decimal']) . "</td>";
                                        }
                                        if ($isLocCost) {
                                            echo "<td class='text-right reporttotal'>" . format_number(array_sum( $grandTotal_PDC["PDCtoal"]), $this->common_data['company_data']['company_default_decimal']) . "</td>";
                                        }
                                        echo "</tr>";
                                    }
                                }
                        ...
                        if ($isRptCost || $isLocCost) {
                            ...
                            if ($isRptCost) {
                                echo "<td class='text-right reporttotal'>" . format_number(array_sum( $grandTotal_pdc_new["PDCtoalNew"]), $this->common_data['company_data']['company_reporting_decimal']) . "</td>";
                            }
                            if ($isLocCost) {
                                echo "<td class='text-right reporttotal'>" . format_number(array_sum( $grandTotal_pdc_new["PDCtoalNew"]), $this->common_data['company_data']['company_default_decimal']) . "</td>";
                            }
                            echo "</tr>";
                        }
                        ?>
