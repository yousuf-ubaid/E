...
class Chart_of_acconts extends ERP_Controller
{
    ...
    function save_chart_of_accont()
    {
        ...
        {  /*if its 0 edit | not control account */
        ...
        else
        {
            ...
            echo json_encode($this->Chart_of_acconts_model->save_chart_of_accont());
        }
    }
    ...
    {
        echo json_encode($this->Chart_of_acconts_model->save_signature_authority());
    }
    /**SMSD  */
    function fetch_signature_authority()
    {
        echo json_encode($this->Chart_of_acconts_model->fetch_signature_authority());
    }
    /**SMSD  */
    function delete_author()
    {
        echo json_encode($this->Chart_of_acconts_model->delete_author());
    }
    ...
    {
        echo json_encode($this->Chart_of_acconts_model->load_chart_of_accont_header());
    }

    function fetch_master_account()
    {
        echo json_encode($this->Chart_of_acconts_model->fetch_master_account());
    }
    ...
    {
        echo json_encode($this->Chart_of_acconts_model->reOpen_chart_of_accont());
    }
    /* Function added */
    function export_excel_chartofaccounts_master()
    {
        ...
        $this->excel->getActiveSheet()->setTitle('Chart Of Account Master List');
        $this->load->database();
        $data = $this->Chart_of_acconts_model->export_excel_chartofaccounts_master();

        $header = ['#', 'System Code', 'Secondary Code', 'GL Description', 'Category Type', 'Sub Category', 'Bank Currency', 'Master Account Systemcode', 'Master GLCode', 'Master Account Description', 'Control Account YN', 'Is Bank', 'Bank Name', 'Bank Branch', 'Bank Short Code', 'Bank Swift Code', 'Balance', 'Data Exist'];
        $body = $data['chartofaccounts'];
        ...
        $filename = 'Chart Of Account Master.xls'; //save our workbook as this file name
