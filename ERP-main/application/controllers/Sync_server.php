...
/* -- =============================================
-- File Name : Sync_server.php
-- Project Name : POS
-- Module Name : Local POS Syncing
-- Create date : 2017
-- Description : SME POS System.

--REVISION HISTORY
--Date: 25 - Oct 2016 : SME-1307 Manual Pulling from LIVE to Local POS - Gift Card new function is added
...
class Sync_server extends CI_Controller
{
    ...
    function pull_data()
    {
        ...
        if (!empty($companyInfo)) {
            ...
            if (($companyInfo['localposaccesstoken'] === $input_token) && (!empty($companyInfo['localposaccesstoken'])) && ($companyInfo['localposaccesstoken'] != '') && ($companyInfo['localposaccesstoken'] != '0')) {
                ...
                $tables[] = 'srp_erp_pos_warehousemenucategory';
                $tables[] = 'srp_erp_warehouse_users';
                $tables[] = 'srp_erp_warehousemaster';
                $tables[] = 'srp_erp_companycurrencyassign';
                $tables[] = 'srp_erp_companycurrencyconversion';

                /** Added on 23-Aug-2018 */
                $tables[] = 'srp_erp_company';
                $tables[] = 'srp_erp_chartofaccounts';
                $tables[] = 'srp_erp_companyfinanceperiod';
                ...
                $tables[] = 'srp_erp_pos_customermaster'; // FOREIGN KEY CONSTRAIN
                ...
                $tables[] = 'srp_erp_pos_menuservicecharge';
    ...
    /**
     * Gift Card Data Pulling from Live
     */
