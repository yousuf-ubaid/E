...
class Api_srm_portal extends REST_Controller
{
    ...
    public function save_supplier_invoice_post(){
       // $this->load->library('jwt');
        ...
        try {
            ...
            $detail = $this->Srm_master_model->save_supplier_invoice($orders['results']['dataMaster'],$orders['results']['dataSub'],$orders['results']['dataCat']);
    ...
    public function save_supplier_grv_post(){
        ...
        try {
            ...
            $detail = $this->Srm_master_model->save_supplier_grv($orders['results']['dataMaster'],$orders['results']['dataSub']);
    ...
    public function re_upload_vendor_reject_document_post(){
        ...
        try {
            ...
            $detail = $this->Srm_master_model->re_upload_vendor_reject_document($orders['results']['dataMaster']);
    ...
    public function save_vendor_company_request_post(){
        ...
        try {
            ...
            $detail = $this->Srm_master_model->save_vendor_company_request_details($orders['results']['dataMaster'],$orders['results']['dataSub'],$orders['results']['dataCat'],$orders['results']['dataOther'],$orders['results']['type']);
    ...
    public function get_group_company_employee_detail_post(){
        ...
        try {
            ...
            $emp_detail = $this->Srm_master_model->fetch_group_company_employee_detail($companyID);
           
            if($emp_detail['status']==true){
                $data['status'] = true;
                $data['message'] = "update successfully";
                $data['result'] = $emp_detail;
                return $this->set_response($data, REST_Controller::HTTP_INTERNAL_SERVER_ERROR);
            }else{
                $data['status'] = false;
                $data['message'] = "Try Again";
    ...
    public function save_vendor_attachment_post(){
        ...
        try {
            ...
            $detail = $this->Srm_master_model->save_vendor_attachment($orders['results']['dataMaster']);
    ...
    public function get_supplier_po_status_post(){
        ...
        try {
            ...
            $detail = $this->Srm_master_model->get_supplier_po_status($orders['results']['dataSub']);
    ...
    public function save_supplier_po_close_details_post(){
        ...
        try {
            ...
            $detail = $this->Srm_master_model->save_supplier_po_close_details($orders['results']['dataMaster']);
