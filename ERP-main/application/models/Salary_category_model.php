...
class Salary_category_model extends ERP_Model{
    ...
    function usageInSalaryDeclaration($catID,$companyID){
        $query = $this->db->select('declarationDetailID')->from('srp_erp_salarydeclarationdetails')
                ->where('salaryCategoryID', $catID)->where('companyID', $companyID)->get();
