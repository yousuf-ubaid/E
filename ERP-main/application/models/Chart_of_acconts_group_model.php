...
class Chart_of_acconts_group_model extends ERP_Model
{
    ...
    function load_chart_of_accont_header()
    {
        ...
        $res = $this->db->get('srp_erp_groupchartofaccounts')->row_array();
...
GLAutoID = $GlAutoid ")->row_array();
    ...
    function updategroppolicy()
    {
        ...
        if ($results) {
            return array('s', 'Chart of Accounts policy updated successfully');
        } else {
            return array('e', 'Chart of Accounts policy updated failed');
        }
